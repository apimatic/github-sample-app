...
/**
 * This is a model class for UserMigrations404ErrorException type.
 */
public class UserMigrations404ErrorException extends ApiException {
    private static final long serialVersionUID = -3970447988040116364L;
     ...
     */
    public UserMigrations404ErrorException(String reason, Context context) {
