 ...
 */
@JsonDeserialize(using = PullRequest34Assignees.PullRequest34AssigneesDeserializer.class)
public abstract class PullRequest34Assignees {
     ...
     */
    public static PullRequest34Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest34Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest34Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest34Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest34Assignees.
     */
    protected static class PullRequest34AssigneesDeserializer
            extends JsonDeserializer<PullRequest34Assignees> {

        @Override
        public PullRequest34Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
