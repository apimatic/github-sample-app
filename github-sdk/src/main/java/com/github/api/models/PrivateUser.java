...
/**
 * This is a model class for PrivateUser type.
 */
public class PrivateUser {
     ...
     */
    protected PrivateUser(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    /**
     * Converts this PrivateUser into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PrivateUser [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link PrivateUser.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PrivateUser.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PrivateUser}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PrivateUser} object using the set fields.
         * @return {@link PrivateUser}
         */
        public PrivateUser build() {
            return new PrivateUser(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
                    organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin, name,
