...
/**
 * This is a model class for Labelcreatedevent type.
 */
public class Labelcreatedevent {
    ...
    /**
     * Converts this Labelcreatedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Labelcreatedevent [" + "action=" + action + ", label=" + label + ", repository="
                + repository + ", enterprise=" + enterprise + ", installation=" + installation
                + ", organization=" + organization + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link Labelcreatedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Labelcreatedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, label, repository)
    ...
    /**
     * Class to build instances of {@link Labelcreatedevent}.
     */
    public static class Builder {
         ...
         * @param  repository  Repository3 value for repository.
         */
        public Builder(String action, Label10 label, Repository3 repository) {
            this.action = action;
            this.label = label;
            this.repository = repository;
        }
        ...
        /**
         * Builds a new {@link Labelcreatedevent} object using the set fields.
         * @return {@link Labelcreatedevent}
         */
        public Labelcreatedevent build() {
            return new Labelcreatedevent(action, label, repository, enterprise, installation,
                    organization, sender);
        }
    }
}
