 ...
 */
@JsonDeserialize(using = SimplePullRequestAssignees.SimplePullRequestAssigneesDeserializer.class)
public abstract class SimplePullRequestAssignees {
     ...
     */
    public static SimplePullRequestAssignees fromObject(Map<String, Object> object) {
     ...
     */
    public static SimplePullRequestAssignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends SimplePullRequestAssignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends SimplePullRequestAssignees {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequestAssignees.
     */
    protected static class SimplePullRequestAssigneesDeserializer
            extends JsonDeserializer<SimplePullRequestAssignees> {

        @Override
        public SimplePullRequestAssignees deserialize(JsonParser jp, DeserializationContext ctxt)
