...
/**
 * This is a model class for CommitComparison type.
 */
public class CommitComparison {
    ...
    /**
     * Converts this CommitComparison into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CommitComparison [" + "url=" + url + ", htmlUrl=" + htmlUrl + ", permalinkUrl="
                + permalinkUrl + ", diffUrl=" + diffUrl + ", patchUrl=" + patchUrl + ", baseCommit="
                + baseCommit + ", mergeBaseCommit=" + mergeBaseCommit + ", status=" + status
                + ", aheadBy=" + aheadBy + ", behindBy=" + behindBy + ", totalCommits="
                + totalCommits + ", commits=" + commits + ", files=" + files + "]";
    }

    /**
     * Builds a new {@link CommitComparison.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CommitComparison.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CommitComparison}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CommitComparison} object using the set fields.
         * @return {@link CommitComparison}
         */
        public CommitComparison build() {
            return new CommitComparison(url, htmlUrl, permalinkUrl, diffUrl, patchUrl, baseCommit,
                    mergeBaseCommit, status, aheadBy, behindBy, totalCommits, commits, files);
        }
    }
}
