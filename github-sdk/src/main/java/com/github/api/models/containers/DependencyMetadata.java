 ...
 */
@JsonDeserialize(using = DependencyMetadata.DependencyMetadataDeserializer.class)
public abstract class DependencyMetadata {
     ...
     */
    public static DependencyMetadata fromMString(String mString) {
     ...
     */
    public static DependencyMetadata fromPrecision(double precision) {
     ...
     */
    public static DependencyMetadata fromMBoolean(boolean mBoolean) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends DependencyMetadata {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class PrecisionCase extends DependencyMetadata {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class MBooleanCase extends DependencyMetadata {
    ...
    /**
     * This is a custom deserializer class for DependencyMetadata.
     */
    protected static class DependencyMetadataDeserializer
            extends JsonDeserializer<DependencyMetadata> {

        @Override
        public DependencyMetadata deserialize(JsonParser jp, DeserializationContext ctxt)
