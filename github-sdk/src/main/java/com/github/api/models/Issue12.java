...
import com.github.api.models.containers.Issue12Assignees;
...
/**
 * This is a model class for Issue12 type.
 */
public class Issue12 {
    private Object activeLockReason;
    private Object assignee;
    private List<Issue12Assignees> assignees;
     ...
     * @param  assignees  List of Issue12Assignees value for assignees.
    ...
    public Issue12(
            ...
            List<Issue12Assignees> assignees,
     ...
     */
    protected Issue12(Object activeLockReason, List<Issue12Assignees> assignees,
            ...
            ReactionRollup reactions, String repositoryUrl, String title, LocalDateTime updatedAt,
            String url, Object user, Object assignee, Boolean draft, List<Label10> labels,
            Boolean locked, Object performedViaGithubApp, PullRequest7 pullRequest,
     ...
     * @return Returns the List of Issue12Assignees
     */
    @JsonGetter("assignees")
    public List<Issue12Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of Issue12Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<Issue12Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Converts this Issue12 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue12 [" + "activeLockReason=" + activeLockReason + ", assignees=" + assignees
                ...
                + ", repositoryUrl=" + repositoryUrl + ", title=" + title + ", updatedAt="
                + updatedAt + ", url=" + url + ", user=" + user + ", assignee=" + assignee
                + ", draft=" + draft + ", labels=" + labels + ", locked=" + locked
                + ", performedViaGithubApp=" + performedViaGithubApp + ", pullRequest="
                + pullRequest + ", state=" + state + ", stateReason=" + stateReason
                + ", timelineUrl=" + timelineUrl + "]";
    }

    /**
     * Builds a new {@link Issue12.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue12.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(activeLockReason, assignees, authorAssociation, body,
                ...
                milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user)
    ...
    /**
     * Class to build instances of {@link Issue12}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(Object activeLockReason, List<Issue12Assignees> assignees,
                AuthorAssociationEnum authorAssociation, String body, LocalDateTime closedAt,
                int comments, String commentsUrl, LocalDateTime createdAt, String eventsUrl,
                String htmlUrl, int id, String labelsUrl, Object milestone, String nodeId,
                int number, ReactionRollup reactions, String repositoryUrl, String title,
                LocalDateTime updatedAt, String url, Object user) {
            this.activeLockReason = activeLockReason;
            this.assignees = assignees;
            this.authorAssociation = authorAssociation;
            this.body = body;
         ...
         * @return Builder
         */
        public Builder assignees(List<Issue12Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue12} object using the set fields.
         * @return {@link Issue12}
         */
        public Issue12 build() {
            return new Issue12(activeLockReason, assignees, authorAssociation, body, closedAt,
                    comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, milestone,
                    nodeId, number, reactions, repositoryUrl, title, updatedAt, url, user, assignee,
                    draft, labels, locked, performedViaGithubApp, pullRequest, state, stateReason,
                    timelineUrl);
        }
    }
}
