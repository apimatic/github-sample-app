...
/**
 * This is a model class for SimpleCheckSuite type.
 */
public class SimpleCheckSuite {
     ...
     */
    protected SimpleCheckSuite(OptionalNullable<String> after, App22 app,
    ...
    /**
     * Converts this SimpleCheckSuite into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SimpleCheckSuite [" + "after=" + after + ", app=" + app + ", before=" + before
    ...
    /**
     * Builds a new {@link SimpleCheckSuite.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SimpleCheckSuite.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SimpleCheckSuite}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SimpleCheckSuite} object using the set fields.
         * @return {@link SimpleCheckSuite}
         */
        public SimpleCheckSuite build() {
            return new SimpleCheckSuite(after, app, before, conclusion, createdAt, headBranch,
                    headSha, id, nodeId, pullRequests, repository, status, updatedAt, url);
        }
    }
}
