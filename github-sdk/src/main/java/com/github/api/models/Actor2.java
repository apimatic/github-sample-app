...
/**
 * This is a model class for Actor2 type.
 */
public class Actor2 {
     ...
     */
    protected Actor2(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    /**
     * Converts this Actor2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Actor2 [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", avatarUrl="
    ...
    /**
     * Builds a new {@link Actor2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Actor2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Actor2}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Actor2} object using the set fields.
         * @return {@link Actor2}
         */
        public Actor2 build() {
            return new Actor2(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl,
