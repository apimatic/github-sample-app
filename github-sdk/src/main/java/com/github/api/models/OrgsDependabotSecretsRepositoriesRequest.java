...
/**
 * This is a model class for OrgsDependabotSecretsRepositoriesRequest type.
 */
public class OrgsDependabotSecretsRepositoriesRequest {
    private List<Integer> selectedRepositoryIds;

    /**
     * Default constructor.
     */
    public OrgsDependabotSecretsRepositoriesRequest() {
    }
    ...
    /**
     * Converts this OrgsDependabotSecretsRepositoriesRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OrgsDependabotSecretsRepositoriesRequest [" + "selectedRepositoryIds="
                + selectedRepositoryIds + "]";
    }

    /**
     * Builds a new {@link OrgsDependabotSecretsRepositoriesRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link OrgsDependabotSecretsRepositoriesRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link OrgsDependabotSecretsRepositoriesRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link OrgsDependabotSecretsRepositoriesRequest} object using the set
         * fields.
         * @return {@link OrgsDependabotSecretsRepositoriesRequest}
         */
        public OrgsDependabotSecretsRepositoriesRequest build() {
            return new OrgsDependabotSecretsRepositoriesRequest(selectedRepositoryIds);
        }
    }
}
