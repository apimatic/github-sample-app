...
/**
 * This is a model class for MarketplaceListingStubbedAccountsResponse type.
 */
public class MarketplaceListingStubbedAccountsResponse {
    private String url;
    private String type;
    private int id;
     ...
     * Default constructor.
     */
    public MarketplaceListingStubbedAccountsResponse() {
    }
     ...
     */
    protected MarketplaceListingStubbedAccountsResponse(String url, String type, int id,
            String login, MarketplacePurchase1 marketplacePurchase, String organizationBillingEmail,
    ...
    /**
     * Converts this MarketplaceListingStubbedAccountsResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MarketplaceListingStubbedAccountsResponse [" + "url=" + url + ", type=" + type
                + ", id=" + id + ", login=" + login + ", marketplacePurchase=" + marketplacePurchase
                + ", organizationBillingEmail=" + organizationBillingEmail + ", email=" + email
                + ", marketplacePendingChange=" + marketplacePendingChange + "]";
    }

    /**
     * Builds a new {@link MarketplaceListingStubbedAccountsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MarketplaceListingStubbedAccountsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MarketplaceListingStubbedAccountsResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link MarketplaceListingStubbedAccountsResponse} object using the set
         * fields.
         * @return {@link MarketplaceListingStubbedAccountsResponse}
         */
        public MarketplaceListingStubbedAccountsResponse build() {
            return new MarketplaceListingStubbedAccountsResponse(url, type, id, login,
                    marketplacePurchase, organizationBillingEmail, email, marketplacePendingChange);
        }
    }
}
