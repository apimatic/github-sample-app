...
/**
 * This is a model class for AppHookDeliveriesResponse1 type.
 */
public class AppHookDeliveriesResponse1 {
    private int id;
    private String guid;
     ...
     * Default constructor.
     */
    public AppHookDeliveriesResponse1() {
    }
    ...
    /**
     * Converts this AppHookDeliveriesResponse1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AppHookDeliveriesResponse1 [" + "id=" + id + ", guid=" + guid + ", deliveredAt="
                + deliveredAt + ", redelivery=" + redelivery + ", duration=" + duration
                + ", status=" + status + ", statusCode=" + statusCode + ", event=" + event
                + ", action=" + action + ", installationId=" + installationId + ", repositoryId="
                + repositoryId + ", request=" + request + ", response=" + response + ", url=" + url
                + "]";
    }

    /**
     * Builds a new {@link AppHookDeliveriesResponse1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AppHookDeliveriesResponse1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AppHookDeliveriesResponse1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link AppHookDeliveriesResponse1} object using the set fields.
         * @return {@link AppHookDeliveriesResponse1}
         */
        public AppHookDeliveriesResponse1 build() {
            return new AppHookDeliveriesResponse1(id, guid, deliveredAt, redelivery, duration,
                    status, statusCode, event, action, installationId, repositoryId, request,
                    response, url);
        }
    }
}
