...
import com.github.api.models.containers.PullRequest50Assignees;
import com.github.api.models.containers.PullRequest50RequestedReviewers;
...
/**
 * This is a model class for PullRequest50 type.
 */
public class PullRequest50 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest50Assignees> assignees;
    ...
    private List<PullRequest50RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest50Assignees value for assignees.
     ...
     * @param  head  Head35 value for head.
     ...
     * @param  requestedReviewers  List of PullRequest50RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest50(
            ...
            Object assignee,
            List<PullRequest50Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest50RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest50(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest50Assignees> assignees, AuthorAssociationEnum authorAssociation,
            Object autoMerge, Base8 base, String body, LocalDateTime closedAt, String commentsUrl,
            String commitsUrl, LocalDateTime createdAt, String diffUrl, boolean draft, Head35 head,
            ...
            int number, String patchUrl, List<PullRequest50RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest50Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest50Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest50Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest50Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Head.
     * @return Returns the Head35
     */
    @JsonGetter("head")
    public Head35 getHead() {
        return head;
    }

    /**
     * Setter for Head.
     * @param head Value for Head35
     */
    @JsonSetter("head")
    public void setHead(Head35 head) {
        this.head = head;
    }
     ...
     * @return Returns the List of PullRequest50RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest50RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest50RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest50RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest50 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest50 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest50.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest50.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest50}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<PullRequest50Assignees> assignees, AuthorAssociationEnum authorAssociation,
                Object autoMerge, Base8 base, String body, LocalDateTime closedAt,
                String commentsUrl, String commitsUrl, LocalDateTime createdAt, String diffUrl,
                boolean draft, Head35 head, String htmlUrl, int id, String issueUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest50Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder head(Head35 head) {
            this.head = head;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest50} object using the set fields.
         * @return {@link PullRequest50}
         */
        public PullRequest50 build() {
            return new PullRequest50(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
