...
/**
 * This is a model class for Projectsv2ItemReorderedEvent type.
 */
public class Projectsv2ItemReorderedEvent {
    private String action;
    private Changes23 changes;
     ...
     * Default constructor.
     */
    public Projectsv2ItemReorderedEvent() {
        action = "reordered";
    }
     ...
     * @param  changes  Changes23 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes23
     */
    @JsonGetter("changes")
    public Changes23 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes23
     */
    @JsonSetter("changes")
    public void setChanges(Changes23 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Projectsv2ItemReorderedEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Projectsv2ItemReorderedEvent [" + "action=" + action + ", changes=" + changes
                + ", organization=" + organization + ", projectsV2Item=" + projectsV2Item
                + ", sender=" + sender + ", installation=" + installation + "]";
    }

    /**
     * Builds a new {@link Projectsv2ItemReorderedEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Projectsv2ItemReorderedEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Projectsv2ItemReorderedEvent}.
     */
    public static class Builder {
        private String action = "reordered";
        private Changes23 changes;
        private Organization2 organization;
        private ProjectsV2Item1 projectsV2Item;
        private Sender sender;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes23 changes, Organization2 organization,
         ...
         * @return Builder
         */
        public Builder changes(Changes23 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Projectsv2ItemReorderedEvent} object using the set fields.
         * @return {@link Projectsv2ItemReorderedEvent}
         */
        public Projectsv2ItemReorderedEvent build() {
            return new Projectsv2ItemReorderedEvent(action, changes, organization, projectsV2Item,
                    sender, installation);
        }
    }
}
