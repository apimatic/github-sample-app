...
/**
 * This is a model class for ProjectCard11 type.
 */
public class ProjectCard11 {
    ...
    /**
     * Converts this ProjectCard11 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ProjectCard11 [" + "afterId=" + afterId + ", archived=" + archived + ", columnId="
                + columnId + ", columnUrl=" + columnUrl + ", createdAt=" + createdAt + ", creator="
                + creator + ", id=" + id + ", nodeId=" + nodeId + ", note=" + note + ", projectUrl="
                + projectUrl + ", updatedAt=" + updatedAt + ", url=" + url + ", contentUrl="
                + contentUrl + "]";
    }

    /**
     * Builds a new {@link ProjectCard11.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ProjectCard11.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(afterId, archived, columnId, columnUrl, createdAt, creator,
                id, nodeId, note, projectUrl, updatedAt, url)
                .contentUrl(getContentUrl());
        return builder;
    }

    /**
     * Class to build instances of {@link ProjectCard11}.
     */
    public static class Builder {
         ...
         * @param  url  String value for url.
         */
        public Builder(Integer afterId, boolean archived, int columnId, String columnUrl,
        ...
        /**
         * Builds a new {@link ProjectCard11} object using the set fields.
         * @return {@link ProjectCard11}
         */
        public ProjectCard11 build() {
            return new ProjectCard11(afterId, archived, columnId, columnUrl, createdAt, creator, id,
                    nodeId, note, projectUrl, updatedAt, url, contentUrl);
        }
    }
}
