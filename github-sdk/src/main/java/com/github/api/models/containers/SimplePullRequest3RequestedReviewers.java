 ...
 */
@JsonDeserialize(using = SimplePullRequest3RequestedReviewers.SimplePullRequest3RequestedReviewersDeserializer.class)
public abstract class SimplePullRequest3RequestedReviewers {
     ...
     */
    public static SimplePullRequest3RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static SimplePullRequest3RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends SimplePullRequest3RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends SimplePullRequest3RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest3RequestedReviewers.
     */
    protected static class SimplePullRequest3RequestedReviewersDeserializer
            extends JsonDeserializer<SimplePullRequest3RequestedReviewers> {

        @Override
        public SimplePullRequest3RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
