 ...
 */
@JsonDeserialize(using = NpmMetadata1Bugs.NpmMetadata1BugsDeserializer.class)
public abstract class NpmMetadata1Bugs {
     ...
     */
    public static NpmMetadata1Bugs fromMString(String mString) {
     ...
     */
    public static NpmMetadata1Bugs fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends NpmMetadata1Bugs {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends NpmMetadata1Bugs {
    ...
    /**
     * This is a custom deserializer class for NpmMetadata1Bugs.
     */
    protected static class NpmMetadata1BugsDeserializer
            extends JsonDeserializer<NpmMetadata1Bugs> {

        @Override
        public NpmMetadata1Bugs deserialize(JsonParser jp, DeserializationContext ctxt)
