 ...
 */
@JsonDeserialize(using = NewRepositoryCreatedAt.NewRepositoryCreatedAtDeserializer.class)
public abstract class NewRepositoryCreatedAt {
     ...
     */
    public static NewRepositoryCreatedAt fromNumber(int number) {
     ...
     */
    public static NewRepositoryCreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends NewRepositoryCreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends NewRepositoryCreatedAt {
    ...
    /**
     * This is a custom deserializer class for NewRepositoryCreatedAt.
     */
    protected static class NewRepositoryCreatedAtDeserializer
            extends JsonDeserializer<NewRepositoryCreatedAt> {

        @Override
        public NewRepositoryCreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
