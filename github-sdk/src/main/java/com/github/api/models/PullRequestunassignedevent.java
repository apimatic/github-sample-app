...
/**
 * This is a model class for PullRequestunassignedevent type.
 */
public class PullRequestunassignedevent {
    ...
    private PullRequest51 pullRequest;
     ...
     * Default constructor.
     */
    public PullRequestunassignedevent() {
        action = "unassigned";
    }
     ...
     * @param  pullRequest  PullRequest51 value for pullRequest.
     ...
     * @return Returns the PullRequest51
     */
    @JsonGetter("pull_request")
    public PullRequest51 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest51
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest51 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestunassignedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestunassignedevent [" + "action=" + action + ", number=" + number
                + ", pullRequest=" + pullRequest + ", repository=" + repository + ", assignee="
                + assignee + ", enterprise=" + enterprise + ", installation=" + installation
                + ", organization=" + organization + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link PullRequestunassignedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestunassignedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestunassignedevent}.
     */
    public static class Builder {
         ...
         * @param  repository  Repository3 value for repository.
         */
        public Builder(String action, int number, PullRequest51 pullRequest,
                Repository3 repository) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest51 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestunassignedevent} object using the set fields.
         * @return {@link PullRequestunassignedevent}
         */
        public PullRequestunassignedevent build() {
            return new PullRequestunassignedevent(action, number, pullRequest, repository, assignee,
