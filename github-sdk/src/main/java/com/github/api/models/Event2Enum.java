...
public enum Event2Enum {
    ...
    private static TreeMap<String, Event2Enum> valueMap = new TreeMap<>();
    ...
    static {
        ...
        PULL_REQUEST_REVIEW_THREAD.value = "pull_request_review_thread";
        WORKFLOW_JOB.value = "workflow_job";
        MERGE_QUEUE_ENTRY.value = "merge_queue_entry";
        SECURITY_AND_ANALYSIS.value = "security_and_analysis";
        SECRET_SCANNING_ALERT_LOCATION.value = "secret_scanning_alert_location";
        PROJECTS_V2_ITEM.value = "projects_v2_item";
        MERGE_GROUP.value = "merge_group";
        REPOSITORY_IMPORT.value = "repository_import";
        ...
        valueMap.put("pull_request_review_thread", PULL_REQUEST_REVIEW_THREAD);
        valueMap.put("workflow_job", WORKFLOW_JOB);
        valueMap.put("merge_queue_entry", MERGE_QUEUE_ENTRY);
        valueMap.put("security_and_analysis", SECURITY_AND_ANALYSIS);
        valueMap.put("secret_scanning_alert_location", SECRET_SCANNING_ALERT_LOCATION);
        valueMap.put("projects_v2_item", PROJECTS_V2_ITEM);
        valueMap.put("merge_group", MERGE_GROUP);
        valueMap.put("repository_import", REPOSITORY_IMPORT);
    }
    ...
    public static Event2Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Event2Enum values to list of string values.
     * @param toConvert The list of Event2Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Event2Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Event2Enum enumValue : toConvert) {
