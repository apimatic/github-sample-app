 ...
 */
@JsonDeserialize(using = ReposPagesRequest34Source.ReposPagesRequest34SourceDeserializer.class)
public abstract class ReposPagesRequest34Source {
     ...
     */
    public static ReposPagesRequest34Source fromSource2(Source2Enum source2) {
     ...
     */
    public static ReposPagesRequest34Source fromSource21(Source21 source21) {
    ...
    @TypeCombinatorCase
    private static class Source2Case extends ReposPagesRequest34Source {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Source21Case extends ReposPagesRequest34Source {
    ...
    /**
     * This is a custom deserializer class for ReposPagesRequest34Source.
     */
    protected static class ReposPagesRequest34SourceDeserializer
            extends JsonDeserializer<ReposPagesRequest34Source> {

        @Override
        public ReposPagesRequest34Source deserialize(JsonParser jp, DeserializationContext ctxt)
