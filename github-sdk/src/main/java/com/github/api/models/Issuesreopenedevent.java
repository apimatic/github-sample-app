...
/**
 * This is a model class for Issuesreopenedevent type.
 */
public class Issuesreopenedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private Issue16 issue;
     ...
     * @param  issue  Issue16 value for issue.
    ...
    /**
     * Getter for Issue.
     * @return Returns the Issue16
     */
    @JsonGetter("issue")
    public Issue16 getIssue() {
        return issue;
    }

    /**
     * Setter for Issue.
     * @param issue Value for Issue16
     */
    @JsonSetter("issue")
    public void setIssue(Issue16 issue) {
        this.issue = issue;
    }
    ...
    /**
     * Converts this Issuesreopenedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issuesreopenedevent [" + "action=" + action + ", issue=" + issue + ", repository="
                + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Issuesreopenedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issuesreopenedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Issuesreopenedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Issue16 issue, Repository3 repository, Sender sender) {
            this.action = action;
            this.issue = issue;
            this.repository = repository;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder issue(Issue16 issue) {
            this.issue = issue;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issuesreopenedevent} object using the set fields.
         * @return {@link Issuesreopenedevent}
         */
        public Issuesreopenedevent build() {
            return new Issuesreopenedevent(action, issue, repository, sender, enterprise,
