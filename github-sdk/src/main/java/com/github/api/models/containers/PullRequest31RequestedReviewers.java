 ...
 */
@JsonDeserialize(using = PullRequest31RequestedReviewers.PullRequest31RequestedReviewersDeserializer.class)
public abstract class PullRequest31RequestedReviewers {
     ...
     */
    public static PullRequest31RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest31RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest31RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest31RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest31RequestedReviewers.
     */
    protected static class PullRequest31RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest31RequestedReviewers> {

        @Override
        public PullRequest31RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
