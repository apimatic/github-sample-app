 ...
 */
@JsonDeserialize(using = Repository43CreatedAt.Repository43CreatedAtDeserializer.class)
public abstract class Repository43CreatedAt {
     ...
     */
    public static Repository43CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository43CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository43CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository43CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository43CreatedAt.
     */
    protected static class Repository43CreatedAtDeserializer
            extends JsonDeserializer<Repository43CreatedAt> {

        @Override
        public Repository43CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
