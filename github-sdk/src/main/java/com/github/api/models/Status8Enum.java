...
/**
 * Status8Enum to be used.
 */
public enum Status8Enum {
    COMPLETED,
    ...
    private static TreeMap<String, Status8Enum> valueMap = new TreeMap<>();
    ...
    public static Status8Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Status8Enum values to list of string values.
     * @param toConvert The list of Status8Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Status8Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Status8Enum enumValue : toConvert) {
