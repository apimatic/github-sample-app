 ...
 */
@JsonDeserialize(using = ActionsEnableWorkflowWorkflowId.ActionsEnableWorkflowWorkflowIdDeserializer.class)
public abstract class ActionsEnableWorkflowWorkflowId {
     ...
     */
    public static ActionsEnableWorkflowWorkflowId fromNumber(int number) {
     ...
     */
    public static ActionsEnableWorkflowWorkflowId fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ActionsEnableWorkflowWorkflowId {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ActionsEnableWorkflowWorkflowId {
    ...
    /**
     * This is a custom deserializer class for ActionsEnableWorkflowWorkflowId.
     */
    protected static class ActionsEnableWorkflowWorkflowIdDeserializer
            extends JsonDeserializer<ActionsEnableWorkflowWorkflowId> {

        @Override
        public ActionsEnableWorkflowWorkflowId deserialize(JsonParser jp, DeserializationContext ctxt)
