 ...
 */
@JsonDeserialize(using = NpmMetadata1Author.NpmMetadata1AuthorDeserializer.class)
public abstract class NpmMetadata1Author {
     ...
     */
    public static NpmMetadata1Author fromMString(String mString) {
     ...
     */
    public static NpmMetadata1Author fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends NpmMetadata1Author {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends NpmMetadata1Author {
    ...
    /**
     * This is a custom deserializer class for NpmMetadata1Author.
     */
    protected static class NpmMetadata1AuthorDeserializer
            extends JsonDeserializer<NpmMetadata1Author> {

        @Override
        public NpmMetadata1Author deserialize(JsonParser jp, DeserializationContext ctxt)
