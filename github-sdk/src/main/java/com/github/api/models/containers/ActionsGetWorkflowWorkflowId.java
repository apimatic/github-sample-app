 ...
 */
@JsonDeserialize(using = ActionsGetWorkflowWorkflowId.ActionsGetWorkflowWorkflowIdDeserializer.class)
public abstract class ActionsGetWorkflowWorkflowId {
     ...
     */
    public static ActionsGetWorkflowWorkflowId fromNumber(int number) {
     ...
     */
    public static ActionsGetWorkflowWorkflowId fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ActionsGetWorkflowWorkflowId {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ActionsGetWorkflowWorkflowId {
    ...
    /**
     * This is a custom deserializer class for ActionsGetWorkflowWorkflowId.
     */
    protected static class ActionsGetWorkflowWorkflowIdDeserializer
            extends JsonDeserializer<ActionsGetWorkflowWorkflowId> {

        @Override
        public ActionsGetWorkflowWorkflowId deserialize(JsonParser jp, DeserializationContext ctxt)
