 ...
 */
@JsonDeserialize(using = Repository22CreatedAt.Repository22CreatedAtDeserializer.class)
public abstract class Repository22CreatedAt {
     ...
     */
    public static Repository22CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository22CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository22CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository22CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository22CreatedAt.
     */
    protected static class Repository22CreatedAtDeserializer
            extends JsonDeserializer<Repository22CreatedAt> {

        @Override
        public Repository22CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
