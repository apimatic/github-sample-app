 ...
 */
@JsonDeserialize(using = Repository22PushedAt.Repository22PushedAtDeserializer.class)
public abstract class Repository22PushedAt {
     ...
     */
    public static Repository22PushedAt fromNumber(int number) {
     ...
     */
    public static Repository22PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repository22PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository22PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository22PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repository22PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository22PushedAt.
     */
    protected static class Repository22PushedAtDeserializer
            extends JsonDeserializer<Repository22PushedAt> {

        @Override
        public Repository22PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
