...
/**
 * This is a model class for WorkflowJob3 type.
 */
public class WorkflowJob3 {
    ...
    private List<WorkflowStep3> steps;
    private String url;
     ...
     * @param  steps  List of WorkflowStep3 value for steps.
    ...
    /**
     * Getter for Steps.
     * @return Returns the List of WorkflowStep3
     */
    @JsonGetter("steps")
    ...
    /**
     * Setter for Steps.
     * @param steps Value for List of WorkflowStep3
     */
    @JsonSetter("steps")
    ...
    /**
     * Converts this WorkflowJob3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WorkflowJob3 [" + "checkRunUrl=" + checkRunUrl + ", completedAt=" + completedAt
                ...
                + startedAt + ", headBranch=" + headBranch + ", workflowName=" + workflowName
                + ", status=" + status + ", steps=" + steps + ", url=" + url + "]";
    }

    /**
     * Builds a new {@link WorkflowJob3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WorkflowJob3.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(checkRunUrl, completedAt, conclusion, headSha, htmlUrl, id,
                ...
                runnerId, runnerName, startedAt, headBranch, workflowName, status, steps, url);
        return builder;
    }

    /**
     * Class to build instances of {@link WorkflowJob3}.
     */
    public static class Builder {
        ...
        public Builder(String checkRunUrl, String completedAt, String conclusion, String headSha,
                ...
                LocalDateTime startedAt, String headBranch, String workflowName,
                Status25Enum status, List<WorkflowStep3> steps, String url) {
            this.checkRunUrl = checkRunUrl;
            this.completedAt = completedAt;
            this.conclusion = conclusion;
            this.headSha = headSha;
         ...
         * @return Builder
         */
        public Builder steps(List<WorkflowStep3> steps) {
            this.steps = steps;
            return this;
        }
        ...
        /**
         * Builds a new {@link WorkflowJob3} object using the set fields.
         * @return {@link WorkflowJob3}
         */
        public WorkflowJob3 build() {
            return new WorkflowJob3(checkRunUrl, completedAt, conclusion, headSha, htmlUrl, id,
                    labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName,
                    runnerId, runnerName, startedAt, headBranch, workflowName, status, steps, url);
        }
    }
