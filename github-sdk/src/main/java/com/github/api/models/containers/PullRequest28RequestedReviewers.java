 ...
 */
@JsonDeserialize(using = PullRequest28RequestedReviewers.PullRequest28RequestedReviewersDeserializer.class)
public abstract class PullRequest28RequestedReviewers {
     ...
     */
    public static PullRequest28RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest28RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest28RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest28RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest28RequestedReviewers.
     */
    protected static class PullRequest28RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest28RequestedReviewers> {

        @Override
        public PullRequest28RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
