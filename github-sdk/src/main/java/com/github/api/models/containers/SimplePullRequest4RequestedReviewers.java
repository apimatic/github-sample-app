 ...
 */
@JsonDeserialize(using = SimplePullRequest4RequestedReviewers.SimplePullRequest4RequestedReviewersDeserializer.class)
public abstract class SimplePullRequest4RequestedReviewers {
     ...
     */
    public static SimplePullRequest4RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static SimplePullRequest4RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends SimplePullRequest4RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends SimplePullRequest4RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest4RequestedReviewers.
     */
    protected static class SimplePullRequest4RequestedReviewersDeserializer
            extends JsonDeserializer<SimplePullRequest4RequestedReviewers> {

        @Override
        public SimplePullRequest4RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
