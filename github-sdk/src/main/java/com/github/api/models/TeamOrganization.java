...
/**
 * This is a model class for TeamOrganization type.
 */
public class TeamOrganization {
     ...
     */
    protected TeamOrganization(String login, int id, String nodeId, String url, String reposUrl,
    ...
    /**
     * Converts this TeamOrganization into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TeamOrganization [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link TeamOrganization.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TeamOrganization.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TeamOrganization}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TeamOrganization} object using the set fields.
         * @return {@link TeamOrganization}
         */
        public TeamOrganization build() {
            return new TeamOrganization(login, id, nodeId, url, reposUrl, eventsUrl, hooksUrl,
                    issuesUrl, membersUrl, publicMembersUrl, avatarUrl, description,
