 ...
 */
@JsonDeserialize(using = PullRequest50Assignees.PullRequest50AssigneesDeserializer.class)
public abstract class PullRequest50Assignees {
     ...
     */
    public static PullRequest50Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest50Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest50Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends PullRequest50Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest50Assignees.
     */
    protected static class PullRequest50AssigneesDeserializer
            extends JsonDeserializer<PullRequest50Assignees> {

        @Override
        public PullRequest50Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
