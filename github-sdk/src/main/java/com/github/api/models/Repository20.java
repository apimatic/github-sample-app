...
import com.github.api.models.containers.Repository20CreatedAt;
import com.github.api.models.containers.Repository20PushedAt;
...
/**
 * This is a model class for Repository20 type.
 */
public class Repository20 {
    ...
    private Repository20CreatedAt createdAt;
    ...
    private Repository20PushedAt pushedAt;
    private String releasesUrl;
    private OptionalNullable<String> roleName;
    private int size;
    private SquashMergeCommitMessage13Enum squashMergeCommitMessage;
     ...
     * @param  createdAt  Repository20CreatedAt value for createdAt.
     ...
     * @param  pushedAt  Repository20PushedAt value for pushedAt.
     ...
     * @param  squashMergeCommitMessage  SquashMergeCommitMessage13Enum value for
    ...
    public Repository20(
            ...
            Repository20CreatedAt createdAt,
            ...
            Boolean mPublic,
            String roleName,
            SquashMergeCommitMessage13Enum squashMergeCommitMessage,
     ...
     */
    protected Repository20(String archiveUrl, boolean archived, String assigneesUrl,
            ...
            String contributorsUrl, Repository20CreatedAt createdAt, String defaultBranch,
            ...
            boolean mPrivate, String pullsUrl, Repository20PushedAt pushedAt, String releasesUrl,
            ...
            MergeCommitMessageEnum mergeCommitMessage, MergeCommitTitleEnum mergeCommitTitle,
     ...
     * @return Returns the Repository20CreatedAt
     */
    @JsonGetter("created_at")
    public Repository20CreatedAt getCreatedAt() {
        return createdAt;
    }

    /**
     * Setter for CreatedAt.
     * @param createdAt Value for Repository20CreatedAt
     */
    @JsonSetter("created_at")
    public void setCreatedAt(Repository20CreatedAt createdAt) {
        this.createdAt = createdAt;
    }
    ...
    /**
     * Getter for PushedAt.
     * @return Returns the Repository20PushedAt
     */
    @JsonGetter("pushed_at")
    public Repository20PushedAt getPushedAt() {
        return pushedAt;
    }

    /**
     * Setter for PushedAt.
     * @param pushedAt Value for Repository20PushedAt
     */
    @JsonSetter("pushed_at")
    public void setPushedAt(Repository20PushedAt pushedAt) {
        this.pushedAt = pushedAt;
    }
     ...
     * @return Returns the SquashMergeCommitMessage13Enum
     */
    @JsonGetter("squash_merge_commit_message")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SquashMergeCommitMessage13Enum getSquashMergeCommitMessage() {
        return squashMergeCommitMessage;
    }

    /**
     * Setter for SquashMergeCommitMessage.
     * @param squashMergeCommitMessage Value for SquashMergeCommitMessage13Enum
     */
    @JsonSetter("squash_merge_commit_message")
    public void setSquashMergeCommitMessage(SquashMergeCommitMessage13Enum squashMergeCommitMessage) {
        this.squashMergeCommitMessage = squashMergeCommitMessage;
    }
    ...
    /**
     * Converts this Repository20 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repository20 [" + "archiveUrl=" + archiveUrl + ", archived=" + archived
    ...
    /**
     * Builds a new {@link Repository20.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repository20.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Repository20}.
     */
    public static class Builder {
        ...
        public Builder(String archiveUrl, boolean archived, String assigneesUrl, String blobsUrl,
                ...
                Repository20CreatedAt createdAt, String defaultBranch, String deploymentsUrl,
                ...
                String notificationsUrl, int openIssues, int openIssuesCount, Object owner,
                boolean mPrivate, String pullsUrl, Repository20PushedAt pushedAt,
         ...
         * @return Builder
         */
        public Builder createdAt(Repository20CreatedAt createdAt) {
            this.createdAt = createdAt;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder pushedAt(Repository20PushedAt pushedAt) {
            this.pushedAt = pushedAt;
            return this;
        }
        ...
        /**
         * Builds a new {@link Repository20} object using the set fields.
         * @return {@link Repository20}
         */
        public Repository20 build() {
            return new Repository20(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl,
                    cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl,
                    contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description,
