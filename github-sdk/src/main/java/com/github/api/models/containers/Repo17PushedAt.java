 ...
 */
@JsonDeserialize(using = Repo17PushedAt.Repo17PushedAtDeserializer.class)
public abstract class Repo17PushedAt {
     ...
     */
    public static Repo17PushedAt fromNumber(int number) {
     ...
     */
    public static Repo17PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repo17PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo17PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo17PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repo17PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo17PushedAt.
     */
    protected static class Repo17PushedAtDeserializer
            extends JsonDeserializer<Repo17PushedAt> {

        @Override
        public Repo17PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
