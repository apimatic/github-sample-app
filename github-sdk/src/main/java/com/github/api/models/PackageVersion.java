...
/**
 * This is a model class for PackageVersion type.
 */
public class PackageVersion {
    ...
    /**
     * Converts this PackageVersion into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PackageVersion [" + "id=" + id + ", name=" + name + ", url=" + url
                + ", packageHtmlUrl=" + packageHtmlUrl + ", createdAt=" + createdAt + ", updatedAt="
                + updatedAt + ", htmlUrl=" + htmlUrl + ", license=" + license + ", description="
                + description + ", deletedAt=" + deletedAt + ", metadata=" + metadata + "]";
    }

    /**
     * Builds a new {@link PackageVersion.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PackageVersion.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PackageVersion}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PackageVersion} object using the set fields.
         * @return {@link PackageVersion}
         */
        public PackageVersion build() {
            return new PackageVersion(id, name, url, packageHtmlUrl, createdAt, updatedAt, htmlUrl,
                    license, description, deletedAt, metadata);
        }
    }
}
