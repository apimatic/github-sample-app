...
import com.github.api.models.containers.Issue42Assignees;
...
/**
 * This is a model class for Issue42 type.
 */
public class Issue42 {
    private Object activeLockReason;
    private Object assignee;
    private List<Issue42Assignees> assignees;
     ...
     * @param  assignees  List of Issue42Assignees value for assignees.
    ...
    public Issue42(
            ...
            Object assignee,
            List<Issue42Assignees> assignees,
     ...
     */
    protected Issue42(Object activeLockReason, Object assignee, List<Issue42Assignees> assignees,
            ...
            String htmlUrl, int id, List<Label10> labels, String labelsUrl, boolean locked,
            Object milestone, String nodeId, int number, ReactionRollup reactions,
            String repositoryUrl, State45Enum state, String title, LocalDateTime updatedAt,
            String url, Object user, Boolean draft, Object performedViaGithubApp,
     ...
     * @return Returns the List of Issue42Assignees
     */
    @JsonGetter("assignees")
    public List<Issue42Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of Issue42Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<Issue42Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Converts this Issue42 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue42 [" + "activeLockReason=" + activeLockReason + ", assignee=" + assignee
                + ", assignees=" + assignees + ", authorAssociation=" + authorAssociation
                + ", body=" + body + ", closedAt=" + closedAt + ", comments=" + comments
                + ", commentsUrl=" + commentsUrl + ", createdAt=" + createdAt + ", eventsUrl="
                + eventsUrl + ", htmlUrl=" + htmlUrl + ", id=" + id + ", labels=" + labels
                + ", labelsUrl=" + labelsUrl + ", locked=" + locked + ", milestone=" + milestone
                + ", nodeId=" + nodeId + ", number=" + number + ", reactions=" + reactions
                + ", repositoryUrl=" + repositoryUrl + ", state=" + state + ", title=" + title
                + ", updatedAt=" + updatedAt + ", url=" + url + ", user=" + user + ", draft="
                + draft + ", performedViaGithubApp=" + performedViaGithubApp + ", pullRequest="
                + pullRequest + ", stateReason=" + stateReason + ", timelineUrl=" + timelineUrl
                + "]";
    }

    /**
     * Builds a new {@link Issue42.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue42.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(activeLockReason, assignee, assignees, authorAssociation,
                body, closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels,
                labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, state,
    ...
    /**
     * Class to build instances of {@link Issue42}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(Object activeLockReason, Object assignee, List<Issue42Assignees> assignees,
                AuthorAssociationEnum authorAssociation, String body, LocalDateTime closedAt,
                int comments, String commentsUrl, LocalDateTime createdAt, String eventsUrl,
                String htmlUrl, int id, List<Label10> labels, String labelsUrl, boolean locked,
                Object milestone, String nodeId, int number, ReactionRollup reactions,
         ...
         * @return Builder
         */
        public Builder assignees(List<Issue42Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue42} object using the set fields.
         * @return {@link Issue42}
         */
        public Issue42 build() {
            return new Issue42(activeLockReason, assignee, assignees, authorAssociation, body,
                    closedAt, comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labels,
                    labelsUrl, locked, milestone, nodeId, number, reactions, repositoryUrl, state,
                    title, updatedAt, url, user, draft, performedViaGithubApp, pullRequest,
