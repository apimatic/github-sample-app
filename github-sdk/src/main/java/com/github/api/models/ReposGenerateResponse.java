...
/**
 * This is a model class for ReposGenerateResponse type.
 */
public class ReposGenerateResponse {
    private int id;
    ...
    /**
     * Converts this ReposGenerateResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposGenerateResponse [" + "id=" + id + ", nodeId=" + nodeId + ", name=" + name
                + ", fullName=" + fullName + ", license=" + license + ", forks=" + forks
                + ", owner=" + owner + ", mPrivate=" + mPrivate + ", htmlUrl=" + htmlUrl
                + ", description=" + description + ", fork=" + fork + ", url=" + url
                + ", archiveUrl=" + archiveUrl + ", assigneesUrl=" + assigneesUrl + ", blobsUrl="
                + blobsUrl + ", branchesUrl=" + branchesUrl + ", collaboratorsUrl="
                ...
                + ", hasPages=" + hasPages + ", hasDownloads=" + hasDownloads + ", archived="
                + archived + ", disabled=" + disabled + ", pushedAt=" + pushedAt + ", createdAt="
                + createdAt + ", updatedAt=" + updatedAt + ", openIssues=" + openIssues
                + ", watchers=" + watchers + ", organization=" + organization + ", permissions="
                + permissions + ", isTemplate=" + isTemplate + ", topics=" + topics
                + ", hasDiscussions=" + hasDiscussions + ", visibility=" + visibility
    ...
    /**
     * Builds a new {@link ReposGenerateResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposGenerateResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposGenerateResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReposGenerateResponse} object using the set fields.
         * @return {@link ReposGenerateResponse}
         */
        public ReposGenerateResponse build() {
            return new ReposGenerateResponse(id, nodeId, name, fullName, license, forks, owner,
                    mPrivate, htmlUrl, description, fork, url, archiveUrl, assigneesUrl, blobsUrl,
