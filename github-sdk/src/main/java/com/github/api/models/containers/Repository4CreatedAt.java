 ...
 */
@JsonDeserialize(using = Repository4CreatedAt.Repository4CreatedAtDeserializer.class)
public abstract class Repository4CreatedAt {
     ...
     */
    public static Repository4CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository4CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository4CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository4CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository4CreatedAt.
     */
    protected static class Repository4CreatedAtDeserializer
            extends JsonDeserializer<Repository4CreatedAt> {

        @Override
        public Repository4CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
