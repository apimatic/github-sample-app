...
/**
 * This is a model class for MarketplacePurchase2 type.
 */
public class MarketplacePurchase2 {
    ...
    /**
     * Converts this MarketplacePurchase2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MarketplacePurchase2 [" + "account=" + account + ", billingCycle=" + billingCycle
                + ", freeTrialEndsOn=" + freeTrialEndsOn + ", nextBillingDate=" + nextBillingDate
                + ", onFreeTrial=" + onFreeTrial + ", plan=" + plan + ", unitCount=" + unitCount
                + "]";
    }

    /**
     * Builds a new {@link MarketplacePurchase2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MarketplacePurchase2.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(account, billingCycle, freeTrialEndsOn, nextBillingDate,
                onFreeTrial, plan, unitCount);
        return builder;
    }

    /**
     * Class to build instances of {@link MarketplacePurchase2}.
     */
    public static class Builder {
         ...
         * @param  unitCount  int value for unitCount.
         */
        public Builder(Account2 account, String billingCycle, String freeTrialEndsOn,
                String nextBillingDate, boolean onFreeTrial, Plan4 plan, int unitCount) {
            this.account = account;
            this.billingCycle = billingCycle;
            this.freeTrialEndsOn = freeTrialEndsOn;
            this.nextBillingDate = nextBillingDate;
        ...
        /**
         * Builds a new {@link MarketplacePurchase2} object using the set fields.
         * @return {@link MarketplacePurchase2}
         */
        public MarketplacePurchase2 build() {
            return new MarketplacePurchase2(account, billingCycle, freeTrialEndsOn, nextBillingDate,
                    onFreeTrial, plan, unitCount);
        }
    }
}
