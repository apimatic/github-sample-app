 ...
 */
@JsonDeserialize(using = Repo15CreatedAt.Repo15CreatedAtDeserializer.class)
public abstract class Repo15CreatedAt {
     ...
     */
    public static Repo15CreatedAt fromNumber(int number) {
     ...
     */
    public static Repo15CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo15CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo15CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repo15CreatedAt.
     */
    protected static class Repo15CreatedAtDeserializer
            extends JsonDeserializer<Repo15CreatedAt> {

        @Override
        public Repo15CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
