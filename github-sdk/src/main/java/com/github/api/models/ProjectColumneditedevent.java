...
/**
 * This is a model class for ProjectColumneditedevent type.
 */
public class ProjectColumneditedevent {
    private String action;
    private Changes18 changes;
     ...
     * Default constructor.
     */
    public ProjectColumneditedevent() {
        action = "edited";
    }
     ...
     * @param  changes  Changes18 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes18
     */
    @JsonGetter("changes")
    public Changes18 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes18
     */
    @JsonSetter("changes")
    public void setChanges(Changes18 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this ProjectColumneditedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ProjectColumneditedevent [" + "action=" + action + ", changes=" + changes
                + ", projectColumn=" + projectColumn + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization
                + ", repository=" + repository + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link ProjectColumneditedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ProjectColumneditedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, changes, projectColumn)
    ...
    /**
     * Class to build instances of {@link ProjectColumneditedevent}.
     */
    public static class Builder {
         ...
         * @param  projectColumn  ProjectColumn1 value for projectColumn.
         */
        public Builder(String action, Changes18 changes, ProjectColumn1 projectColumn) {
            this.action = action;
            this.changes = changes;
            this.projectColumn = projectColumn;
        }
         ...
         * @return Builder
         */
        public Builder changes(Changes18 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link ProjectColumneditedevent} object using the set fields.
         * @return {@link ProjectColumneditedevent}
         */
        public ProjectColumneditedevent build() {
            return new ProjectColumneditedevent(action, changes, projectColumn, enterprise,
