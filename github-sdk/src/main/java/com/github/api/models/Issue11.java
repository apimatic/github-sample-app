...
import com.github.api.models.containers.Issue11Assignees;
...
/**
 * This is a model class for Issue11 type.
 */
public class Issue11 {
    private Object activeLockReason;
    private Object assignee;
    private List<Issue11Assignees> assignees;
     ...
     * @param  assignees  List of Issue11Assignees value for assignees.
    ...
    public Issue11(
            ...
            List<Issue11Assignees> assignees,
     ...
     */
    protected Issue11(Object activeLockReason, List<Issue11Assignees> assignees,
            ...
            String htmlUrl, int id, String labelsUrl, String locked, Object milestone,
            String nodeId, int number, ReactionRollup reactions, String repositoryUrl, String title,
            LocalDateTime updatedAt, String url, Object user, Object assignee, Boolean draft,
            List<Label10> labels, Object performedViaGithubApp, PullRequest7 pullRequest,
            State45Enum state, OptionalNullable<String> stateReason, String timelineUrl) {
        this.activeLockReason = activeLockReason;
        this.assignee = assignee;
        this.assignees = assignees;
        this.authorAssociation = authorAssociation;
     ...
     * @return Returns the List of Issue11Assignees
     */
    @JsonGetter("assignees")
    public List<Issue11Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of Issue11Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<Issue11Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Converts this Issue11 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue11 [" + "activeLockReason=" + activeLockReason + ", assignees=" + assignees
                ...
                + ", id=" + id + ", labelsUrl=" + labelsUrl + ", locked=" + locked + ", milestone="
                + milestone + ", nodeId=" + nodeId + ", number=" + number + ", reactions="
                + reactions + ", repositoryUrl=" + repositoryUrl + ", title=" + title
                + ", updatedAt=" + updatedAt + ", url=" + url + ", user=" + user + ", assignee="
                + assignee + ", draft=" + draft + ", labels=" + labels + ", performedViaGithubApp="
                + performedViaGithubApp + ", pullRequest=" + pullRequest + ", state=" + state
                + ", stateReason=" + stateReason + ", timelineUrl=" + timelineUrl + "]";
    }

    /**
     * Builds a new {@link Issue11.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue11.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(activeLockReason, assignees, authorAssociation, body,
                ...
                locked, milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url,
                user)
    ...
    /**
     * Class to build instances of {@link Issue11}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(Object activeLockReason, List<Issue11Assignees> assignees,
                AuthorAssociationEnum authorAssociation, String body, LocalDateTime closedAt,
                int comments, String commentsUrl, LocalDateTime createdAt, String eventsUrl,
                String htmlUrl, int id, String labelsUrl, String locked, Object milestone,
                String nodeId, int number, ReactionRollup reactions, String repositoryUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<Issue11Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue11} object using the set fields.
         * @return {@link Issue11}
         */
        public Issue11 build() {
            return new Issue11(activeLockReason, assignees, authorAssociation, body, closedAt,
                    comments, commentsUrl, createdAt, eventsUrl, htmlUrl, id, labelsUrl, locked,
                    milestone, nodeId, number, reactions, repositoryUrl, title, updatedAt, url,
                    user, assignee, draft, labels, performedViaGithubApp, pullRequest, state,
