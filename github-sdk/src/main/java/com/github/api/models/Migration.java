...
public class Migration {
    ...
    public String toString() {
        return "Migration [" + "id=" + id + ", owner=" + owner + ", guid=" + guid + ", state="
                + state + ", lockRepositories=" + lockRepositories + ", excludeMetadata="
                + excludeMetadata + ", excludeGitData=" + excludeGitData + ", excludeAttachments="
                + excludeAttachments + ", excludeReleases=" + excludeReleases
                + ", excludeOwnerProjects=" + excludeOwnerProjects + ", orgMetadataOnly="
                + orgMetadataOnly + ", repositories=" + repositories + ", url=" + url
                + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + ", nodeId=" + nodeId
                + ", archiveUrl=" + archiveUrl + ", exclude=" + exclude + "]";
    }
    ...
    public static class Builder {
        ...
        public Migration build() {
            return new Migration(id, owner, guid, state, lockRepositories, excludeMetadata,
                    excludeGitData, excludeAttachments, excludeReleases, excludeOwnerProjects,
                    orgMetadataOnly, repositories, url, createdAt, updatedAt, nodeId, archiveUrl,
                    exclude);
        }
    }
}
