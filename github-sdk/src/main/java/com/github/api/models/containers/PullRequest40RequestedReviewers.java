 ...
 */
@JsonDeserialize(using = PullRequest40RequestedReviewers.PullRequest40RequestedReviewersDeserializer.class)
public abstract class PullRequest40RequestedReviewers {
     ...
     */
    public static PullRequest40RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest40RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest40RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends PullRequest40RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest40RequestedReviewers.
     */
    protected static class PullRequest40RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest40RequestedReviewers> {

        @Override
        public PullRequest40RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
