...
import com.github.api.models.containers.Issue6Assignees;
...
/**
 * This is a model class for Issue6 type.
 */
public class Issue6 {
    private Object activeLockReason;
    private Object assignee;
    private List<Issue6Assignees> assignees;
     ...
     * @param  assignees  List of Issue6Assignees value for assignees.
    ...
    public Issue6(
            ...
            List<Issue6Assignees> assignees,
     ...
     */
    protected Issue6(Object activeLockReason, List<Issue6Assignees> assignees,
     ...
     * @return Returns the List of Issue6Assignees
     */
    @JsonGetter("assignees")
    public List<Issue6Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of Issue6Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<Issue6Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Converts this Issue6 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue6 [" + "activeLockReason=" + activeLockReason + ", assignees=" + assignees
    ...
    /**
     * Builds a new {@link Issue6.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue6.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Issue6}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(Object activeLockReason, List<Issue6Assignees> assignees,
                AuthorAssociationEnum authorAssociation, String body, LocalDateTime closedAt,
                int comments, String commentsUrl, LocalDateTime createdAt, String eventsUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<Issue6Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue6} object using the set fields.
         * @return {@link Issue6}
         */
        public Issue6 build() {
            return new Issue6(activeLockReason, assignees, authorAssociation, body, closedAt,
