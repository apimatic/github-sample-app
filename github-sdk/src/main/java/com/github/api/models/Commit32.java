...
/**
 * This is a model class for Commit32 type.
 */
public class Commit32 {
    private String url;
    private String sha;
    ...
    /**
     * Converts this Commit32 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Commit32 [" + "url=" + url + ", sha=" + sha + ", nodeId=" + nodeId + ", htmlUrl="
    ...
    /**
     * Builds a new {@link Commit32.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Commit32.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Commit32}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Commit32} object using the set fields.
         * @return {@link Commit32}
         */
        public Commit32 build() {
            return new Commit32(url, sha, nodeId, htmlUrl, commentsUrl, commit, author, committer,
                    parents, stats, files);
        }
    }
}
