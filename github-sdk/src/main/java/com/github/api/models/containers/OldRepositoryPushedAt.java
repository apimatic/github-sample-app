 ...
 */
@JsonDeserialize(using = OldRepositoryPushedAt.OldRepositoryPushedAtDeserializer.class)
public abstract class OldRepositoryPushedAt {
     ...
     */
    public static OldRepositoryPushedAt fromNumber(int number) {
     ...
     */
    public static OldRepositoryPushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static OldRepositoryPushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends OldRepositoryPushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends OldRepositoryPushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends OldRepositoryPushedAt {
    ...
    /**
     * This is a custom deserializer class for OldRepositoryPushedAt.
     */
    protected static class OldRepositoryPushedAtDeserializer
            extends JsonDeserializer<OldRepositoryPushedAt> {

        @Override
        public OldRepositoryPushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
