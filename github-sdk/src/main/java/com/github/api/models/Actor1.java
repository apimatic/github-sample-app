...
/**
 * This is a model class for Actor1 type.
 */
public class Actor1 {
    private int id;
    ...
    /**
     * Converts this Actor1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Actor1 [" + "id=" + id + ", login=" + login + ", gravatarId=" + gravatarId
                + ", url=" + url + ", avatarUrl=" + avatarUrl + ", displayLogin=" + displayLogin
                + "]";
    }

    /**
     * Builds a new {@link Actor1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Actor1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Actor1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Actor1} object using the set fields.
         * @return {@link Actor1}
         */
        public Actor1 build() {
            return new Actor1(id, login, gravatarId, url, avatarUrl, displayLogin);
        }
    }
}
