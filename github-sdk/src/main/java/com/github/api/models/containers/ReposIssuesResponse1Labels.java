 ...
 */
@JsonDeserialize(using = ReposIssuesResponse1Labels.ReposIssuesResponse1LabelsDeserializer.class)
public abstract class ReposIssuesResponse1Labels {
     ...
     */
    public static ReposIssuesResponse1Labels fromMString(String mString) {
     ...
     */
    public static ReposIssuesResponse1Labels fromLabel2(Label2 label2) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposIssuesResponse1Labels {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Label2Case extends ReposIssuesResponse1Labels {
    ...
    /**
     * This is a custom deserializer class for ReposIssuesResponse1Labels.
     */
    protected static class ReposIssuesResponse1LabelsDeserializer
            extends JsonDeserializer<ReposIssuesResponse1Labels> {

        @Override
        public ReposIssuesResponse1Labels deserialize(JsonParser jp, DeserializationContext ctxt)
