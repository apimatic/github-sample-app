...
/**
 * This is a model class for RequestedReviewer type.
 */
public class RequestedReviewer {
     ...
     */
    protected RequestedReviewer(String login, int id, String nodeId, String avatarUrl,
    ...
    /**
     * Converts this RequestedReviewer into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RequestedReviewer [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link RequestedReviewer.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RequestedReviewer.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RequestedReviewer}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RequestedReviewer} object using the set fields.
         * @return {@link RequestedReviewer}
         */
        public RequestedReviewer build() {
            return new RequestedReviewer(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
