...
/**
 * This is a model class for ActionsCacheUsagebyrepository type.
 */
public class ActionsCacheUsagebyrepository {
    ...
    /**
     * Converts this ActionsCacheUsagebyrepository into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ActionsCacheUsagebyrepository [" + "fullName=" + fullName
                + ", activeCachesSizeInBytes=" + activeCachesSizeInBytes + ", activeCachesCount="
                + activeCachesCount + "]";
    }

    /**
     * Builds a new {@link ActionsCacheUsagebyrepository.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ActionsCacheUsagebyrepository.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ActionsCacheUsagebyrepository}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ActionsCacheUsagebyrepository} object using the set fields.
         * @return {@link ActionsCacheUsagebyrepository}
         */
        public ActionsCacheUsagebyrepository build() {
            return new ActionsCacheUsagebyrepository(fullName, activeCachesSizeInBytes,
                    activeCachesCount);
        }
    }
}
