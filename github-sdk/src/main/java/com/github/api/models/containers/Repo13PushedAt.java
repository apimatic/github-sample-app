 ...
 */
@JsonDeserialize(using = Repo13PushedAt.Repo13PushedAtDeserializer.class)
public abstract class Repo13PushedAt {
     ...
     */
    public static Repo13PushedAt fromNumber(int number) {
     ...
     */
    public static Repo13PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repo13PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo13PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo13PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repo13PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo13PushedAt.
     */
    protected static class Repo13PushedAtDeserializer
            extends JsonDeserializer<Repo13PushedAt> {

        @Override
        public Repo13PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
