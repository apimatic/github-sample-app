...
/**
 * This is a model class for Config5 type.
 */
public class Config5 {
    ...
    /**
     * Converts this Config5 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Config5 [" + "url=" + url + ", contentType=" + contentType + ", secret=" + secret
                + ", insecureSsl=" + insecureSsl + "]";
    }

    /**
     * Builds a new {@link Config5.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Config5.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Config5}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Config5} object using the set fields.
         * @return {@link Config5}
         */
        public Config5 build() {
            return new Config5(url, contentType, secret, insecureSsl);
        }
    }
}
