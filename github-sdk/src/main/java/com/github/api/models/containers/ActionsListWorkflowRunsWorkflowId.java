 ...
 */
@JsonDeserialize(using = ActionsListWorkflowRunsWorkflowId.ActionsListWorkflowRunsWorkflowIdDeserializer.class)
public abstract class ActionsListWorkflowRunsWorkflowId {
     ...
     */
    public static ActionsListWorkflowRunsWorkflowId fromNumber(int number) {
     ...
     */
    public static ActionsListWorkflowRunsWorkflowId fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ActionsListWorkflowRunsWorkflowId {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ActionsListWorkflowRunsWorkflowId {
    ...
    /**
     * This is a custom deserializer class for ActionsListWorkflowRunsWorkflowId.
     */
    protected static class ActionsListWorkflowRunsWorkflowIdDeserializer
            extends JsonDeserializer<ActionsListWorkflowRunsWorkflowId> {

        @Override
        public ActionsListWorkflowRunsWorkflowId deserialize(JsonParser jp, DeserializationContext ctxt)
