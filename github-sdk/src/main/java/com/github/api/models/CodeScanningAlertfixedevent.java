...
/**
 * This is a model class for CodeScanningAlertfixedevent type.
 */
public class CodeScanningAlertfixedevent {
    private String action;
    private Alert32 alert;
     ...
     * Default constructor.
     */
    public CodeScanningAlertfixedevent() {
        action = "fixed";
    }
     ...
     * @param  alert  Alert32 value for alert.
    ...
    /**
     * Getter for Alert.
     * @return Returns the Alert32
     */
    @JsonGetter("alert")
    public Alert32 getAlert() {
        return alert;
    }

    /**
     * Setter for Alert.
     * @param alert Value for Alert32
     */
    @JsonSetter("alert")
    public void setAlert(Alert32 alert) {
        this.alert = alert;
    }
    ...
    /**
     * Converts this CodeScanningAlertfixedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CodeScanningAlertfixedevent [" + "action=" + action + ", alert=" + alert
    ...
    /**
     * Builds a new {@link CodeScanningAlertfixedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CodeScanningAlertfixedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CodeScanningAlertfixedevent}.
     */
    public static class Builder {
        private String action = "fixed";
        private Alert32 alert;
        private String commitOid;
        private String ref;
        private Repository3 repository;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Alert32 alert, String commitOid, String ref,
         ...
         * @return Builder
         */
        public Builder alert(Alert32 alert) {
            this.alert = alert;
            return this;
        }
        ...
        /**
         * Builds a new {@link CodeScanningAlertfixedevent} object using the set fields.
         * @return {@link CodeScanningAlertfixedevent}
         */
        public CodeScanningAlertfixedevent build() {
            return new CodeScanningAlertfixedevent(action, alert, commitOid, ref, repository,
