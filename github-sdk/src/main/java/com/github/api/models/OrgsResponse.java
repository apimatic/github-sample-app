...
public class OrgsResponse {
     ...
     */
    protected OrgsResponse(String login, int id, String nodeId, String url, String reposUrl,
    ...
    public String toString() {
        return "OrgsResponse [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", url="
    ...
    public static class Builder {
        ...
        public OrgsResponse build() {
            return new OrgsResponse(login, id, nodeId, url, reposUrl, eventsUrl, hooksUrl,
                    issuesUrl, membersUrl, publicMembersUrl, avatarUrl, description,
