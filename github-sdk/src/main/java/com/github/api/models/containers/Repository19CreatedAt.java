 ...
 */
@JsonDeserialize(using = Repository19CreatedAt.Repository19CreatedAtDeserializer.class)
public abstract class Repository19CreatedAt {
     ...
     */
    public static Repository19CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository19CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository19CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository19CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository19CreatedAt.
     */
    protected static class Repository19CreatedAtDeserializer
            extends JsonDeserializer<Repository19CreatedAt> {

        @Override
        public Repository19CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
