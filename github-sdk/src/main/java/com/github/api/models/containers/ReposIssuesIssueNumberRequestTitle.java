 ...
 */
@JsonDeserialize(using = ReposIssuesIssueNumberRequestTitle.ReposIssuesIssueNumberRequestTitleDeserializer.class)
public abstract class ReposIssuesIssueNumberRequestTitle {
     ...
     */
    public static ReposIssuesIssueNumberRequestTitle fromMString(String mString) {
     ...
     */
    public static ReposIssuesIssueNumberRequestTitle fromNumber(int number) {
     ...
     */
    public static ReposIssuesIssueNumberRequestTitle fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposIssuesIssueNumberRequestTitle {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class NumberCase extends ReposIssuesIssueNumberRequestTitle {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends ReposIssuesIssueNumberRequestTitle {
    ...
    /**
     * This is a custom deserializer class for ReposIssuesIssueNumberRequestTitle.
     */
    protected static class ReposIssuesIssueNumberRequestTitleDeserializer
            extends JsonDeserializer<ReposIssuesIssueNumberRequestTitle> {

        @Override
        public ReposIssuesIssueNumberRequestTitle deserialize(JsonParser jp, DeserializationContext ctxt)
