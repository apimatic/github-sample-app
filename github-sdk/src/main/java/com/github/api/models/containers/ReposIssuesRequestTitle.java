 ...
 */
@JsonDeserialize(using = ReposIssuesRequestTitle.ReposIssuesRequestTitleDeserializer.class)
public abstract class ReposIssuesRequestTitle {
     ...
     */
    public static ReposIssuesRequestTitle fromMString(String mString) {
     ...
     */
    public static ReposIssuesRequestTitle fromNumber(int number) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposIssuesRequestTitle {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class NumberCase extends ReposIssuesRequestTitle {
    ...
    /**
     * This is a custom deserializer class for ReposIssuesRequestTitle.
     */
    protected static class ReposIssuesRequestTitleDeserializer
            extends JsonDeserializer<ReposIssuesRequestTitle> {

        @Override
        public ReposIssuesRequestTitle deserialize(JsonParser jp, DeserializationContext ctxt)
