...
/**
 * This is a model class for DiscussionCommenteditedevent type.
 */
public class DiscussionCommenteditedevent {
     ...
     * Default constructor.
     */
    public DiscussionCommenteditedevent() {
        action = "edited";
    }
     ...
     * @param  changes  Changes2 value for changes.
     * @param  comment  Comment1 value for comment.
     * @param  discussion  Discussion2 value for discussion.
    ...
    /**
     * Setter for Changes.
     * @param changes Value for Changes2
     */
    @JsonSetter("changes")
    public void setChanges(Changes2 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Setter for Comment.
     * @param comment Value for Comment1
     */
    @JsonSetter("comment")
     ...
     * @return Returns the Discussion2
     */
    @JsonGetter("discussion")
    public Discussion2 getDiscussion() {
        return discussion;
    }

    /**
     * Setter for Discussion.
     * @param discussion Value for Discussion2
     */
    @JsonSetter("discussion")
    public void setDiscussion(Discussion2 discussion) {
        this.discussion = discussion;
    }
    ...
    /**
     * Converts this DiscussionCommenteditedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DiscussionCommenteditedevent [" + "action=" + action + ", changes=" + changes
                + ", comment=" + comment + ", discussion=" + discussion + ", repository="
                + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link DiscussionCommenteditedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DiscussionCommenteditedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, changes, comment, discussion, repository, sender)
    ...
    /**
     * Class to build instances of {@link DiscussionCommenteditedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes2 changes, Comment1 comment, Discussion2 discussion,
         ...
         * @return Builder
         */
        public Builder changes(Changes2 changes) {
            this.changes = changes;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder comment(Comment1 comment) {
            this.comment = comment;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder discussion(Discussion2 discussion) {
            this.discussion = discussion;
            return this;
        }
        ...
        /**
         * Builds a new {@link DiscussionCommenteditedevent} object using the set fields.
         * @return {@link DiscussionCommenteditedevent}
         */
        public DiscussionCommenteditedevent build() {
            return new DiscussionCommenteditedevent(action, changes, comment, discussion,
