 ...
 */
@JsonDeserialize(using = ReposDeploymentsDeploymentIdResponsePayload.ReposDeploymentsDeploymentIdResponsePayloadDeserializer.class)
public abstract class ReposDeploymentsDeploymentIdResponsePayload {
     ...
     */
    public static ReposDeploymentsDeploymentIdResponsePayload fromObject(
     ...
     */
    public static ReposDeploymentsDeploymentIdResponsePayload fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends ReposDeploymentsDeploymentIdResponsePayload {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposDeploymentsDeploymentIdResponsePayload {
    ...
    /**
     * This is a custom deserializer class for ReposDeploymentsDeploymentIdResponsePayload.
     */
    protected static class ReposDeploymentsDeploymentIdResponsePayloadDeserializer
            extends JsonDeserializer<ReposDeploymentsDeploymentIdResponsePayload> {

        @Override
        public ReposDeploymentsDeploymentIdResponsePayload deserialize(JsonParser jp, DeserializationContext ctxt)
