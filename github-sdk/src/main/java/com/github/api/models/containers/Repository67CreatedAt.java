 ...
 */
@JsonDeserialize(using = Repository67CreatedAt.Repository67CreatedAtDeserializer.class)
public abstract class Repository67CreatedAt {
     ...
     */
    public static Repository67CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository67CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository67CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository67CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository67CreatedAt.
     */
    protected static class Repository67CreatedAtDeserializer
            extends JsonDeserializer<Repository67CreatedAt> {

        @Override
        public Repository67CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
