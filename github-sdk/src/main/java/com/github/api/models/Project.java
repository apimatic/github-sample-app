...
public class Project {
    ...
    public String toString() {
        return "Project [" + "ownerUrl=" + ownerUrl + ", url=" + url + ", htmlUrl=" + htmlUrl
    ...
    public static class Builder {
        ...
        public Project build() {
            return new Project(ownerUrl, url, htmlUrl, columnsUrl, id, nodeId, name, body, number,
                    state, creator, createdAt, updatedAt, organizationPermission, mPrivate);
        }
    }
}
