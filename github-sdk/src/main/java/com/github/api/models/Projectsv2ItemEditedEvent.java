...
import com.github.api.models.containers.Projectsv2ItemEditedEventChanges;
import io.apimatic.core.types.BaseModel;

/**
 * This is a model class for Projectsv2ItemEditedEvent type.
 */
public class Projectsv2ItemEditedEvent {
    private String action;
    private Projectsv2ItemEditedEventChanges changes;
     ...
     * Default constructor.
     */
    public Projectsv2ItemEditedEvent() {
        action = "edited";
    }
     ...
     * @param  changes  Projectsv2ItemEditedEventChanges value for changes.
    ...
    public Projectsv2ItemEditedEvent(
            ...
            Sender sender,
            Projectsv2ItemEditedEventChanges changes,
    ...
    /**
     * Getter for Changes.
     * @return Returns the Projectsv2ItemEditedEventChanges
     */
    @JsonGetter("changes")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Projectsv2ItemEditedEventChanges getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Projectsv2ItemEditedEventChanges
     */
    @JsonSetter("changes")
    public void setChanges(Projectsv2ItemEditedEventChanges changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Projectsv2ItemEditedEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Projectsv2ItemEditedEvent [" + "action=" + action + ", organization=" + organization
                + ", projectsV2Item=" + projectsV2Item + ", sender=" + sender + ", changes="
                + changes + ", installation=" + installation + "]";
    }

    /**
     * Builds a new {@link Projectsv2ItemEditedEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Projectsv2ItemEditedEvent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, organization, projectsV2Item, sender)
                .changes(getChanges())
    ...
    /**
     * Class to build instances of {@link Projectsv2ItemEditedEvent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Organization2 organization, ProjectsV2Item1 projectsV2Item,
                Sender sender) {
            this.action = action;
            this.organization = organization;
            this.projectsV2Item = projectsV2Item;
         ...
         * @return Builder
         */
        public Builder changes(Projectsv2ItemEditedEventChanges changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Projectsv2ItemEditedEvent} object using the set fields.
         * @return {@link Projectsv2ItemEditedEvent}
         */
        public Projectsv2ItemEditedEvent build() {
            return new Projectsv2ItemEditedEvent(action, organization, projectsV2Item, sender,
