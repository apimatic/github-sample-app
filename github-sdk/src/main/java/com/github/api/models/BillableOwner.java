...
/**
 * This is a model class for BillableOwner type.
 */
public class BillableOwner {
     ...
     */
    protected BillableOwner(String login, int id, String nodeId, String avatarUrl,
            String gravatarId, String url, String htmlUrl, String followersUrl, String followingUrl,
            ...
            boolean siteAdmin, OptionalNullable<String> name, OptionalNullable<String> email,
            String starredAt) {
        this.name = name;
        this.email = email;
        this.login = login;
    ...
    /**
     * Converts this BillableOwner into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BillableOwner [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
                ...
                + siteAdmin + ", name=" + name + ", email=" + email + ", starredAt=" + starredAt
                + "]";
    }

    /**
     * Builds a new {@link BillableOwner.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BillableOwner.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BillableOwner}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BillableOwner} object using the set fields.
         * @return {@link BillableOwner}
         */
        public BillableOwner build() {
            return new BillableOwner(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
