...
import com.github.api.models.containers.PullRequest34Assignees;
import com.github.api.models.containers.PullRequest34RequestedReviewers;
...
/**
 * This is a model class for PullRequest34 type.
 */
public class PullRequest34 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest34Assignees> assignees;
    ...
    private List<PullRequest34RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest34Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest34RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest34(
            ...
            Object assignee,
            List<PullRequest34Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest34RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest34(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest34Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            int number, String patchUrl, List<PullRequest34RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest34Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest34Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest34Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest34Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest34RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest34RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest34RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest34RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest34 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest34 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest34.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest34.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest34}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest34Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest34} object using the set fields.
         * @return {@link PullRequest34}
         */
        public PullRequest34 build() {
            return new PullRequest34(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
