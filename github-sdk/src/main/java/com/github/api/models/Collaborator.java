...
/**
 * This is a model class for Collaborator type.
 */
public class Collaborator {
     ...
     */
    protected Collaborator(String login, int id, String nodeId, String avatarUrl, String gravatarId,
            ...
            String roleName, OptionalNullable<String> email, OptionalNullable<String> name,
            Permissions1 permissions) {
        this.login = login;
        this.id = id;
        this.email = email;
    ...
    /**
     * Converts this Collaborator into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Collaborator [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
                ...
                + siteAdmin + ", roleName=" + roleName + ", email=" + email + ", name=" + name
                + ", permissions=" + permissions + "]";
    }

    /**
     * Builds a new {@link Collaborator.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Collaborator.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                ...
                organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin, roleName)
    ...
    /**
     * Class to build instances of {@link Collaborator}.
     */
    public static class Builder {
        ...
        public Builder(String login, int id, String nodeId, String avatarUrl, String gravatarId,
                ...
                String receivedEventsUrl, String type, boolean siteAdmin, String roleName) {
            this.login = login;
            this.id = id;
            this.nodeId = nodeId;
            this.avatarUrl = avatarUrl;
        ...
        /**
         * Builds a new {@link Collaborator} object using the set fields.
         * @return {@link Collaborator}
         */
        public Collaborator build() {
            return new Collaborator(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
                    organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin,
                    roleName, email, name, permissions);
        }
    }
}
