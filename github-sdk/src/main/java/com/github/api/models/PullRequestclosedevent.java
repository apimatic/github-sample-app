...
/**
 * This is a model class for PullRequestclosedevent type.
 */
public class PullRequestclosedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest31 pullRequest;
     ...
     * @param  pullRequest  PullRequest31 value for pullRequest.
     ...
     * @return Returns the PullRequest31
     */
    @JsonGetter("pull_request")
    public PullRequest31 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest31
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest31 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestclosedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestclosedevent [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestclosedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestclosedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestclosedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest31 pullRequest, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest31 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestclosedevent} object using the set fields.
         * @return {@link PullRequestclosedevent}
         */
        public PullRequestclosedevent build() {
            return new PullRequestclosedevent(action, number, pullRequest, repository, sender,
