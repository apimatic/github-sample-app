 ...
 */
@JsonDeserialize(using = Issue6Assignees.Issue6AssigneesDeserializer.class)
public abstract class Issue6Assignees {
     ...
     */
    public static Issue6Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue6Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue6Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends Issue6Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue6Assignees.
     */
    protected static class Issue6AssigneesDeserializer
            extends JsonDeserializer<Issue6Assignees> {

        @Override
        public Issue6Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
