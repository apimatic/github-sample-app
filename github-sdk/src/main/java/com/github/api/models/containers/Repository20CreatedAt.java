 ...
 */
@JsonDeserialize(using = Repository20CreatedAt.Repository20CreatedAtDeserializer.class)
public abstract class Repository20CreatedAt {
     ...
     */
    public static Repository20CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository20CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository20CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository20CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository20CreatedAt.
     */
    protected static class Repository20CreatedAtDeserializer
            extends JsonDeserializer<Repository20CreatedAt> {

        @Override
        public Repository20CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
