...
/**
 * This is a model class for Packagepublishedevent type.
 */
public class Packagepublishedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private Organization2 organization;
    private Package32 mPackage;
     ...
     * @param  mPackage  Package32 value for mPackage.
    ...
    /**
     * Getter for Package.
     * @return Returns the Package32
     */
    @JsonGetter("package")
    public Package32 getPackage() {
        return mPackage;
    }

    /**
     * Setter for Package.
     * @param mPackage Value for Package32
     */
    @JsonSetter("package")
    public void setPackage(Package32 mPackage) {
        this.mPackage = mPackage;
    }
    ...
    /**
     * Converts this Packagepublishedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Packagepublishedevent [" + "action=" + action + ", mPackage=" + mPackage
    ...
    /**
     * Builds a new {@link Packagepublishedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Packagepublishedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, mPackage, sender)
    ...
    /**
     * Class to build instances of {@link Packagepublishedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Package32 mPackage, Sender sender) {
            this.action = action;
            this.mPackage = mPackage;
            this.sender = sender;
        }
         ...
         * @return Builder
         */
        public Builder mPackage(Package32 mPackage) {
            this.mPackage = mPackage;
            return this;
        }
        ...
        /**
         * Builds a new {@link Packagepublishedevent} object using the set fields.
         * @return {@link Packagepublishedevent}
         */
        public Packagepublishedevent build() {
            return new Packagepublishedevent(action, mPackage, sender, enterprise, installation,
