...
/**
 * This is a model class for Publicevent type.
 */
public class Publicevent {
    ...
    /**
     * Converts this Publicevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Publicevent [" + "repository=" + repository + ", sender=" + sender + ", enterprise="
                + enterprise + ", installation=" + installation + ", organization=" + organization
                + "]";
    }

    /**
     * Builds a new {@link Publicevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Publicevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(repository, sender)
    ...
    /**
     * Class to build instances of {@link Publicevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(Repository3 repository, Sender sender) {
            this.repository = repository;
            this.sender = sender;
        }
        ...
        /**
         * Builds a new {@link Publicevent} object using the set fields.
         * @return {@link Publicevent}
         */
        public Publicevent build() {
            return new Publicevent(repository, sender, enterprise, installation, organization);
        }
    }
}
