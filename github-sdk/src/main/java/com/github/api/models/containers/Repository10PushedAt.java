 ...
 */
@JsonDeserialize(using = Repository10PushedAt.Repository10PushedAtDeserializer.class)
public abstract class Repository10PushedAt {
     ...
     */
    public static Repository10PushedAt fromNumber(int number) {
     ...
     */
    public static Repository10PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repository10PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository10PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository10PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repository10PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository10PushedAt.
     */
    protected static class Repository10PushedAtDeserializer
            extends JsonDeserializer<Repository10PushedAt> {

        @Override
        public Repository10PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
