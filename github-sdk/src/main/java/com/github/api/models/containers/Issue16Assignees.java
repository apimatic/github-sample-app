 ...
 */
@JsonDeserialize(using = Issue16Assignees.Issue16AssigneesDeserializer.class)
public abstract class Issue16Assignees {
     ...
     */
    public static Issue16Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue16Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue16Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends Issue16Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue16Assignees.
     */
    protected static class Issue16AssigneesDeserializer
            extends JsonDeserializer<Issue16Assignees> {

        @Override
        public Issue16Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
