...
/**
 * This is a model class for PullRequestreviewRequestedevent1 type.
 */
public class PullRequestreviewRequestedevent1 {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest49 pullRequest;
    private Repository3 repository;
    private RequestedTeam6 requestedTeam;
    private Sender sender;

    /**
     * Default constructor.
     */
    public PullRequestreviewRequestedevent1() {
     ...
     * @param  pullRequest  PullRequest49 value for pullRequest.
     * @param  repository  Repository3 value for repository.
     * @param  requestedTeam  RequestedTeam6 value for requestedTeam.
    ...
    public PullRequestreviewRequestedevent1(
            String action,
            int number,
            PullRequest49 pullRequest,
            Repository3 repository,
            RequestedTeam6 requestedTeam,
            Sender sender,
     ...
     * @return Returns the PullRequest49
     */
    @JsonGetter("pull_request")
    public PullRequest49 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest49
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest49 pullRequest) {
        this.pullRequest = pullRequest;
    }
     ...
     * @return Returns the RequestedTeam6
     */
    @JsonGetter("requested_team")
    public RequestedTeam6 getRequestedTeam() {
        return requestedTeam;
    }

    /**
     * Setter for RequestedTeam.
     * @param requestedTeam Value for RequestedTeam6
     */
    @JsonSetter("requested_team")
    public void setRequestedTeam(RequestedTeam6 requestedTeam) {
        this.requestedTeam = requestedTeam;
    }
    ...
    /**
     * Converts this PullRequestreviewRequestedevent1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestreviewRequestedevent1 [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestreviewRequestedevent1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestreviewRequestedevent1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestreviewRequestedevent1}.
     */
    public static class Builder {
        private String action = "review_requested";
        private int number;
        private PullRequest49 pullRequest;
        private Repository3 repository;
        private RequestedTeam6 requestedTeam;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest49 pullRequest, Repository3 repository,
                RequestedTeam6 requestedTeam, Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
            this.repository = repository;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest49 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder requestedTeam(RequestedTeam6 requestedTeam) {
            this.requestedTeam = requestedTeam;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestreviewRequestedevent1} object using the set fields.
         * @return {@link PullRequestreviewRequestedevent1}
         */
        public PullRequestreviewRequestedevent1 build() {
            return new PullRequestreviewRequestedevent1(action, number, pullRequest, repository,
                    requestedTeam, sender, enterprise, installation, organization);
        }
    }
}
