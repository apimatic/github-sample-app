 ...
 */
@JsonDeserialize(using = Issue1Labels.Issue1LabelsDeserializer.class)
public abstract class Issue1Labels {
     ...
     */
    public static Issue1Labels fromMString(String mString) {
     ...
     */
    public static Issue1Labels fromLabel2(Label2 label2) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends Issue1Labels {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Label2Case extends Issue1Labels {
    ...
    /**
     * This is a custom deserializer class for Issue1Labels.
     */
    protected static class Issue1LabelsDeserializer
            extends JsonDeserializer<Issue1Labels> {

        @Override
        public Issue1Labels deserialize(JsonParser jp, DeserializationContext ctxt)
