...
/**
 * This is a model class for ReposPullsPullNumberRequestedReviewersResponse1 type.
 */
public class ReposPullsPullNumberRequestedReviewersResponse1 {
    private String url;
    private int id;
     ...
     * Default constructor.
     */
    public ReposPullsPullNumberRequestedReviewersResponse1() {
    }
     ...
     */
    protected ReposPullsPullNumberRequestedReviewersResponse1(String url, int id, String nodeId,
            String htmlUrl, String diffUrl, String patchUrl, String issueUrl, String commitsUrl,
            String reviewCommentsUrl, String reviewCommentUrl, String commentsUrl,
            String statusesUrl, int number, String state, boolean locked, String title, Object user,
            String body, List<Label1> labels, Object milestone, LocalDateTime createdAt,
    ...
    /**
     * Converts this ReposPullsPullNumberRequestedReviewersResponse1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposPullsPullNumberRequestedReviewersResponse1 [" + "url=" + url + ", id=" + id
                + ", nodeId=" + nodeId + ", htmlUrl=" + htmlUrl + ", diffUrl=" + diffUrl
                + ", patchUrl=" + patchUrl + ", issueUrl=" + issueUrl + ", commitsUrl=" + commitsUrl
                + ", reviewCommentsUrl=" + reviewCommentsUrl + ", reviewCommentUrl="
                + reviewCommentUrl + ", commentsUrl=" + commentsUrl + ", statusesUrl=" + statusesUrl
                + ", number=" + number + ", state=" + state + ", locked=" + locked + ", title="
                + title + ", user=" + user + ", body=" + body + ", labels=" + labels
                + ", milestone=" + milestone + ", createdAt=" + createdAt + ", updatedAt="
                + updatedAt + ", closedAt=" + closedAt + ", mergedAt=" + mergedAt
                + ", mergeCommitSha=" + mergeCommitSha + ", assignee=" + assignee + ", head=" + head
                + ", base=" + base + ", links=" + links + ", authorAssociation=" + authorAssociation
                + ", autoMerge=" + autoMerge + ", activeLockReason=" + activeLockReason
                + ", assignees=" + assignees + ", requestedReviewers=" + requestedReviewers
                + ", requestedTeams=" + requestedTeams + ", draft=" + draft + "]";
    }

    /**
     * Builds a new {@link ReposPullsPullNumberRequestedReviewersResponse1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposPullsPullNumberRequestedReviewersResponse1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposPullsPullNumberRequestedReviewersResponse1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReposPullsPullNumberRequestedReviewersResponse1} object using the set
         * fields.
         * @return {@link ReposPullsPullNumberRequestedReviewersResponse1}
         */
        public ReposPullsPullNumberRequestedReviewersResponse1 build() {
            return new ReposPullsPullNumberRequestedReviewersResponse1(url, id, nodeId, htmlUrl,
                    diffUrl, patchUrl, issueUrl, commitsUrl, reviewCommentsUrl, reviewCommentUrl,
                    commentsUrl, statusesUrl, number, state, locked, title, user, body, labels,
                    milestone, createdAt, updatedAt, closedAt, mergedAt, mergeCommitSha, assignee,
                    head, base, links, authorAssociation, autoMerge, activeLockReason, assignees,
                    requestedReviewers, requestedTeams, draft);
        }
    }
}
