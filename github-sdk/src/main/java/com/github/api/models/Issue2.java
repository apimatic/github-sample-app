...
import com.github.api.models.containers.Issue2Assignees;
...
/**
 * This is a model class for Issue2 type.
 */
public class Issue2 {
    private Object activeLockReason;
    private Object assignee;
    private List<Issue2Assignees> assignees;
     ...
     * @param  assignees  List of Issue2Assignees value for assignees.
    ...
    public Issue2(
            ...
            Object assignee,
            List<Issue2Assignees> assignees,
     ...
     */
    protected Issue2(Object activeLockReason, Object assignee, List<Issue2Assignees> assignees,
     ...
     * @return Returns the List of Issue2Assignees
     */
    @JsonGetter("assignees")
    public List<Issue2Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of Issue2Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<Issue2Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Converts this Issue2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue2 [" + "activeLockReason=" + activeLockReason + ", assignee=" + assignee
    ...
    /**
     * Builds a new {@link Issue2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Issue2}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(Object activeLockReason, Object assignee, List<Issue2Assignees> assignees,
                AuthorAssociationEnum authorAssociation, String body, LocalDateTime closedAt,
                int comments, String commentsUrl, LocalDateTime createdAt, String eventsUrl,
                String htmlUrl, int id, List<Label10> labels, String labelsUrl, boolean locked,
                Object milestone, String nodeId, int number, ReactionRollup reactions,
         ...
         * @return Builder
         */
        public Builder assignees(List<Issue2Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue2} object using the set fields.
         * @return {@link Issue2}
         */
        public Issue2 build() {
            return new Issue2(activeLockReason, assignee, assignees, authorAssociation, body,
