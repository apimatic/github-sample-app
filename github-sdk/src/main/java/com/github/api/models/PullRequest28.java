...
import com.github.api.models.containers.PullRequest28Assignees;
import com.github.api.models.containers.PullRequest28RequestedReviewers;
...
/**
 * This is a model class for PullRequest28 type.
 */
public class PullRequest28 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest28Assignees> assignees;
    ...
    private List<PullRequest28RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest28Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest28RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest28(
            ...
            Object assignee,
            List<PullRequest28Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest28RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest28(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest28Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            int number, String patchUrl, List<PullRequest28RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest28Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest28Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest28Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest28Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest28RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest28RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest28RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest28RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest28 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest28 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest28.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest28.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest28}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest28Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest28} object using the set fields.
         * @return {@link PullRequest28}
         */
        public PullRequest28 build() {
            return new PullRequest28(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
