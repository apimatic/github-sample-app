...
public class Job {
    ...
    public String toString() {
        return "Job [" + "id=" + id + ", runId=" + runId + ", runUrl=" + runUrl + ", nodeId="
                + nodeId + ", headSha=" + headSha + ", url=" + url + ", htmlUrl=" + htmlUrl
                + ", status=" + status + ", conclusion=" + conclusion + ", startedAt=" + startedAt
                + ", completedAt=" + completedAt + ", name=" + name + ", checkRunUrl=" + checkRunUrl
                + ", labels=" + labels + ", runnerId=" + runnerId + ", runnerName=" + runnerName
                + ", runnerGroupId=" + runnerGroupId + ", runnerGroupName=" + runnerGroupName
                + ", workflowName=" + workflowName + ", headBranch=" + headBranch + ", runAttempt="
                + runAttempt + ", steps=" + steps + "]";
    }
    ...
    public static class Builder {
         ...
         */
        public Job build() {
            return new Job(id, runId, runUrl, nodeId, headSha, url, htmlUrl, status, conclusion,
                    startedAt, completedAt, name, checkRunUrl, labels, runnerId, runnerName,
                    runnerGroupId, runnerGroupName, workflowName, headBranch, runAttempt, steps);
        }
    }
}
