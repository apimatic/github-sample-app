...
/**
 * This is a model class for Releaseprereleasedevent type.
 */
public class Releaseprereleasedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private Organization2 organization;
    private Release8 release;
     ...
     * Default constructor.
     */
    public Releaseprereleasedevent() {
        action = "prereleased";
    }
     ...
     * @param  release  Release8 value for release.
    ...
    /**
     * Getter for Release.
     * @return Returns the Release8
     */
    @JsonGetter("release")
    public Release8 getRelease() {
        return release;
    }

    /**
     * Setter for Release.
     * @param release Value for Release8
     */
    @JsonSetter("release")
    public void setRelease(Release8 release) {
        this.release = release;
    }
    ...
    /**
     * Converts this Releaseprereleasedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Releaseprereleasedevent [" + "action=" + action + ", release=" + release
                + ", repository=" + repository + ", enterprise=" + enterprise + ", installation="
                + installation + ", organization=" + organization + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link Releaseprereleasedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Releaseprereleasedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Releaseprereleasedevent}.
     */
    public static class Builder {
        private String action = "prereleased";
        private Release8 release;
        private Repository3 repository;
        private Enterprise1 enterprise;
        private Installation1 installation;
         ...
         * @param  repository  Repository3 value for repository.
         */
        public Builder(String action, Release8 release, Repository3 repository) {
            this.action = action;
            this.release = release;
            this.repository = repository;
        }
         ...
         * @return Builder
         */
        public Builder release(Release8 release) {
            this.release = release;
            return this;
        }
        ...
        /**
         * Builds a new {@link Releaseprereleasedevent} object using the set fields.
         * @return {@link Releaseprereleasedevent}
         */
        public Releaseprereleasedevent build() {
            return new Releaseprereleasedevent(action, release, repository, enterprise,
