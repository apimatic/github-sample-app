...
/**
 * This is a model class for IssueEvent type.
 */
public class IssueEvent {
     ...
     */
    protected IssueEvent(int id, String nodeId, String url, Object actor, String event,
            String commitId, String commitUrl, LocalDateTime createdAt, Object issue, Label22 label,
            Object assignee, Object assigner, Object reviewRequester, Object requestedReviewer,
            RequestedTeam requestedTeam, IssueEventDismissedReview dismissedReview,
            Milestone1 milestone, ProjectCard1 projectCard, Rename rename,
            AuthorAssociationEnum authorAssociation, OptionalNullable<String> lockReason,
            Object performedViaGithubApp) {
        this.id = id;
        this.nodeId = nodeId;
        this.url = url;
    ...
    /**
     * Converts this IssueEvent into string format.
    ...
    public String toString() {
        return "IssueEvent [" + "id=" + id + ", nodeId=" + nodeId + ", url=" + url + ", actor="
                ...
                + ", createdAt=" + createdAt + ", issue=" + issue + ", label=" + label
                + ", assignee=" + assignee + ", assigner=" + assigner + ", reviewRequester="
                + reviewRequester + ", requestedReviewer=" + requestedReviewer + ", requestedTeam="
                + requestedTeam + ", dismissedReview=" + dismissedReview + ", milestone="
                + milestone + ", projectCard=" + projectCard + ", rename=" + rename
                + ", authorAssociation=" + authorAssociation + ", lockReason=" + lockReason
                + ", performedViaGithubApp=" + performedViaGithubApp + "]";
    }

    /**
     * Builds a new {@link IssueEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link IssueEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link IssueEvent}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link IssueEvent} object using the set fields.
         * @return {@link IssueEvent}
         */
        public IssueEvent build() {
            return new IssueEvent(id, nodeId, url, actor, event, commitId, commitUrl, createdAt,
                    issue, label, assignee, assigner, reviewRequester, requestedReviewer,
                    requestedTeam, dismissedReview, milestone, projectCard, rename,
                    authorAssociation, lockReason, performedViaGithubApp);
        }
    }
}
