 ...
 */
@JsonDeserialize(using = SimplePullRequest2Assignees.SimplePullRequest2AssigneesDeserializer.class)
public abstract class SimplePullRequest2Assignees {
     ...
     */
    public static SimplePullRequest2Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static SimplePullRequest2Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends SimplePullRequest2Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends SimplePullRequest2Assignees {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest2Assignees.
     */
    protected static class SimplePullRequest2AssigneesDeserializer
            extends JsonDeserializer<SimplePullRequest2Assignees> {

        @Override
        public SimplePullRequest2Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
