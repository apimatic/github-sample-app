...
/**
 * This is a model class for PullRequestreviewRequestedevent type.
 */
public class PullRequestreviewRequestedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest48 pullRequest;
     ...
     * Default constructor.
     */
    public PullRequestreviewRequestedevent() {
     ...
     * @param  pullRequest  PullRequest48 value for pullRequest.
     ...
     * @return Returns the PullRequest48
     */
    @JsonGetter("pull_request")
    public PullRequest48 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest48
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest48 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestreviewRequestedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestreviewRequestedevent [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestreviewRequestedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestreviewRequestedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestreviewRequestedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest48 pullRequest, Repository3 repository,
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest48 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestreviewRequestedevent} object using the set fields.
         * @return {@link PullRequestreviewRequestedevent}
         */
        public PullRequestreviewRequestedevent build() {
            return new PullRequestreviewRequestedevent(action, number, pullRequest, repository,
