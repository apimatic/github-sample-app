 ...
 */
@JsonDeserialize(using = ReposPagesRequest32Source.ReposPagesRequest32SourceDeserializer.class)
public abstract class ReposPagesRequest32Source {
     ...
     */
    public static ReposPagesRequest32Source fromSource2(Source2Enum source2) {
     ...
     */
    public static ReposPagesRequest32Source fromSource21(Source21 source21) {
    ...
    @TypeCombinatorCase
    private static class Source2Case extends ReposPagesRequest32Source {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Source21Case extends ReposPagesRequest32Source {
    ...
    /**
     * This is a custom deserializer class for ReposPagesRequest32Source.
     */
    protected static class ReposPagesRequest32SourceDeserializer
            extends JsonDeserializer<ReposPagesRequest32Source> {

        @Override
        public ReposPagesRequest32Source deserialize(JsonParser jp, DeserializationContext ctxt)
