...
import com.github.api.models.containers.SimplePullRequest2Assignees;
import com.github.api.models.containers.SimplePullRequest2RequestedReviewers;
import io.apimatic.core.types.BaseModel;
import java.util.List;

/**
 * This is a model class for SimplePullRequest2 type.
 */
public class SimplePullRequest2 {
    private Links2 links;
    private Object activeLockReason;
    private Object assignee;
    private List<SimplePullRequest2Assignees> assignees;
    ...
    private List<SimplePullRequest2RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of SimplePullRequest2Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of SimplePullRequest2RequestedReviewers value for
     *         requestedReviewers.
    ...
    public SimplePullRequest2(
            ...
            Object assignee,
            List<SimplePullRequest2Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<SimplePullRequest2RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of SimplePullRequest2Assignees
     */
    @JsonGetter("assignees")
    public List<SimplePullRequest2Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of SimplePullRequest2Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<SimplePullRequest2Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of SimplePullRequest2RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<SimplePullRequest2RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of SimplePullRequest2RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<SimplePullRequest2RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this SimplePullRequest2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SimplePullRequest2 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link SimplePullRequest2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SimplePullRequest2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SimplePullRequest2}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<SimplePullRequest2Assignees> assignees,
                AuthorAssociationEnum authorAssociation, Object autoMerge, Base8 base, String body,
         ...
         * @return Builder
         */
        public Builder assignees(List<SimplePullRequest2Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link SimplePullRequest2} object using the set fields.
         * @return {@link SimplePullRequest2}
         */
        public SimplePullRequest2 build() {
            return new SimplePullRequest2(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
