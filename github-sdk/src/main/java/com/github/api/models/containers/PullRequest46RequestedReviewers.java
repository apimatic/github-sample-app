 ...
 */
@JsonDeserialize(using = PullRequest46RequestedReviewers.PullRequest46RequestedReviewersDeserializer.class)
public abstract class PullRequest46RequestedReviewers {
     ...
     */
    public static PullRequest46RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest46RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest46RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest46RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest46RequestedReviewers.
     */
    protected static class PullRequest46RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest46RequestedReviewers> {

        @Override
        public PullRequest46RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
