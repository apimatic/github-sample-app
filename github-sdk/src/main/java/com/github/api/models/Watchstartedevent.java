...
/**
 * This is a model class for Watchstartedevent type.
 */
public class Watchstartedevent {
    ...
    /**
     * Converts this Watchstartedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Watchstartedevent [" + "action=" + action + ", repository=" + repository
                + ", sender=" + sender + ", enterprise=" + enterprise + ", installation="
                + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Watchstartedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Watchstartedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Watchstartedevent}.
     */
    public static class Builder {
        private String action = "started";
        private Repository3 repository;
        private Sender sender;
        private Enterprise1 enterprise;
        private Installation1 installation;
        ...
        /**
         * Builds a new {@link Watchstartedevent} object using the set fields.
         * @return {@link Watchstartedevent}
         */
        public Watchstartedevent build() {
            return new Watchstartedevent(action, repository, sender, enterprise, installation,
                    organization);
        }
    }
}
