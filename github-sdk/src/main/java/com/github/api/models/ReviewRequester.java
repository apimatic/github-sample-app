...
/**
 * This is a model class for ReviewRequester type.
 */
public class ReviewRequester {
     ...
     */
    protected ReviewRequester(String login, int id, String nodeId, String avatarUrl,
    ...
    /**
     * Converts this ReviewRequester into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReviewRequester [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link ReviewRequester.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReviewRequester.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReviewRequester}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReviewRequester} object using the set fields.
         * @return {@link ReviewRequester}
         */
        public ReviewRequester build() {
            return new ReviewRequester(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
