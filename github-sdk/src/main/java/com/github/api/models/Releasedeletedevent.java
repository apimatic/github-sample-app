...
/**
 * This is a model class for Releasedeletedevent type.
 */
public class Releasedeletedevent {
    ...
    /**
     * Converts this Releasedeletedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Releasedeletedevent [" + "action=" + action + ", release=" + release
                + ", repository=" + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Releasedeletedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Releasedeletedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, release, repository, sender)
    ...
    /**
     * Class to build instances of {@link Releasedeletedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Release9 release, Repository3 repository, Sender sender) {
            this.action = action;
            this.release = release;
            this.repository = repository;
            this.sender = sender;
        ...
        /**
         * Builds a new {@link Releasedeletedevent} object using the set fields.
         * @return {@link Releasedeletedevent}
         */
        public Releasedeletedevent build() {
            return new Releasedeletedevent(action, release, repository, sender, enterprise,
