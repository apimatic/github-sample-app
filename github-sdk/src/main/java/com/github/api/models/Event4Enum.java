...
/**
 * Event4Enum to be used.
 */
public enum Event4Enum {
    ...
    private static TreeMap<String, Event4Enum> valueMap = new TreeMap<>();
    ...
    public static Event4Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Event4Enum values to list of string values.
     * @param toConvert The list of Event4Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Event4Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Event4Enum enumValue : toConvert) {
