 ...
 */
@JsonDeserialize(using = PullRequest53Assignees.PullRequest53AssigneesDeserializer.class)
public abstract class PullRequest53Assignees {
     ...
     */
    public static PullRequest53Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest53Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest53Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest53Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest53Assignees.
     */
    protected static class PullRequest53AssigneesDeserializer
            extends JsonDeserializer<PullRequest53Assignees> {

        @Override
        public PullRequest53Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
