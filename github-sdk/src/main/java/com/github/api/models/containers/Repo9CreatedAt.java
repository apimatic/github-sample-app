 ...
 */
@JsonDeserialize(using = Repo9CreatedAt.Repo9CreatedAtDeserializer.class)
public abstract class Repo9CreatedAt {
     ...
     */
    public static Repo9CreatedAt fromNumber(int number) {
     ...
     */
    public static Repo9CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo9CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo9CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repo9CreatedAt.
     */
    protected static class Repo9CreatedAtDeserializer
            extends JsonDeserializer<Repo9CreatedAt> {

        @Override
        public Repo9CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
