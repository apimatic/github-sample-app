...
/**
 * This is a model class for Owner1 type.
 */
public class Owner1 {
     ...
     */
    protected Owner1(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    /**
     * Converts this Owner1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Owner1 [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", avatarUrl="
    ...
    /**
     * Builds a new {@link Owner1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Owner1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Owner1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Owner1} object using the set fields.
         * @return {@link Owner1}
         */
        public Owner1 build() {
            return new Owner1(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl,
