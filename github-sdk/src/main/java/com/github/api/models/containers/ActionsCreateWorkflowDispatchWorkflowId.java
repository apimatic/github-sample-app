 ...
 */
@JsonDeserialize(using = ActionsCreateWorkflowDispatchWorkflowId.ActionsCreateWorkflowDispatchWorkflowIdDeserializer.class)
public abstract class ActionsCreateWorkflowDispatchWorkflowId {
     ...
     */
    public static ActionsCreateWorkflowDispatchWorkflowId fromNumber(int number) {
     ...
     */
    public static ActionsCreateWorkflowDispatchWorkflowId fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ActionsCreateWorkflowDispatchWorkflowId {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ActionsCreateWorkflowDispatchWorkflowId {
    ...
    /**
     * This is a custom deserializer class for ActionsCreateWorkflowDispatchWorkflowId.
     */
    protected static class ActionsCreateWorkflowDispatchWorkflowIdDeserializer
            extends JsonDeserializer<ActionsCreateWorkflowDispatchWorkflowId> {

        @Override
        public ActionsCreateWorkflowDispatchWorkflowId deserialize(JsonParser jp, DeserializationContext ctxt)
