...
public class Organization1 {
     ...
     */
    protected Organization1(String login, int id, String nodeId, String url, String reposUrl,
    ...
    public String toString() {
        return "Organization1 [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", url="
    ...
    public static class Builder {
        ...
        public Organization1 build() {
            return new Organization1(login, id, nodeId, url, reposUrl, eventsUrl, hooksUrl,
                    issuesUrl, membersUrl, publicMembersUrl, avatarUrl, description,
