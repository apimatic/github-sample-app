...
/**
 * This is a model class for Permissions27 type.
 */
public class Permissions27 {
    ...
    private Actions1Enum organizationProjects;
    ...
    private Actions1Enum repositoryProjects;
     ...
     * @param  organizationProjects  Actions1Enum value for organizationProjects.
     ...
     * @param  repositoryProjects  Actions1Enum value for repositoryProjects.
    ...
    public Permissions27(
            ...
            Actions1Enum organizationProjects,
            ...
            Actions1Enum repositoryProjects,
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Actions1Enum getOrganizationProjects() {
        return organizationProjects;
    }

    /**
     * Setter for OrganizationProjects.
     * @param organizationProjects Value for Actions1Enum
     */
    @JsonSetter("organization_projects")
    public void setOrganizationProjects(Actions1Enum organizationProjects) {
        this.organizationProjects = organizationProjects;
    }
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Actions1Enum getRepositoryProjects() {
        return repositoryProjects;
    }

    /**
     * Setter for RepositoryProjects.
     * @param repositoryProjects Value for Actions1Enum
     */
    @JsonSetter("repository_projects")
    public void setRepositoryProjects(Actions1Enum repositoryProjects) {
        this.repositoryProjects = repositoryProjects;
    }
    ...
    /**
     * Converts this Permissions27 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Permissions27 [" + "actions=" + actions + ", administration=" + administration
    ...
    /**
     * Builds a new {@link Permissions27.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Permissions27.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Permissions27}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder organizationProjects(Actions1Enum organizationProjects) {
            this.organizationProjects = organizationProjects;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder repositoryProjects(Actions1Enum repositoryProjects) {
            this.repositoryProjects = repositoryProjects;
            return this;
        }
        ...
        /**
         * Builds a new {@link Permissions27} object using the set fields.
         * @return {@link Permissions27}
         */
        public Permissions27 build() {
            return new Permissions27(actions, administration, checks, contentReferences, contents,
