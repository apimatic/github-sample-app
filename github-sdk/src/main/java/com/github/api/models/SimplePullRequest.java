...
import com.github.api.models.containers.SimplePullRequestAssignees;
import com.github.api.models.containers.SimplePullRequestRequestedReviewers;
import io.apimatic.core.types.BaseModel;
import java.util.List;

/**
 * This is a model class for SimplePullRequest type.
 */
public class SimplePullRequest {
    private Links2 links;
    private Object activeLockReason;
    private Object assignee;
    private List<SimplePullRequestAssignees> assignees;
    ...
    private List<SimplePullRequestRequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of SimplePullRequestAssignees value for assignees.
     ...
     * @param  requestedReviewers  List of SimplePullRequestRequestedReviewers value for
     *         requestedReviewers.
    ...
    public SimplePullRequest(
            ...
            Object assignee,
            List<SimplePullRequestAssignees> assignees,
            ...
            int number,
            String patchUrl,
            List<SimplePullRequestRequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of SimplePullRequestAssignees
     */
    @JsonGetter("assignees")
    public List<SimplePullRequestAssignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of SimplePullRequestAssignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<SimplePullRequestAssignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of SimplePullRequestRequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<SimplePullRequestRequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of SimplePullRequestRequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<SimplePullRequestRequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this SimplePullRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SimplePullRequest [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link SimplePullRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SimplePullRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SimplePullRequest}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<SimplePullRequestAssignees> assignees, AuthorAssociationEnum authorAssociation,
                Object autoMerge, Base8 base, String body, String closedAt, String commentsUrl,
                String commitsUrl, String createdAt, String diffUrl, boolean draft, Head12 head,
                String htmlUrl, int id, String issueUrl, List<Label10> labels, boolean locked,
                String mergeCommitSha, String mergedAt, Object milestone, String nodeId, int number,
                String patchUrl, List<SimplePullRequestRequestedReviewers> requestedReviewers,
         ...
         * @return Builder
         */
        public Builder assignees(List<SimplePullRequestAssignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link SimplePullRequest} object using the set fields.
         * @return {@link SimplePullRequest}
         */
        public SimplePullRequest build() {
            return new SimplePullRequest(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
