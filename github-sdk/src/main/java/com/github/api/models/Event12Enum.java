...
/**
 * Event12Enum to be used.
 */
public enum Event12Enum {
    ...
    private static TreeMap<String, Event12Enum> valueMap = new TreeMap<>();
    ...
    public static Event12Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Event12Enum values to list of string values.
     * @param toConvert The list of Event12Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Event12Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Event12Enum enumValue : toConvert) {
