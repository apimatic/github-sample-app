...
/**
 * This is a model class for Discussiontransferredevent type.
 */
public class Discussiontransferredevent {
    private String action;
    private Changes4 changes;
     ...
     * Default constructor.
     */
    public Discussiontransferredevent() {
        action = "transferred";
    }
     ...
     * @param  changes  Changes4 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes4
     */
    @JsonGetter("changes")
    public Changes4 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes4
     */
    @JsonSetter("changes")
    public void setChanges(Changes4 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Discussiontransferredevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Discussiontransferredevent [" + "action=" + action + ", changes=" + changes
    ...
    /**
     * Builds a new {@link Discussiontransferredevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Discussiontransferredevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Discussiontransferredevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes4 changes, Discussion1 discussion,
         ...
         * @return Builder
         */
        public Builder changes(Changes4 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Discussiontransferredevent} object using the set fields.
         * @return {@link Discussiontransferredevent}
         */
        public Discussiontransferredevent build() {
            return new Discussiontransferredevent(action, changes, discussion, repository, sender,
