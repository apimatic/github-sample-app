...
public class Authorization {
    ...
    public String toString() {
        return "Authorization [" + "id=" + id + ", url=" + url + ", scopes=" + scopes + ", token="
                + token + ", tokenLastEight=" + tokenLastEight + ", hashedToken=" + hashedToken
                + ", app=" + app + ", note=" + note + ", noteUrl=" + noteUrl + ", updatedAt="
                + updatedAt + ", createdAt=" + createdAt + ", fingerprint=" + fingerprint
                + ", expiresAt=" + expiresAt + ", user=" + user + ", installation=" + installation
                + "]";
    }
    ...
    public static class Builder {
        ...
        public Authorization build() {
            return new Authorization(id, url, scopes, token, tokenLastEight, hashedToken, app, note,
                    noteUrl, updatedAt, createdAt, fingerprint, expiresAt, user, installation);
        }
    }
}
