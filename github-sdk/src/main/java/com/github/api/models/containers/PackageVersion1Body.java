 ...
 */
@JsonDeserialize(using = PackageVersion1Body.PackageVersion1BodyDeserializer.class)
public abstract class PackageVersion1Body {
     ...
     */
    public static PackageVersion1Body fromMString(String mString) {
     ...
     */
    public static PackageVersion1Body fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends PackageVersion1Body {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends PackageVersion1Body {
    ...
    /**
     * This is a custom deserializer class for PackageVersion1Body.
     */
    protected static class PackageVersion1BodyDeserializer
            extends JsonDeserializer<PackageVersion1Body> {

        @Override
        public PackageVersion1Body deserialize(JsonParser jp, DeserializationContext ctxt)
