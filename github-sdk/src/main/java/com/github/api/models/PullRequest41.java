...
import com.github.api.models.containers.PullRequest41Assignees;
import com.github.api.models.containers.PullRequest41RequestedReviewers;
...
/**
 * This is a model class for PullRequest41 type.
 */
public class PullRequest41 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest41Assignees> assignees;
    ...
    private List<PullRequest41RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest41Assignees value for assignees.
     ...
     * @param  head  Head21 value for head.
     ...
     * @param  requestedReviewers  List of PullRequest41RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest41(
            ...
            Object assignee,
            List<PullRequest41Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest41RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest41(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest41Assignees> assignees, AuthorAssociationEnum authorAssociation,
            Object autoMerge, Base11 base, String body, LocalDateTime closedAt, String commentsUrl,
            String commitsUrl, LocalDateTime createdAt, String diffUrl, boolean draft, Head21 head,
            ...
            List<PullRequest41RequestedReviewers> requestedReviewers, List<Team4> requestedTeams,
     ...
     * @return Returns the List of PullRequest41Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest41Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest41Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest41Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Head.
     * @return Returns the Head21
     */
    @JsonGetter("head")
    public Head21 getHead() {
        return head;
    }

    /**
     * Setter for Head.
     * @param head Value for Head21
     */
    @JsonSetter("head")
    public void setHead(Head21 head) {
        this.head = head;
    }
     ...
     * @return Returns the List of PullRequest41RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest41RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest41RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest41RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest41 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest41 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest41.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest41.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest41}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                ...
                boolean draft, Head21 head, String htmlUrl, int id, String issueUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest41Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder head(Head21 head) {
            this.head = head;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest41} object using the set fields.
         * @return {@link PullRequest41}
         */
        public PullRequest41 build() {
            return new PullRequest41(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
                    mergeCommitSha, merged, mergedAt, mergedBy, milestone, nodeId, number, patchUrl,
                    requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state,
