 ...
 */
@JsonDeserialize(using = PullRequest51Assignees.PullRequest51AssigneesDeserializer.class)
public abstract class PullRequest51Assignees {
     ...
     */
    public static PullRequest51Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest51Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest51Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends PullRequest51Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest51Assignees.
     */
    protected static class PullRequest51AssigneesDeserializer
            extends JsonDeserializer<PullRequest51Assignees> {

        @Override
        public PullRequest51Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
