...
/**
 * This is a model class for PublicUser type.
 */
public class PublicUser {
     ...
     */
    protected PublicUser(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    /**
     * Converts this PublicUser into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PublicUser [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
                ...
                + createdAt + ", updatedAt=" + updatedAt + ", twitterUsername=" + twitterUsername
                + ", plan=" + plan + ", suspendedAt=" + suspendedAt + ", privateGists="
                + privateGists + ", totalPrivateRepos=" + totalPrivateRepos + ", ownedPrivateRepos="
                + ownedPrivateRepos + ", diskUsage=" + diskUsage + ", collaborators="
                + collaborators + "]";
    }

    /**
     * Builds a new {@link PublicUser.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PublicUser.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PublicUser}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PublicUser} object using the set fields.
         * @return {@link PublicUser}
         */
        public PublicUser build() {
            return new PublicUser(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
                    organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin, name,
                    company, blog, location, email, hireable, bio, publicRepos, publicGists,
                    followers, following, createdAt, updatedAt, twitterUsername, plan, suspendedAt,
                    privateGists, totalPrivateRepos, ownedPrivateRepos, diskUsage, collaborators);
        }
    }
}
