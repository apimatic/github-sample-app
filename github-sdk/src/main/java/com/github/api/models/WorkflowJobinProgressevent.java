...
/**
 * This is a model class for WorkflowJobinProgressevent type.
 */
public class WorkflowJobinProgressevent {
    ...
    private WorkflowJob1 workflowJob;
    private Deployment6 deployment;

    /**
     * Default constructor.
     */
    public WorkflowJobinProgressevent() {
        action = "in_progress";
    }
     ...
     * @param  workflowJob  WorkflowJob1 value for workflowJob.
     ...
     * @return Returns the WorkflowJob1
     */
    @JsonGetter("workflow_job")
    public WorkflowJob1 getWorkflowJob() {
        return workflowJob;
    }

    /**
     * Setter for WorkflowJob.
     * @param workflowJob Value for WorkflowJob1
     */
    @JsonSetter("workflow_job")
    public void setWorkflowJob(WorkflowJob1 workflowJob) {
        this.workflowJob = workflowJob;
    }
    ...
    /**
     * Converts this WorkflowJobinProgressevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WorkflowJobinProgressevent [" + "action=" + action + ", repository=" + repository
    ...
    /**
     * Builds a new {@link WorkflowJobinProgressevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WorkflowJobinProgressevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WorkflowJobinProgressevent}.
     */
    public static class Builder {
        private String action = "in_progress";
        private Repository3 repository;
        private Sender sender;
        private WorkflowJob1 workflowJob;
        private Enterprise1 enterprise;
         ...
         * @return Builder
         */
        public Builder workflowJob(WorkflowJob1 workflowJob) {
            this.workflowJob = workflowJob;
            return this;
        }
        ...
        /**
         * Builds a new {@link WorkflowJobinProgressevent} object using the set fields.
         * @return {@link WorkflowJobinProgressevent}
         */
        public WorkflowJobinProgressevent build() {
            return new WorkflowJobinProgressevent(action, repository, sender, workflowJob,
                    enterprise, installation, organization, deployment);
        }
    }
}
