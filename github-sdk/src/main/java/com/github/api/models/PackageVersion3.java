...
import com.github.api.models.containers.PackageVersion3Body;
import io.apimatic.core.types.BaseModel;
import io.apimatic.core.types.OptionalNullable;
import java.util.List;

/**
 * This is a model class for PackageVersion3 type.
 */
public class PackageVersion3 {
    private Author6 author;
    private PackageVersion3Body body;
    private String bodyHtml;
    private ContainerMetadata1 containerMetadata;
    ...
    private OptionalNullable<List<NugetMetadatum1>> nugetMetadata;
    private List<PackageFile> packageFiles;
    private String packageUrl;
    private Boolean prerelease;
    private Release3 release;
     ...
     * @param  body  PackageVersion3Body value for body.
     * @param  bodyHtml  String value for bodyHtml.
     * @param  containerMetadata  ContainerMetadata1 value for containerMetadata.
     ...
     * @param  nugetMetadata  List of NugetMetadatum1 value for nugetMetadata.
     * @param  prerelease  Boolean value for prerelease.
     * @param  release  Release3 value for release.
    ...
    public PackageVersion3(
            ...
            String version,
            Author6 author,
            PackageVersion3Body body,
            String bodyHtml,
            ContainerMetadata1 containerMetadata,
            String createdAt,
            List<Object> dockerMetadata,
            Boolean draft,
            String manifest,
            Object npmMetadata,
            List<NugetMetadatum1> nugetMetadata,
            Boolean prerelease,
            Release3 release,
     ...
     */
    protected PackageVersion3(String description, String htmlUrl, int id,
            String installationCommand, List<Object> metadata, String name,
            List<PackageFile> packageFiles, String packageUrl, String summary, String version,
            Author6 author, PackageVersion3Body body, String bodyHtml,
            ContainerMetadata1 containerMetadata, String createdAt, List<Object> dockerMetadata,
            Boolean draft, String manifest, Object npmMetadata,
            OptionalNullable<List<NugetMetadatum1>> nugetMetadata, Boolean prerelease,
            Release3 release, List<Object> rubygemsMetadata, String tagName, String targetCommitish,
            String targetOid, String updatedAt) {
        this.author = author;
        this.body = body;
        this.bodyHtml = bodyHtml;
        this.containerMetadata = containerMetadata;
    ...
    /**
     * Getter for Body.
     * @return Returns the PackageVersion3Body
     */
    @JsonGetter("body")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public PackageVersion3Body getBody() {
        return body;
    }

    /**
     * Setter for Body.
     * @param body Value for PackageVersion3Body
     */
    @JsonSetter("body")
    public void setBody(PackageVersion3Body body) {
        this.body = body;
    }
     ...
     * @return Returns the ContainerMetadata1
     */
    @JsonGetter("container_metadata")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ContainerMetadata1 getContainerMetadata() {
        return containerMetadata;
    }

    /**
     * Setter for ContainerMetadata.
     * @param containerMetadata Value for ContainerMetadata1
     */
    @JsonSetter("container_metadata")
    public void setContainerMetadata(ContainerMetadata1 containerMetadata) {
        this.containerMetadata = containerMetadata;
    }
     ...
     * @return Returns the Internal List of NugetMetadatum1
     */
    @JsonGetter("nuget_metadata")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<List<NugetMetadatum1>> internalGetNugetMetadata() {
        return this.nugetMetadata;
    }

    /**
     * Getter for NugetMetadata.
     * @return Returns the List of NugetMetadatum1
     */
    public List<NugetMetadatum1> getNugetMetadata() {
        return OptionalNullable.getFrom(nugetMetadata);
    }

    /**
     * Setter for NugetMetadata.
     * @param nugetMetadata Value for List of NugetMetadatum1
     */
    @JsonSetter("nuget_metadata")
    public void setNugetMetadata(List<NugetMetadatum1> nugetMetadata) {
        this.nugetMetadata = OptionalNullable.of(nugetMetadata);
    }
    ...
    /**
     * Getter for Release.
     * @return Returns the Release3
     */
    @JsonGetter("release")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Release3 getRelease() {
        return release;
    }

    /**
     * Setter for Release.
     * @param release Value for Release3
     */
    @JsonSetter("release")
    public void setRelease(Release3 release) {
        this.release = release;
    }
    ...
    /**
     * Converts this PackageVersion3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PackageVersion3 [" + "description=" + description + ", htmlUrl=" + htmlUrl + ", id="
                + id + ", installationCommand=" + installationCommand + ", metadata=" + metadata
                + ", name=" + name + ", packageFiles=" + packageFiles + ", packageUrl=" + packageUrl
                + ", summary=" + summary + ", version=" + version + ", author=" + author + ", body="
                + body + ", bodyHtml=" + bodyHtml + ", containerMetadata=" + containerMetadata
                + ", createdAt=" + createdAt + ", dockerMetadata=" + dockerMetadata + ", draft="
                + draft + ", manifest=" + manifest + ", npmMetadata=" + npmMetadata
                + ", nugetMetadata=" + nugetMetadata + ", prerelease=" + prerelease + ", release="
                + release + ", rubygemsMetadata=" + rubygemsMetadata + ", tagName=" + tagName
                + ", targetCommitish=" + targetCommitish + ", targetOid=" + targetOid
                + ", updatedAt=" + updatedAt + "]";
    }

    /**
     * Builds a new {@link PackageVersion3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PackageVersion3.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(description, htmlUrl, id, installationCommand, metadata, name,
                packageFiles, packageUrl, summary, version)
                .author(getAuthor())
                .body(getBody())
    ...
    /**
     * Class to build instances of {@link PackageVersion3}.
     */
    public static class Builder {
        ...
        public Builder(String description, String htmlUrl, int id, String installationCommand,
                List<Object> metadata, String name, List<PackageFile> packageFiles,
                String packageUrl, String summary, String version) {
            this.description = description;
            this.htmlUrl = htmlUrl;
            this.id = id;
            this.installationCommand = installationCommand;
         ...
         * @return Builder
         */
        public Builder body(PackageVersion3Body body) {
            this.body = body;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder containerMetadata(ContainerMetadata1 containerMetadata) {
            this.containerMetadata = containerMetadata;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder nugetMetadata(List<NugetMetadatum1> nugetMetadata) {
            this.nugetMetadata = OptionalNullable.of(nugetMetadata);
            return this;
        }
         ...
         * @return Builder
         */
        public Builder release(Release3 release) {
            this.release = release;
            return this;
        }
        ...
        /**
         * Builds a new {@link PackageVersion3} object using the set fields.
         * @return {@link PackageVersion3}
         */
        public PackageVersion3 build() {
            return new PackageVersion3(description, htmlUrl, id, installationCommand, metadata,
                    name, packageFiles, packageUrl, summary, version, author, body, bodyHtml,
                    containerMetadata, createdAt, dockerMetadata, draft, manifest, npmMetadata,
                    nugetMetadata, prerelease, release, rubygemsMetadata, tagName, targetCommitish,
                    targetOid, updatedAt);
        }
    }
}
