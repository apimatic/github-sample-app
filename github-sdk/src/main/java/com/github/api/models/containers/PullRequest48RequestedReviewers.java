 ...
 */
@JsonDeserialize(using = PullRequest48RequestedReviewers.PullRequest48RequestedReviewersDeserializer.class)
public abstract class PullRequest48RequestedReviewers {
     ...
     */
    public static PullRequest48RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest48RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest48RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest48RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest48RequestedReviewers.
     */
    protected static class PullRequest48RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest48RequestedReviewers> {

        @Override
        public PullRequest48RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
