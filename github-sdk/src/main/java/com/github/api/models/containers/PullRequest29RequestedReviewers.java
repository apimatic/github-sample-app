 ...
 */
@JsonDeserialize(using = PullRequest29RequestedReviewers.PullRequest29RequestedReviewersDeserializer.class)
public abstract class PullRequest29RequestedReviewers {
     ...
     */
    public static PullRequest29RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest29RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest29RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest29RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest29RequestedReviewers.
     */
    protected static class PullRequest29RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest29RequestedReviewers> {

        @Override
        public PullRequest29RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
