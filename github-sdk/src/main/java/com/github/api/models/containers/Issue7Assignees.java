 ...
 */
@JsonDeserialize(using = Issue7Assignees.Issue7AssigneesDeserializer.class)
public abstract class Issue7Assignees {
     ...
     */
    public static Issue7Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue7Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue7Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends Issue7Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue7Assignees.
     */
    protected static class Issue7AssigneesDeserializer
            extends JsonDeserializer<Issue7Assignees> {

        @Override
        public Issue7Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
