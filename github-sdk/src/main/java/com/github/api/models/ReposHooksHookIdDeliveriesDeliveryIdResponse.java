...
/**
 * This is a model class for ReposHooksHookIdDeliveriesDeliveryIdResponse type.
 */
public class ReposHooksHookIdDeliveriesDeliveryIdResponse {
    private int id;
    private String guid;
     ...
     * Default constructor.
     */
    public ReposHooksHookIdDeliveriesDeliveryIdResponse() {
    }
    ...
    /**
     * Converts this ReposHooksHookIdDeliveriesDeliveryIdResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposHooksHookIdDeliveriesDeliveryIdResponse [" + "id=" + id + ", guid=" + guid
                + ", deliveredAt=" + deliveredAt + ", redelivery=" + redelivery + ", duration="
                + duration + ", status=" + status + ", statusCode=" + statusCode + ", event="
                + event + ", action=" + action + ", installationId=" + installationId
                + ", repositoryId=" + repositoryId + ", request=" + request + ", response="
                + response + ", url=" + url + "]";
    }

    /**
     * Builds a new {@link ReposHooksHookIdDeliveriesDeliveryIdResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposHooksHookIdDeliveriesDeliveryIdResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposHooksHookIdDeliveriesDeliveryIdResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReposHooksHookIdDeliveriesDeliveryIdResponse} object using the set
         * fields.
         * @return {@link ReposHooksHookIdDeliveriesDeliveryIdResponse}
         */
        public ReposHooksHookIdDeliveriesDeliveryIdResponse build() {
            return new ReposHooksHookIdDeliveriesDeliveryIdResponse(id, guid, deliveredAt,
                    redelivery, duration, status, statusCode, event, action, installationId,
                    repositoryId, request, response, url);
        }
    }
}
