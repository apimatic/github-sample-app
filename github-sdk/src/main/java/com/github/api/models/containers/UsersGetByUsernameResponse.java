 ...
 */
@JsonDeserialize(using = UsersGetByUsernameResponse.UsersGetByUsernameResponseDeserializer.class)
public abstract class UsersGetByUsernameResponse {
     ...
     */
    public static UsersGetByUsernameResponse fromPrivateUser(PrivateUser privateUser) {
     ...
     */
    public static UsersGetByUsernameResponse fromPublicUser(PublicUser publicUser) {
    ...
    @TypeCombinatorCase
    private static class PrivateUserCase extends UsersGetByUsernameResponse {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class PublicUserCase extends UsersGetByUsernameResponse {
    ...
    /**
     * This is a custom deserializer class for UsersGetByUsernameResponse.
     */
    protected static class UsersGetByUsernameResponseDeserializer
            extends JsonDeserializer<UsersGetByUsernameResponse> {

        @Override
        public UsersGetByUsernameResponse deserialize(JsonParser jp, DeserializationContext ctxt)
