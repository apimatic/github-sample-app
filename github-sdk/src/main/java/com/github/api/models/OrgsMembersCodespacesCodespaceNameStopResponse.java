...
/**
 * This is a model class for OrgsMembersCodespacesCodespaceNameStopResponse type.
 */
public class OrgsMembersCodespacesCodespaceNameStopResponse {
    private int id;
    private String name;
     ...
     * Default constructor.
     */
    public OrgsMembersCodespacesCodespaceNameStopResponse() {
    }
     ...
     */
    protected OrgsMembersCodespacesCodespaceNameStopResponse(int id, String name,
            String environmentId, Owner1 owner, BillableOwner billableOwner, Repository7 repository,
            Object machine, Boolean prebuild, LocalDateTime createdAt, LocalDateTime updatedAt,
            LocalDateTime lastUsedAt, State3Enum state, String url, GitStatus1 gitStatus,
            LocationEnum location, Integer idleTimeoutMinutes, String webUrl, String machinesUrl,
            String startUrl, String stopUrl, String pullsUrl, List<String> recentFolders,
    ...
    /**
     * Converts this OrgsMembersCodespacesCodespaceNameStopResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OrgsMembersCodespacesCodespaceNameStopResponse [" + "id=" + id + ", name=" + name
                + ", environmentId=" + environmentId + ", owner=" + owner + ", billableOwner="
                + billableOwner + ", repository=" + repository + ", machine=" + machine
                + ", prebuild=" + prebuild + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt
                + ", lastUsedAt=" + lastUsedAt + ", state=" + state + ", url=" + url
                + ", gitStatus=" + gitStatus + ", location=" + location + ", idleTimeoutMinutes="
                + idleTimeoutMinutes + ", webUrl=" + webUrl + ", machinesUrl=" + machinesUrl
                + ", startUrl=" + startUrl + ", stopUrl=" + stopUrl + ", pullsUrl=" + pullsUrl
                + ", recentFolders=" + recentFolders + ", displayName=" + displayName
                + ", devcontainerPath=" + devcontainerPath + ", publishUrl=" + publishUrl
                + ", runtimeConstraints=" + runtimeConstraints + ", pendingOperation="
    ...
    /**
     * Builds a new {@link OrgsMembersCodespacesCodespaceNameStopResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link OrgsMembersCodespacesCodespaceNameStopResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link OrgsMembersCodespacesCodespaceNameStopResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link OrgsMembersCodespacesCodespaceNameStopResponse} object using the set
         * fields.
         * @return {@link OrgsMembersCodespacesCodespaceNameStopResponse}
         */
        public OrgsMembersCodespacesCodespaceNameStopResponse build() {
            return new OrgsMembersCodespacesCodespaceNameStopResponse(id, name, environmentId,
                    owner, billableOwner, repository, machine, prebuild, createdAt, updatedAt,
                    lastUsedAt, state, url, gitStatus, location, idleTimeoutMinutes, webUrl,
                    machinesUrl, startUrl, stopUrl, pullsUrl, recentFolders, displayName,
                    devcontainerPath, publishUrl, runtimeConstraints, pendingOperation,
                    pendingOperationDisabledReason, idleTimeoutNotice, retentionPeriodMinutes,
                    retentionExpiresAt, lastKnownStopNotice);
        }
    }
}
