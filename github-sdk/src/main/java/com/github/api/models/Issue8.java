...
import com.github.api.models.containers.Issue8Assignees;
...
/**
 * This is a model class for Issue8 type.
 */
public class Issue8 {
    private Object activeLockReason;
    private Object assignee;
    private List<Issue8Assignees> assignees;
     ...
     * @param  assignees  List of Issue8Assignees value for assignees.
    ...
    public Issue8(
            ...
            List<Issue8Assignees> assignees,
     ...
     */
    protected Issue8(Object activeLockReason, List<Issue8Assignees> assignees,
     ...
     * @return Returns the List of Issue8Assignees
     */
    @JsonGetter("assignees")
    public List<Issue8Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of Issue8Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<Issue8Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Converts this Issue8 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue8 [" + "activeLockReason=" + activeLockReason + ", assignees=" + assignees
    ...
    /**
     * Builds a new {@link Issue8.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue8.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Issue8}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(Object activeLockReason, List<Issue8Assignees> assignees,
                AuthorAssociationEnum authorAssociation, String body, LocalDateTime closedAt,
                int comments, String commentsUrl, LocalDateTime createdAt, String eventsUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<Issue8Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue8} object using the set fields.
         * @return {@link Issue8}
         */
        public Issue8 build() {
            return new Issue8(activeLockReason, assignees, authorAssociation, body, closedAt,
