 ...
 */
@JsonDeserialize(using = SimplePullRequest1RequestedReviewers.SimplePullRequest1RequestedReviewersDeserializer.class)
public abstract class SimplePullRequest1RequestedReviewers {
     ...
     */
    public static SimplePullRequest1RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static SimplePullRequest1RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends SimplePullRequest1RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends SimplePullRequest1RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest1RequestedReviewers.
     */
    protected static class SimplePullRequest1RequestedReviewersDeserializer
            extends JsonDeserializer<SimplePullRequest1RequestedReviewers> {

        @Override
        public SimplePullRequest1RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
