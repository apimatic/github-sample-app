 ...
 */
@JsonDeserialize(using = Issue42Assignees.Issue42AssigneesDeserializer.class)
public abstract class Issue42Assignees {
     ...
     */
    public static Issue42Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue42Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue42Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends Issue42Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue42Assignees.
     */
    protected static class Issue42AssigneesDeserializer
            extends JsonDeserializer<Issue42Assignees> {

        @Override
        public Issue42Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
