...
/**
 * This is a model class for UserCodespacesStartResponse type.
 */
public class UserCodespacesStartResponse {
    private int id;
    private String name;
     ...
     * Default constructor.
     */
    public UserCodespacesStartResponse() {
    }
     ...
     */
    protected UserCodespacesStartResponse(int id, String name, String environmentId, Owner1 owner,
    ...
    /**
     * Converts this UserCodespacesStartResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "UserCodespacesStartResponse [" + "id=" + id + ", name=" + name + ", environmentId="
                + environmentId + ", owner=" + owner + ", billableOwner=" + billableOwner
                + ", repository=" + repository + ", machine=" + machine + ", prebuild=" + prebuild
                + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + ", lastUsedAt="
                + lastUsedAt + ", state=" + state + ", url=" + url + ", gitStatus=" + gitStatus
                + ", location=" + location + ", idleTimeoutMinutes=" + idleTimeoutMinutes
                + ", webUrl=" + webUrl + ", machinesUrl=" + machinesUrl + ", startUrl=" + startUrl
                + ", stopUrl=" + stopUrl + ", pullsUrl=" + pullsUrl + ", recentFolders="
                + recentFolders + ", displayName=" + displayName + ", devcontainerPath="
                + devcontainerPath + ", publishUrl=" + publishUrl + ", runtimeConstraints="
                + runtimeConstraints + ", pendingOperation=" + pendingOperation
                + ", pendingOperationDisabledReason=" + pendingOperationDisabledReason
                + ", idleTimeoutNotice=" + idleTimeoutNotice + ", retentionPeriodMinutes="
                + retentionPeriodMinutes + ", retentionExpiresAt=" + retentionExpiresAt
                + ", lastKnownStopNotice=" + lastKnownStopNotice + "]";
    }

    /**
     * Builds a new {@link UserCodespacesStartResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UserCodespacesStartResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UserCodespacesStartResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UserCodespacesStartResponse} object using the set fields.
         * @return {@link UserCodespacesStartResponse}
         */
        public UserCodespacesStartResponse build() {
            return new UserCodespacesStartResponse(id, name, environmentId, owner, billableOwner,
