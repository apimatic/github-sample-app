 ...
 */
@JsonDeserialize(using = Repository67PushedAt.Repository67PushedAtDeserializer.class)
public abstract class Repository67PushedAt {
     ...
     */
    public static Repository67PushedAt fromNumber(int number) {
     ...
     */
    public static Repository67PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repository67PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository67PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository67PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repository67PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository67PushedAt.
     */
    protected static class Repository67PushedAtDeserializer
            extends JsonDeserializer<Repository67PushedAt> {

        @Override
        public Repository67PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
