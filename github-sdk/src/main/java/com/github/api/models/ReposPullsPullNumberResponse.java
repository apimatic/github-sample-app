...
/**
 * This is a model class for ReposPullsPullNumberResponse type.
 */
public class ReposPullsPullNumberResponse {
    private String url;
    private int id;
     ...
     * Default constructor.
     */
    public ReposPullsPullNumberResponse() {
    }
     ...
     */
    protected ReposPullsPullNumberResponse(String url, int id, String nodeId, String htmlUrl,
            String diffUrl, String patchUrl, String issueUrl, String commitsUrl,
            String reviewCommentsUrl, String reviewCommentUrl, String commentsUrl,
            String statusesUrl, int number, State13Enum state, boolean locked, String title,
            Object user, String body, List<Label8> labels, Object milestone,
            LocalDateTime createdAt, LocalDateTime updatedAt, LocalDateTime closedAt,
            LocalDateTime mergedAt, String mergeCommitSha, Object assignee, Head2 head, Base2 base,
            Links2 links, AuthorAssociationEnum authorAssociation, Object autoMerge, boolean merged,
            ...
            int deletions, int changedFiles, OptionalNullable<String> activeLockReason,
    ...
    /**
     * Converts this ReposPullsPullNumberResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposPullsPullNumberResponse [" + "url=" + url + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link ReposPullsPullNumberResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposPullsPullNumberResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposPullsPullNumberResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReposPullsPullNumberResponse} object using the set fields.
         * @return {@link ReposPullsPullNumberResponse}
         */
        public ReposPullsPullNumberResponse build() {
            return new ReposPullsPullNumberResponse(url, id, nodeId, htmlUrl, diffUrl, patchUrl,
                    issueUrl, commitsUrl, reviewCommentsUrl, reviewCommentUrl, commentsUrl,
                    statusesUrl, number, state, locked, title, user, body, labels, milestone,
                    createdAt, updatedAt, closedAt, mergedAt, mergeCommitSha, assignee, head, base,
                    links, authorAssociation, autoMerge, merged, mergeable, mergeableState,
                    mergedBy, comments, reviewComments, maintainerCanModify, commits, additions,
                    deletions, changedFiles, activeLockReason, assignees, requestedReviewers,
                    requestedTeams, draft, rebaseable);
        }
    }
}
