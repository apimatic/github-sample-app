 ...
 */
@JsonDeserialize(using = Deployment3Payload.Deployment3PayloadDeserializer.class)
public abstract class Deployment3Payload {
     ...
     */
    public static Deployment3Payload fromMString(String mString) {
     ...
     */
    public static Deployment3Payload fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends Deployment3Payload {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Deployment3Payload {
    ...
    /**
     * This is a custom deserializer class for Deployment3Payload.
     */
    protected static class Deployment3PayloadDeserializer
            extends JsonDeserializer<Deployment3Payload> {

        @Override
        public Deployment3Payload deserialize(JsonParser jp, DeserializationContext ctxt)
