...
/**
 * This is a model class for Codespace1 type.
 */
public class Codespace1 {
     ...
     */
    protected Codespace1(int id, String name, String environmentId, Owner1 owner,
    ...
    /**
     * Converts this Codespace1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Codespace1 [" + "id=" + id + ", name=" + name + ", environmentId=" + environmentId
    ...
    /**
     * Builds a new {@link Codespace1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Codespace1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Codespace1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Codespace1} object using the set fields.
         * @return {@link Codespace1}
         */
        public Codespace1 build() {
            return new Codespace1(id, name, environmentId, owner, billableOwner, repository,
                    machine, prebuild, createdAt, updatedAt, lastUsedAt, state, url, gitStatus,
                    location, idleTimeoutMinutes, webUrl, machinesUrl, startUrl, stopUrl, pullsUrl,
