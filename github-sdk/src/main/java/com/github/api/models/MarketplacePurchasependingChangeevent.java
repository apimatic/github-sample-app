...
/**
 * This is a model class for MarketplacePurchasependingChangeevent type.
 */
public class MarketplacePurchasependingChangeevent {
    ...
    private MarketplacePurchase7 previousMarketplacePurchase;
     ...
     * Default constructor.
     */
    public MarketplacePurchasependingChangeevent() {
     ...
     * @param  previousMarketplacePurchase  MarketplacePurchase7 value for
    ...
    public MarketplacePurchasependingChangeevent(
            ...
            MarketplacePurchase7 previousMarketplacePurchase,
     ...
     * @return Returns the MarketplacePurchase7
     */
    @JsonGetter("previous_marketplace_purchase")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public MarketplacePurchase7 getPreviousMarketplacePurchase() {
        return previousMarketplacePurchase;
    }

    /**
     * Setter for PreviousMarketplacePurchase.
     * @param previousMarketplacePurchase Value for MarketplacePurchase7
     */
    @JsonSetter("previous_marketplace_purchase")
    public void setPreviousMarketplacePurchase(MarketplacePurchase7 previousMarketplacePurchase) {
        this.previousMarketplacePurchase = previousMarketplacePurchase;
    }
    ...
    /**
     * Converts this MarketplacePurchasependingChangeevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MarketplacePurchasependingChangeevent [" + "action=" + action + ", effectiveDate="
    ...
    /**
     * Builds a new {@link MarketplacePurchasependingChangeevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MarketplacePurchasependingChangeevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MarketplacePurchasependingChangeevent}.
     */
    public static class Builder {
        private String action = "pending_change";
        private String effectiveDate;
        private MarketplacePurchase2 marketplacePurchase;
        private Sender sender;
        private Enterprise1 enterprise;
        ...
        /**
         * Builds a new {@link MarketplacePurchasependingChangeevent} object using the set fields.
         * @return {@link MarketplacePurchasependingChangeevent}
         */
        public MarketplacePurchasependingChangeevent build() {
            return new MarketplacePurchasependingChangeevent(action, effectiveDate,
