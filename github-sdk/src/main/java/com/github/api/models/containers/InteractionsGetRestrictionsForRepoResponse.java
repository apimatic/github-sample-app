 ...
 */
@JsonDeserialize(using = InteractionsGetRestrictionsForRepoResponse.InteractionsGetRestrictionsForRepoResponseDeserializer.class)
public abstract class InteractionsGetRestrictionsForRepoResponse {
     ...
     */
    public static InteractionsGetRestrictionsForRepoResponse fromInteractionLimits(
     ...
     */
    public static InteractionsGetRestrictionsForRepoResponse fromObject(
    ...
    @TypeCombinatorCase
    private static class InteractionLimitsCase extends InteractionsGetRestrictionsForRepoResponse {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends InteractionsGetRestrictionsForRepoResponse {
    ...
    /**
     * This is a custom deserializer class for InteractionsGetRestrictionsForRepoResponse.
     */
    protected static class InteractionsGetRestrictionsForRepoResponseDeserializer
            extends JsonDeserializer<InteractionsGetRestrictionsForRepoResponse> {

        @Override
        public InteractionsGetRestrictionsForRepoResponse deserialize(JsonParser jp, DeserializationContext ctxt)
