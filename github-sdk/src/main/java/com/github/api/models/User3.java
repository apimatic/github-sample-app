...
public class User3 {
     ...
     */
    protected User3(int id, String login, String avatarUrl, Boolean deleted,
            ...
            Boolean siteAdmin, String starredUrl, String subscriptionsUrl, Type4Enum type,
            String url) {
        this.avatarUrl = avatarUrl;
        this.deleted = deleted;
        this.email = email;
    ...
    public String toString() {
        return "User3 [" + "id=" + id + ", login=" + login + ", avatarUrl=" + avatarUrl
    ...
    public static class Builder {
         ...
         */
        public User3 build() {
            return new User3(id, login, avatarUrl, deleted, email, eventsUrl, followersUrl,
