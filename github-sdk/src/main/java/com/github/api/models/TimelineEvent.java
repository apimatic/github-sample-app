...
/**
 * This is a model class for TimelineEvent type.
 */
public class TimelineEvent {
    ...
    private List<PullRequestReviewComment1> comments;
     ...
     * @param  comments  List of PullRequestReviewComment1 value for comments.
    ...
    public TimelineEvent(
            ...
            List<PullRequestReviewComment1> comments,
            Assignee assignee,
            String stateReason) {
        this.id = id;
        this.nodeId = nodeId;
     ...
     */
    protected TimelineEvent(Integer id, String nodeId, String url, Actor2 actor, String event,
            OptionalNullable<String> commitId, OptionalNullable<String> commitUrl,
            LocalDateTime createdAt, Object performedViaGithubApp, Label3 label,
            ...
            User2 user, LocalDateTime updatedAt, String issueUrl,
            AuthorAssociationEnum authorAssociation, ReactionRollup reactions, Source source,
            String sha, Author1 author, Committer1 committer, String message, Tree2 tree,
            List<Parent2> parents, Verification verification, String state, String pullRequestUrl,
            Links10 links, LocalDateTime submittedAt, List<PullRequestReviewComment1> comments,
            Assignee assignee, OptionalNullable<String> stateReason) {
        this.id = id;
        this.nodeId = nodeId;
        this.url = url;
        this.actor = actor;
    ...
    /**
     * Getter for Comments.
     * @return Returns the List of PullRequestReviewComment1
     */
    @JsonGetter("comments")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    /**
     * Setter for Comments.
     * @param comments Value for List of PullRequestReviewComment1
     */
    @JsonSetter("comments")
    ...
    /**
     * Converts this TimelineEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TimelineEvent [" + "id=" + id + ", nodeId=" + nodeId + ", url=" + url + ", actor="
    ...
    /**
     * Builds a new {@link TimelineEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TimelineEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TimelineEvent}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder comments(List<PullRequestReviewComment1> comments) {
            this.comments = comments;
            return this;
        }
        ...
        /**
         * Builds a new {@link TimelineEvent} object using the set fields.
         * @return {@link TimelineEvent}
         */
        public TimelineEvent build() {
            return new TimelineEvent(id, nodeId, url, actor, event, commitId, commitUrl, createdAt,
