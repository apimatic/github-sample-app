...
/**
 * This is a model class for PullRequestreopenedevent type.
 */
public class PullRequestreopenedevent {
    ...
    private PullRequest42 pullRequest;
     ...
     * @param  pullRequest  PullRequest42 value for pullRequest.
     ...
     * @return Returns the PullRequest42
     */
    @JsonGetter("pull_request")
    public PullRequest42 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest42
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest42 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestreopenedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestreopenedevent [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestreopenedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestreopenedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestreopenedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest42 pullRequest, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest42 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestreopenedevent} object using the set fields.
         * @return {@link PullRequestreopenedevent}
         */
        public PullRequestreopenedevent build() {
            return new PullRequestreopenedevent(action, number, pullRequest, repository, sender,
