...
/**
 * This is a model class for ProjectCardconvertedevent type.
 */
public class ProjectCardconvertedevent {
    private String action;
    private Changes15 changes;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private Organization2 organization;
    private ProjectCard7 projectCard;
     ...
     * Default constructor.
     */
    public ProjectCardconvertedevent() {
        action = "converted";
    }
     ...
     * @param  changes  Changes15 value for changes.
     * @param  projectCard  ProjectCard7 value for projectCard.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes15
     */
    @JsonGetter("changes")
    public Changes15 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes15
     */
    @JsonSetter("changes")
    public void setChanges(Changes15 changes) {
        this.changes = changes;
    }
     ...
     * @return Returns the ProjectCard7
     */
    @JsonGetter("project_card")
    public ProjectCard7 getProjectCard() {
        return projectCard;
    }

    /**
     * Setter for ProjectCard.
     * @param projectCard Value for ProjectCard7
     */
    @JsonSetter("project_card")
    public void setProjectCard(ProjectCard7 projectCard) {
        this.projectCard = projectCard;
    }
    ...
    /**
     * Converts this ProjectCardconvertedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ProjectCardconvertedevent [" + "action=" + action + ", changes=" + changes
                + ", projectCard=" + projectCard + ", sender=" + sender + ", enterprise="
                + enterprise + ", installation=" + installation + ", organization=" + organization
                + ", repository=" + repository + "]";
    }

    /**
     * Builds a new {@link ProjectCardconvertedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ProjectCardconvertedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, changes, projectCard, sender)
    ...
    /**
     * Class to build instances of {@link ProjectCardconvertedevent}.
     */
    public static class Builder {
        private String action = "converted";
        private Changes15 changes;
        private ProjectCard7 projectCard;
        private Sender sender;
        private Enterprise1 enterprise;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes15 changes, ProjectCard7 projectCard, Sender sender) {
            this.action = action;
            this.changes = changes;
            this.projectCard = projectCard;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder changes(Changes15 changes) {
            this.changes = changes;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder projectCard(ProjectCard7 projectCard) {
            this.projectCard = projectCard;
            return this;
        }
        ...
        /**
         * Builds a new {@link ProjectCardconvertedevent} object using the set fields.
         * @return {@link ProjectCardconvertedevent}
         */
        public ProjectCardconvertedevent build() {
            return new ProjectCardconvertedevent(action, changes, projectCard, sender, enterprise,
