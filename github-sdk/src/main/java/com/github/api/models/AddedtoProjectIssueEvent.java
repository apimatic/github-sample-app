...
/**
 * This is a model class for AddedtoProjectIssueEvent type.
 */
public class AddedtoProjectIssueEvent {
     ...
     */
    @JsonCreator
    private AddedtoProjectIssueEvent(
    ...
    /**
     * Converts this AddedtoProjectIssueEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AddedtoProjectIssueEvent [" + "id=" + id + ", nodeId=" + nodeId + ", url=" + url
    ...
    /**
     * Builds a new {@link AddedtoProjectIssueEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AddedtoProjectIssueEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AddedtoProjectIssueEvent}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link AddedtoProjectIssueEvent} object using the set fields.
         * @return {@link AddedtoProjectIssueEvent}
         */
        public AddedtoProjectIssueEvent build() {
            return new AddedtoProjectIssueEvent(id, nodeId, url, actor, event, commitId, commitUrl,
                    createdAt, performedViaGithubApp, projectCard);
        }
    }
}
