 ...
 */
@JsonDeserialize(using = DeploymentPayload.DeploymentPayloadDeserializer.class)
public abstract class DeploymentPayload {
     ...
     */
    public static DeploymentPayload fromObject(Map<String, Object> object) {
     ...
     */
    public static DeploymentPayload fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends DeploymentPayload {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends DeploymentPayload {
    ...
    /**
     * This is a custom deserializer class for DeploymentPayload.
     */
    protected static class DeploymentPayloadDeserializer
            extends JsonDeserializer<DeploymentPayload> {

        @Override
        public DeploymentPayload deserialize(JsonParser jp, DeserializationContext ctxt)
