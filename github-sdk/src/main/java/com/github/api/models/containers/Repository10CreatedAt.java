 ...
 */
@JsonDeserialize(using = Repository10CreatedAt.Repository10CreatedAtDeserializer.class)
public abstract class Repository10CreatedAt {
     ...
     */
    public static Repository10CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository10CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository10CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository10CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository10CreatedAt.
     */
    protected static class Repository10CreatedAtDeserializer
            extends JsonDeserializer<Repository10CreatedAt> {

        @Override
        public Repository10CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
