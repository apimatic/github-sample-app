 ...
 */
@JsonDeserialize(using = Issue5Assignees.Issue5AssigneesDeserializer.class)
public abstract class Issue5Assignees {
     ...
     */
    public static Issue5Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue5Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue5Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends Issue5Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue5Assignees.
     */
    protected static class Issue5AssigneesDeserializer
            extends JsonDeserializer<Issue5Assignees> {

        @Override
        public Issue5Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
