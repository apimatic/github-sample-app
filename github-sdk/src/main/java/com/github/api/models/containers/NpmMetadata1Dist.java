 ...
 */
@JsonDeserialize(using = NpmMetadata1Dist.NpmMetadata1DistDeserializer.class)
public abstract class NpmMetadata1Dist {
     ...
     */
    public static NpmMetadata1Dist fromMString(String mString) {
     ...
     */
    public static NpmMetadata1Dist fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends NpmMetadata1Dist {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends NpmMetadata1Dist {
    ...
    /**
     * This is a custom deserializer class for NpmMetadata1Dist.
     */
    protected static class NpmMetadata1DistDeserializer
            extends JsonDeserializer<NpmMetadata1Dist> {

        @Override
        public NpmMetadata1Dist deserialize(JsonParser jp, DeserializationContext ctxt)
