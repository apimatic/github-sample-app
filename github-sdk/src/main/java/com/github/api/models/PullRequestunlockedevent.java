...
/**
 * This is a model class for PullRequestunlockedevent type.
 */
public class PullRequestunlockedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest53 pullRequest;
     ...
     * Default constructor.
     */
    public PullRequestunlockedevent() {
        action = "unlocked";
    }
     ...
     * @param  pullRequest  PullRequest53 value for pullRequest.
     ...
     * @return Returns the PullRequest53
     */
    @JsonGetter("pull_request")
    public PullRequest53 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest53
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest53 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestunlockedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestunlockedevent [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestunlockedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestunlockedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestunlockedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest53 pullRequest, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest53 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestunlockedevent} object using the set fields.
         * @return {@link PullRequestunlockedevent}
         */
        public PullRequestunlockedevent build() {
            return new PullRequestunlockedevent(action, number, pullRequest, repository, sender,
