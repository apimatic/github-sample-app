 ...
 */
@JsonDeserialize(using = PullRequest50RequestedReviewers.PullRequest50RequestedReviewersDeserializer.class)
public abstract class PullRequest50RequestedReviewers {
     ...
     */
    public static PullRequest50RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest50RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest50RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest50RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest50RequestedReviewers.
     */
    protected static class PullRequest50RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest50RequestedReviewers> {

        @Override
        public PullRequest50RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
