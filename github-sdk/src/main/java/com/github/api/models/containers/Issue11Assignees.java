 ...
 */
@JsonDeserialize(using = Issue11Assignees.Issue11AssigneesDeserializer.class)
public abstract class Issue11Assignees {
     ...
     */
    public static Issue11Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue11Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue11Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends Issue11Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue11Assignees.
     */
    protected static class Issue11AssigneesDeserializer
            extends JsonDeserializer<Issue11Assignees> {

        @Override
        public Issue11Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
