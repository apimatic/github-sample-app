 ...
 */
@JsonDeserialize(using = Forkee2PushedAt.Forkee2PushedAtDeserializer.class)
public abstract class Forkee2PushedAt {
     ...
     */
    public static Forkee2PushedAt fromNumber(int number) {
     ...
     */
    public static Forkee2PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Forkee2PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Forkee2PushedAt {
    ...
    /**
     * This is a custom deserializer class for Forkee2PushedAt.
     */
    protected static class Forkee2PushedAtDeserializer
            extends JsonDeserializer<Forkee2PushedAt> {

        @Override
        public Forkee2PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
