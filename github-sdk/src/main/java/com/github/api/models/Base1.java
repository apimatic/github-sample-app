...
/**
 * This is a model class for Base1 type.
 */
public class Base1 {
    ...
    /**
     * Converts this Base1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Base1 [" + "label=" + label + ", ref=" + ref + ", repo=" + repo + ", sha=" + sha
                + ", user=" + user + "]";
    }

    /**
     * Builds a new {@link Base1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Base1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Base1}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(String label, String ref, Repo6 repo, String sha, Object user) {
            this.label = label;
            this.ref = ref;
            this.repo = repo;
            this.sha = sha;
        ...
        /**
         * Builds a new {@link Base1} object using the set fields.
         * @return {@link Base1}
         */
        public Base1 build() {
            return new Base1(label, ref, repo, sha, user);
        }
    }
}
