...
/**
 * This is a model class for WorkflowRun3 type.
 */
public class WorkflowRun3 {
     ...
     * @param  status  Status30Enum value for status.
     ...
     */
    protected WorkflowRun3(Object actor, String artifactsUrl, String cancelUrl, int checkSuiteId,
            ...
            int runAttempt, int runNumber, LocalDateTime runStartedAt, Status30Enum status,
    ...
    /**
     * Getter for Status.
     * @return Returns the Status30Enum
     */
    @JsonGetter("status")
    public Status30Enum getStatus() {
        return status;
    }

    /**
     * Setter for Status.
     * @param status Value for Status30Enum
     */
    @JsonSetter("status")
    public void setStatus(Status30Enum status) {
        this.status = status;
    }
    ...
    /**
     * Converts this WorkflowRun3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WorkflowRun3 [" + "actor=" + actor + ", artifactsUrl=" + artifactsUrl
    ...
    /**
     * Builds a new {@link WorkflowRun3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WorkflowRun3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WorkflowRun3}.
     */
    public static class Builder {
        ...
        public Builder(Object actor, String artifactsUrl, String cancelUrl, int checkSuiteId,
                ...
                LocalDateTime runStartedAt, Status30Enum status, Object triggeringActor,
         ...
         * @return Builder
         */
        public Builder status(Status30Enum status) {
            this.status = status;
            return this;
        }
        ...
        /**
         * Builds a new {@link WorkflowRun3} object using the set fields.
         * @return {@link WorkflowRun3}
         */
        public WorkflowRun3 build() {
            return new WorkflowRun3(actor, artifactsUrl, cancelUrl, checkSuiteId, checkSuiteNodeId,
