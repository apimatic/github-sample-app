...
import com.github.api.models.containers.PullRequest48Assignees;
import com.github.api.models.containers.PullRequest48RequestedReviewers;
...
/**
 * This is a model class for PullRequest48 type.
 */
public class PullRequest48 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest48Assignees> assignees;
    ...
    private List<PullRequest48RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest48Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest48RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest48(
            ...
            Object assignee,
            List<PullRequest48Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest48RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest48(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest48Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            int number, String patchUrl, List<PullRequest48RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest48Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest48Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest48Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest48Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest48RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest48RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest48RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest48RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest48 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest48 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest48.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest48.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest48}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest48Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest48} object using the set fields.
         * @return {@link PullRequest48}
         */
        public PullRequest48 build() {
            return new PullRequest48(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
