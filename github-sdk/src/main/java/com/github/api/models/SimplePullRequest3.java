...
import com.github.api.models.containers.SimplePullRequest3Assignees;
import com.github.api.models.containers.SimplePullRequest3RequestedReviewers;
import io.apimatic.core.types.BaseModel;
import java.util.List;

/**
 * This is a model class for SimplePullRequest3 type.
 */
public class SimplePullRequest3 {
    private Links2 links;
    private Object activeLockReason;
    private Object assignee;
    private List<SimplePullRequest3Assignees> assignees;
    ...
    private List<SimplePullRequest3RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of SimplePullRequest3Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of SimplePullRequest3RequestedReviewers value for
     *         requestedReviewers.
    ...
    public SimplePullRequest3(
            ...
            Object assignee,
            List<SimplePullRequest3Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<SimplePullRequest3RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of SimplePullRequest3Assignees
     */
    @JsonGetter("assignees")
    public List<SimplePullRequest3Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of SimplePullRequest3Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<SimplePullRequest3Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of SimplePullRequest3RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<SimplePullRequest3RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of SimplePullRequest3RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<SimplePullRequest3RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this SimplePullRequest3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SimplePullRequest3 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link SimplePullRequest3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SimplePullRequest3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SimplePullRequest3}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                ...
                String diffUrl, boolean draft, Head8 head, String htmlUrl, int id, String issueUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<SimplePullRequest3Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link SimplePullRequest3} object using the set fields.
         * @return {@link SimplePullRequest3}
         */
        public SimplePullRequest3 build() {
            return new SimplePullRequest3(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
