...
import com.github.api.models.containers.Repository43CreatedAt;
import com.github.api.models.containers.Repository43PushedAt;
...
/**
 * This is a model class for Repository43 type.
 */
public class Repository43 {
    ...
    private Repository43CreatedAt createdAt;
    ...
    private Repository43PushedAt pushedAt;
     ...
     * @param  createdAt  Repository43CreatedAt value for createdAt.
     ...
     * @param  pushedAt  Repository43PushedAt value for pushedAt.
    ...
    public Repository43(
            ...
            Repository43CreatedAt createdAt,
     ...
     */
    protected Repository43(String archiveUrl, boolean archived, String assigneesUrl,
            ...
            String contributorsUrl, Repository43CreatedAt createdAt, String defaultBranch,
            ...
            boolean mPrivate, String pullsUrl, Repository43PushedAt pushedAt, String releasesUrl,
            ...
            Boolean deleteBranchOnMerge, Boolean disabled, Boolean hasDiscussions,
            Boolean isTemplate, String masterBranch, MergeCommitMessageEnum mergeCommitMessage,
            MergeCommitTitleEnum mergeCommitTitle, String organization, Permissions1 permissions,
            Boolean mPublic, OptionalNullable<String> roleName,
            SquashMergeCommitMessageEnum squashMergeCommitMessage,
     ...
     * @return Returns the Repository43CreatedAt
     */
    @JsonGetter("created_at")
    public Repository43CreatedAt getCreatedAt() {
        return createdAt;
    }

    /**
     * Setter for CreatedAt.
     * @param createdAt Value for Repository43CreatedAt
     */
    @JsonSetter("created_at")
    public void setCreatedAt(Repository43CreatedAt createdAt) {
        this.createdAt = createdAt;
    }
    ...
    /**
     * Getter for PushedAt.
     * @return Returns the Repository43PushedAt
     */
    @JsonGetter("pushed_at")
    public Repository43PushedAt getPushedAt() {
        return pushedAt;
    }

    /**
     * Setter for PushedAt.
     * @param pushedAt Value for Repository43PushedAt
     */
    @JsonSetter("pushed_at")
    public void setPushedAt(Repository43PushedAt pushedAt) {
        this.pushedAt = pushedAt;
    }
    ...
    /**
     * Converts this Repository43 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repository43 [" + "archiveUrl=" + archiveUrl + ", archived=" + archived
                ...
                + disabled + ", hasDiscussions=" + hasDiscussions + ", isTemplate=" + isTemplate
                + ", masterBranch=" + masterBranch + ", mergeCommitMessage=" + mergeCommitMessage
                + ", mergeCommitTitle=" + mergeCommitTitle + ", organization=" + organization
                + ", permissions=" + permissions + ", mPublic=" + mPublic + ", roleName=" + roleName
    ...
    /**
     * Builds a new {@link Repository43.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repository43.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Repository43}.
     */
    public static class Builder {
        ...
        public Builder(String archiveUrl, boolean archived, String assigneesUrl, String blobsUrl,
                ...
                Repository43CreatedAt createdAt, String defaultBranch, String deploymentsUrl,
                ...
                String notificationsUrl, int openIssues, int openIssuesCount, Object owner,
                boolean mPrivate, String pullsUrl, Repository43PushedAt pushedAt,
         ...
         * @return Builder
         */
        public Builder createdAt(Repository43CreatedAt createdAt) {
            this.createdAt = createdAt;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder pushedAt(Repository43PushedAt pushedAt) {
            this.pushedAt = pushedAt;
            return this;
        }
        ...
        /**
         * Builds a new {@link Repository43} object using the set fields.
         * @return {@link Repository43}
         */
        public Repository43 build() {
            return new Repository43(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl,
                    cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl,
                    contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description,
                    ...
                    allowUpdateBranch, deleteBranchOnMerge, disabled, hasDiscussions, isTemplate,
                    masterBranch, mergeCommitMessage, mergeCommitTitle, organization, permissions,
                    mPublic, roleName, squashMergeCommitMessage, squashMergeCommitTitle, stargazers,
