...
public enum Event1Enum {
    ...
    private static TreeMap<String, Event1Enum> valueMap = new TreeMap<>();
    ...
    public static Event1Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Event1Enum values to list of string values.
     * @param toConvert The list of Event1Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Event1Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Event1Enum enumValue : toConvert) {
