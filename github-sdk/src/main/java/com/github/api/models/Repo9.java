...
import com.github.api.models.containers.Repo9CreatedAt;
import com.github.api.models.containers.Repo9PushedAt;
...
/**
 * This is a model class for Repo9 type.
 */
public class Repo9 {
    ...
    private Repo9CreatedAt createdAt;
    ...
    private Repo9PushedAt pushedAt;
     ...
     * @param  createdAt  Repo9CreatedAt value for createdAt.
     ...
     * @param  pushedAt  Repo9PushedAt value for pushedAt.
     ...
     */
    protected Repo9(String archiveUrl, boolean archived, String assigneesUrl, String blobsUrl,
            ...
            Repo9CreatedAt createdAt, String defaultBranch, String deploymentsUrl,
            ...
            boolean mPrivate, String pullsUrl, Repo9PushedAt pushedAt, String releasesUrl, int size,
            String sshUrl, int stargazersCount, String stargazersUrl, String statusesUrl,
     ...
     * @return Returns the Repo9CreatedAt
     */
    @JsonGetter("created_at")
    public Repo9CreatedAt getCreatedAt() {
        return createdAt;
    }

    /**
     * Setter for CreatedAt.
     * @param createdAt Value for Repo9CreatedAt
     */
    @JsonSetter("created_at")
    public void setCreatedAt(Repo9CreatedAt createdAt) {
        this.createdAt = createdAt;
    }
    ...
    /**
     * Getter for PushedAt.
     * @return Returns the Repo9PushedAt
     */
    @JsonGetter("pushed_at")
    public Repo9PushedAt getPushedAt() {
        return pushedAt;
    }

    /**
     * Setter for PushedAt.
     * @param pushedAt Value for Repo9PushedAt
     */
    @JsonSetter("pushed_at")
    public void setPushedAt(Repo9PushedAt pushedAt) {
        this.pushedAt = pushedAt;
    }
    ...
    /**
     * Converts this Repo9 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repo9 [" + "archiveUrl=" + archiveUrl + ", archived=" + archived + ", assigneesUrl="
                + assigneesUrl + ", blobsUrl=" + blobsUrl + ", branchesUrl=" + branchesUrl
                + ", cloneUrl=" + cloneUrl + ", collaboratorsUrl=" + collaboratorsUrl
    ...
    /**
     * Builds a new {@link Repo9.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repo9.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Repo9}.
     */
    public static class Builder {
        ...
        public Builder(String archiveUrl, boolean archived, String assigneesUrl, String blobsUrl,
                ...
                Object owner, boolean mPrivate, String pullsUrl, Repo9PushedAt pushedAt,
         ...
         * @return Builder
         */
        public Builder createdAt(Repo9CreatedAt createdAt) {
            this.createdAt = createdAt;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder pushedAt(Repo9PushedAt pushedAt) {
            this.pushedAt = pushedAt;
            return this;
        }
        ...
        /**
         * Builds a new {@link Repo9} object using the set fields.
         * @return {@link Repo9}
         */
        public Repo9 build() {
            return new Repo9(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl, cloneUrl,
