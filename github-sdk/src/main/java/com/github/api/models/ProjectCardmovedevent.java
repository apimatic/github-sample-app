...
/**
 * This is a model class for ProjectCardmovedevent type.
 */
public class ProjectCardmovedevent {
    private String action;
    private Changes17 changes;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private Organization2 organization;
    private ProjectCard11 projectCard;
     ...
     * @param  projectCard  ProjectCard11 value for projectCard.
     * @param  sender  Sender value for sender.
     * @param  changes  Changes17 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes17
     */
    @JsonGetter("changes")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Changes17 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes17
     */
    @JsonSetter("changes")
    public void setChanges(Changes17 changes) {
        this.changes = changes;
    }
     ...
     * @return Returns the ProjectCard11
     */
    @JsonGetter("project_card")
    public ProjectCard11 getProjectCard() {
        return projectCard;
    }

    /**
     * Setter for ProjectCard.
     * @param projectCard Value for ProjectCard11
     */
    @JsonSetter("project_card")
    public void setProjectCard(ProjectCard11 projectCard) {
        this.projectCard = projectCard;
    }
    ...
    /**
     * Converts this ProjectCardmovedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ProjectCardmovedevent [" + "action=" + action + ", projectCard=" + projectCard
    ...
    /**
     * Builds a new {@link ProjectCardmovedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ProjectCardmovedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, projectCard, sender)
                .changes(getChanges())
    ...
    /**
     * Class to build instances of {@link ProjectCardmovedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, ProjectCard11 projectCard, Sender sender) {
            this.action = action;
            this.projectCard = projectCard;
            this.sender = sender;
        }
         ...
         * @return Builder
         */
        public Builder projectCard(ProjectCard11 projectCard) {
            this.projectCard = projectCard;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder changes(Changes17 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link ProjectCardmovedevent} object using the set fields.
         * @return {@link ProjectCardmovedevent}
         */
        public ProjectCardmovedevent build() {
            return new ProjectCardmovedevent(action, projectCard, sender, changes, enterprise,
