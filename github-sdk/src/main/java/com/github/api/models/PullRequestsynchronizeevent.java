...
/**
 * This is a model class for PullRequestsynchronizeevent type.
 */
public class PullRequestsynchronizeevent {
    ...
    private PullRequest50 pullRequest;
     ...
     * Default constructor.
     */
    public PullRequestsynchronizeevent() {
        action = "synchronize";
    }
     ...
     * @param  pullRequest  PullRequest50 value for pullRequest.
     ...
     * @return Returns the PullRequest50
     */
    @JsonGetter("pull_request")
    public PullRequest50 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest50
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest50 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestsynchronizeevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestsynchronizeevent [" + "action=" + action + ", after=" + after
                + ", before=" + before + ", number=" + number + ", pullRequest=" + pullRequest
                + ", repository=" + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link PullRequestsynchronizeevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestsynchronizeevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, after, before, number, pullRequest, repository,
                sender)
    ...
    /**
     * Class to build instances of {@link PullRequestsynchronizeevent}.
     */
    public static class Builder {
        private String action = "synchronize";
        private String after;
        private String before;
        private int number;
        private PullRequest50 pullRequest;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, String after, String before, int number,
                PullRequest50 pullRequest, Repository3 repository, Sender sender) {
            this.action = action;
            this.after = after;
            this.before = before;
            this.number = number;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest50 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestsynchronizeevent} object using the set fields.
         * @return {@link PullRequestsynchronizeevent}
         */
        public PullRequestsynchronizeevent build() {
            return new PullRequestsynchronizeevent(action, after, before, number, pullRequest,
