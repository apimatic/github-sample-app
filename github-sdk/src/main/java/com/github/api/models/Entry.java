...
public class Entry {
    ...
    public String toString() {
        return "Entry [" + "type=" + type + ", size=" + size + ", name=" + name + ", path=" + path
                + ", sha=" + sha + ", url=" + url + ", gitUrl=" + gitUrl + ", htmlUrl=" + htmlUrl
                + ", downloadUrl=" + downloadUrl + ", links=" + links + ", content=" + content
                + "]";
    }
    ...
    public static class Builder {
         ...
         */
        public Entry build() {
            return new Entry(type, size, name, path, sha, url, gitUrl, htmlUrl, downloadUrl, links,
                    content);
        }
    }
}
