...
/**
 * This is a model class for PullRequestReviewComment4 type.
 */
public class PullRequestReviewComment4 {
    private String url;
     ...
     * Default constructor.
     */
    public PullRequestReviewComment4() {
    }
     ...
     */
    protected PullRequestReviewComment4(String url, Integer pullRequestReviewId, int id,
            ...
            Object authorAssociation, Links11 links, int line, Integer inReplyToId,
            OptionalNullable<Integer> startLine, OptionalNullable<Integer> originalStartLine,
            Object startSide, Integer originalLine, SideEnum side, ReactionRollup reactions,
    ...
    /**
     * Converts this PullRequestReviewComment4 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestReviewComment4 [" + "url=" + url + ", pullRequestReviewId="
                ...
                + ", links=" + links + ", line=" + line + ", inReplyToId=" + inReplyToId
                + ", startLine=" + startLine + ", originalStartLine=" + originalStartLine
                + ", startSide=" + startSide + ", originalLine=" + originalLine + ", side=" + side
                + ", reactions=" + reactions + ", bodyHtml=" + bodyHtml + ", bodyText=" + bodyText
                + "]";
    }

    /**
     * Builds a new {@link PullRequestReviewComment4.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestReviewComment4.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(url, pullRequestReviewId, id, nodeId, diffHunk, path,
                ...
                updatedAt, htmlUrl, pullRequestUrl, authorAssociation, links, line)
    ...
    /**
     * Class to build instances of {@link PullRequestReviewComment4}.
     */
    public static class Builder {
        ...
        public Builder(String url, Integer pullRequestReviewId, int id, String nodeId,
                ...
                Object authorAssociation, Links11 links, int line) {
            this.url = url;
            this.pullRequestReviewId = pullRequestReviewId;
            this.id = id;
            this.nodeId = nodeId;
        ...
        /**
         * Builds a new {@link PullRequestReviewComment4} object using the set fields.
         * @return {@link PullRequestReviewComment4}
         */
        public PullRequestReviewComment4 build() {
            return new PullRequestReviewComment4(url, pullRequestReviewId, id, nodeId, diffHunk,
                    path, position, originalPosition, commitId, originalCommitId, user, body,
                    createdAt, updatedAt, htmlUrl, pullRequestUrl, authorAssociation, links, line,
                    inReplyToId, startLine, originalStartLine, startSide, originalLine, side,
