 ...
 */
@JsonDeserialize(using = PullRequest33Assignees.PullRequest33AssigneesDeserializer.class)
public abstract class PullRequest33Assignees {
     ...
     */
    public static PullRequest33Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest33Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest33Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends PullRequest33Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest33Assignees.
     */
    protected static class PullRequest33AssigneesDeserializer
            extends JsonDeserializer<PullRequest33Assignees> {

        @Override
        public PullRequest33Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
