 ...
 */
@JsonDeserialize(using = ActionsDisableWorkflowWorkflowId.ActionsDisableWorkflowWorkflowIdDeserializer.class)
public abstract class ActionsDisableWorkflowWorkflowId {
     ...
     */
    public static ActionsDisableWorkflowWorkflowId fromNumber(int number) {
     ...
     */
    public static ActionsDisableWorkflowWorkflowId fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ActionsDisableWorkflowWorkflowId {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ActionsDisableWorkflowWorkflowId {
    ...
    /**
     * This is a custom deserializer class for ActionsDisableWorkflowWorkflowId.
     */
    protected static class ActionsDisableWorkflowWorkflowIdDeserializer
            extends JsonDeserializer<ActionsDisableWorkflowWorkflowId> {

        @Override
        public ActionsDisableWorkflowWorkflowId deserialize(JsonParser jp, DeserializationContext ctxt)
