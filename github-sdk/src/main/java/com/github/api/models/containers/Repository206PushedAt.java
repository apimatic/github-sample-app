 ...
 */
@JsonDeserialize(using = Repository206PushedAt.Repository206PushedAtDeserializer.class)
public abstract class Repository206PushedAt {
     ...
     */
    public static Repository206PushedAt fromNumber(int number) {
     ...
     */
    public static Repository206PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repository206PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository206PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository206PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repository206PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository206PushedAt.
     */
    protected static class Repository206PushedAtDeserializer
            extends JsonDeserializer<Repository206PushedAt> {

        @Override
        public Repository206PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
