...
/**
 * This is a model class for SymlinkContent type.
 */
public class SymlinkContent {
    ...
    /**
     * Converts this SymlinkContent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SymlinkContent [" + "type=" + type + ", target=" + target + ", size=" + size
                + ", name=" + name + ", path=" + path + ", sha=" + sha + ", url=" + url
                + ", gitUrl=" + gitUrl + ", htmlUrl=" + htmlUrl + ", downloadUrl=" + downloadUrl
                + ", links=" + links + "]";
    }

    /**
     * Builds a new {@link SymlinkContent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SymlinkContent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(type, target, size, name, path, sha, url, gitUrl, htmlUrl,
                downloadUrl, links);
        return builder;
    }

    /**
     * Class to build instances of {@link SymlinkContent}.
     */
    public static class Builder {
         ...
         * @param  links  Links3 value for links.
         */
        public Builder(String type, String target, int size, String name, String path, String sha,
                String url, String gitUrl, String htmlUrl, String downloadUrl, Links3 links) {
            this.type = type;
            this.target = target;
            this.size = size;
            this.name = name;
        ...
        /**
         * Builds a new {@link SymlinkContent} object using the set fields.
         * @return {@link SymlinkContent}
         */
        public SymlinkContent build() {
            return new SymlinkContent(type, target, size, name, path, sha, url, gitUrl, htmlUrl,
                    downloadUrl, links);
        }
    }
}
