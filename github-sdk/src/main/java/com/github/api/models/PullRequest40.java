...
import com.github.api.models.containers.PullRequest40Assignees;
import com.github.api.models.containers.PullRequest40RequestedReviewers;
...
/**
 * This is a model class for PullRequest40 type.
 */
public class PullRequest40 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest40Assignees> assignees;
    ...
    private List<PullRequest40RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest40Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest40RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest40(
            ...
            Object assignee,
            List<PullRequest40Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest40RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest40(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest40Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            String mergeCommitSha, LocalDateTime mergedAt, Object mergedBy, Object milestone,
            String nodeId, int number, String patchUrl,
            List<PullRequest40RequestedReviewers> requestedReviewers, List<Team4> requestedTeams,
            ...
            String mergeableState, OptionalNullable<Boolean> merged,
            OptionalNullable<Boolean> rebaseable, Integer reviewComments) {
        this.links = links;
        this.activeLockReason = activeLockReason;
        this.additions = additions;
        this.assignee = assignee;
     ...
     * @return Returns the List of PullRequest40Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest40Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest40Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest40Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest40RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest40RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest40RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest40RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest40 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest40 [" + "links=" + links + ", activeLockReason=" + activeLockReason
                ...
                + mergeCommitSha + ", mergedAt=" + mergedAt + ", mergedBy=" + mergedBy
                + ", milestone=" + milestone + ", nodeId=" + nodeId + ", number=" + number
                + ", patchUrl=" + patchUrl + ", requestedReviewers=" + requestedReviewers
                ...
                + ", mergeableState=" + mergeableState + ", merged=" + merged + ", rebaseable="
                + rebaseable + ", reviewComments=" + reviewComments + "]";
    }

    /**
     * Builds a new {@link PullRequest40.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest40.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(links, activeLockReason, assignee, assignees,
                ...
                mergeCommitSha, mergedAt, mergedBy, milestone, nodeId, number, patchUrl,
    ...
    /**
     * Class to build instances of {@link PullRequest40}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                ...
                Object mergedBy, Object milestone, String nodeId, int number, String patchUrl,
                List<PullRequest40RequestedReviewers> requestedReviewers,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest40Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest40} object using the set fields.
         * @return {@link PullRequest40}
         */
        public PullRequest40 build() {
            return new PullRequest40(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
                    mergeCommitSha, mergedAt, mergedBy, milestone, nodeId, number, patchUrl,
                    requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state,
