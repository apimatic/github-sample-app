...
/**
 * This is a model class for Discussioneditedevent type.
 */
public class Discussioneditedevent {
    private String action;
    private Changes3 changes;
     ...
     * @param  changes  Changes3 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes3
     */
    @JsonGetter("changes")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Changes3 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes3
     */
    @JsonSetter("changes")
    public void setChanges(Changes3 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Discussioneditedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Discussioneditedevent [" + "action=" + action + ", discussion=" + discussion
                + ", repository=" + repository + ", sender=" + sender + ", changes=" + changes
                + ", enterprise=" + enterprise + ", installation=" + installation
                + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Discussioneditedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Discussioneditedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Discussioneditedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Discussion1 discussion, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.discussion = discussion;
            this.repository = repository;
         ...
         * @return Builder
         */
        public Builder changes(Changes3 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Discussioneditedevent} object using the set fields.
         * @return {@link Discussioneditedevent}
         */
        public Discussioneditedevent build() {
            return new Discussioneditedevent(action, discussion, repository, sender, changes,
