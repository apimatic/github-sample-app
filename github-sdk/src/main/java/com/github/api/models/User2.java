...
public class User2 {
     ...
     */
    protected User2(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    public String toString() {
        return "User2 [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", avatarUrl="
    ...
    public static class Builder {
         ...
         */
        public User2 build() {
            return new User2(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl,
