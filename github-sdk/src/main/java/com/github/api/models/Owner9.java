...
/**
 * This is a model class for Owner9 type.
 */
public class Owner9 {
    ...
    /**
     * Converts this Owner9 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Owner9 [" + "avatarUrl=" + avatarUrl + ", eventsUrl=" + eventsUrl
    ...
    /**
     * Builds a new {@link Owner9.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Owner9.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Owner9}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Owner9} object using the set fields.
         * @return {@link Owner9}
         */
        public Owner9 build() {
            return new Owner9(avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl,
                    gravatarId, htmlUrl, id, login, nodeId, organizationsUrl, receivedEventsUrl,
                    reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url);
        }
    }
