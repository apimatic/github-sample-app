...
/**
 * This is a model class for DeploymentWorkflowRun type.
 */
public class DeploymentWorkflowRun {
    ...
    private OptionalNullable<Object> headCommit;
    ...
    private String path;
    private OptionalNullable<Object> previousAttemptUrl;
     ...
     * @param  headRepository  HeadRepository value for headRepository.
     * @param  jobsUrl  String value for jobsUrl.
     * @param  logsUrl  String value for logsUrl.
     * @param  previousAttemptUrl  Object value for previousAttemptUrl.
     * @param  referencedWorkflows  List of ReferencedWorkflow1 value for referencedWorkflows.
     * @param  repository  HeadRepository value for repository.
    ...
    public DeploymentWorkflowRun(
        ...
        this.headCommit = OptionalNullable.of(headCommit);
     ...
     */
    protected DeploymentWorkflowRun(Object actor, int checkSuiteId, String checkSuiteNodeId,
            Object conclusion, LocalDateTime createdAt, String displayTitle, String event,
            String headBranch, String headSha, String htmlUrl, int id, String name, String nodeId,
            String path, List<CheckRunPullRequest> pullRequests, int runAttempt, int runNumber,
            LocalDateTime runStartedAt, Status17Enum status, LocalDateTime updatedAt, String url,
            int workflowId, String artifactsUrl, String cancelUrl, String checkSuiteUrl,
            OptionalNullable<Object> headCommit, HeadRepository headRepository, String jobsUrl,
            String logsUrl, OptionalNullable<Object> previousAttemptUrl,
            OptionalNullable<List<ReferencedWorkflow1>> referencedWorkflows,
            HeadRepository repository, String rerunUrl, Object triggeringActor,
            String workflowUrl) {
        this.actor = actor;
        this.artifactsUrl = artifactsUrl;
        this.cancelUrl = cancelUrl;
    ...
    /**
     * Internal Getter for HeadCommit.
     * @return Returns the Internal Object
     */
    @JsonGetter("head_commit")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<Object> internalGetHeadCommit() {
    ...
    public Object getHeadCommit() {
        return OptionalNullable.getFrom(headCommit);
    }
    ...
    /**
     * UnSetter for HeadCommit.
     */
    public void unsetHeadCommit() {
        headCommit = null;
    }

    /**
     * Getter for HeadRepository.
     * @return Returns the HeadRepository
     */
     ...
     * @param headRepository Value for HeadRepository
     */
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<Object> internalGetPreviousAttemptUrl() {
     ...
     * @param previousAttemptUrl Value for Object
     */
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public HeadRepository getRepository() {
        return repository;
    }

    /**
     * Setter for Repository.
     * @param repository Value for HeadRepository
     */
    @JsonSetter("repository")
    public void setRepository(HeadRepository repository) {
        this.repository = repository;
    }
    ...
    /**
     * Converts this DeploymentWorkflowRun into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DeploymentWorkflowRun [" + "actor=" + actor + ", checkSuiteId=" + checkSuiteId
                + ", checkSuiteNodeId=" + checkSuiteNodeId + ", conclusion=" + conclusion
                + ", createdAt=" + createdAt + ", displayTitle=" + displayTitle + ", event=" + event
                + ", headBranch=" + headBranch + ", headSha=" + headSha + ", htmlUrl=" + htmlUrl
                + ", id=" + id + ", name=" + name + ", nodeId=" + nodeId + ", path=" + path
                + ", pullRequests=" + pullRequests + ", runAttempt=" + runAttempt + ", runNumber="
                + runNumber + ", runStartedAt=" + runStartedAt + ", status=" + status
                + ", updatedAt=" + updatedAt + ", url=" + url + ", workflowId=" + workflowId
                + ", artifactsUrl=" + artifactsUrl + ", cancelUrl=" + cancelUrl + ", checkSuiteUrl="
                + checkSuiteUrl + ", headCommit=" + headCommit + ", headRepository="
                + headRepository + ", jobsUrl=" + jobsUrl + ", logsUrl=" + logsUrl
                + ", previousAttemptUrl=" + previousAttemptUrl + ", referencedWorkflows="
                + referencedWorkflows + ", repository=" + repository + ", rerunUrl=" + rerunUrl
                + ", triggeringActor=" + triggeringActor + ", workflowUrl=" + workflowUrl + "]";
    }

    /**
     * Builds a new {@link DeploymentWorkflowRun.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DeploymentWorkflowRun.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt,
                displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId, path,
                pullRequests, runAttempt, runNumber, runStartedAt, status, updatedAt, url,
                workflowId)
                .artifactsUrl(getArtifactsUrl())
                .cancelUrl(getCancelUrl())
                .checkSuiteUrl(getCheckSuiteUrl())
                .headRepository(getHeadRepository())
                .jobsUrl(getJobsUrl())
                .logsUrl(getLogsUrl())
                .repository(getRepository())
                .rerunUrl(getRerunUrl())
                .triggeringActor(getTriggeringActor())
                .workflowUrl(getWorkflowUrl());
        builder.headCommit = internalGetHeadCommit();
    ...
    /**
     * Class to build instances of {@link DeploymentWorkflowRun}.
     */
    public static class Builder {
         ...
         * @param  workflowId  int value for workflowId.
         */
        public Builder(Object actor, int checkSuiteId, String checkSuiteNodeId, Object conclusion,
                LocalDateTime createdAt, String displayTitle, String event, String headBranch,
                String headSha, String htmlUrl, int id, String name, String nodeId, String path,
                List<CheckRunPullRequest> pullRequests, int runAttempt, int runNumber,
                LocalDateTime runStartedAt, Status17Enum status, LocalDateTime updatedAt,
                String url, int workflowId) {
            this.actor = actor;
            this.checkSuiteId = checkSuiteId;
            this.checkSuiteNodeId = checkSuiteNodeId;
            this.conclusion = conclusion;
         ...
         * @return Builder
         */
        public Builder unsetHeadCommit() {
            headCommit = null;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder headRepository(HeadRepository headRepository) {
            this.headRepository = headRepository;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder previousAttemptUrl(Object previousAttemptUrl) {
            this.previousAttemptUrl = OptionalNullable.of(previousAttemptUrl);
            return this;
        }
         ...
         * @return Builder
         */
        public Builder repository(HeadRepository repository) {
            this.repository = repository;
            return this;
        }
        ...
        /**
         * Builds a new {@link DeploymentWorkflowRun} object using the set fields.
         * @return {@link DeploymentWorkflowRun}
         */
        public DeploymentWorkflowRun build() {
            return new DeploymentWorkflowRun(actor, checkSuiteId, checkSuiteNodeId, conclusion,
                    createdAt, displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId,
                    path, pullRequests, runAttempt, runNumber, runStartedAt, status, updatedAt, url,
                    workflowId, artifactsUrl, cancelUrl, checkSuiteUrl, headCommit, headRepository,
                    jobsUrl, logsUrl, previousAttemptUrl, referencedWorkflows, repository, rerunUrl,
                    triggeringActor, workflowUrl);
        }
    }
}
