...
/**
 * This is a model class for MinimalRepository type.
 */
public class MinimalRepository {
     ...
     */
    protected MinimalRepository(int id, String nodeId, String name, String fullName, Owner1 owner,
    ...
    /**
     * Converts this MinimalRepository into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MinimalRepository [" + "id=" + id + ", nodeId=" + nodeId + ", name=" + name
    ...
    /**
     * Builds a new {@link MinimalRepository.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MinimalRepository.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MinimalRepository}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link MinimalRepository} object using the set fields.
         * @return {@link MinimalRepository}
         */
        public MinimalRepository build() {
            return new MinimalRepository(id, nodeId, name, fullName, owner, mPrivate, htmlUrl,
                    description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl,
