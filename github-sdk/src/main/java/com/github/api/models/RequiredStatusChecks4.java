...
/**
 * This is a model class for RequiredStatusChecks4 type.
 */
public class RequiredStatusChecks4 {
    private String url;
    ...
    /**
     * Converts this RequiredStatusChecks4 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RequiredStatusChecks4 [" + "contexts=" + contexts + ", checks=" + checks + ", url="
                + url + ", enforcementLevel=" + enforcementLevel + ", contextsUrl=" + contextsUrl
                + ", strict=" + strict + "]";
    }

    /**
     * Builds a new {@link RequiredStatusChecks4.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RequiredStatusChecks4.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RequiredStatusChecks4}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RequiredStatusChecks4} object using the set fields.
         * @return {@link RequiredStatusChecks4}
         */
        public RequiredStatusChecks4 build() {
            return new RequiredStatusChecks4(contexts, checks, url, enforcementLevel, contextsUrl,
                    strict);
        }
    }
}
