...
/**
 * This is a model class for ReposActionsRunsRunIdAttemptsAttemptNumberResponse type.
 */
public class ReposActionsRunsRunIdAttemptsAttemptNumberResponse {
    private int id;
     ...
     * Default constructor.
     */
    public ReposActionsRunsRunIdAttemptsAttemptNumberResponse() {
    }
     ...
     */
    protected ReposActionsRunsRunIdAttemptsAttemptNumberResponse(int id, String nodeId,
            String headBranch, String headSha, String path, int runNumber, String event,
            String status, String conclusion, int workflowId, String url, String htmlUrl,
            List<PullRequestMinimal> pullRequests, LocalDateTime createdAt, LocalDateTime updatedAt,
            String jobsUrl, String logsUrl, String checkSuiteUrl, String artifactsUrl,
            String cancelUrl, String rerunUrl, String workflowUrl, Object headCommit,
            Repository7 repository, HeadRepository7 headRepository, String displayTitle,
            OptionalNullable<String> name, Integer checkSuiteId, String checkSuiteNodeId,
            Integer runAttempt, OptionalNullable<List<Referencedworkflow>> referencedWorkflows,
            Actor2 actor, TriggeringActor triggeringActor, LocalDateTime runStartedAt,
    ...
    /**
     * Converts this ReposActionsRunsRunIdAttemptsAttemptNumberResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposActionsRunsRunIdAttemptsAttemptNumberResponse [" + "id=" + id + ", nodeId="
                + nodeId + ", headBranch=" + headBranch + ", headSha=" + headSha + ", path=" + path
                + ", runNumber=" + runNumber + ", event=" + event + ", status=" + status
                + ", conclusion=" + conclusion + ", workflowId=" + workflowId + ", url=" + url
                + ", htmlUrl=" + htmlUrl + ", pullRequests=" + pullRequests + ", createdAt="
                + createdAt + ", updatedAt=" + updatedAt + ", jobsUrl=" + jobsUrl + ", logsUrl="
                + logsUrl + ", checkSuiteUrl=" + checkSuiteUrl + ", artifactsUrl=" + artifactsUrl
                + ", cancelUrl=" + cancelUrl + ", rerunUrl=" + rerunUrl + ", workflowUrl="
                + workflowUrl + ", headCommit=" + headCommit + ", repository=" + repository
                + ", headRepository=" + headRepository + ", displayTitle=" + displayTitle
                + ", name=" + name + ", checkSuiteId=" + checkSuiteId + ", checkSuiteNodeId="
                + checkSuiteNodeId + ", runAttempt=" + runAttempt + ", referencedWorkflows="
                + referencedWorkflows + ", actor=" + actor + ", triggeringActor=" + triggeringActor
                + ", runStartedAt=" + runStartedAt + ", previousAttemptUrl=" + previousAttemptUrl
                + ", headRepositoryId=" + headRepositoryId + "]";
    }

    /**
     * Builds a new {@link ReposActionsRunsRunIdAttemptsAttemptNumberResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposActionsRunsRunIdAttemptsAttemptNumberResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposActionsRunsRunIdAttemptsAttemptNumberResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReposActionsRunsRunIdAttemptsAttemptNumberResponse} object using the
         * set fields.
         * @return {@link ReposActionsRunsRunIdAttemptsAttemptNumberResponse}
         */
        public ReposActionsRunsRunIdAttemptsAttemptNumberResponse build() {
            return new ReposActionsRunsRunIdAttemptsAttemptNumberResponse(id, nodeId, headBranch,
                    headSha, path, runNumber, event, status, conclusion, workflowId, url, htmlUrl,
                    pullRequests, createdAt, updatedAt, jobsUrl, logsUrl, checkSuiteUrl,
                    artifactsUrl, cancelUrl, rerunUrl, workflowUrl, headCommit, repository,
                    headRepository, displayTitle, name, checkSuiteId, checkSuiteNodeId, runAttempt,
                    referencedWorkflows, actor, triggeringActor, runStartedAt, previousAttemptUrl,
                    headRepositoryId);
        }
    }
}
