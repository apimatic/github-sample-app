...
/**
 * This is a model class for Reviewer1 type.
 */
public class Reviewer1 {
    ...
    private OptionalNullable<String> gravatarId;
    private String url;
    ...
    public Reviewer1(
        ...
        this.gravatarId = OptionalNullable.of(gravatarId);
        this.url = url;
     ...
     */
    protected Reviewer1(OptionalNullable<String> name, OptionalNullable<String> email, String login,
            Integer id, String nodeId, String avatarUrl, OptionalNullable<String> gravatarId,
            ...
            String starredAt, String slug, OptionalNullable<String> description, String privacy,
            String permission, Permissions5 permissions, String membersUrl, String repositoriesUrl,
            Object parent) {
        this.name = name;
        this.email = email;
        this.login = login;
    ...
    /**
     * Internal Getter for GravatarId.
     * @return Returns the Internal String
     */
    @JsonGetter("gravatar_id")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<String> internalGetGravatarId() {
    ...
    public String getGravatarId() {
        return OptionalNullable.getFrom(gravatarId);
    }
    ...
    /**
     * UnSetter for GravatarId.
     */
    public void unsetGravatarId() {
        gravatarId = null;
    }
    ...
    /**
     * Converts this Reviewer1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Reviewer1 [" + "name=" + name + ", email=" + email + ", login=" + login + ", id="
                + id + ", nodeId=" + nodeId + ", avatarUrl=" + avatarUrl + ", gravatarId="
                + gravatarId + ", url=" + url + ", htmlUrl=" + htmlUrl + ", followersUrl="
                + followersUrl + ", followingUrl=" + followingUrl + ", gistsUrl=" + gistsUrl
                + ", starredUrl=" + starredUrl + ", subscriptionsUrl=" + subscriptionsUrl
                + ", organizationsUrl=" + organizationsUrl + ", reposUrl=" + reposUrl
                + ", eventsUrl=" + eventsUrl + ", receivedEventsUrl=" + receivedEventsUrl
                + ", type=" + type + ", siteAdmin=" + siteAdmin + ", starredAt=" + starredAt
                + ", slug=" + slug + ", description=" + description + ", privacy=" + privacy
                + ", permission=" + permission + ", permissions=" + permissions + ", membersUrl="
                + membersUrl + ", repositoriesUrl=" + repositoriesUrl + ", parent=" + parent + "]";
    }

    /**
     * Builds a new {@link Reviewer1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Reviewer1.Builder} object
     */
    public Builder toBuilder() {
        ...
        builder.gravatarId = internalGetGravatarId();
        builder.description = internalGetDescription();
        return builder;
    }

    /**
     * Class to build instances of {@link Reviewer1}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder unsetGravatarId() {
            gravatarId = null;
            return this;
        }
        ...
        /**
         * Builds a new {@link Reviewer1} object using the set fields.
         * @return {@link Reviewer1}
         */
        public Reviewer1 build() {
            return new Reviewer1(name, email, login, id, nodeId, avatarUrl, gravatarId, url,
                    htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
                    organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl, type, siteAdmin,
                    starredAt, slug, description, privacy, permission, permissions, membersUrl,
                    repositoriesUrl, parent);
        }
    }
}
