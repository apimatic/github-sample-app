 ...
 */
@JsonDeserialize(using = PullRequest47RequestedReviewers.PullRequest47RequestedReviewersDeserializer.class)
public abstract class PullRequest47RequestedReviewers {
     ...
     */
    public static PullRequest47RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest47RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest47RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest47RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest47RequestedReviewers.
     */
    protected static class PullRequest47RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest47RequestedReviewers> {

        @Override
        public PullRequest47RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
