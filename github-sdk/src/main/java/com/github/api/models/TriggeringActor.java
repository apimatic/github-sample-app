...
/**
 * This is a model class for TriggeringActor type.
 */
public class TriggeringActor {
     ...
     */
    protected TriggeringActor(String login, int id, String nodeId, String avatarUrl,
    ...
    /**
     * Converts this TriggeringActor into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TriggeringActor [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link TriggeringActor.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TriggeringActor.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TriggeringActor}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TriggeringActor} object using the set fields.
         * @return {@link TriggeringActor}
         */
        public TriggeringActor build() {
            return new TriggeringActor(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
