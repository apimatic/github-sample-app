 ...
 */
@JsonDeserialize(using = IssueLabels.IssueLabelsDeserializer.class)
public abstract class IssueLabels {
     ...
     */
    public static IssueLabels fromMString(String mString) {
     ...
     */
    public static IssueLabels fromLabel2(Label2 label2) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends IssueLabels {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Label2Case extends IssueLabels {
    ...
    /**
     * This is a custom deserializer class for IssueLabels.
     */
    protected static class IssueLabelsDeserializer
            extends JsonDeserializer<IssueLabels> {

        @Override
        public IssueLabels deserialize(JsonParser jp, DeserializationContext ctxt)
