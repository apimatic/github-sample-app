 ...
 */
@JsonDeserialize(using = Repo9PushedAt.Repo9PushedAtDeserializer.class)
public abstract class Repo9PushedAt {
     ...
     */
    public static Repo9PushedAt fromNumber(int number) {
     ...
     */
    public static Repo9PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repo9PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo9PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo9PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repo9PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo9PushedAt.
     */
    protected static class Repo9PushedAtDeserializer
            extends JsonDeserializer<Repo9PushedAt> {

        @Override
        public Repo9PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
