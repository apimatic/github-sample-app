...
/**
 * This is a model class for Alert19 type.
 */
public class Alert19 {
     ...
     * @param  state  State19Enum value for state.
    ...
    /**
     * Getter for State.
     * @return Returns the State19Enum
     */
    @JsonGetter("state")
    public State19Enum getState() {
        return state;
    }

    /**
     * Setter for State.
     * @param state Value for State19Enum
     */
    @JsonSetter("state")
    public void setState(State19Enum state) {
        this.state = state;
    }
    ...
    /**
     * Converts this Alert19 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Alert19 [" + "createdAt=" + createdAt + ", dismissedAt=" + dismissedAt
    ...
    /**
     * Builds a new {@link Alert19.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Alert19.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Alert19}.
     */
    public static class Builder {
        ...
        public Builder(LocalDateTime createdAt, LocalDateTime dismissedAt, Object dismissedBy,
                Object dismissedReason, String htmlUrl, int number, Rule1 rule, State19Enum state,
         ...
         * @return Builder
         */
        public Builder state(State19Enum state) {
            this.state = state;
            return this;
        }
        ...
        /**
         * Builds a new {@link Alert19} object using the set fields.
         * @return {@link Alert19}
         */
        public Alert19 build() {
            return new Alert19(createdAt, dismissedAt, dismissedBy, dismissedReason, htmlUrl,
