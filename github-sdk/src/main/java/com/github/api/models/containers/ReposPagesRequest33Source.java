 ...
 */
@JsonDeserialize(using = ReposPagesRequest33Source.ReposPagesRequest33SourceDeserializer.class)
public abstract class ReposPagesRequest33Source {
     ...
     */
    public static ReposPagesRequest33Source fromSource2(Source2Enum source2) {
     ...
     */
    public static ReposPagesRequest33Source fromSource21(Source21 source21) {
    ...
    @TypeCombinatorCase
    private static class Source2Case extends ReposPagesRequest33Source {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Source21Case extends ReposPagesRequest33Source {
    ...
    /**
     * This is a custom deserializer class for ReposPagesRequest33Source.
     */
    protected static class ReposPagesRequest33SourceDeserializer
            extends JsonDeserializer<ReposPagesRequest33Source> {

        @Override
        public ReposPagesRequest33Source deserialize(JsonParser jp, DeserializationContext ctxt)
