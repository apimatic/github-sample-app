...
/**
 * This is a model class for WorkflowJob1 type.
 */
public class WorkflowJob1 {
     ...
     * @param  status  Status23Enum value for status.
     ...
     * attribute](https://docs.github.com/actions/reference/workflow-syntax-for-github-actions#jobsjob_idruns-on)
     ...
     * The ID of the runner group that is running this job. This will be `null` as long as
     * `workflow_job[status]` is `queued`.
     ...
     * The name of the runner group that is running this job. This will be `null` as long as
     * `workflow_job[status]` is `queued`.
     * @return Returns the String
     */
    ...
    /**
     * Getter for RunnerId.
     * The ID of the runner that is running this job. This will be `null` as long as
     * `workflow_job[status]` is `queued`.
     * @return Returns the Integer
     */
     ...
     * The name of the runner that is running this job. This will be `null` as long as
     * `workflow_job[status]` is `queued`.
     * @return Returns the String
     */
    ...
    /**
     * Getter for Status.
     * @return Returns the Status23Enum
     */
    @JsonGetter("status")
    public Status23Enum getStatus() {
        return status;
    }

    /**
     * Setter for Status.
     * @param status Value for Status23Enum
     */
    @JsonSetter("status")
    public void setStatus(Status23Enum status) {
        this.status = status;
    }
    ...
    /**
     * Converts this WorkflowJob1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WorkflowJob1 [" + "checkRunUrl=" + checkRunUrl + ", completedAt=" + completedAt
    ...
    /**
     * Builds a new {@link WorkflowJob1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WorkflowJob1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WorkflowJob1}.
     */
    public static class Builder {
         ...
         * @param  url  String value for url.
         */
        public Builder(String checkRunUrl, String completedAt, Object conclusion, String headSha,
                ...
                String runnerGroupName, Integer runnerId, String runnerName, String startedAt,
                Status23Enum status, String headBranch, String workflowName,
                List<WorkflowStep1> steps, String url) {
            this.checkRunUrl = checkRunUrl;
            this.completedAt = completedAt;
            this.conclusion = conclusion;
            this.headSha = headSha;
         ...
         * @return Builder
         */
        public Builder status(Status23Enum status) {
            this.status = status;
            return this;
        }
        ...
        /**
         * Builds a new {@link WorkflowJob1} object using the set fields.
         * @return {@link WorkflowJob1}
         */
        public WorkflowJob1 build() {
            return new WorkflowJob1(checkRunUrl, completedAt, conclusion, headSha, htmlUrl, id,
                    labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName,
                    runnerId, runnerName, startedAt, status, headBranch, workflowName, steps, url);
        }
    }
