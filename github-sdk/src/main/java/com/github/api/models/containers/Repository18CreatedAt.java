 ...
 */
@JsonDeserialize(using = Repository18CreatedAt.Repository18CreatedAtDeserializer.class)
public abstract class Repository18CreatedAt {
     ...
     */
    public static Repository18CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository18CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository18CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository18CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository18CreatedAt.
     */
    protected static class Repository18CreatedAtDeserializer
            extends JsonDeserializer<Repository18CreatedAt> {

        @Override
        public Repository18CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
