 ...
 */
@JsonDeserialize(using = Repo22PushedAt.Repo22PushedAtDeserializer.class)
public abstract class Repo22PushedAt {
     ...
     */
    public static Repo22PushedAt fromNumber(int number) {
     ...
     */
    public static Repo22PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repo22PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo22PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo22PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repo22PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo22PushedAt.
     */
    protected static class Repo22PushedAtDeserializer
            extends JsonDeserializer<Repo22PushedAt> {

        @Override
        public Repo22PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
