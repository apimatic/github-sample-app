...
/**
 * This is a model class for PullRequestdequeuedevent type.
 */
public class PullRequestdequeuedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest34 pullRequest;
     ...
     * Default constructor.
     */
    public PullRequestdequeuedevent() {
        action = "dequeued";
    }
     ...
     * @param  pullRequest  PullRequest34 value for pullRequest.
     ...
     * @return Returns the PullRequest34
     */
    @JsonGetter("pull_request")
    public PullRequest34 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest34
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest34 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestdequeuedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestdequeuedevent [" + "action=" + action + ", number=" + number
                + ", pullRequest=" + pullRequest + ", reason=" + reason + ", repository="
                + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link PullRequestdequeuedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestdequeuedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, number, pullRequest, reason, repository, sender)
    ...
    /**
     * Class to build instances of {@link PullRequestdequeuedevent}.
     */
    public static class Builder {
        private String action = "dequeued";
        private int number;
        private PullRequest34 pullRequest;
        private String reason;
        private Repository3 repository;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest34 pullRequest, String reason,
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest34 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestdequeuedevent} object using the set fields.
         * @return {@link PullRequestdequeuedevent}
         */
        public PullRequestdequeuedevent build() {
            return new PullRequestdequeuedevent(action, number, pullRequest, reason, repository,
