...
/**
 * This is a model class for Packageupdatedevent type.
 */
public class Packageupdatedevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private Organization2 organization;
    private Package4 mPackage;
     ...
     * @param  mPackage  Package4 value for mPackage.
    ...
    /**
     * Getter for Package.
     * @return Returns the Package4
     */
    @JsonGetter("package")
    public Package4 getPackage() {
        return mPackage;
    }

    /**
     * Setter for Package.
     * @param mPackage Value for Package4
     */
    @JsonSetter("package")
    public void setPackage(Package4 mPackage) {
        this.mPackage = mPackage;
    }
    ...
    /**
     * Converts this Packageupdatedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Packageupdatedevent [" + "action=" + action + ", mPackage=" + mPackage
                + ", repository=" + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Packageupdatedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Packageupdatedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, mPackage, repository, sender)
    ...
    /**
     * Class to build instances of {@link Packageupdatedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Package4 mPackage, Repository3 repository, Sender sender) {
            this.action = action;
            this.mPackage = mPackage;
            this.repository = repository;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder mPackage(Package4 mPackage) {
            this.mPackage = mPackage;
            return this;
        }
        ...
        /**
         * Builds a new {@link Packageupdatedevent} object using the set fields.
         * @return {@link Packageupdatedevent}
         */
        public Packageupdatedevent build() {
            return new Packageupdatedevent(action, mPackage, repository, sender, enterprise,
