...
/**
 * This is a model class for Assignee type.
 */
public class Assignee {
     ...
     */
    protected Assignee(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    /**
     * Converts this Assignee into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Assignee [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link Assignee.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Assignee.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Assignee}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Assignee} object using the set fields.
         * @return {@link Assignee}
         */
        public Assignee build() {
            return new Assignee(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
