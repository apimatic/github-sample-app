...
import com.github.api.models.containers.ReposIssuesResponse1Labels;
...
/**
 * This is a model class for ReposIssuesResponse1 type.
 */
public class ReposIssuesResponse1 {
    private int id;
    ...
    private Object user;
    private List<ReposIssuesResponse1Labels> labels;
     ...
     * @param  labels  List of ReposIssuesResponse1Labels value for labels.
    ...
    public ReposIssuesResponse1(
            ...
            String title,
            Object user,
            List<ReposIssuesResponse1Labels> labels,
            Object assignee,
            Object milestone,
            boolean locked,
            int comments,
     ...
     */
    protected ReposIssuesResponse1(int id, String nodeId, String url, String repositoryUrl,
            String labelsUrl, String commentsUrl, String eventsUrl, String htmlUrl, int number,
            String state, String title, Object user, List<ReposIssuesResponse1Labels> labels,
            Object assignee, Object milestone, boolean locked, int comments, LocalDateTime closedAt,
     ...
     * @return Returns the List of ReposIssuesResponse1Labels
     */
    @JsonGetter("labels")
    public List<ReposIssuesResponse1Labels> getLabels() {
        return labels;
    }
     ...
     * labels on this issue; send an empty array to clear all labels from the issue; note that the
     * labels are silently dropped for users without push access to the repository
     * @param labels Value for List of ReposIssuesResponse1Labels
     */
    @JsonSetter("labels")
    public void setLabels(List<ReposIssuesResponse1Labels> labels) {
        this.labels = labels;
    }
    ...
    /**
     * Converts this ReposIssuesResponse1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposIssuesResponse1 [" + "id=" + id + ", nodeId=" + nodeId + ", url=" + url
                + ", repositoryUrl=" + repositoryUrl + ", labelsUrl=" + labelsUrl + ", commentsUrl="
                + commentsUrl + ", eventsUrl=" + eventsUrl + ", htmlUrl=" + htmlUrl + ", number="
                + number + ", state=" + state + ", title=" + title + ", user=" + user + ", labels="
                + labels + ", assignee=" + assignee + ", milestone=" + milestone + ", locked="
                + locked + ", comments=" + comments + ", closedAt=" + closedAt + ", createdAt="
                + createdAt + ", updatedAt=" + updatedAt + ", authorAssociation="
                + authorAssociation + ", stateReason=" + stateReason + ", body=" + body
                + ", assignees=" + assignees + ", activeLockReason=" + activeLockReason
                + ", pullRequest=" + pullRequest + ", draft=" + draft + ", closedBy=" + closedBy
                + ", bodyHtml=" + bodyHtml + ", bodyText=" + bodyText + ", timelineUrl="
                + timelineUrl + ", repository=" + repository + ", performedViaGithubApp="
                + performedViaGithubApp + ", reactions=" + reactions + "]";
    }

    /**
     * Builds a new {@link ReposIssuesResponse1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposIssuesResponse1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposIssuesResponse1}.
     */
    public static class Builder {
        ...
        public Builder(int id, String nodeId, String url, String repositoryUrl, String labelsUrl,
                ...
                String title, Object user, List<ReposIssuesResponse1Labels> labels, Object assignee,
         ...
         * @return Builder
         */
        public Builder labels(List<ReposIssuesResponse1Labels> labels) {
            this.labels = labels;
            return this;
        }
        ...
        /**
         * Builds a new {@link ReposIssuesResponse1} object using the set fields.
         * @return {@link ReposIssuesResponse1}
         */
        public ReposIssuesResponse1 build() {
            return new ReposIssuesResponse1(id, nodeId, url, repositoryUrl, labelsUrl, commentsUrl,
                    eventsUrl, htmlUrl, number, state, title, user, labels, assignee, milestone,
                    locked, comments, closedAt, createdAt, updatedAt, authorAssociation,
