 ...
 */
@JsonDeserialize(using = Repository161CreatedAt.Repository161CreatedAtDeserializer.class)
public abstract class Repository161CreatedAt {
     ...
     */
    public static Repository161CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository161CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository161CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository161CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository161CreatedAt.
     */
    protected static class Repository161CreatedAtDeserializer
            extends JsonDeserializer<Repository161CreatedAt> {

        @Override
        public Repository161CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
