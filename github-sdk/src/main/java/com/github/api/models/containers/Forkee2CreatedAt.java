 ...
 */
@JsonDeserialize(using = Forkee2CreatedAt.Forkee2CreatedAtDeserializer.class)
public abstract class Forkee2CreatedAt {
     ...
     */
    public static Forkee2CreatedAt fromNumber(int number) {
     ...
     */
    public static Forkee2CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Forkee2CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Forkee2CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Forkee2CreatedAt.
     */
    protected static class Forkee2CreatedAtDeserializer
            extends JsonDeserializer<Forkee2CreatedAt> {

        @Override
        public Forkee2CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
