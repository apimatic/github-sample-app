...
/**
 * This is a model class for Artifact type.
 */
public class Artifact {
    ...
    /**
     * Converts this Artifact into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Artifact [" + "id=" + id + ", nodeId=" + nodeId + ", name=" + name
                + ", sizeInBytes=" + sizeInBytes + ", url=" + url + ", archiveDownloadUrl="
                + archiveDownloadUrl + ", expired=" + expired + ", createdAt=" + createdAt
                + ", expiresAt=" + expiresAt + ", updatedAt=" + updatedAt + ", workflowRun="
                + workflowRun + "]";
    }

    /**
     * Builds a new {@link Artifact.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Artifact.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Artifact}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Artifact} object using the set fields.
         * @return {@link Artifact}
         */
        public Artifact build() {
            return new Artifact(id, nodeId, name, sizeInBytes, url, archiveDownloadUrl, expired,
                    createdAt, expiresAt, updatedAt, workflowRun);
        }
    }
}
