...
/**
 * This is a model class for OrgsActionsRequiredWorkflowsRequest type.
 */
public class OrgsActionsRequiredWorkflowsRequest {
     ...
     * Default constructor.
     */
    public OrgsActionsRequiredWorkflowsRequest() {
    }
     ...
     * A list of repository IDs where you want to enable the required workflow. You can only provide
    ...
    /**
     * Converts this OrgsActionsRequiredWorkflowsRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OrgsActionsRequiredWorkflowsRequest [" + "workflowFilePath=" + workflowFilePath
                + ", repositoryId=" + repositoryId + ", scope=" + scope + ", selectedRepositoryIds="
                + selectedRepositoryIds + "]";
    }

    /**
     * Builds a new {@link OrgsActionsRequiredWorkflowsRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link OrgsActionsRequiredWorkflowsRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(workflowFilePath, repositoryId)
                .scope(getScope())
    ...
    /**
     * Class to build instances of {@link OrgsActionsRequiredWorkflowsRequest}.
     */
    public static class Builder {
         ...
         * @param  repositoryId  String value for repositoryId.
         */
        public Builder(String workflowFilePath, String repositoryId) {
            this.workflowFilePath = workflowFilePath;
            this.repositoryId = repositoryId;
        }
        ...
        /**
         * Builds a new {@link OrgsActionsRequiredWorkflowsRequest} object using the set fields.
         * @return {@link OrgsActionsRequiredWorkflowsRequest}
         */
        public OrgsActionsRequiredWorkflowsRequest build() {
            return new OrgsActionsRequiredWorkflowsRequest(workflowFilePath, repositoryId, scope,
                    selectedRepositoryIds);
        }
    }
}
