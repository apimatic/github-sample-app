 ...
 */
@JsonDeserialize(using = PullRequest32Assignees.PullRequest32AssigneesDeserializer.class)
public abstract class PullRequest32Assignees {
     ...
     */
    public static PullRequest32Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest32Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest32Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest32Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest32Assignees.
     */
    protected static class PullRequest32AssigneesDeserializer
            extends JsonDeserializer<PullRequest32Assignees> {

        @Override
        public PullRequest32Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
