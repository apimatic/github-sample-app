...
public class Creator {
     ...
     */
    protected Creator(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    public String toString() {
        return "Creator [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId + ", avatarUrl="
    ...
    public static class Builder {
        ...
        public Creator build() {
            return new Creator(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl, followersUrl,
