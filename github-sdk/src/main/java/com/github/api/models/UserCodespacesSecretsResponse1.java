...
/**
 * This is a model class for UserCodespacesSecretsResponse1 type.
 */
public class UserCodespacesSecretsResponse1 {
    private String name;
     ...
     * Default constructor.
     */
    public UserCodespacesSecretsResponse1() {
    }
    ...
    /**
     * Converts this UserCodespacesSecretsResponse1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "UserCodespacesSecretsResponse1 [" + "name=" + name + ", createdAt=" + createdAt
                + ", updatedAt=" + updatedAt + ", visibility=" + visibility
                + ", selectedRepositoriesUrl=" + selectedRepositoriesUrl + "]";
    }

    /**
     * Builds a new {@link UserCodespacesSecretsResponse1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UserCodespacesSecretsResponse1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UserCodespacesSecretsResponse1}.
     */
    public static class Builder {
        ...
        public Builder(String name, LocalDateTime createdAt, LocalDateTime updatedAt,
                Visibility2Enum visibility, String selectedRepositoriesUrl) {
            this.name = name;
            this.createdAt = createdAt;
            this.updatedAt = updatedAt;
            this.visibility = visibility;
        ...
        /**
         * Builds a new {@link UserCodespacesSecretsResponse1} object using the set fields.
         * @return {@link UserCodespacesSecretsResponse1}
         */
        public UserCodespacesSecretsResponse1 build() {
            return new UserCodespacesSecretsResponse1(name, createdAt, updatedAt, visibility,
                    selectedRepositoriesUrl);
        }
    }
}
