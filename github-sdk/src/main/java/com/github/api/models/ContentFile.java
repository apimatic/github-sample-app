...
/**
 * This is a model class for ContentFile type.
 */
public class ContentFile {
    ...
    /**
     * Converts this ContentFile into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ContentFile [" + "type=" + type + ", encoding=" + encoding + ", size=" + size
                + ", name=" + name + ", path=" + path + ", content=" + content + ", sha=" + sha
                + ", url=" + url + ", gitUrl=" + gitUrl + ", htmlUrl=" + htmlUrl + ", downloadUrl="
                + downloadUrl + ", links=" + links + ", target=" + target + ", submoduleGitUrl="
                + submoduleGitUrl + "]";
    }

    /**
     * Builds a new {@link ContentFile.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ContentFile.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ContentFile}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ContentFile} object using the set fields.
         * @return {@link ContentFile}
         */
        public ContentFile build() {
            return new ContentFile(type, encoding, size, name, path, content, sha, url, gitUrl,
                    htmlUrl, downloadUrl, links, target, submoduleGitUrl);
        }
    }
}
