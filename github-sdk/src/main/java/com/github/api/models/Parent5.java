...
public class Parent5 {
    ...
    public static class Builder {
        ...
        public Parent5 build() {
            return new Parent5(description, htmlUrl, id, membersUrl, name, nodeId, permission,
                    privacy, repositoriesUrl, slug, url);
        }
    }
}
