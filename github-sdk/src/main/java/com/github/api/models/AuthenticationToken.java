...
/**
 * This is a model class for AuthenticationToken type.
 */
public class AuthenticationToken {
     ...
     */
    protected AuthenticationToken(String token, LocalDateTime expiresAt, Object permissions,
            List<Repository> repositories, OptionalNullable<String> singleFile,
            RepositorySelectionEnum repositorySelection) {
        this.token = token;
        this.expiresAt = expiresAt;
        this.permissions = permissions;
    ...
    /**
     * Converts this AuthenticationToken into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AuthenticationToken [" + "token=" + token + ", expiresAt=" + expiresAt
    ...
    /**
     * Builds a new {@link AuthenticationToken.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AuthenticationToken.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AuthenticationToken}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link AuthenticationToken} object using the set fields.
         * @return {@link AuthenticationToken}
         */
        public AuthenticationToken build() {
            return new AuthenticationToken(token, expiresAt, permissions, repositories, singleFile,
                    repositorySelection);
        }
    }
}
