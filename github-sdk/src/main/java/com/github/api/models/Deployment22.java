...
/**
 * This is a model class for Deployment22 type.
 */
public class Deployment22 {
    private String url;
    private int id;
    ...
    /**
     * Converts this Deployment22 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Deployment22 [" + "url=" + url + ", id=" + id + ", nodeId=" + nodeId + ", task="
    ...
    /**
     * Builds a new {@link Deployment22.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Deployment22.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Deployment22}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Deployment22} object using the set fields.
         * @return {@link Deployment22}
         */
        public Deployment22 build() {
            return new Deployment22(url, id, nodeId, task, environment, description, createdAt,
