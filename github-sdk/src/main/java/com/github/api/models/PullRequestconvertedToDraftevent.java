...
/**
 * This is a model class for PullRequestconvertedToDraftevent type.
 */
public class PullRequestconvertedToDraftevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest32 pullRequest;
     ...
     * Default constructor.
     */
    public PullRequestconvertedToDraftevent() {
     ...
     * @param  pullRequest  PullRequest32 value for pullRequest.
     ...
     * @return Returns the PullRequest32
     */
    @JsonGetter("pull_request")
    public PullRequest32 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest32
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest32 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestconvertedToDraftevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestconvertedToDraftevent [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestconvertedToDraftevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestconvertedToDraftevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestconvertedToDraftevent}.
     */
    public static class Builder {
        private String action = "converted_to_draft";
        private int number;
        private PullRequest32 pullRequest;
        private Repository3 repository;
        private Sender sender;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest32 pullRequest, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest32 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestconvertedToDraftevent} object using the set fields.
         * @return {@link PullRequestconvertedToDraftevent}
         */
        public PullRequestconvertedToDraftevent build() {
            return new PullRequestconvertedToDraftevent(action, number, pullRequest, repository,
