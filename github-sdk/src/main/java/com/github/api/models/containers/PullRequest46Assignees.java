 ...
 */
@JsonDeserialize(using = PullRequest46Assignees.PullRequest46AssigneesDeserializer.class)
public abstract class PullRequest46Assignees {
     ...
     */
    public static PullRequest46Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest46Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest46Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest46Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest46Assignees.
     */
    protected static class PullRequest46AssigneesDeserializer
            extends JsonDeserializer<PullRequest46Assignees> {

        @Override
        public PullRequest46Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
