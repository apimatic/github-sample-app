 ...
 */
@JsonDeserialize(using = PullRequest49RequestedReviewers.PullRequest49RequestedReviewersDeserializer.class)
public abstract class PullRequest49RequestedReviewers {
     ...
     */
    public static PullRequest49RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest49RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest49RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends PullRequest49RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest49RequestedReviewers.
     */
    protected static class PullRequest49RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest49RequestedReviewers> {

        @Override
        public PullRequest49RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
