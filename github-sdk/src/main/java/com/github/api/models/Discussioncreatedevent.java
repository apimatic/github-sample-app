...
/**
 * This is a model class for Discussioncreatedevent type.
 */
public class Discussioncreatedevent {
    private String action;
    private Discussion5 discussion;
     ...
     * @param  discussion  Discussion5 value for discussion.
     ...
     * @return Returns the Discussion5
     */
    @JsonGetter("discussion")
    public Discussion5 getDiscussion() {
        return discussion;
    }

    /**
     * Setter for Discussion.
     * @param discussion Value for Discussion5
     */
    @JsonSetter("discussion")
    public void setDiscussion(Discussion5 discussion) {
        this.discussion = discussion;
    }
    ...
    /**
     * Converts this Discussioncreatedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Discussioncreatedevent [" + "action=" + action + ", discussion=" + discussion
                + ", repository=" + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Discussioncreatedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Discussioncreatedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Discussioncreatedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Discussion5 discussion, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.discussion = discussion;
            this.repository = repository;
         ...
         * @return Builder
         */
        public Builder discussion(Discussion5 discussion) {
            this.discussion = discussion;
            return this;
        }
        ...
        /**
         * Builds a new {@link Discussioncreatedevent} object using the set fields.
         * @return {@link Discussioncreatedevent}
         */
        public Discussioncreatedevent build() {
            return new Discussioncreatedevent(action, discussion, repository, sender, enterprise,
