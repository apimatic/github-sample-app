 ...
 */
@JsonDeserialize(using = NpmMetadata1Repository.NpmMetadata1RepositoryDeserializer.class)
public abstract class NpmMetadata1Repository {
     ...
     */
    public static NpmMetadata1Repository fromMString(String mString) {
     ...
     */
    public static NpmMetadata1Repository fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends NpmMetadata1Repository {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends NpmMetadata1Repository {
    ...
    /**
     * This is a custom deserializer class for NpmMetadata1Repository.
     */
    protected static class NpmMetadata1RepositoryDeserializer
            extends JsonDeserializer<NpmMetadata1Repository> {

        @Override
        public NpmMetadata1Repository deserialize(JsonParser jp, DeserializationContext ctxt)
