 ...
 */
@JsonDeserialize(using = Repository12CreatedAt.Repository12CreatedAtDeserializer.class)
public abstract class Repository12CreatedAt {
     ...
     */
    public static Repository12CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository12CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository12CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository12CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository12CreatedAt.
     */
    protected static class Repository12CreatedAtDeserializer
            extends JsonDeserializer<Repository12CreatedAt> {

        @Override
        public Repository12CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
