...
import com.github.api.models.containers.PullRequest31Assignees;
import com.github.api.models.containers.PullRequest31RequestedReviewers;
...
/**
 * This is a model class for PullRequest31 type.
 */
public class PullRequest31 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest31Assignees> assignees;
    ...
    private List<PullRequest31RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest31Assignees value for assignees.
     ...
     * @param  head  Head8 value for head.
     ...
     * @param  requestedReviewers  List of PullRequest31RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest31(
            ...
            Object assignee,
            List<PullRequest31Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest31RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest31(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest31Assignees> assignees, AuthorAssociationEnum authorAssociation,
            Object autoMerge, Base11 base, String body, LocalDateTime closedAt, String commentsUrl,
            String commitsUrl, LocalDateTime createdAt, String diffUrl, boolean draft, Head8 head,
            String htmlUrl, int id, String issueUrl, List<Label10> labels, boolean locked,
            String mergeCommitSha, Boolean merged, LocalDateTime mergedAt, Object milestone,
            String nodeId, int number, String patchUrl,
            List<PullRequest31RequestedReviewers> requestedReviewers, List<Team4> requestedTeams,
            ...
            String mergeableState, Object mergedBy, OptionalNullable<Boolean> rebaseable,
            Integer reviewComments) {
        this.links = links;
        this.activeLockReason = activeLockReason;
        this.additions = additions;
     ...
     * @return Returns the List of PullRequest31Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest31Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest31Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest31Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Head.
     * @return Returns the Head8
     */
    @JsonGetter("head")
    public Head8 getHead() {
        return head;
    }

    /**
     * Setter for Head.
     * @param head Value for Head8
     */
    @JsonSetter("head")
    public void setHead(Head8 head) {
        this.head = head;
    }
     ...
     * @return Returns the List of PullRequest31RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest31RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest31RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest31RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest31 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest31 [" + "links=" + links + ", activeLockReason=" + activeLockReason
                ...
                + mergeCommitSha + ", merged=" + merged + ", mergedAt=" + mergedAt + ", milestone="
                + milestone + ", nodeId=" + nodeId + ", number=" + number + ", patchUrl=" + patchUrl
                ...
                + ", mergeableState=" + mergeableState + ", mergedBy=" + mergedBy + ", rebaseable="
                + rebaseable + ", reviewComments=" + reviewComments + "]";
    }

    /**
     * Builds a new {@link PullRequest31.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest31.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(links, activeLockReason, assignee, assignees,
                ...
                mergeCommitSha, merged, mergedAt, milestone, nodeId, number, patchUrl,
    ...
    /**
     * Class to build instances of {@link PullRequest31}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                ...
                boolean draft, Head8 head, String htmlUrl, int id, String issueUrl,
                List<Label10> labels, boolean locked, String mergeCommitSha, Boolean merged,
                LocalDateTime mergedAt, Object milestone, String nodeId, int number,
                String patchUrl, List<PullRequest31RequestedReviewers> requestedReviewers,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest31Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder head(Head8 head) {
            this.head = head;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest31} object using the set fields.
         * @return {@link PullRequest31}
         */
        public PullRequest31 build() {
            return new PullRequest31(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
                    mergeCommitSha, merged, mergedAt, milestone, nodeId, number, patchUrl,
                    requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state,
                    statusesUrl, title, updatedAt, url, user, additions, changedFiles, comments,
                    commits, deletions, maintainerCanModify, mergeable, mergeableState, mergedBy,
