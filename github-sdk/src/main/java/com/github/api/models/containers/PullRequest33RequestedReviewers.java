 ...
 */
@JsonDeserialize(using = PullRequest33RequestedReviewers.PullRequest33RequestedReviewersDeserializer.class)
public abstract class PullRequest33RequestedReviewers {
     ...
     */
    public static PullRequest33RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest33RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest33RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends PullRequest33RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest33RequestedReviewers.
     */
    protected static class PullRequest33RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest33RequestedReviewers> {

        @Override
        public PullRequest33RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
