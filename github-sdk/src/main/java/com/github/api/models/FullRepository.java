...
/**
 * This is a model class for FullRepository type.
 */
public class FullRepository {
     ...
     */
    protected FullRepository(int id, String nodeId, String name, String fullName, Owner1 owner,
    ...
    /**
     * Converts this FullRepository into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "FullRepository [" + "id=" + id + ", nodeId=" + nodeId + ", name=" + name
    ...
    /**
     * Builds a new {@link FullRepository.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link FullRepository.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link FullRepository}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link FullRepository} object using the set fields.
         * @return {@link FullRepository}
         */
        public FullRepository build() {
            return new FullRepository(id, nodeId, name, fullName, owner, mPrivate, htmlUrl,
                    description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl,
