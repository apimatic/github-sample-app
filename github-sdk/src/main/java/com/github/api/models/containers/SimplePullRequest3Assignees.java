 ...
 */
@JsonDeserialize(using = SimplePullRequest3Assignees.SimplePullRequest3AssigneesDeserializer.class)
public abstract class SimplePullRequest3Assignees {
     ...
     */
    public static SimplePullRequest3Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static SimplePullRequest3Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends SimplePullRequest3Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends SimplePullRequest3Assignees {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest3Assignees.
     */
    protected static class SimplePullRequest3AssigneesDeserializer
            extends JsonDeserializer<SimplePullRequest3Assignees> {

        @Override
        public SimplePullRequest3Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
