 ...
 */
@JsonDeserialize(using = PullRequest29Assignees.PullRequest29AssigneesDeserializer.class)
public abstract class PullRequest29Assignees {
     ...
     */
    public static PullRequest29Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest29Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest29Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest29Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest29Assignees.
     */
    protected static class PullRequest29AssigneesDeserializer
            extends JsonDeserializer<PullRequest29Assignees> {

        @Override
        public PullRequest29Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
