...
/**
 * This is a model class for TeamAddevent type.
 */
public class TeamAddevent {
    ...
    /**
     * Converts this TeamAddevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TeamAddevent [" + "repository=" + repository + ", sender=" + sender + ", team="
                + team + ", enterprise=" + enterprise + ", installation=" + installation
                + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link TeamAddevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TeamAddevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(repository, sender, team)
    ...
    /**
     * Class to build instances of {@link TeamAddevent}.
     */
    public static class Builder {
         ...
         * @param  team  Team2 value for team.
         */
        public Builder(Repository3 repository, Sender sender, Team2 team) {
            this.repository = repository;
            this.sender = sender;
            this.team = team;
        }
        ...
        /**
         * Builds a new {@link TeamAddevent} object using the set fields.
         * @return {@link TeamAddevent}
         */
        public TeamAddevent build() {
            return new TeamAddevent(repository, sender, team, enterprise, installation,
                    organization);
        }
    }
}
