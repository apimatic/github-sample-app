...
/**
 * This is a model class for WorkflowStep3 type.
 */
public class WorkflowStep3 {
    ...
    /**
     * Converts this WorkflowStep3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WorkflowStep3 [" + "completedAt=" + completedAt + ", conclusion=" + conclusion
                + ", name=" + name + ", number=" + number + ", startedAt=" + startedAt + ", status="
                + status + "]";
    }

    /**
     * Builds a new {@link WorkflowStep3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WorkflowStep3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WorkflowStep3}.
     */
    public static class Builder {
        ...
        public Builder(String completedAt, Object conclusion, String name, int number,
                String startedAt, Status12Enum status) {
            this.completedAt = completedAt;
            this.conclusion = conclusion;
            this.name = name;
            this.number = number;
        ...
        /**
         * Builds a new {@link WorkflowStep3} object using the set fields.
         * @return {@link WorkflowStep3}
         */
        public WorkflowStep3 build() {
            return new WorkflowStep3(completedAt, conclusion, name, number, startedAt, status);
        }
    }
}
