 ...
 */
@JsonDeserialize(using = Repo15PushedAt.Repo15PushedAtDeserializer.class)
public abstract class Repo15PushedAt {
     ...
     */
    public static Repo15PushedAt fromNumber(int number) {
     ...
     */
    public static Repo15PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo15PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo15PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo15PushedAt.
     */
    protected static class Repo15PushedAtDeserializer
            extends JsonDeserializer<Repo15PushedAt> {

        @Override
        public Repo15PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
