 ...
 */
@JsonDeserialize(using = Repository19PushedAt.Repository19PushedAtDeserializer.class)
public abstract class Repository19PushedAt {
     ...
     */
    public static Repository19PushedAt fromNumber(int number) {
     ...
     */
    public static Repository19PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository19PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository19PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository19PushedAt.
     */
    protected static class Repository19PushedAtDeserializer
            extends JsonDeserializer<Repository19PushedAt> {

        @Override
        public Repository19PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
