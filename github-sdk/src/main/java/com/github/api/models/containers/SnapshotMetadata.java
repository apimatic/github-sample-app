 ...
 */
@JsonDeserialize(using = SnapshotMetadata.SnapshotMetadataDeserializer.class)
public abstract class SnapshotMetadata {
     ...
     */
    public static SnapshotMetadata fromMString(String mString) {
     ...
     */
    public static SnapshotMetadata fromPrecision(double precision) {
     ...
     */
    public static SnapshotMetadata fromMBoolean(boolean mBoolean) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends SnapshotMetadata {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class PrecisionCase extends SnapshotMetadata {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class MBooleanCase extends SnapshotMetadata {
    ...
    /**
     * This is a custom deserializer class for SnapshotMetadata.
     */
    protected static class SnapshotMetadataDeserializer
            extends JsonDeserializer<SnapshotMetadata> {

        @Override
        public SnapshotMetadata deserialize(JsonParser jp, DeserializationContext ctxt)
