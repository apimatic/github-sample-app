 ...
 */
@JsonDeserialize(using = SimplePullRequest4Assignees.SimplePullRequest4AssigneesDeserializer.class)
public abstract class SimplePullRequest4Assignees {
     ...
     */
    public static SimplePullRequest4Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static SimplePullRequest4Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends SimplePullRequest4Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends SimplePullRequest4Assignees {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest4Assignees.
     */
    protected static class SimplePullRequest4AssigneesDeserializer
            extends JsonDeserializer<SimplePullRequest4Assignees> {

        @Override
        public SimplePullRequest4Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
