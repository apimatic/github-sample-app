...
/**
 * This is a model class for Hook type.
 */
public class Hook {
    ...
    /**
     * Converts this Hook into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Hook [" + "active=" + active + ", config=" + config + ", createdAt=" + createdAt
                + ", events=" + events + ", id=" + id + ", name=" + name + ", type=" + type
                + ", updatedAt=" + updatedAt + "]";
    }

    /**
     * Builds a new {@link Hook.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Hook.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Hook}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Hook} object using the set fields.
         * @return {@link Hook}
         */
        public Hook build() {
            return new Hook(active, config, createdAt, events, id, name, type, updatedAt);
        }
    }
}
