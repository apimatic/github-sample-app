...
/**
 * This is a model class for ReposCheckRunsResponse type.
 */
public class ReposCheckRunsResponse {
    private int id;
    ...
    /**
     * Converts this ReposCheckRunsResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposCheckRunsResponse [" + "id=" + id + ", headSha=" + headSha + ", nodeId="
                + nodeId + ", externalId=" + externalId + ", url=" + url + ", htmlUrl=" + htmlUrl
                + ", detailsUrl=" + detailsUrl + ", status=" + status + ", conclusion=" + conclusion
                + ", startedAt=" + startedAt + ", completedAt=" + completedAt + ", output=" + output
                + ", name=" + name + ", checkSuite=" + checkSuite + ", app=" + app
                + ", pullRequests=" + pullRequests + ", deployment=" + deployment + "]";
    }

    /**
     * Builds a new {@link ReposCheckRunsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposCheckRunsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposCheckRunsResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReposCheckRunsResponse} object using the set fields.
         * @return {@link ReposCheckRunsResponse}
         */
        public ReposCheckRunsResponse build() {
            return new ReposCheckRunsResponse(id, headSha, nodeId, externalId, url, htmlUrl,
                    detailsUrl, status, conclusion, startedAt, completedAt, output, name,
