...
/**
 * This is a model class for Repositoryrenamedevent type.
 */
public class Repositoryrenamedevent {
    private String action;
    private Changes30 changes;
     ...
     * @param  changes  Changes30 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes30
     */
    @JsonGetter("changes")
    public Changes30 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes30
     */
    @JsonSetter("changes")
    public void setChanges(Changes30 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Repositoryrenamedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repositoryrenamedevent [" + "action=" + action + ", changes=" + changes
                + ", repository=" + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Repositoryrenamedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repositoryrenamedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Repositoryrenamedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes30 changes, Repository3 repository, Sender sender) {
            this.action = action;
            this.changes = changes;
            this.repository = repository;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder changes(Changes30 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Repositoryrenamedevent} object using the set fields.
         * @return {@link Repositoryrenamedevent}
         */
        public Repositoryrenamedevent build() {
            return new Repositoryrenamedevent(action, changes, repository, sender, enterprise,
