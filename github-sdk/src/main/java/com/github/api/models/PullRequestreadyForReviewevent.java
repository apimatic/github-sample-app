...
/**
 * This is a model class for PullRequestreadyForReviewevent type.
 */
public class PullRequestreadyForReviewevent {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest41 pullRequest;
     ...
     * Default constructor.
     */
    public PullRequestreadyForReviewevent() {
     ...
     * @param  pullRequest  PullRequest41 value for pullRequest.
     ...
     * @return Returns the PullRequest41
     */
    @JsonGetter("pull_request")
    public PullRequest41 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest41
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest41 pullRequest) {
        this.pullRequest = pullRequest;
    }
    ...
    /**
     * Converts this PullRequestreadyForReviewevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestreadyForReviewevent [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestreadyForReviewevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestreadyForReviewevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestreadyForReviewevent}.
     */
    public static class Builder {
        private String action = "ready_for_review";
        private int number;
        private PullRequest41 pullRequest;
        private Repository3 repository;
        private Sender sender;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest41 pullRequest, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest41 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestreadyForReviewevent} object using the set fields.
         * @return {@link PullRequestreadyForReviewevent}
         */
        public PullRequestreadyForReviewevent build() {
            return new PullRequestreadyForReviewevent(action, number, pullRequest, repository,
