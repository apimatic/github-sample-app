 ...
 */
@JsonDeserialize(using = PullRequest32RequestedReviewers.PullRequest32RequestedReviewersDeserializer.class)
public abstract class PullRequest32RequestedReviewers {
     ...
     */
    public static PullRequest32RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest32RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest32RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends PullRequest32RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest32RequestedReviewers.
     */
    protected static class PullRequest32RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest32RequestedReviewers> {

        @Override
        public PullRequest32RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
