...
import com.github.api.models.containers.PullRequest51Assignees;
import com.github.api.models.containers.PullRequest51RequestedReviewers;
...
/**
 * This is a model class for PullRequest51 type.
 */
public class PullRequest51 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest51Assignees> assignees;
    ...
    private List<PullRequest51RequestedReviewers> requestedReviewers;
     ...
     * @param  requestedReviewers  List of PullRequest51RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest51(
            ...
            Object assignee,
            List<PullRequest51Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest51RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest51(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest51Assignees> assignees, AuthorAssociationEnum authorAssociation,
            Object autoMerge, Base37 base, String body, LocalDateTime closedAt, String commentsUrl,
            ...
            int number, String patchUrl, List<PullRequest51RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest51Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest51Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest51Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest51Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Base.
     * @return Returns the Base37
     */
    @JsonGetter("base")
    public Base37 getBase() {
        return base;
    }

    /**
     * Setter for Base.
     * @param base Value for Base37
     */
    @JsonSetter("base")
    public void setBase(Base37 base) {
        this.base = base;
    }
     ...
     * @return Returns the List of PullRequest51RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest51RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest51RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest51RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest51 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest51 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest51.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest51.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest51}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<PullRequest51Assignees> assignees, AuthorAssociationEnum authorAssociation,
                Object autoMerge, Base37 base, String body, LocalDateTime closedAt,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest51Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder base(Base37 base) {
            this.base = base;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest51} object using the set fields.
         * @return {@link PullRequest51}
         */
        public PullRequest51 build() {
            return new PullRequest51(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
