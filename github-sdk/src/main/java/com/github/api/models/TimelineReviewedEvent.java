...
/**
 * This is a model class for TimelineReviewedEvent type.
 */
public class TimelineReviewedEvent {
    ...
    private TimelineReviewedEvent(
            ...
            @JsonProperty("_links") Links10 links,
    ...
    /**
     * Converts this TimelineReviewedEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TimelineReviewedEvent [" + "event=" + event + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link TimelineReviewedEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TimelineReviewedEvent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(event, id, nodeId, user, body, state, htmlUrl, pullRequestUrl,
                links, commitId, authorAssociation)
    ...
    /**
     * Class to build instances of {@link TimelineReviewedEvent}.
     */
    public static class Builder {
         ...
         * @param  authorAssociation  AuthorAssociationEnum value for authorAssociation.
         */
        public Builder(String event, int id, String nodeId, User2 user, String body, String state,
        ...
        /**
         * Builds a new {@link TimelineReviewedEvent} object using the set fields.
         * @return {@link TimelineReviewedEvent}
         */
        public TimelineReviewedEvent build() {
            return new TimelineReviewedEvent(event, id, nodeId, user, body, state, htmlUrl,
                    pullRequestUrl, links, commitId, authorAssociation, submittedAt, bodyHtml,
                    bodyText);
        }
    }
}
