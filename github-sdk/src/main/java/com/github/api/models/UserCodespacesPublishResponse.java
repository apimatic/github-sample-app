...
/**
 * This is a model class for UserCodespacesPublishResponse type.
 */
public class UserCodespacesPublishResponse {
    private int id;
    private String name;
     ...
     * Default constructor.
     */
    public UserCodespacesPublishResponse() {
    }
     ...
     */
    protected UserCodespacesPublishResponse(int id, String name, String environmentId, Owner1 owner,
            BillableOwner billableOwner, Repository16 repository, Object machine, Boolean prebuild,
    ...
    /**
     * Converts this UserCodespacesPublishResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "UserCodespacesPublishResponse [" + "id=" + id + ", name=" + name
    ...
    /**
     * Builds a new {@link UserCodespacesPublishResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UserCodespacesPublishResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UserCodespacesPublishResponse}.
     */
    public static class Builder {
        ...
        public Builder(int id, String name, String environmentId, Owner1 owner,
                BillableOwner billableOwner, Repository16 repository, Object machine,
        ...
        /**
         * Builds a new {@link UserCodespacesPublishResponse} object using the set fields.
         * @return {@link UserCodespacesPublishResponse}
         */
        public UserCodespacesPublishResponse build() {
            return new UserCodespacesPublishResponse(id, name, environmentId, owner, billableOwner,
                    repository, machine, prebuild, createdAt, updatedAt, lastUsedAt, state, url,
                    gitStatus, location, idleTimeoutMinutes, webUrl, machinesUrl, startUrl, stopUrl,
                    pullsUrl, recentFolders, displayName, devcontainerPath, publishUrl,
                    runtimeConstraints, pendingOperation, pendingOperationDisabledReason,
                    idleTimeoutNotice, retentionPeriodMinutes, retentionExpiresAt);
        }
    }
}
