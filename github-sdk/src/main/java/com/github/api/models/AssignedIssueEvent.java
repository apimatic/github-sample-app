...
/**
 * This is a model class for AssignedIssueEvent type.
 */
public class AssignedIssueEvent {
    ...
    public AssignedIssueEvent(
            ...
            @JsonProperty("assigner") Assigner assigner) {
        this.id = id;
        this.nodeId = nodeId;
        this.url = url;
        this.actor = actor;
    ...
    /**
     * Converts this AssignedIssueEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AssignedIssueEvent [" + "id=" + id + ", nodeId=" + nodeId + ", url=" + url
    ...
    /**
     * Builds a new {@link AssignedIssueEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AssignedIssueEvent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(id, nodeId, url, actor, event, commitId, commitUrl, createdAt,
                performedViaGithubApp, assignee, assigner);
        return builder;
    }

    /**
     * Class to build instances of {@link AssignedIssueEvent}.
     */
    public static class Builder {
        ...
        public Builder(int id, String nodeId, String url, Actor2 actor, String event,
                ...
                PerformedViaGithubApp performedViaGithubApp, Assignee assignee, Assigner assigner) {
            this.id = id;
            this.nodeId = nodeId;
            this.url = url;
            this.actor = actor;
        ...
        /**
         * Builds a new {@link AssignedIssueEvent} object using the set fields.
         * @return {@link AssignedIssueEvent}
         */
        public AssignedIssueEvent build() {
            return new AssignedIssueEvent(id, nodeId, url, actor, event, commitId, commitUrl,
                    createdAt, performedViaGithubApp, assignee, assigner);
        }
    }
}
