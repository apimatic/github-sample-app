...
import com.github.api.models.containers.PullRequest44Assignees;
import com.github.api.models.containers.PullRequest44RequestedReviewers;
import io.apimatic.core.types.BaseModel;
import java.util.List;

/**
 * This is a model class for PullRequest44 type.
 */
public class PullRequest44 {
    private Links2 links;
    private Object activeLockReason;
    private Object assignee;
    private List<PullRequest44Assignees> assignees;
    ...
    private List<PullRequest44RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest44Assignees value for assignees.
     * @param  authorAssociation  AuthorAssociationEnum value for authorAssociation.
     * @param  base  Base8 value for base.
     ...
     * @param  requestedReviewers  List of PullRequest44RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest44(
            ...
            Object assignee,
            List<PullRequest44Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest44RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest44Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest44Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest44Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest44Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Base.
     * @return Returns the Base8
     */
    @JsonGetter("base")
    public Base8 getBase() {
        return base;
    }

    /**
     * Setter for Base.
     * @param base Value for Base8
     */
    @JsonSetter("base")
    public void setBase(Base8 base) {
        this.base = base;
    }
     ...
     * @return Returns the List of PullRequest44RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest44RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest44RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest44RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest44 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest44 [" + "links=" + links + ", activeLockReason=" + activeLockReason
                + ", assignee=" + assignee + ", assignees=" + assignees + ", authorAssociation="
                + authorAssociation + ", base=" + base + ", body=" + body + ", closedAt=" + closedAt
                + ", commentsUrl=" + commentsUrl + ", commitsUrl=" + commitsUrl + ", createdAt="
                + createdAt + ", diffUrl=" + diffUrl + ", head=" + head + ", htmlUrl=" + htmlUrl
                + ", id=" + id + ", issueUrl=" + issueUrl + ", labels=" + labels + ", locked="
                + locked + ", mergeCommitSha=" + mergeCommitSha + ", mergedAt=" + mergedAt
                ...
                + ", user=" + user + ", autoMerge=" + autoMerge + ", draft=" + draft + "]";
    }

    /**
     * Builds a new {@link PullRequest44.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest44.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(links, activeLockReason, assignee, assignees,
                authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt,
                diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt,
                milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams,
                reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url,
                user)
    ...
    /**
     * Class to build instances of {@link PullRequest44}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<PullRequest44Assignees> assignees, AuthorAssociationEnum authorAssociation,
                Base8 base, String body, String closedAt, String commentsUrl, String commitsUrl,
                String createdAt, String diffUrl, Head12 head, String htmlUrl, int id,
                String issueUrl, List<Label10> labels, boolean locked, String mergeCommitSha,
                String mergedAt, Object milestone, String nodeId, int number, String patchUrl,
                List<PullRequest44RequestedReviewers> requestedReviewers,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest44Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder base(Base8 base) {
            this.base = base;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest44} object using the set fields.
         * @return {@link PullRequest44}
         */
        public PullRequest44 build() {
            return new PullRequest44(links, activeLockReason, assignee, assignees,
                    authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt,
                    diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt,
                    milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams,
                    reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url,
                    user, autoMerge, draft);
        }
    }
}
