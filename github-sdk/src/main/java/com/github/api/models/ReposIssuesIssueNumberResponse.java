...
import com.github.api.models.containers.ReposIssuesIssueNumberResponseLabels;
...
/**
 * This is a model class for ReposIssuesIssueNumberResponse type.
 */
public class ReposIssuesIssueNumberResponse {
    private int id;
    ...
    private Object user;
    private List<ReposIssuesIssueNumberResponseLabels> labels;
     ...
     * Default constructor.
     */
    public ReposIssuesIssueNumberResponse() {
    }
     ...
     * @param  labels  List of ReposIssuesIssueNumberResponseLabels value for labels.
    ...
    public ReposIssuesIssueNumberResponse(
            ...
            String title,
            Object user,
            List<ReposIssuesIssueNumberResponseLabels> labels,
            Object assignee,
            Object milestone,
            boolean locked,
            int comments,
     ...
     */
    protected ReposIssuesIssueNumberResponse(int id, String nodeId, String url,
            ...
            List<ReposIssuesIssueNumberResponseLabels> labels, Object assignee, Object milestone,
     ...
     * @return Returns the List of ReposIssuesIssueNumberResponseLabels
     */
    @JsonGetter("labels")
    public List<ReposIssuesIssueNumberResponseLabels> getLabels() {
        return labels;
    }
     ...
     * labels on this issue; send an empty array to clear all labels from the issue; note that the
     * labels are silently dropped for users without push access to the repository
     * @param labels Value for List of ReposIssuesIssueNumberResponseLabels
     */
    @JsonSetter("labels")
    public void setLabels(List<ReposIssuesIssueNumberResponseLabels> labels) {
        this.labels = labels;
    }
    ...
    /**
     * Converts this ReposIssuesIssueNumberResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposIssuesIssueNumberResponse [" + "id=" + id + ", nodeId=" + nodeId + ", url="
                + url + ", repositoryUrl=" + repositoryUrl + ", labelsUrl=" + labelsUrl
    ...
    /**
     * Builds a new {@link ReposIssuesIssueNumberResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposIssuesIssueNumberResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposIssuesIssueNumberResponse}.
     */
    public static class Builder {
        ...
        public Builder(int id, String nodeId, String url, String repositoryUrl, String labelsUrl,
                ...
                String title, Object user, List<ReposIssuesIssueNumberResponseLabels> labels,
                Object assignee, Object milestone, boolean locked, int comments,
         ...
         * @return Builder
         */
        public Builder labels(List<ReposIssuesIssueNumberResponseLabels> labels) {
            this.labels = labels;
            return this;
        }
        ...
        /**
         * Builds a new {@link ReposIssuesIssueNumberResponse} object using the set fields.
         * @return {@link ReposIssuesIssueNumberResponse}
         */
        public ReposIssuesIssueNumberResponse build() {
            return new ReposIssuesIssueNumberResponse(id, nodeId, url, repositoryUrl, labelsUrl,
                    commentsUrl, eventsUrl, htmlUrl, number, state, title, user, labels, assignee,
                    milestone, locked, comments, closedAt, createdAt, updatedAt, authorAssociation,
                    stateReason, body, assignees, activeLockReason, pullRequest, draft, closedBy,
                    bodyHtml, bodyText, timelineUrl, repository, performedViaGithubApp, reactions);
        }
    }
}
