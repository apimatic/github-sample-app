...
/**
 * This is a model class for WorkflowJob type.
 */
public class WorkflowJob {
    ...
    /**
     * Getter for Status.
     * @return Returns the Status21Enum
     */
    @JsonGetter("status")
    public Status21Enum getStatus() {
        return status;
    }

    /**
     * Setter for Status.
     * @param status Value for Status21Enum
     */
    @JsonSetter("status")
    public void setStatus(Status21Enum status) {
        this.status = status;
    }
    ...
    /**
     * Getter for Steps.
     * @return Returns the List of WorkflowStep
     */
    @JsonGetter("steps")
    ...
    /**
     * Setter for Steps.
     * @param steps Value for List of WorkflowStep
     */
    @JsonSetter("steps")
    ...
    /**
     * Converts this WorkflowJob into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WorkflowJob [" + "checkRunUrl=" + checkRunUrl + ", completedAt=" + completedAt
    ...
    /**
     * Builds a new {@link WorkflowJob.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WorkflowJob.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WorkflowJob}.
     */
    public static class Builder {
        ...
        public Builder(String checkRunUrl, String completedAt, Object conclusion, String headSha,
                ...
                Status21Enum status, String headBranch, String workflowName,
                List<WorkflowStep> steps, String url) {
            this.checkRunUrl = checkRunUrl;
            this.completedAt = completedAt;
            this.conclusion = conclusion;
            this.headSha = headSha;
         ...
         * @return Builder
         */
        public Builder status(Status21Enum status) {
            this.status = status;
            return this;
        }
        ...
        /**
         * Builds a new {@link WorkflowJob} object using the set fields.
         * @return {@link WorkflowJob}
         */
        public WorkflowJob build() {
            return new WorkflowJob(checkRunUrl, completedAt, conclusion, headSha, htmlUrl, id,
                    labels, name, nodeId, runAttempt, runId, runUrl, runnerGroupId, runnerGroupName,
                    runnerId, runnerName, startedAt, status, headBranch, workflowName, steps, url);
        }
    }
