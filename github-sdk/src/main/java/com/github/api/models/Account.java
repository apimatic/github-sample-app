...
public class Account {
     ...
     */
    protected Account(OptionalNullable<String> name, OptionalNullable<String> email, String login,
            ...
            String starredAt, OptionalNullable<String> description,
            OptionalNullable<String> websiteUrl, String slug,
    ...
    public String toString() {
        return "Account [" + "name=" + name + ", email=" + email + ", login=" + login + ", id=" + id
                + ", nodeId=" + nodeId + ", avatarUrl=" + avatarUrl + ", gravatarId=" + gravatarId
                + ", url=" + url + ", htmlUrl=" + htmlUrl + ", followersUrl=" + followersUrl
                + ", followingUrl=" + followingUrl + ", gistsUrl=" + gistsUrl + ", starredUrl="
                + starredUrl + ", subscriptionsUrl=" + subscriptionsUrl + ", organizationsUrl="
                + organizationsUrl + ", reposUrl=" + reposUrl + ", eventsUrl=" + eventsUrl
                + ", receivedEventsUrl=" + receivedEventsUrl + ", type=" + type + ", siteAdmin="
                + siteAdmin + ", starredAt=" + starredAt + ", description=" + description
                + ", websiteUrl=" + websiteUrl + ", slug=" + slug + ", createdAt=" + createdAt
                + ", updatedAt=" + updatedAt + "]";
    }
    ...
    public static class Builder {
        ...
        public Account build() {
            return new Account(name, email, login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    ...
                    starredAt, description, websiteUrl, slug, createdAt, updatedAt);
        }
    }
}
