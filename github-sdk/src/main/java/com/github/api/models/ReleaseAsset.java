...
/**
 * This is a model class for ReleaseAsset type.
 */
public class ReleaseAsset {
    ...
    /**
     * Converts this ReleaseAsset into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReleaseAsset [" + "url=" + url + ", browserDownloadUrl=" + browserDownloadUrl
                + ", id=" + id + ", nodeId=" + nodeId + ", name=" + name + ", label=" + label
                + ", state=" + state + ", contentType=" + contentType + ", size=" + size
                + ", downloadCount=" + downloadCount + ", createdAt=" + createdAt + ", updatedAt="
                + updatedAt + ", uploader=" + uploader + "]";
    }

    /**
     * Builds a new {@link ReleaseAsset.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReleaseAsset.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReleaseAsset}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReleaseAsset} object using the set fields.
         * @return {@link ReleaseAsset}
         */
        public ReleaseAsset build() {
            return new ReleaseAsset(url, browserDownloadUrl, id, nodeId, name, label, state,
                    contentType, size, downloadCount, createdAt, updatedAt, uploader);
        }
    }
}
