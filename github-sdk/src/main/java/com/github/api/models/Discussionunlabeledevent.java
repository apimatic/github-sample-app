...
/**
 * This is a model class for Discussionunlabeledevent type.
 */
public class Discussionunlabeledevent {
     ...
     * Default constructor.
     */
    public Discussionunlabeledevent() {
        action = "unlabeled";
    }
    ...
    /**
     * Converts this Discussionunlabeledevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Discussionunlabeledevent [" + "action=" + action + ", discussion=" + discussion
                + ", label=" + label + ", repository=" + repository + ", sender=" + sender
                + ", enterprise=" + enterprise + ", installation=" + installation
                + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Discussionunlabeledevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Discussionunlabeledevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, discussion, label, repository, sender)
    ...
    /**
     * Class to build instances of {@link Discussionunlabeledevent}.
     */
    public static class Builder {
        private String action = "unlabeled";
        private Discussion1 discussion;
        private Label10 label;
        private Repository3 repository;
        private Sender sender;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Discussion1 discussion, Label10 label, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.discussion = discussion;
            this.label = label;
        ...
        /**
         * Builds a new {@link Discussionunlabeledevent} object using the set fields.
         * @return {@link Discussionunlabeledevent}
         */
        public Discussionunlabeledevent build() {
            return new Discussionunlabeledevent(action, discussion, label, repository, sender,
