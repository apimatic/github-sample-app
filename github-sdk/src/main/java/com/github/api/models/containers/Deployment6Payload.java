 ...
 */
@JsonDeserialize(using = Deployment6Payload.Deployment6PayloadDeserializer.class)
public abstract class Deployment6Payload {
     ...
     */
    public static Deployment6Payload fromObject(Map<String, Object> object) {
     ...
     */
    public static Deployment6Payload fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Deployment6Payload {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends Deployment6Payload {
    ...
    /**
     * This is a custom deserializer class for Deployment6Payload.
     */
    protected static class Deployment6PayloadDeserializer
            extends JsonDeserializer<Deployment6Payload> {

        @Override
        public Deployment6Payload deserialize(JsonParser jp, DeserializationContext ctxt)
