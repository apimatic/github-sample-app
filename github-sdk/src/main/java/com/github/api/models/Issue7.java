...
import com.github.api.models.containers.Issue7Assignees;
...
/**
 * This is a model class for Issue7 type.
 */
public class Issue7 {
    private Object activeLockReason;
    private Object assignee;
    private List<Issue7Assignees> assignees;
     ...
     * @param  assignees  List of Issue7Assignees value for assignees.
    ...
    public Issue7(
            ...
            List<Issue7Assignees> assignees,
     ...
     */
    protected Issue7(Object activeLockReason, List<Issue7Assignees> assignees,
     ...
     * @return Returns the List of Issue7Assignees
     */
    @JsonGetter("assignees")
    public List<Issue7Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of Issue7Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<Issue7Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Converts this Issue7 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue7 [" + "activeLockReason=" + activeLockReason + ", assignees=" + assignees
    ...
    /**
     * Builds a new {@link Issue7.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue7.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Issue7}.
     */
    public static class Builder {
         ...
         * @param  user  Object value for user.
         */
        public Builder(Object activeLockReason, List<Issue7Assignees> assignees,
                AuthorAssociationEnum authorAssociation, String body, LocalDateTime closedAt,
                int comments, String commentsUrl, LocalDateTime createdAt, String eventsUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<Issue7Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue7} object using the set fields.
         * @return {@link Issue7}
         */
        public Issue7 build() {
            return new Issue7(activeLockReason, assignees, authorAssociation, body, closedAt,
