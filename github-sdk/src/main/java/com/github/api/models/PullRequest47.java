...
import com.github.api.models.containers.PullRequest47Assignees;
import com.github.api.models.containers.PullRequest47RequestedReviewers;
...
/**
 * This is a model class for PullRequest47 type.
 */
public class PullRequest47 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest47Assignees> assignees;
    ...
    private List<PullRequest47RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest47Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest47RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest47(
            ...
            Object assignee,
            List<PullRequest47Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest47RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest47(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest47Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            int number, String patchUrl, List<PullRequest47RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest47Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest47Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest47Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest47Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest47RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest47RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest47RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest47RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest47 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest47 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest47.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest47.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest47}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest47Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest47} object using the set fields.
         * @return {@link PullRequest47}
         */
        public PullRequest47 build() {
            return new PullRequest47(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
