...
/**
 * This is a model class for DeploymentWorkflowRun1 type.
 */
public class DeploymentWorkflowRun1 {
     ...
     */
    protected DeploymentWorkflowRun1(Object actor, int checkSuiteId, String checkSuiteNodeId,
            ...
            LocalDateTime updatedAt, String url, int workflowId, String artifactsUrl,
            String cancelUrl, String checkSuiteUrl, OptionalNullable<Object> headCommit,
            HeadRepository headRepository, String jobsUrl, String logsUrl,
            OptionalNullable<Object> previousAttemptUrl,
            OptionalNullable<List<ReferencedWorkflow1>> referencedWorkflows,
            HeadRepository repository, String rerunUrl, String workflowUrl) {
        this.actor = actor;
        this.artifactsUrl = artifactsUrl;
        this.cancelUrl = cancelUrl;
        this.checkSuiteId = checkSuiteId;
    ...
    /**
     * Converts this DeploymentWorkflowRun1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DeploymentWorkflowRun1 [" + "actor=" + actor + ", checkSuiteId=" + checkSuiteId
                ...
                + ", triggeringActor=" + triggeringActor + ", updatedAt=" + updatedAt + ", url="
                + url + ", workflowId=" + workflowId + ", artifactsUrl=" + artifactsUrl
                + ", cancelUrl=" + cancelUrl + ", checkSuiteUrl=" + checkSuiteUrl + ", headCommit="
                + headCommit + ", headRepository=" + headRepository + ", jobsUrl=" + jobsUrl
                + ", logsUrl=" + logsUrl + ", previousAttemptUrl=" + previousAttemptUrl
                + ", referencedWorkflows=" + referencedWorkflows + ", repository=" + repository
                + ", rerunUrl=" + rerunUrl + ", workflowUrl=" + workflowUrl + "]";
    }

    /**
     * Builds a new {@link DeploymentWorkflowRun1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DeploymentWorkflowRun1.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(actor, checkSuiteId, checkSuiteNodeId, conclusion, createdAt,
                ...
                pullRequests, runAttempt, runNumber, runStartedAt, status, triggeringActor,
                updatedAt, url, workflowId)
    ...
    /**
     * Class to build instances of {@link DeploymentWorkflowRun1}.
     */
    public static class Builder {
        ...
        public Builder(Object actor, int checkSuiteId, String checkSuiteNodeId, Object conclusion,
                ...
                LocalDateTime runStartedAt, Status17Enum status, Object triggeringActor,
                LocalDateTime updatedAt, String url, int workflowId) {
            this.actor = actor;
            this.checkSuiteId = checkSuiteId;
            this.checkSuiteNodeId = checkSuiteNodeId;
            this.conclusion = conclusion;
        ...
        /**
         * Builds a new {@link DeploymentWorkflowRun1} object using the set fields.
         * @return {@link DeploymentWorkflowRun1}
         */
        public DeploymentWorkflowRun1 build() {
            return new DeploymentWorkflowRun1(actor, checkSuiteId, checkSuiteNodeId, conclusion,
                    createdAt, displayTitle, event, headBranch, headSha, htmlUrl, id, name, nodeId,
                    path, pullRequests, runAttempt, runNumber, runStartedAt, status,
                    triggeringActor, updatedAt, url, workflowId, artifactsUrl, cancelUrl,
                    checkSuiteUrl, headCommit, headRepository, jobsUrl, logsUrl, previousAttemptUrl,
                    referencedWorkflows, repository, rerunUrl, workflowUrl);
        }
    }
}
