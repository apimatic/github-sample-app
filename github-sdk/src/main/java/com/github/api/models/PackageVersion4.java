...
/**
 * This is a model class for PackageVersion4 type.
 */
public class PackageVersion4 {
    ...
    private String name;
    private List<PackageFile3> packageFiles;
    private String packageUrl;
    private Boolean prerelease;
    private Release4 release;
     ...
     * @param  packageFiles  List of PackageFile3 value for packageFiles.
     ...
     * @param  release  Release4 value for release.
    ...
    public PackageVersion4(
            ...
            String name,
            List<PackageFile3> packageFiles,
            String packageUrl,
            String summary,
     ...
     * @return Returns the List of PackageFile3
     */
    @JsonGetter("package_files")
    public List<PackageFile3> getPackageFiles() {
        return packageFiles;
    }

    /**
     * Setter for PackageFiles.
     * @param packageFiles Value for List of PackageFile3
     */
    @JsonSetter("package_files")
    public void setPackageFiles(List<PackageFile3> packageFiles) {
        this.packageFiles = packageFiles;
    }
    ...
    /**
     * Getter for Release.
     * @return Returns the Release4
     */
    @JsonGetter("release")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Release4 getRelease() {
        return release;
    }

    /**
     * Setter for Release.
     * @param release Value for Release4
     */
    @JsonSetter("release")
    public void setRelease(Release4 release) {
        this.release = release;
    }
    ...
    /**
     * Converts this PackageVersion4 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PackageVersion4 [" + "author=" + author + ", body=" + body + ", bodyHtml="
                ...
                + ", packageFiles=" + packageFiles + ", packageUrl=" + packageUrl + ", summary="
                + summary + ", targetCommitish=" + targetCommitish + ", targetOid=" + targetOid
                + ", updatedAt=" + updatedAt + ", version=" + version + ", dockerMetadata="
                + dockerMetadata + ", draft=" + draft + ", manifest=" + manifest + ", prerelease="
                + prerelease + ", release=" + release + ", rubygemsMetadata=" + rubygemsMetadata
                + ", tagName=" + tagName + "]";
    }

    /**
     * Builds a new {@link PackageVersion4.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PackageVersion4.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(author, body, bodyHtml, createdAt, description, htmlUrl, id,
                installationCommand, metadata, name, packageFiles, packageUrl, summary,
                targetCommitish, targetOid, updatedAt, version)
    ...
    /**
     * Class to build instances of {@link PackageVersion4}.
     */
    public static class Builder {
         ...
         * @param  version  String value for version.
         */
        public Builder(Author6 author, String body, String bodyHtml, String createdAt,
                String description, String htmlUrl, int id, String installationCommand,
                List<Object> metadata, String name, List<PackageFile3> packageFiles,
                String packageUrl, String summary, String targetCommitish, String targetOid,
                String updatedAt, String version) {
            this.author = author;
            this.body = body;
            this.bodyHtml = bodyHtml;
            this.createdAt = createdAt;
         ...
         * @return Builder
         */
        public Builder packageFiles(List<PackageFile3> packageFiles) {
            this.packageFiles = packageFiles;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder release(Release4 release) {
            this.release = release;
            return this;
        }
        ...
        /**
         * Builds a new {@link PackageVersion4} object using the set fields.
         * @return {@link PackageVersion4}
         */
        public PackageVersion4 build() {
            return new PackageVersion4(author, body, bodyHtml, createdAt, description, htmlUrl, id,
                    installationCommand, metadata, name, packageFiles, packageUrl, summary,
                    targetCommitish, targetOid, updatedAt, version, dockerMetadata, draft, manifest,
                    prerelease, release, rubygemsMetadata, tagName);
        }
    }
}
