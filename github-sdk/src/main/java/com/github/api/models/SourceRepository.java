...
/**
 * This is a model class for SourceRepository type.
 */
public class SourceRepository {
     ...
     */
    protected SourceRepository(int id, String nodeId, String name, String fullName, Owner1 owner,
    ...
    /**
     * Converts this SourceRepository into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SourceRepository [" + "id=" + id + ", nodeId=" + nodeId + ", name=" + name
    ...
    /**
     * Builds a new {@link SourceRepository.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SourceRepository.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SourceRepository}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SourceRepository} object using the set fields.
         * @return {@link SourceRepository}
         */
        public SourceRepository build() {
            return new SourceRepository(id, nodeId, name, fullName, owner, mPrivate, htmlUrl,
                    description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl,
