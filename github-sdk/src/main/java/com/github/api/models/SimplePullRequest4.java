...
import com.github.api.models.containers.SimplePullRequest4Assignees;
import com.github.api.models.containers.SimplePullRequest4RequestedReviewers;
import io.apimatic.core.types.BaseModel;
import java.util.List;

/**
 * This is a model class for SimplePullRequest4 type.
 */
public class SimplePullRequest4 {
    private Links2 links;
    private Object activeLockReason;
    private Object assignee;
    private List<SimplePullRequest4Assignees> assignees;
    ...
    private List<SimplePullRequest4RequestedReviewers> requestedReviewers;
     ...
     * @param  head  Head34 value for head.
     ...
     * @param  requestedReviewers  List of SimplePullRequest4RequestedReviewers value for
     *         requestedReviewers.
    ...
    public SimplePullRequest4(
            ...
            Object assignee,
            List<SimplePullRequest4Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<SimplePullRequest4RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of SimplePullRequest4Assignees
     */
    @JsonGetter("assignees")
    public List<SimplePullRequest4Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of SimplePullRequest4Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<SimplePullRequest4Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Base.
     * @return Returns the Base34
     */
    @JsonGetter("base")
    public Base34 getBase() {
        return base;
    }

    /**
     * Setter for Base.
     * @param base Value for Base34
     */
    @JsonSetter("base")
    public void setBase(Base34 base) {
        this.base = base;
    }
    ...
    /**
     * Getter for Head.
     * @return Returns the Head34
     */
    @JsonGetter("head")
    public Head34 getHead() {
        return head;
    }

    /**
     * Setter for Head.
     * @param head Value for Head34
     */
    @JsonSetter("head")
    public void setHead(Head34 head) {
        this.head = head;
    }
     ...
     * @return Returns the List of SimplePullRequest4RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<SimplePullRequest4RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of SimplePullRequest4RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<SimplePullRequest4RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this SimplePullRequest4 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SimplePullRequest4 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link SimplePullRequest4.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SimplePullRequest4.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SimplePullRequest4}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<SimplePullRequest4Assignees> assignees,
                AuthorAssociationEnum authorAssociation, Object autoMerge, Base34 base, String body,
                String closedAt, String commentsUrl, String commitsUrl, String createdAt,
                String diffUrl, boolean draft, Head34 head, String htmlUrl, int id, String issueUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<SimplePullRequest4Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder base(Base34 base) {
            this.base = base;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder head(Head34 head) {
            this.head = head;
            return this;
        }
        ...
        /**
         * Builds a new {@link SimplePullRequest4} object using the set fields.
         * @return {@link SimplePullRequest4}
         */
        public SimplePullRequest4 build() {
            return new SimplePullRequest4(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
