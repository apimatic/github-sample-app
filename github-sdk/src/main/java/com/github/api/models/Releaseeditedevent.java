...
/**
 * This is a model class for Releaseeditedevent type.
 */
public class Releaseeditedevent {
    private String action;
    private Changes28 changes;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private Organization2 organization;
    private Release9 release;
     ...
     * @param  changes  Changes28 value for changes.
     * @param  release  Release9 value for release.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes28
     */
    @JsonGetter("changes")
    public Changes28 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes28
     */
    @JsonSetter("changes")
    public void setChanges(Changes28 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Getter for Release.
     * @return Returns the Release9
     */
    @JsonGetter("release")
    public Release9 getRelease() {
        return release;
    }

    /**
     * Setter for Release.
     * @param release Value for Release9
     */
    @JsonSetter("release")
    public void setRelease(Release9 release) {
        this.release = release;
    }
    ...
    /**
     * Converts this Releaseeditedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Releaseeditedevent [" + "action=" + action + ", changes=" + changes + ", release="
                + release + ", repository=" + repository + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + ", sender="
                + sender + "]";
    }

    /**
     * Builds a new {@link Releaseeditedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Releaseeditedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, changes, release, repository)
    ...
    /**
     * Class to build instances of {@link Releaseeditedevent}.
     */
    public static class Builder {
         ...
         * @param  repository  Repository3 value for repository.
         */
        public Builder(String action, Changes28 changes, Release9 release, Repository3 repository) {
            this.action = action;
            this.changes = changes;
            this.release = release;
            this.repository = repository;
         ...
         * @return Builder
         */
        public Builder changes(Changes28 changes) {
            this.changes = changes;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder release(Release9 release) {
            this.release = release;
            return this;
        }
        ...
        /**
         * Builds a new {@link Releaseeditedevent} object using the set fields.
         * @return {@link Releaseeditedevent}
         */
        public Releaseeditedevent build() {
            return new Releaseeditedevent(action, changes, release, repository, enterprise,
                    installation, organization, sender);
        }
    }
}
