...
public class Package {
    ...
    public String toString() {
        return "Package [" + "id=" + id + ", name=" + name + ", packageType=" + packageType
                + ", url=" + url + ", htmlUrl=" + htmlUrl + ", versionCount=" + versionCount
                + ", visibility=" + visibility + ", createdAt=" + createdAt + ", updatedAt="
                + updatedAt + ", owner=" + owner + ", repository=" + repository + "]";
    }
    ...
    public static class Builder {
        ...
        public Package build() {
            return new Package(id, name, packageType, url, htmlUrl, versionCount, visibility,
                    createdAt, updatedAt, owner, repository);
        }
    }
}
