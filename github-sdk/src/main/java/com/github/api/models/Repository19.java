...
import com.github.api.models.containers.Repository19CreatedAt;
import com.github.api.models.containers.Repository19PushedAt;
...
/**
 * This is a model class for Repository19 type.
 */
public class Repository19 {
    ...
    private Repository19CreatedAt createdAt;
    ...
    private Repository19PushedAt pushedAt;
    private String releasesUrl;
    private OptionalNullable<String> roleName;
    private int size;
    private SquashMergeCommitMessage12Enum squashMergeCommitMessage;
    private SquashMergeCommitTitle12Enum squashMergeCommitTitle;
     ...
     * @param  createdAt  Repository19CreatedAt value for createdAt.
     ...
     * @param  pushedAt  Repository19PushedAt value for pushedAt.
     ...
     * @param  squashMergeCommitMessage  SquashMergeCommitMessage12Enum value for
     *         squashMergeCommitMessage.
     * @param  squashMergeCommitTitle  SquashMergeCommitTitle12Enum value for
    ...
    public Repository19(
            ...
            Repository19CreatedAt createdAt,
            ...
            Boolean mPublic,
            String roleName,
            SquashMergeCommitMessage12Enum squashMergeCommitMessage,
            SquashMergeCommitTitle12Enum squashMergeCommitTitle,
            Integer stargazers,
     ...
     */
    protected Repository19(String archiveUrl, boolean archived, String assigneesUrl,
            ...
            String contributorsUrl, Repository19CreatedAt createdAt, String defaultBranch,
            ...
            boolean hasWiki, String homepage, String hooksUrl, String htmlUrl, int id,
            ...
            boolean mPrivate, String pullsUrl, Repository19PushedAt pushedAt, String releasesUrl,
            ...
            SquashMergeCommitMessage12Enum squashMergeCommitMessage,
            SquashMergeCommitTitle12Enum squashMergeCommitTitle, Integer stargazers,
     ...
     * @return Returns the Repository19CreatedAt
     */
    @JsonGetter("created_at")
    public Repository19CreatedAt getCreatedAt() {
        return createdAt;
    }

    /**
     * Setter for CreatedAt.
     * @param createdAt Value for Repository19CreatedAt
     */
    @JsonSetter("created_at")
    public void setCreatedAt(Repository19CreatedAt createdAt) {
        this.createdAt = createdAt;
    }
    ...
    /**
     * Getter for PushedAt.
     * @return Returns the Repository19PushedAt
     */
    @JsonGetter("pushed_at")
    public Repository19PushedAt getPushedAt() {
        return pushedAt;
    }

    /**
     * Setter for PushedAt.
     * @param pushedAt Value for Repository19PushedAt
     */
    @JsonSetter("pushed_at")
    public void setPushedAt(Repository19PushedAt pushedAt) {
        this.pushedAt = pushedAt;
    }
     ...
     * @return Returns the SquashMergeCommitMessage12Enum
     */
    @JsonGetter("squash_merge_commit_message")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SquashMergeCommitMessage12Enum getSquashMergeCommitMessage() {
        return squashMergeCommitMessage;
    }

    /**
     * Setter for SquashMergeCommitMessage.
     * @param squashMergeCommitMessage Value for SquashMergeCommitMessage12Enum
     */
    @JsonSetter("squash_merge_commit_message")
    public void setSquashMergeCommitMessage(SquashMergeCommitMessage12Enum squashMergeCommitMessage) {
        this.squashMergeCommitMessage = squashMergeCommitMessage;
    }

    /**
     * Getter for SquashMergeCommitTitle.
     * @return Returns the SquashMergeCommitTitle12Enum
     */
    @JsonGetter("squash_merge_commit_title")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SquashMergeCommitTitle12Enum getSquashMergeCommitTitle() {
        return squashMergeCommitTitle;
    }

    /**
     * Setter for SquashMergeCommitTitle.
     * @param squashMergeCommitTitle Value for SquashMergeCommitTitle12Enum
     */
    @JsonSetter("squash_merge_commit_title")
    public void setSquashMergeCommitTitle(SquashMergeCommitTitle12Enum squashMergeCommitTitle) {
        this.squashMergeCommitTitle = squashMergeCommitTitle;
    }
    ...
    /**
     * Converts this Repository19 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repository19 [" + "archiveUrl=" + archiveUrl + ", archived=" + archived
                ...
                + hasPages + ", hasProjects=" + hasProjects + ", hasWiki=" + hasWiki + ", homepage="
                + homepage + ", hooksUrl=" + hooksUrl + ", htmlUrl=" + htmlUrl + ", id=" + id
                + ", issueCommentUrl=" + issueCommentUrl + ", issueEventsUrl=" + issueEventsUrl
                + ", issuesUrl=" + issuesUrl + ", keysUrl=" + keysUrl + ", labelsUrl=" + labelsUrl
                + ", language=" + language + ", languagesUrl=" + languagesUrl + ", license="
                + license + ", mergesUrl=" + mergesUrl + ", milestonesUrl=" + milestonesUrl
                + ", mirrorUrl=" + mirrorUrl + ", name=" + name + ", nodeId=" + nodeId
                + ", notificationsUrl=" + notificationsUrl + ", openIssues=" + openIssues
                + ", openIssuesCount=" + openIssuesCount + ", owner=" + owner + ", mPrivate="
                + mPrivate + ", pullsUrl=" + pullsUrl + ", pushedAt=" + pushedAt + ", releasesUrl="
                + releasesUrl + ", size=" + size + ", sshUrl=" + sshUrl + ", stargazersCount="
                + stargazersCount + ", stargazersUrl=" + stargazersUrl + ", statusesUrl="
                + statusesUrl + ", subscribersUrl=" + subscribersUrl + ", subscriptionUrl="
                + subscriptionUrl + ", svnUrl=" + svnUrl + ", tagsUrl=" + tagsUrl + ", teamsUrl="
                + teamsUrl + ", topics=" + topics + ", treesUrl=" + treesUrl + ", updatedAt="
                + updatedAt + ", url=" + url + ", visibility=" + visibility + ", watchers="
                + watchers + ", watchersCount=" + watchersCount + ", allowAutoMerge="
                + allowAutoMerge + ", allowForking=" + allowForking + ", allowMergeCommit="
                + allowMergeCommit + ", allowRebaseMerge=" + allowRebaseMerge
                + ", allowSquashMerge=" + allowSquashMerge + ", allowUpdateBranch="
                + allowUpdateBranch + ", deleteBranchOnMerge=" + deleteBranchOnMerge + ", disabled="
                + disabled + ", isTemplate=" + isTemplate + ", masterBranch=" + masterBranch
    ...
    /**
     * Builds a new {@link Repository19.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repository19.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl,
                ...
                hasWiki, homepage, hooksUrl, htmlUrl, id, issueCommentUrl, issueEventsUrl,
                issuesUrl, keysUrl, labelsUrl, language, languagesUrl, license, mergesUrl,
                milestonesUrl, mirrorUrl, name, nodeId, notificationsUrl, openIssues,
    ...
    /**
     * Class to build instances of {@link Repository19}.
     */
    public static class Builder {
        ...
        public Builder(String archiveUrl, boolean archived, String assigneesUrl, String blobsUrl,
                ...
                Repository19CreatedAt createdAt, String defaultBranch, String deploymentsUrl,
                ...
                String homepage, String hooksUrl, String htmlUrl, int id, String issueCommentUrl,
                String issueEventsUrl, String issuesUrl, String keysUrl, String labelsUrl,
                String language, String languagesUrl, Object license, String mergesUrl,
                String milestonesUrl, String mirrorUrl, String name, String nodeId,
                String notificationsUrl, int openIssues, int openIssuesCount, Object owner,
                boolean mPrivate, String pullsUrl, Repository19PushedAt pushedAt,
         ...
         * @return Builder
         */
        public Builder createdAt(Repository19CreatedAt createdAt) {
            this.createdAt = createdAt;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder pushedAt(Repository19PushedAt pushedAt) {
            this.pushedAt = pushedAt;
            return this;
        }
        ...
        /**
         * Builds a new {@link Repository19} object using the set fields.
         * @return {@link Repository19}
         */
        public Repository19 build() {
            return new Repository19(archiveUrl, archived, assigneesUrl, blobsUrl, branchesUrl,
                    cloneUrl, collaboratorsUrl, commentsUrl, commitsUrl, compareUrl, contentsUrl,
                    contributorsUrl, createdAt, defaultBranch, deploymentsUrl, description,
                    ...
                    hasPages, hasProjects, hasWiki, homepage, hooksUrl, htmlUrl, id,
