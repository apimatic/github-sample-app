 ...
 */
@JsonDeserialize(using = Issue12Assignees.Issue12AssigneesDeserializer.class)
public abstract class Issue12Assignees {
     ...
     */
    public static Issue12Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue12Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue12Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends Issue12Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue12Assignees.
     */
    protected static class Issue12AssigneesDeserializer
            extends JsonDeserializer<Issue12Assignees> {

        @Override
        public Issue12Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
