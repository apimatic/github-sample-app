 ...
 */
@JsonDeserialize(using = NpmMetadata1Directories.NpmMetadata1DirectoriesDeserializer.class)
public abstract class NpmMetadata1Directories {
     ...
     */
    public static NpmMetadata1Directories fromMString(String mString) {
     ...
     */
    public static NpmMetadata1Directories fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends NpmMetadata1Directories {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends NpmMetadata1Directories {
    ...
    /**
     * This is a custom deserializer class for NpmMetadata1Directories.
     */
    protected static class NpmMetadata1DirectoriesDeserializer
            extends JsonDeserializer<NpmMetadata1Directories> {

        @Override
        public NpmMetadata1Directories deserialize(JsonParser jp, DeserializationContext ctxt)
