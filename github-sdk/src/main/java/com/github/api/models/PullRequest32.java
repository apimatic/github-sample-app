...
import com.github.api.models.containers.PullRequest32Assignees;
import com.github.api.models.containers.PullRequest32RequestedReviewers;
...
/**
 * This is a model class for PullRequest32 type.
 */
public class PullRequest32 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest32Assignees> assignees;
    ...
    private List<PullRequest32RequestedReviewers> requestedReviewers;
     ...
     * @param  merged  String value for merged.
     ...
     * @param  requestedReviewers  List of PullRequest32RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest32(
            ...
            Object assignee,
            List<PullRequest32Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest32RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest32(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest32Assignees> assignees, AuthorAssociationEnum authorAssociation,
            Object autoMerge, Base12 base, String body, LocalDateTime closedAt, String commentsUrl,
            String commitsUrl, LocalDateTime createdAt, String diffUrl, boolean draft, Head12 head,
            String htmlUrl, int id, String issueUrl, List<Label10> labels, boolean locked,
            String mergeCommitSha, String merged, LocalDateTime mergedAt, Object mergedBy,
            Object milestone, String nodeId, int number, String patchUrl,
            List<PullRequest32RequestedReviewers> requestedReviewers, List<Team4> requestedTeams,
            String reviewCommentUrl, String reviewCommentsUrl, State13Enum state,
            String statusesUrl, String title, LocalDateTime updatedAt, String url, Object user,
            Integer additions, Integer changedFiles, Integer comments, Integer commits,
            Integer deletions, Boolean maintainerCanModify, OptionalNullable<Boolean> mergeable,
            String mergeableState, OptionalNullable<Boolean> rebaseable, Integer reviewComments) {
        this.links = links;
        this.activeLockReason = activeLockReason;
        this.additions = additions;
        this.assignee = assignee;
     ...
     * @return Returns the List of PullRequest32Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest32Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest32Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest32Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Base.
     * @return Returns the Base12
     */
    @JsonGetter("base")
    public Base12 getBase() {
        return base;
    }

    /**
     * Setter for Base.
     * @param base Value for Base12
     */
    @JsonSetter("base")
    public void setBase(Base12 base) {
        this.base = base;
    }
    ...
    /**
     * Setter for Merged.
     * @param merged Value for String
     */
    @JsonSetter("merged")
    private void setMerged(String merged) {
        this.merged = merged;
    }
     ...
     * @return Returns the List of PullRequest32RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest32RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest32RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest32RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest32 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest32 [" + "links=" + links + ", activeLockReason=" + activeLockReason
                ...
                + mergeCommitSha + ", merged=" + merged + ", mergedAt=" + mergedAt + ", mergedBy="
                + mergedBy + ", milestone=" + milestone + ", nodeId=" + nodeId + ", number="
                + number + ", patchUrl=" + patchUrl + ", requestedReviewers=" + requestedReviewers
                + ", requestedTeams=" + requestedTeams + ", reviewCommentUrl=" + reviewCommentUrl
                + ", reviewCommentsUrl=" + reviewCommentsUrl + ", state=" + state + ", statusesUrl="
                + statusesUrl + ", title=" + title + ", updatedAt=" + updatedAt + ", url=" + url
                + ", user=" + user + ", additions=" + additions + ", changedFiles=" + changedFiles
                + ", comments=" + comments + ", commits=" + commits + ", deletions=" + deletions
                + ", maintainerCanModify=" + maintainerCanModify + ", mergeable=" + mergeable
                + ", mergeableState=" + mergeableState + ", rebaseable=" + rebaseable
                + ", reviewComments=" + reviewComments + "]";
    }

    /**
     * Builds a new {@link PullRequest32.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest32.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(links, activeLockReason, assignee, assignees,
                ...
                mergeCommitSha, merged, mergedAt, mergedBy, milestone, nodeId, number, patchUrl,
    ...
    /**
     * Class to build instances of {@link PullRequest32}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<PullRequest32Assignees> assignees, AuthorAssociationEnum authorAssociation,
                Object autoMerge, Base12 base, String body, LocalDateTime closedAt,
                String commentsUrl, String commitsUrl, LocalDateTime createdAt, String diffUrl,
                boolean draft, Head12 head, String htmlUrl, int id, String issueUrl,
                List<Label10> labels, boolean locked, String mergeCommitSha, String merged,
                LocalDateTime mergedAt, Object mergedBy, Object milestone, String nodeId,
                int number, String patchUrl,
                List<PullRequest32RequestedReviewers> requestedReviewers,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest32Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder base(Base12 base) {
            this.base = base;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder merged(String merged) {
            this.merged = merged;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest32} object using the set fields.
         * @return {@link PullRequest32}
         */
        public PullRequest32 build() {
            return new PullRequest32(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
                    mergeCommitSha, merged, mergedAt, mergedBy, milestone, nodeId, number, patchUrl,
                    requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state,
                    statusesUrl, title, updatedAt, url, user, additions, changedFiles, comments,
                    commits, deletions, maintainerCanModify, mergeable, mergeableState, rebaseable,
                    reviewComments);
        }
    }
}
