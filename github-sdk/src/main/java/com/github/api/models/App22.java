...
/**
 * This is a model class for App22 type.
 */
public class App22 {
    private int id;
    private String slug;
     ...
     */
    protected App22(int id, String nodeId, Object owner, String name, String description,
    ...
    /**
     * Converts this App22 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "App22 [" + "id=" + id + ", nodeId=" + nodeId + ", owner=" + owner + ", name=" + name
                + ", description=" + description + ", externalUrl=" + externalUrl + ", htmlUrl="
    ...
    /**
     * Builds a new {@link App22.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link App22.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link App22}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link App22} object using the set fields.
         * @return {@link App22}
         */
        public App22 build() {
            return new App22(id, nodeId, owner, name, description, externalUrl, htmlUrl, createdAt,
                    updatedAt, permissions, events, slug, installationsCount, clientId,
