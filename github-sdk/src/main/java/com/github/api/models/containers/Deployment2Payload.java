 ...
 */
@JsonDeserialize(using = Deployment2Payload.Deployment2PayloadDeserializer.class)
public abstract class Deployment2Payload {
     ...
     */
    public static Deployment2Payload fromObject(Map<String, Object> object) {
     ...
     */
    public static Deployment2Payload fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Deployment2Payload {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends Deployment2Payload {
    ...
    /**
     * This is a custom deserializer class for Deployment2Payload.
     */
    protected static class Deployment2PayloadDeserializer
            extends JsonDeserializer<Deployment2Payload> {

        @Override
        public Deployment2Payload deserialize(JsonParser jp, DeserializationContext ctxt)
