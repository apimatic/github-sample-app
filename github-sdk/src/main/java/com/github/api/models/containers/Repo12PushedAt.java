 ...
 */
@JsonDeserialize(using = Repo12PushedAt.Repo12PushedAtDeserializer.class)
public abstract class Repo12PushedAt {
     ...
     */
    public static Repo12PushedAt fromNumber(int number) {
     ...
     */
    public static Repo12PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo12PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo12PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo12PushedAt.
     */
    protected static class Repo12PushedAtDeserializer
            extends JsonDeserializer<Repo12PushedAt> {

        @Override
        public Repo12PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
