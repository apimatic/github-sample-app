...
/**
 * This is a model class for Dependency3 type.
 */
public class Dependency3 {
    ...
    /**
     * Converts this Dependency3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Dependency3 [" + "mPackage=" + mPackage + ", manifestPath=" + manifestPath
                + ", scope=" + scope + "]";
    }

    /**
     * Builds a new {@link Dependency3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Dependency3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Dependency3}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Dependency3} object using the set fields.
         * @return {@link Dependency3}
         */
        public Dependency3 build() {
            return new Dependency3(mPackage, manifestPath, scope);
        }
    }
}
