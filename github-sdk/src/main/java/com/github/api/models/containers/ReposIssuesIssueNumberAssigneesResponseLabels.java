 ...
 */
@JsonDeserialize(using = ReposIssuesIssueNumberAssigneesResponseLabels.ReposIssuesIssueNumberAssigneesResponseLabelsDeserializer.class)
public abstract class ReposIssuesIssueNumberAssigneesResponseLabels {
     ...
     */
    public static ReposIssuesIssueNumberAssigneesResponseLabels fromMString(String mString) {
     ...
     */
    public static ReposIssuesIssueNumberAssigneesResponseLabels fromLabel2(Label2 label2) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposIssuesIssueNumberAssigneesResponseLabels {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Label2Case extends ReposIssuesIssueNumberAssigneesResponseLabels {
    ...
    /**
     * This is a custom deserializer class for ReposIssuesIssueNumberAssigneesResponseLabels.
     */
    protected static class ReposIssuesIssueNumberAssigneesResponseLabelsDeserializer
            extends JsonDeserializer<ReposIssuesIssueNumberAssigneesResponseLabels> {

        @Override
        public ReposIssuesIssueNumberAssigneesResponseLabels deserialize(JsonParser jp, DeserializationContext ctxt)
