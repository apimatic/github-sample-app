...
/**
 * This is a model class for WorkflowJobqueuedevent type.
 */
public class WorkflowJobqueuedevent {
    ...
    private WorkflowJob2 workflowJob;
    private Deployment6 deployment;

    /**
     * Default constructor.
     */
    public WorkflowJobqueuedevent() {
        action = "queued";
    }
     ...
     * @param  workflowJob  WorkflowJob2 value for workflowJob.
     ...
     * @return Returns the WorkflowJob2
     */
    @JsonGetter("workflow_job")
    public WorkflowJob2 getWorkflowJob() {
        return workflowJob;
    }

    /**
     * Setter for WorkflowJob.
     * @param workflowJob Value for WorkflowJob2
     */
    @JsonSetter("workflow_job")
    public void setWorkflowJob(WorkflowJob2 workflowJob) {
        this.workflowJob = workflowJob;
    }
    ...
    /**
     * Converts this WorkflowJobqueuedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WorkflowJobqueuedevent [" + "action=" + action + ", repository=" + repository
    ...
    /**
     * Builds a new {@link WorkflowJobqueuedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WorkflowJobqueuedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link WorkflowJobqueuedevent}.
     */
    public static class Builder {
        private String action = "queued";
        private Repository3 repository;
        private Sender sender;
        private WorkflowJob2 workflowJob;
        private Enterprise1 enterprise;
         ...
         * @return Builder
         */
        public Builder workflowJob(WorkflowJob2 workflowJob) {
            this.workflowJob = workflowJob;
            return this;
        }
        ...
        /**
         * Builds a new {@link WorkflowJobqueuedevent} object using the set fields.
         * @return {@link WorkflowJobqueuedevent}
         */
        public WorkflowJobqueuedevent build() {
            return new WorkflowJobqueuedevent(action, repository, sender, workflowJob, enterprise,
