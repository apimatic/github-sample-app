 ...
 */
@JsonDeserialize(using = ForkeeCreatedAt.ForkeeCreatedAtDeserializer.class)
public abstract class ForkeeCreatedAt {
     ...
     */
    public static ForkeeCreatedAt fromNumber(int number) {
     ...
     */
    public static ForkeeCreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ForkeeCreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends ForkeeCreatedAt {
    ...
    /**
     * This is a custom deserializer class for ForkeeCreatedAt.
     */
    protected static class ForkeeCreatedAtDeserializer
            extends JsonDeserializer<ForkeeCreatedAt> {

        @Override
        public ForkeeCreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
