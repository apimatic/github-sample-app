...
/**
 * This is a model class for Projectsv2ItemConvertedEvent type.
 */
public class Projectsv2ItemConvertedEvent {
    private String action;
    private Changes21 changes;
     ...
     * Default constructor.
     */
    public Projectsv2ItemConvertedEvent() {
        action = "converted";
    }
     ...
     * @param  changes  Changes21 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes21
     */
    @JsonGetter("changes")
    public Changes21 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes21
     */
    @JsonSetter("changes")
    public void setChanges(Changes21 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Projectsv2ItemConvertedEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Projectsv2ItemConvertedEvent [" + "action=" + action + ", changes=" + changes
                + ", organization=" + organization + ", projectsV2Item=" + projectsV2Item
                + ", sender=" + sender + ", installation=" + installation + "]";
    }

    /**
     * Builds a new {@link Projectsv2ItemConvertedEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Projectsv2ItemConvertedEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Projectsv2ItemConvertedEvent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes21 changes, Organization2 organization,
         ...
         * @return Builder
         */
        public Builder changes(Changes21 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Projectsv2ItemConvertedEvent} object using the set fields.
         * @return {@link Projectsv2ItemConvertedEvent}
         */
        public Projectsv2ItemConvertedEvent build() {
            return new Projectsv2ItemConvertedEvent(action, changes, organization, projectsV2Item,
                    sender, installation);
        }
    }
}
