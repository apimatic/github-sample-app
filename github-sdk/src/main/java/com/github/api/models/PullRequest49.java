...
import com.github.api.models.containers.PullRequest49Assignees;
import com.github.api.models.containers.PullRequest49RequestedReviewers;
...
/**
 * This is a model class for PullRequest49 type.
 */
public class PullRequest49 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest49Assignees> assignees;
    ...
    private List<PullRequest49RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest49Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest49RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest49(
            ...
            Object assignee,
            List<PullRequest49Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest49RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest49(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest49Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            int number, String patchUrl, List<PullRequest49RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest49Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest49Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest49Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest49Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest49RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest49RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest49RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest49RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest49 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest49 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest49.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest49.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest49}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest49Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest49} object using the set fields.
         * @return {@link PullRequest49}
         */
        public PullRequest49 build() {
            return new PullRequest49(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
