...
/**
 * This is a model class for TeamaddedToRepositoryevent type.
 */
public class TeamaddedToRepositoryevent {
     ...
     * Default constructor.
     */
    public TeamaddedToRepositoryevent() {
    ...
    /**
     * Converts this TeamaddedToRepositoryevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TeamaddedToRepositoryevent [" + "action=" + action + ", organization="
                + organization + ", team=" + team + ", enterprise=" + enterprise + ", installation="
                + installation + ", repository=" + repository + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link TeamaddedToRepositoryevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TeamaddedToRepositoryevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, organization, team)
    ...
    /**
     * Class to build instances of {@link TeamaddedToRepositoryevent}.
     */
    public static class Builder {
        private String action = "added_to_repository";
        private Organization2 organization;
        private Team2 team;
        private Enterprise1 enterprise;
        private Installation1 installation;
         ...
         * @param  team  Team2 value for team.
         */
        public Builder(String action, Organization2 organization, Team2 team) {
            this.action = action;
            this.organization = organization;
            this.team = team;
        }
        ...
        /**
         * Builds a new {@link TeamaddedToRepositoryevent} object using the set fields.
         * @return {@link TeamaddedToRepositoryevent}
         */
        public TeamaddedToRepositoryevent build() {
            return new TeamaddedToRepositoryevent(action, organization, team, enterprise,
