 ...
 */
@JsonDeserialize(using = Repository43PushedAt.Repository43PushedAtDeserializer.class)
public abstract class Repository43PushedAt {
     ...
     */
    public static Repository43PushedAt fromNumber(int number) {
     ...
     */
    public static Repository43PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repository43PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository43PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository43PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repository43PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository43PushedAt.
     */
    protected static class Repository43PushedAtDeserializer
            extends JsonDeserializer<Repository43PushedAt> {

        @Override
        public Repository43PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
