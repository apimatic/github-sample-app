...
/**
 * This is a model class for CheckSuite type.
 */
public class CheckSuite {
    ...
    /**
     * Converts this CheckSuite into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CheckSuite [" + "id=" + id + ", nodeId=" + nodeId + ", headBranch=" + headBranch
                + ", headSha=" + headSha + ", status=" + status + ", conclusion=" + conclusion
                + ", url=" + url + ", before=" + before + ", after=" + after + ", pullRequests="
                + pullRequests + ", app=" + app + ", repository=" + repository + ", createdAt="
                + createdAt + ", updatedAt=" + updatedAt + ", headCommit=" + headCommit
                + ", latestCheckRunsCount=" + latestCheckRunsCount + ", checkRunsUrl="
                + checkRunsUrl + ", rerequestable=" + rerequestable + ", runsRerequestable="
                + runsRerequestable + "]";
    }

    /**
     * Builds a new {@link CheckSuite.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CheckSuite.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CheckSuite}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CheckSuite} object using the set fields.
         * @return {@link CheckSuite}
         */
        public CheckSuite build() {
            return new CheckSuite(id, nodeId, headBranch, headSha, status, conclusion, url, before,
                    after, pullRequests, app, repository, createdAt, updatedAt, headCommit,
                    latestCheckRunsCount, checkRunsUrl, rerequestable, runsRerequestable);
        }
    }
}
