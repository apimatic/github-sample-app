...
/**
 * This is a model class for Repositorytransferredevent type.
 */
public class Repositorytransferredevent {
    private String action;
    private Changes31 changes;
     ...
     * Default constructor.
     */
    public Repositorytransferredevent() {
        action = "transferred";
    }
     ...
     * @param  changes  Changes31 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes31
     */
    @JsonGetter("changes")
    public Changes31 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes31
     */
    @JsonSetter("changes")
    public void setChanges(Changes31 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Repositorytransferredevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repositorytransferredevent [" + "action=" + action + ", changes=" + changes
                + ", repository=" + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Repositorytransferredevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repositorytransferredevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, changes, repository, sender)
    ...
    /**
     * Class to build instances of {@link Repositorytransferredevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes31 changes, Repository3 repository, Sender sender) {
            this.action = action;
            this.changes = changes;
            this.repository = repository;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder changes(Changes31 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Repositorytransferredevent} object using the set fields.
         * @return {@link Repositorytransferredevent}
         */
        public Repositorytransferredevent build() {
            return new Repositorytransferredevent(action, changes, repository, sender, enterprise,
