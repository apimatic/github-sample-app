 ...
 */
@JsonDeserialize(using = Repo18PushedAt.Repo18PushedAtDeserializer.class)
public abstract class Repo18PushedAt {
     ...
     */
    public static Repo18PushedAt fromNumber(int number) {
     ...
     */
    public static Repo18PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repo18PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo18PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo18PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repo18PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo18PushedAt.
     */
    protected static class Repo18PushedAtDeserializer
            extends JsonDeserializer<Repo18PushedAt> {

        @Override
        public Repo18PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
