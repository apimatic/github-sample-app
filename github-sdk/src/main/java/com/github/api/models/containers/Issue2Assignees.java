 ...
 */
@JsonDeserialize(using = Issue2Assignees.Issue2AssigneesDeserializer.class)
public abstract class Issue2Assignees {
     ...
     */
    public static Issue2Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static Issue2Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends Issue2Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends Issue2Assignees {
    ...
    /**
     * This is a custom deserializer class for Issue2Assignees.
     */
    protected static class Issue2AssigneesDeserializer
            extends JsonDeserializer<Issue2Assignees> {

        @Override
        public Issue2Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
