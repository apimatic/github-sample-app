...
/**
 * This is a model class for Protection type.
 */
public class Protection {
    ...
    /**
     * Converts this Protection into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Protection [" + "url=" + url + ", enabled=" + enabled + ", requiredStatusChecks="
                ...
                + requiredConversationResolution + ", name=" + name + ", protectionUrl="
                + protectionUrl + ", requiredSignatures=" + requiredSignatures + ", lockBranch="
                + lockBranch + ", allowForkSyncing=" + allowForkSyncing + "]";
    }

    /**
     * Builds a new {@link Protection.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Protection.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Protection}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Protection} object using the set fields.
         * @return {@link Protection}
         */
        public Protection build() {
            return new Protection(url, enabled, requiredStatusChecks, enforceAdmins,
