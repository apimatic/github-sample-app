...
/**
 * This is a model class for DependabotAlertWithRepository type.
 */
public class DependabotAlertWithRepository {
    ...
    /**
     * Converts this DependabotAlertWithRepository into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DependabotAlertWithRepository [" + "number=" + number + ", state=" + state
                + ", dependency=" + dependency + ", securityAdvisory=" + securityAdvisory
                ...
                + ", fixedAt=" + fixedAt + ", repository=" + repository + "]";
    }

    /**
     * Builds a new {@link DependabotAlertWithRepository.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DependabotAlertWithRepository.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(number, state, dependency, securityAdvisory,
                ...
                dismissedReason, dismissedComment, fixedAt, repository);
        return builder;
    }

    /**
     * Class to build instances of {@link DependabotAlertWithRepository}.
     */
    public static class Builder {
        ...
        public Builder(int number, StateEnum state, Dependency3 dependency,
                ...
                String dismissedComment, LocalDateTime fixedAt, Repository1 repository) {
            this.number = number;
            this.state = state;
            this.dependency = dependency;
            this.securityAdvisory = securityAdvisory;
        ...
        /**
         * Builds a new {@link DependabotAlertWithRepository} object using the set fields.
         * @return {@link DependabotAlertWithRepository}
         */
        public DependabotAlertWithRepository build() {
            return new DependabotAlertWithRepository(number, state, dependency, securityAdvisory,
                    securityVulnerability, url, htmlUrl, createdAt, updatedAt, dismissedAt,
                    dismissedBy, dismissedReason, dismissedComment, fixedAt, repository);
        }
    }
}
