 ...
 */
@JsonDeserialize(using = Repo18CreatedAt.Repo18CreatedAtDeserializer.class)
public abstract class Repo18CreatedAt {
     ...
     */
    public static Repo18CreatedAt fromNumber(int number) {
     ...
     */
    public static Repo18CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo18CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo18CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repo18CreatedAt.
     */
    protected static class Repo18CreatedAtDeserializer
            extends JsonDeserializer<Repo18CreatedAt> {

        @Override
        public Repo18CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
