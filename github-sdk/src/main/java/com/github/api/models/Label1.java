...
/**
 * This is a model class for Label1 type.
 */
public class Label1 {
    private long id;
    ...
    /**
     * Converts this Label1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Label1 [" + "id=" + id + ", nodeId=" + nodeId + ", url=" + url + ", name=" + name
                + ", description=" + description + ", color=" + color + ", mDefault=" + mDefault
                + "]";
    }

    /**
     * Builds a new {@link Label1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Label1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Label1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Label1} object using the set fields.
         * @return {@link Label1}
         */
        public Label1 build() {
            return new Label1(id, nodeId, url, name, description, color, mDefault);
        }
    }
}
