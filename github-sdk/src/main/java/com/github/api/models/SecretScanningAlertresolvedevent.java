...
/**
 * This is a model class for SecretScanningAlertresolvedevent type.
 */
public class SecretScanningAlertresolvedevent {
    private String action;
    private Alert10 alert;
     ...
     * Default constructor.
     */
    public SecretScanningAlertresolvedevent() {
        action = "resolved";
    }
     ...
     * @param  alert  Alert10 value for alert.
    ...
    /**
     * Getter for Alert.
     * @return Returns the Alert10
     */
    @JsonGetter("alert")
    public Alert10 getAlert() {
        return alert;
    }

    /**
     * Setter for Alert.
     * @param alert Value for Alert10
     */
    @JsonSetter("alert")
    public void setAlert(Alert10 alert) {
        this.alert = alert;
    }
    ...
    /**
     * Converts this SecretScanningAlertresolvedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SecretScanningAlertresolvedevent [" + "action=" + action + ", alert=" + alert
                + ", repository=" + repository + ", enterprise=" + enterprise + ", installation="
                + installation + ", organization=" + organization + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link SecretScanningAlertresolvedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SecretScanningAlertresolvedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, alert, repository)
    ...
    /**
     * Class to build instances of {@link SecretScanningAlertresolvedevent}.
     */
    public static class Builder {
         ...
         * @param  repository  Repository3 value for repository.
         */
        public Builder(String action, Alert10 alert, Repository3 repository) {
            this.action = action;
            this.alert = alert;
            this.repository = repository;
        }
         ...
         * @return Builder
         */
        public Builder alert(Alert10 alert) {
            this.alert = alert;
            return this;
        }
        ...
        /**
         * Builds a new {@link SecretScanningAlertresolvedevent} object using the set fields.
         * @return {@link SecretScanningAlertresolvedevent}
         */
        public SecretScanningAlertresolvedevent build() {
            return new SecretScanningAlertresolvedevent(action, alert, repository, enterprise,
