 ...
 */
@JsonDeserialize(using = PullRequest51RequestedReviewers.PullRequest51RequestedReviewersDeserializer.class)
public abstract class PullRequest51RequestedReviewers {
     ...
     */
    public static PullRequest51RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest51RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest51RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends PullRequest51RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest51RequestedReviewers.
     */
    protected static class PullRequest51RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest51RequestedReviewers> {

        @Override
        public PullRequest51RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
