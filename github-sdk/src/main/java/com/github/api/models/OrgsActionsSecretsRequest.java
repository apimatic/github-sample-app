...
/**
 * This is a model class for OrgsActionsSecretsRequest type.
 */
public class OrgsActionsSecretsRequest {
     ...
     * Default constructor.
     */
    public OrgsActionsSecretsRequest() {
    }
     ...
     * key](https://docs.github.com/rest/reference/actions#get-an-organization-public-key) endpoint.
     ...
     * secret](https://docs.github.com/rest/reference/actions#set-selected-repositories-for-an-organization-secret),
    ...
    /**
     * Converts this OrgsActionsSecretsRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OrgsActionsSecretsRequest [" + "visibility=" + visibility + ", encryptedValue="
                + encryptedValue + ", keyId=" + keyId + ", selectedRepositoryIds="
                + selectedRepositoryIds + "]";
    }

    /**
     * Builds a new {@link OrgsActionsSecretsRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link OrgsActionsSecretsRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link OrgsActionsSecretsRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link OrgsActionsSecretsRequest} object using the set fields.
         * @return {@link OrgsActionsSecretsRequest}
         */
        public OrgsActionsSecretsRequest build() {
            return new OrgsActionsSecretsRequest(visibility, encryptedValue, keyId,
                    selectedRepositoryIds);
        }
    }
}
