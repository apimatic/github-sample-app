...
import com.github.api.models.containers.PullRequest42Assignees;
import com.github.api.models.containers.PullRequest42RequestedReviewers;
...
/**
 * This is a model class for PullRequest42 type.
 */
public class PullRequest42 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest42Assignees> assignees;
    ...
    private List<PullRequest42RequestedReviewers> requestedReviewers;
     ...
     * @param  head  Head20 value for head.
     ...
     * @param  requestedReviewers  List of PullRequest42RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest42(
            ...
            Object assignee,
            List<PullRequest42Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest42RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest42(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest42Assignees> assignees, AuthorAssociationEnum authorAssociation,
            Object autoMerge, Base11 base, String body, LocalDateTime closedAt, String commentsUrl,
            String commitsUrl, LocalDateTime createdAt, String diffUrl, boolean draft, Head20 head,
            String htmlUrl, int id, String issueUrl, List<Label10> labels, boolean locked,
            String mergeCommitSha, Boolean merged, LocalDateTime mergedAt, Object mergedBy,
            Object milestone, String nodeId, int number, String patchUrl,
            List<PullRequest42RequestedReviewers> requestedReviewers, List<Team4> requestedTeams,
     ...
     * @return Returns the List of PullRequest42Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest42Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest42Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest42Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Setter for Base.
     * @param base Value for Base11
     */
    @JsonSetter("base")
    public void setBase(Base11 base) {
        this.base = base;
    }
    ...
    /**
     * Getter for Head.
     * @return Returns the Head20
     */
    @JsonGetter("head")
    public Head20 getHead() {
        return head;
    }

    /**
     * Setter for Head.
     * @param head Value for Head20
     */
    @JsonSetter("head")
    public void setHead(Head20 head) {
        this.head = head;
    }
     ...
     * @return Returns the List of PullRequest42RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest42RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest42RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest42RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest42 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest42 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest42.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest42.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest42}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<PullRequest42Assignees> assignees, AuthorAssociationEnum authorAssociation,
                Object autoMerge, Base11 base, String body, LocalDateTime closedAt,
                String commentsUrl, String commitsUrl, LocalDateTime createdAt, String diffUrl,
                boolean draft, Head20 head, String htmlUrl, int id, String issueUrl,
                List<Label10> labels, boolean locked, String mergeCommitSha, Boolean merged,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest42Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder base(Base11 base) {
            this.base = base;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder head(Head20 head) {
            this.head = head;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest42} object using the set fields.
         * @return {@link PullRequest42}
         */
        public PullRequest42 build() {
            return new PullRequest42(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
                    mergeCommitSha, merged, mergedAt, mergedBy, milestone, nodeId, number, patchUrl,
                    requestedReviewers, requestedTeams, reviewCommentUrl, reviewCommentsUrl, state,
