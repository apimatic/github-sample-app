...
import com.github.api.models.containers.SnapshotMetadata;
...
public class Snapshot {
    ...
    private Map<String, SnapshotMetadata> metadata;
    ...
    public Snapshot(
            ...
            Map<String, SnapshotMetadata> metadata,
     ...
     * values.
     * @return Returns the Map of String, SnapshotMetadata
     */
    @JsonGetter("metadata")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Map<String, SnapshotMetadata> getMetadata() {
        return metadata;
    }
     ...
     * User-defined metadata to store domain-specific information limited to 8 keys with scalar
     * values.
     * @param metadata Value for Map of String, SnapshotMetadata
     */
    @JsonSetter("metadata")
    public void setMetadata(Map<String, SnapshotMetadata> metadata) {
        this.metadata = metadata;
    }
    ...
    public String toString() {
        return "Snapshot [" + "version=" + version + ", job=" + job + ", sha=" + sha + ", ref="
                + ref + ", detector=" + detector + ", scanned=" + scanned + ", metadata=" + metadata
                + ", manifests=" + manifests + "]";
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder metadata(Map<String, SnapshotMetadata> metadata) {
            this.metadata = metadata;
            return this;
        }
        ...
        public Snapshot build() {
            return new Snapshot(version, job, sha, ref, detector, scanned, metadata, manifests);
        }
    }
}
