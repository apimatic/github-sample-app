 ...
 */
@JsonDeserialize(using = ForkeePushedAt.ForkeePushedAtDeserializer.class)
public abstract class ForkeePushedAt {
     ...
     */
    public static ForkeePushedAt fromNumber(int number) {
     ...
     */
    public static ForkeePushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ForkeePushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends ForkeePushedAt {
    ...
    /**
     * This is a custom deserializer class for ForkeePushedAt.
     */
    protected static class ForkeePushedAtDeserializer
            extends JsonDeserializer<ForkeePushedAt> {

        @Override
        public ForkeePushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
