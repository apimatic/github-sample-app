...
import com.github.api.models.containers.Deployment6Payload;
import io.apimatic.core.types.BaseModel;
import java.time.LocalDateTime;

/**
 * This is a model class for Deployment6 type.
 */
public class Deployment6 {
    private String url;
    private int id;
    ...
    private String ref;
    private String task;
    private Deployment6Payload payload;
     ...
     * @param  payload  Deployment6Payload value for payload.
    ...
    /**
     * Getter for Payload.
     * @return Returns the Deployment6Payload
     */
    @JsonGetter("payload")
    public Deployment6Payload getPayload() {
        return payload;
    }

    /**
     * Setter for Payload.
     * @param payload Value for Deployment6Payload
     */
    @JsonSetter("payload")
    public void setPayload(Deployment6Payload payload) {
        this.payload = payload;
    }
    ...
    /**
     * Converts this Deployment6 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Deployment6 [" + "url=" + url + ", id=" + id + ", nodeId=" + nodeId + ", sha=" + sha
    ...
    /**
     * Builds a new {@link Deployment6.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Deployment6.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Deployment6}.
     */
    public static class Builder {
        ...
        public Builder(String url, int id, String nodeId, String sha, String ref, String task,
                Deployment6Payload payload, String environment, String description, Object creator,
         ...
         * @return Builder
         */
        public Builder payload(Deployment6Payload payload) {
            this.payload = payload;
            return this;
        }
        ...
        /**
         * Builds a new {@link Deployment6} object using the set fields.
         * @return {@link Deployment6}
         */
        public Deployment6 build() {
            return new Deployment6(url, id, nodeId, sha, ref, task, payload, environment,
                    description, creator, createdAt, updatedAt, statusesUrl, repositoryUrl,
