 ...
 */
@JsonDeserialize(using = ReposDeploymentsResponse1Payload.ReposDeploymentsResponse1PayloadDeserializer.class)
public abstract class ReposDeploymentsResponse1Payload {
     ...
     */
    public static ReposDeploymentsResponse1Payload fromObject(Map<String, Object> object) {
     ...
     */
    public static ReposDeploymentsResponse1Payload fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends ReposDeploymentsResponse1Payload {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposDeploymentsResponse1Payload {
    ...
    /**
     * This is a custom deserializer class for ReposDeploymentsResponse1Payload.
     */
    protected static class ReposDeploymentsResponse1PayloadDeserializer
            extends JsonDeserializer<ReposDeploymentsResponse1Payload> {

        @Override
        public ReposDeploymentsResponse1Payload deserialize(JsonParser jp, DeserializationContext ctxt)
