...
public class Feed {
    ...
    public String toString() {
        return "Feed [" + "timelineUrl=" + timelineUrl + ", userUrl=" + userUrl + ", links=" + links
                + ", currentUserPublicUrl=" + currentUserPublicUrl + ", currentUserUrl="
                + currentUserUrl + ", currentUserActorUrl=" + currentUserActorUrl
    ...
    public static class Builder {
         ...
         */
        public Feed build() {
            return new Feed(timelineUrl, userUrl, links, currentUserPublicUrl, currentUserUrl,
                    currentUserActorUrl, currentUserOrganizationUrl, currentUserOrganizationUrls,
                    securityAdvisoriesUrl, repositoryDiscussionsUrl,
                    repositoryDiscussionsCategoryUrl);
        }
    }
}
