...
import com.github.api.models.containers.PullRequest43Assignees;
import com.github.api.models.containers.PullRequest43RequestedReviewers;
import io.apimatic.core.types.BaseModel;
import java.util.List;

/**
 * This is a model class for PullRequest43 type.
 */
public class PullRequest43 {
    private Links2 links;
    private Object activeLockReason;
    private Object assignee;
    private List<PullRequest43Assignees> assignees;
    ...
    private List<PullRequest43RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest43Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest43RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest43(
            ...
            Object assignee,
            List<PullRequest43Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest43RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest43Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest43Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest43Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest43Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest43RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest43RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest43RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest43RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest43 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest43 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest43.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest43.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest43}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<PullRequest43Assignees> assignees, AuthorAssociationEnum authorAssociation,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest43Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest43} object using the set fields.
         * @return {@link PullRequest43}
         */
        public PullRequest43 build() {
            return new PullRequest43(links, activeLockReason, assignee, assignees,
                    authorAssociation, base, body, closedAt, commentsUrl, commitsUrl, createdAt,
                    diffUrl, head, htmlUrl, id, issueUrl, labels, locked, mergeCommitSha, mergedAt,
                    milestone, nodeId, number, patchUrl, requestedReviewers, requestedTeams,
                    reviewCommentUrl, reviewCommentsUrl, state, statusesUrl, title, updatedAt, url,
