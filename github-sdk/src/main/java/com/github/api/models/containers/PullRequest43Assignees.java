 ...
 */
@JsonDeserialize(using = PullRequest43Assignees.PullRequest43AssigneesDeserializer.class)
public abstract class PullRequest43Assignees {
     ...
     */
    public static PullRequest43Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest43Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest43Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends PullRequest43Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest43Assignees.
     */
    protected static class PullRequest43AssigneesDeserializer
            extends JsonDeserializer<PullRequest43Assignees> {

        @Override
        public PullRequest43Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
