...
/**
 * This is a model class for Account12 type.
 */
public class Account12 {
     ...
     */
    protected Account12(String login, int id, String nodeId, String avatarUrl, String gravatarId,
    ...
    /**
     * Converts this Account12 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Account12 [" + "login=" + login + ", id=" + id + ", nodeId=" + nodeId
    ...
    /**
     * Builds a new {@link Account12.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Account12.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Account12}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Account12} object using the set fields.
         * @return {@link Account12}
         */
        public Account12 build() {
            return new Account12(login, id, nodeId, avatarUrl, gravatarId, url, htmlUrl,
                    followersUrl, followingUrl, gistsUrl, starredUrl, subscriptionsUrl,
