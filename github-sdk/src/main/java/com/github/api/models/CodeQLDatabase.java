...
/**
 * This is a model class for CodeQLDatabase type.
 */
public class CodeQLDatabase {
    private int id;
    private String name;
    ...
    /**
     * Converts this CodeQLDatabase into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CodeQLDatabase [" + "id=" + id + ", name=" + name + ", language=" + language
                + ", uploader=" + uploader + ", contentType=" + contentType + ", size=" + size
                + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt + ", url=" + url + "]";
    }

    /**
     * Builds a new {@link CodeQLDatabase.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CodeQLDatabase.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CodeQLDatabase}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CodeQLDatabase} object using the set fields.
         * @return {@link CodeQLDatabase}
         */
        public CodeQLDatabase build() {
            return new CodeQLDatabase(id, name, language, uploader, contentType, size, createdAt,
                    updatedAt, url);
        }
    }
}
