...
/**
 * This is a model class for MarketplacePurchasependingChangeCancelledevent type.
 */
public class MarketplacePurchasependingChangeCancelledevent {
    private String action;
    private String effectiveDate;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private MarketplacePurchase8 marketplacePurchase;
     ...
     * Default constructor.
     */
    public MarketplacePurchasependingChangeCancelledevent() {
     ...
     * @param  marketplacePurchase  MarketplacePurchase8 value for marketplacePurchase.
    ...
    public MarketplacePurchasependingChangeCancelledevent(
            ...
            MarketplacePurchase8 marketplacePurchase,
            Sender sender,
     ...
     * @return Returns the MarketplacePurchase8
     */
    @JsonGetter("marketplace_purchase")
    public MarketplacePurchase8 getMarketplacePurchase() {
        return marketplacePurchase;
    }

    /**
     * Setter for MarketplacePurchase.
     * @param marketplacePurchase Value for MarketplacePurchase8
     */
    @JsonSetter("marketplace_purchase")
    public void setMarketplacePurchase(MarketplacePurchase8 marketplacePurchase) {
        this.marketplacePurchase = marketplacePurchase;
    }
    ...
    /**
     * Converts this MarketplacePurchasependingChangeCancelledevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MarketplacePurchasependingChangeCancelledevent [" + "action=" + action
                + ", effectiveDate=" + effectiveDate + ", marketplacePurchase="
                + marketplacePurchase + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization
                + ", previousMarketplacePurchase=" + previousMarketplacePurchase + ", repository="
                + repository + "]";
    }

    /**
     * Builds a new {@link MarketplacePurchasependingChangeCancelledevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MarketplacePurchasependingChangeCancelledevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MarketplacePurchasependingChangeCancelledevent}.
     */
    public static class Builder {
        private String action = "pending_change_cancelled";
        private String effectiveDate;
        private MarketplacePurchase8 marketplacePurchase;
        private Sender sender;
        private Enterprise1 enterprise;
        ...
        public Builder(String action, String effectiveDate,
                MarketplacePurchase8 marketplacePurchase, Sender sender) {
            this.action = action;
            this.effectiveDate = effectiveDate;
            this.marketplacePurchase = marketplacePurchase;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder marketplacePurchase(MarketplacePurchase8 marketplacePurchase) {
            this.marketplacePurchase = marketplacePurchase;
            return this;
        }
        ...
        /**
         * Builds a new {@link MarketplacePurchasependingChangeCancelledevent} object using the set
         * fields.
         * @return {@link MarketplacePurchasependingChangeCancelledevent}
         */
        public MarketplacePurchasependingChangeCancelledevent build() {
            return new MarketplacePurchasependingChangeCancelledevent(action, effectiveDate,
                    marketplacePurchase, sender, enterprise, installation, organization,
                    previousMarketplacePurchase, repository);
        }
    }
}
