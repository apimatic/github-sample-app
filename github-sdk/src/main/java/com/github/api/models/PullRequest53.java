...
import com.github.api.models.containers.PullRequest53Assignees;
import com.github.api.models.containers.PullRequest53RequestedReviewers;
...
/**
 * This is a model class for PullRequest53 type.
 */
public class PullRequest53 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest53Assignees> assignees;
    ...
    private List<PullRequest53RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest53Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest53RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest53(
            ...
            Object assignee,
            List<PullRequest53Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest53RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest53(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest53Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            int number, String patchUrl, List<PullRequest53RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest53Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest53Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest53Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest53Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest53RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest53RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest53RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest53RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest53 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest53 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest53.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest53.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest53}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest53Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest53} object using the set fields.
         * @return {@link PullRequest53}
         */
        public PullRequest53 build() {
            return new PullRequest53(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
