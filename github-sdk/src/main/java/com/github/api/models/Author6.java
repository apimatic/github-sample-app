...
/**
 * This is a model class for Author6 type.
 */
public class Author6 {
    ...
    /**
     * Converts this Author6 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Author6 [" + "avatarUrl=" + avatarUrl + ", eventsUrl=" + eventsUrl
                + ", followersUrl=" + followersUrl + ", followingUrl=" + followingUrl
                + ", gistsUrl=" + gistsUrl + ", gravatarId=" + gravatarId + ", htmlUrl=" + htmlUrl
                + ", id=" + id + ", login=" + login + ", nodeId=" + nodeId + ", organizationsUrl="
                + organizationsUrl + ", receivedEventsUrl=" + receivedEventsUrl + ", reposUrl="
                + reposUrl + ", siteAdmin=" + siteAdmin + ", starredUrl=" + starredUrl
                + ", subscriptionsUrl=" + subscriptionsUrl + ", type=" + type + ", url=" + url
                + "]";
    }

    /**
     * Builds a new {@link Author6.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Author6.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl,
                gravatarId, htmlUrl, id, login, nodeId, organizationsUrl, receivedEventsUrl,
                reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url);
        return builder;
    }

    /**
     * Class to build instances of {@link Author6}.
     */
    public static class Builder {
        ...
        public Builder(String avatarUrl, String eventsUrl, String followersUrl, String followingUrl,
                String gistsUrl, String gravatarId, String htmlUrl, int id, String login,
        ...
        /**
         * Builds a new {@link Author6} object using the set fields.
         * @return {@link Author6}
         */
        public Author6 build() {
            return new Author6(avatarUrl, eventsUrl, followersUrl, followingUrl, gistsUrl,
                    gravatarId, htmlUrl, id, login, nodeId, organizationsUrl, receivedEventsUrl,
                    reposUrl, siteAdmin, starredUrl, subscriptionsUrl, type, url);
        }
    }
