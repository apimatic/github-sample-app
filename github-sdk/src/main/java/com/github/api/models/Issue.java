...
import com.github.api.models.containers.IssueLabels;
...
/**
 * This is a model class for Issue type.
 */
public class Issue {
    private int id;
     ...
     * @param  labels  List of IssueLabels value for labels.
     ...
     */
    protected Issue(int id, String nodeId, String url, String repositoryUrl, String labelsUrl,
            String commentsUrl, String eventsUrl, String htmlUrl, int number, String state,
            String title, Object user, List<IssueLabels> labels, Object assignee, Object milestone,
     ...
     * @return Returns the List of IssueLabels
     */
    @JsonGetter("labels")
     ...
     * labels on this issue; send an empty array to clear all labels from the issue; note that the
     * labels are silently dropped for users without push access to the repository
     * @param labels Value for List of IssueLabels
     */
    @JsonSetter("labels")
    ...
    /**
     * Converts this Issue into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Issue [" + "id=" + id + ", nodeId=" + nodeId + ", url=" + url + ", repositoryUrl="
    ...
    /**
     * Builds a new {@link Issue.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Issue.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Issue}.
     */
    public static class Builder {
        ...
        public Builder(int id, String nodeId, String url, String repositoryUrl, String labelsUrl,
                String commentsUrl, String eventsUrl, String htmlUrl, int number, String state,
                String title, Object user, List<IssueLabels> labels, Object assignee,
         ...
         * @return Builder
         */
        public Builder labels(List<IssueLabels> labels) {
            this.labels = labels;
            return this;
        }
        ...
        /**
         * Builds a new {@link Issue} object using the set fields.
         * @return {@link Issue}
         */
        public Issue build() {
            return new Issue(id, nodeId, url, repositoryUrl, labelsUrl, commentsUrl, eventsUrl,
