...
/**
 * This is a model class for PageBuildevent type.
 */
public class PageBuildevent {
     ...
     * @param  build  Build2 value for build.
    ...
    /**
     * Converts this PageBuildevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PageBuildevent [" + "build=" + build + ", id=" + id + ", repository=" + repository
                + ", sender=" + sender + ", enterprise=" + enterprise + ", installation="
                + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link PageBuildevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PageBuildevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(build, id, repository, sender)
    ...
    /**
     * Class to build instances of {@link PageBuildevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(Build2 build, int id, Repository3 repository, Sender sender) {
            this.build = build;
            this.id = id;
            this.repository = repository;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder build(Build2 build) {
            this.build = build;
            return this;
        }
        ...
        /**
         * Builds a new {@link PageBuildevent} object using the set fields.
         * @return {@link PageBuildevent}
         */
        public PageBuildevent build() {
            return new PageBuildevent(build, id, repository, sender, enterprise, installation,
                    organization);
        }
    }
}
