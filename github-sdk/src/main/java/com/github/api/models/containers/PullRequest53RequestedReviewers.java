 ...
 */
@JsonDeserialize(using = PullRequest53RequestedReviewers.PullRequest53RequestedReviewersDeserializer.class)
public abstract class PullRequest53RequestedReviewers {
     ...
     */
    public static PullRequest53RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest53RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest53RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends PullRequest53RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest53RequestedReviewers.
     */
    protected static class PullRequest53RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest53RequestedReviewers> {

        @Override
        public PullRequest53RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
