 ...
 */
@JsonDeserialize(using = PullRequest34RequestedReviewers.PullRequest34RequestedReviewersDeserializer.class)
public abstract class PullRequest34RequestedReviewers {
     ...
     */
    public static PullRequest34RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest34RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest34RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends PullRequest34RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest34RequestedReviewers.
     */
    protected static class PullRequest34RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest34RequestedReviewers> {

        @Override
        public PullRequest34RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
