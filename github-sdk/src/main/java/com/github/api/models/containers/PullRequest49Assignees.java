 ...
 */
@JsonDeserialize(using = PullRequest49Assignees.PullRequest49AssigneesDeserializer.class)
public abstract class PullRequest49Assignees {
     ...
     */
    public static PullRequest49Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest49Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest49Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends PullRequest49Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest49Assignees.
     */
    protected static class PullRequest49AssigneesDeserializer
            extends JsonDeserializer<PullRequest49Assignees> {

        @Override
        public PullRequest49Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
