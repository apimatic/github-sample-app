...
/**
 * Event11Enum to be used.
 */
public enum Event11Enum {
    ...
    private static TreeMap<String, Event11Enum> valueMap = new TreeMap<>();
    ...
    public static Event11Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Event11Enum values to list of string values.
     * @param toConvert The list of Event11Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Event11Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Event11Enum enumValue : toConvert) {
