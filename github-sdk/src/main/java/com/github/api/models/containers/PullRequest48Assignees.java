 ...
 */
@JsonDeserialize(using = PullRequest48Assignees.PullRequest48AssigneesDeserializer.class)
public abstract class PullRequest48Assignees {
     ...
     */
    public static PullRequest48Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest48Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest48Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends PullRequest48Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest48Assignees.
     */
    protected static class PullRequest48AssigneesDeserializer
            extends JsonDeserializer<PullRequest48Assignees> {

        @Override
        public PullRequest48Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
