...
/**
 * This is a model class for Head1 type.
 */
public class Head1 {
    ...
    /**
     * Converts this Head1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Head1 [" + "label=" + label + ", ref=" + ref + ", repo=" + repo + ", sha=" + sha
                + ", user=" + user + "]";
    }

    /**
     * Builds a new {@link Head1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Head1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Head1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Head1} object using the set fields.
         * @return {@link Head1}
         */
        public Head1 build() {
            return new Head1(label, ref, repo, sha, user);
        }
    }
}
