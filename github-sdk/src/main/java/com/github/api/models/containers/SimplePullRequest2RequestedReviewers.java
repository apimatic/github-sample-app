 ...
 */
@JsonDeserialize(using = SimplePullRequest2RequestedReviewers.SimplePullRequest2RequestedReviewersDeserializer.class)
public abstract class SimplePullRequest2RequestedReviewers {
     ...
     */
    public static SimplePullRequest2RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static SimplePullRequest2RequestedReviewers fromTeam6(Team6 team6) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends SimplePullRequest2RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team6Case extends SimplePullRequest2RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest2RequestedReviewers.
     */
    protected static class SimplePullRequest2RequestedReviewersDeserializer
            extends JsonDeserializer<SimplePullRequest2RequestedReviewers> {

        @Override
        public SimplePullRequest2RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
