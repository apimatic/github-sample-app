 ...
 */
@JsonDeserialize(using = Repo11PushedAt.Repo11PushedAtDeserializer.class)
public abstract class Repo11PushedAt {
     ...
     */
    public static Repo11PushedAt fromNumber(int number) {
     ...
     */
    public static Repo11PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo11PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo11PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo11PushedAt.
     */
    protected static class Repo11PushedAtDeserializer
            extends JsonDeserializer<Repo11PushedAt> {

        @Override
        public Repo11PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
