...
/**
 * This is a model class for Permissions30 type.
 */
public class Permissions30 {
    ...
    /**
     * Converts this Permissions30 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Permissions30 [" + "issues=" + issues + ", checks=" + checks + ", metadata="
                + metadata + ", contents=" + contents + ", deployments=" + deployments + "]";
    }

    /**
     * Builds a new {@link Permissions30.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Permissions30.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Permissions30}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Permissions30} object using the set fields.
         * @return {@link Permissions30}
         */
        public Permissions30 build() {
            return new Permissions30(issues, checks, metadata, contents, deployments);
        }
    }
}
