...
/**
 * This is a model class for TimelineCommittedEvent type.
 */
public class TimelineCommittedEvent {
     ...
     */
    @JsonCreator
    private TimelineCommittedEvent(
            @JsonProperty("sha") String sha,
            @JsonProperty("node_id") String nodeId,
            @JsonProperty("url") String url,
            @JsonProperty("author") Author1 author,
            @JsonProperty("committer") Committer1 committer,
            @JsonProperty("message") String message,
            @JsonProperty("tree") Tree2 tree,
            @JsonProperty("parents") List<Parent2> parents,
    ...
    /**
     * Converts this TimelineCommittedEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TimelineCommittedEvent [" + "sha=" + sha + ", nodeId=" + nodeId + ", url=" + url
    ...
    /**
     * Builds a new {@link TimelineCommittedEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TimelineCommittedEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TimelineCommittedEvent}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TimelineCommittedEvent} object using the set fields.
         * @return {@link TimelineCommittedEvent}
         */
        public TimelineCommittedEvent build() {
            return new TimelineCommittedEvent(sha, nodeId, url, author, committer, message, tree,
                    parents, verification, htmlUrl, event);
        }
    }
}
