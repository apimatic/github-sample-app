 ...
 */
@JsonDeserialize(using = NugetMetadatum1Id.NugetMetadatum1IdDeserializer.class)
public abstract class NugetMetadatum1Id {
     ...
     */
    public static NugetMetadatum1Id fromMString(String mString) {
     ...
     */
    public static NugetMetadatum1Id fromObject(Map<String, Object> object) {
     ...
     */
    public static NugetMetadatum1Id fromNumber(int number) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends NugetMetadatum1Id {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends NugetMetadatum1Id {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class NumberCase extends NugetMetadatum1Id {
    ...
    /**
     * This is a custom deserializer class for NugetMetadatum1Id.
     */
    protected static class NugetMetadatum1IdDeserializer
            extends JsonDeserializer<NugetMetadatum1Id> {

        @Override
        public NugetMetadatum1Id deserialize(JsonParser jp, DeserializationContext ctxt)
                throws IOException, JsonProcessingException {
            ObjectCodec oc = jp.getCodec();
            JsonNode node = oc.readTree(jp);
            return ApiHelper.deserialize(node, Arrays.asList(MStringCase.class, ObjectCase.class,
