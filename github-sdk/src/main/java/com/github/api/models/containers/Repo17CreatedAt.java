 ...
 */
@JsonDeserialize(using = Repo17CreatedAt.Repo17CreatedAtDeserializer.class)
public abstract class Repo17CreatedAt {
     ...
     */
    public static Repo17CreatedAt fromNumber(int number) {
     ...
     */
    public static Repo17CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo17CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo17CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repo17CreatedAt.
     */
    protected static class Repo17CreatedAtDeserializer
            extends JsonDeserializer<Repo17CreatedAt> {

        @Override
        public Repo17CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
