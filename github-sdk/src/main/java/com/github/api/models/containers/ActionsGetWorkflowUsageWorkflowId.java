 ...
 */
@JsonDeserialize(using = ActionsGetWorkflowUsageWorkflowId.ActionsGetWorkflowUsageWorkflowIdDeserializer.class)
public abstract class ActionsGetWorkflowUsageWorkflowId {
     ...
     */
    public static ActionsGetWorkflowUsageWorkflowId fromNumber(int number) {
     ...
     */
    public static ActionsGetWorkflowUsageWorkflowId fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends ActionsGetWorkflowUsageWorkflowId {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ActionsGetWorkflowUsageWorkflowId {
    ...
    /**
     * This is a custom deserializer class for ActionsGetWorkflowUsageWorkflowId.
     */
    protected static class ActionsGetWorkflowUsageWorkflowIdDeserializer
            extends JsonDeserializer<ActionsGetWorkflowUsageWorkflowId> {

        @Override
        public ActionsGetWorkflowUsageWorkflowId deserialize(JsonParser jp, DeserializationContext ctxt)
