...
/**
 * This is a model class for Contributor type.
 */
public class Contributor {
     ...
     * @param  contributions  int value for contributions.
     ...
     */
    protected Contributor(String type, int contributions, String login, Integer id, String nodeId,
            String avatarUrl, OptionalNullable<String> gravatarId, String url, String htmlUrl,
            ...
            String receivedEventsUrl, Boolean siteAdmin, String email, String name) {
        this.login = login;
        this.id = id;
        this.nodeId = nodeId;
        this.avatarUrl = avatarUrl;
     ...
     */
    @JsonGetter("contributions")
    public int getContributions() {
        return contributions;
    }

    /**
     * Setter for Contributions.
     * @param contributions Value for int
     */
    ...
    /**
     * Converts this Contributor into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Contributor [" + "type=" + type + ", contributions=" + contributions + ", login="
                + login + ", id=" + id + ", nodeId=" + nodeId + ", avatarUrl=" + avatarUrl
                + ", gravatarId=" + gravatarId + ", url=" + url + ", htmlUrl=" + htmlUrl
                ...
                + ", siteAdmin=" + siteAdmin + ", email=" + email + ", name=" + name + "]";
    }

    /**
     * Builds a new {@link Contributor.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Contributor.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(type, contributions)
                .login(getLogin())
                .id(getId())
                .nodeId(getNodeId())
    ...
    /**
     * Class to build instances of {@link Contributor}.
     */
    public static class Builder {
         ...
         * @param  contributions  int value for contributions.
         */
        public Builder(String type, int contributions) {
            this.type = type;
            this.contributions = contributions;
        }
         ...
         * @return Builder
         */
        public Builder contributions(int contributions) {
            this.contributions = contributions;
            return this;
        }
        ...
        /**
         * Builds a new {@link Contributor} object using the set fields.
         * @return {@link Contributor}
         */
        public Contributor build() {
            return new Contributor(type, contributions, login, id, nodeId, avatarUrl, gravatarId,
                    url, htmlUrl, followersUrl, followingUrl, gistsUrl, starredUrl,
                    subscriptionsUrl, organizationsUrl, reposUrl, eventsUrl, receivedEventsUrl,
                    siteAdmin, email, name);
        }
    }
}
