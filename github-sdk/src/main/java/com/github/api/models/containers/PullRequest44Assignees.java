 ...
 */
@JsonDeserialize(using = PullRequest44Assignees.PullRequest44AssigneesDeserializer.class)
public abstract class PullRequest44Assignees {
     ...
     */
    public static PullRequest44Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest44Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest44Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest44Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest44Assignees.
     */
    protected static class PullRequest44AssigneesDeserializer
            extends JsonDeserializer<PullRequest44Assignees> {

        @Override
        public PullRequest44Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
