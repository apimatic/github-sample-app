...
/**
 * This is a model class for Rule3 type.
 */
public class Rule3 {
    ...
    /**
     * Converts this Rule3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Rule3 [" + "adminEnforced=" + adminEnforced + ", allowDeletionsEnforcementLevel="
                + allowDeletionsEnforcementLevel + ", allowForcePushesEnforcementLevel="
                + allowForcePushesEnforcementLevel + ", authorizedActorNames="
                ...
                + dismissStaleReviewsOnPush + ", id=" + id + ", ignoreApprovalsFromContributors="
    ...
    /**
     * Builds a new {@link Rule3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Rule3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Rule3}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Rule3} object using the set fields.
         * @return {@link Rule3}
         */
        public Rule3 build() {
            return new Rule3(adminEnforced, allowDeletionsEnforcementLevel,
                    allowForcePushesEnforcementLevel, authorizedActorNames, authorizedActorsOnly,
                    authorizedDismissalActorsOnly, createdAt, dismissStaleReviewsOnPush, id,
                    ignoreApprovalsFromContributors, linearHistoryRequirementEnforcementLevel,
