...
import com.github.api.models.containers.PullRequest29Assignees;
import com.github.api.models.containers.PullRequest29RequestedReviewers;
...
/**
 * This is a model class for PullRequest29 type.
 */
public class PullRequest29 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest29Assignees> assignees;
    ...
    private List<PullRequest29RequestedReviewers> requestedReviewers;
     ...
     * @param  assignees  List of PullRequest29Assignees value for assignees.
     ...
     * @param  requestedReviewers  List of PullRequest29RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest29(
            ...
            Object assignee,
            List<PullRequest29Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest29RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest29(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest29Assignees> assignees, AuthorAssociationEnum authorAssociation,
            ...
            int number, String patchUrl, List<PullRequest29RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest29Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest29Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest29Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest29Assignees> assignees) {
        this.assignees = assignees;
    }
     ...
     * @return Returns the List of PullRequest29RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest29RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest29RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest29RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest29 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest29 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest29.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest29.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest29}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest29Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest29} object using the set fields.
         * @return {@link PullRequest29}
         */
        public PullRequest29 build() {
            return new PullRequest29(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
