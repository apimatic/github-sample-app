 ...
 */
@JsonDeserialize(using = PullRequest47Assignees.PullRequest47AssigneesDeserializer.class)
public abstract class PullRequest47Assignees {
     ...
     */
    public static PullRequest47Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest47Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest47Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest47Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest47Assignees.
     */
    protected static class PullRequest47AssigneesDeserializer
            extends JsonDeserializer<PullRequest47Assignees> {

        @Override
        public PullRequest47Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
