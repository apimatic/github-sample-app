...
/**
 * This is a model class for DeployKeydeletedevent type.
 */
public class DeployKeydeletedevent {
    ...
    /**
     * Converts this DeployKeydeletedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DeployKeydeletedevent [" + "action=" + action + ", key=" + key + ", repository="
                + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link DeployKeydeletedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DeployKeydeletedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, key, repository, sender)
    ...
    /**
     * Class to build instances of {@link DeployKeydeletedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Key2 key, Repository3 repository, Sender sender) {
            this.action = action;
            this.key = key;
            this.repository = repository;
            this.sender = sender;
        ...
        /**
         * Builds a new {@link DeployKeydeletedevent} object using the set fields.
         * @return {@link DeployKeydeletedevent}
         */
        public DeployKeydeletedevent build() {
            return new DeployKeydeletedevent(action, key, repository, sender, enterprise,
