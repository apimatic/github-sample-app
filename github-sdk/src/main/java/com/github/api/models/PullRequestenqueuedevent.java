...
/**
 * This is a model class for PullRequestenqueuedevent type.
 */
public class PullRequestenqueuedevent {
     ...
     * Default constructor.
     */
    public PullRequestenqueuedevent() {
        action = "enqueued";
    }
    ...
    /**
     * Converts this PullRequestenqueuedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestenqueuedevent [" + "action=" + action + ", number=" + number
    ...
    /**
     * Builds a new {@link PullRequestenqueuedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestenqueuedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestenqueuedevent}.
     */
    public static class Builder {
        private String action = "enqueued";
        private int number;
        private PullRequest34 pullRequest;
        private Repository3 repository;
        private Sender sender;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest34 pullRequest, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
        ...
        /**
         * Builds a new {@link PullRequestenqueuedevent} object using the set fields.
         * @return {@link PullRequestenqueuedevent}
         */
        public PullRequestenqueuedevent build() {
            return new PullRequestenqueuedevent(action, number, pullRequest, repository, sender,
