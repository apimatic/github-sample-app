 ...
 */
@JsonDeserialize(using = SimplePullRequest1Assignees.SimplePullRequest1AssigneesDeserializer.class)
public abstract class SimplePullRequest1Assignees {
     ...
     */
    public static SimplePullRequest1Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static SimplePullRequest1Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends SimplePullRequest1Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends SimplePullRequest1Assignees {
    ...
    /**
     * This is a custom deserializer class for SimplePullRequest1Assignees.
     */
    protected static class SimplePullRequest1AssigneesDeserializer
            extends JsonDeserializer<SimplePullRequest1Assignees> {

        @Override
        public SimplePullRequest1Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
