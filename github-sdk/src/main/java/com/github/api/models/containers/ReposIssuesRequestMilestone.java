 ...
 */
@JsonDeserialize(using = ReposIssuesRequestMilestone.ReposIssuesRequestMilestoneDeserializer.class)
public abstract class ReposIssuesRequestMilestone {
     ...
     */
    public static ReposIssuesRequestMilestone fromMString(String mString) {
     ...
     */
    public static ReposIssuesRequestMilestone fromNumber(int number) {
     ...
     */
    public static ReposIssuesRequestMilestone fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposIssuesRequestMilestone {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class NumberCase extends ReposIssuesRequestMilestone {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends ReposIssuesRequestMilestone {
    ...
    /**
     * This is a custom deserializer class for ReposIssuesRequestMilestone.
     */
    protected static class ReposIssuesRequestMilestoneDeserializer
            extends JsonDeserializer<ReposIssuesRequestMilestone> {

        @Override
        public ReposIssuesRequestMilestone deserialize(JsonParser jp, DeserializationContext ctxt)
