 ...
 */
@JsonDeserialize(using = PullRequest41Assignees.PullRequest41AssigneesDeserializer.class)
public abstract class PullRequest41Assignees {
     ...
     */
    public static PullRequest41Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest41Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest41Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest41Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest41Assignees.
     */
    protected static class PullRequest41AssigneesDeserializer
            extends JsonDeserializer<PullRequest41Assignees> {

        @Override
        public PullRequest41Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
