...
/**
 * This is a model class for Review1 type.
 */
public class Review1 {
    ...
    /**
     * Converts this Review1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Review1 [" + "links=" + links + ", authorAssociation=" + authorAssociation
    ...
    /**
     * Builds a new {@link Review1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Review1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Review1}.
     */
    public static class Builder {
        ...
        public Builder(Links10 links, AuthorAssociationEnum authorAssociation, String body,
                ...
                String state, LocalDateTime submittedAt, Object user) {
            this.links = links;
            this.authorAssociation = authorAssociation;
            this.body = body;
            this.commitId = commitId;
        ...
        /**
         * Builds a new {@link Review1} object using the set fields.
         * @return {@link Review1}
         */
        public Review1 build() {
            return new Review1(links, authorAssociation, body, commitId, htmlUrl, id, nodeId,
                    pullRequestUrl, state, submittedAt, user);
        }
    }
}
