 ...
 */
@JsonDeserialize(using = ManifestMetadata.ManifestMetadataDeserializer.class)
public abstract class ManifestMetadata {
     ...
     */
    public static ManifestMetadata fromMString(String mString) {
     ...
     */
    public static ManifestMetadata fromPrecision(double precision) {
     ...
     */
    public static ManifestMetadata fromMBoolean(boolean mBoolean) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ManifestMetadata {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class PrecisionCase extends ManifestMetadata {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class MBooleanCase extends ManifestMetadata {
    ...
    /**
     * This is a custom deserializer class for ManifestMetadata.
     */
    protected static class ManifestMetadataDeserializer
            extends JsonDeserializer<ManifestMetadata> {

        @Override
        public ManifestMetadata deserialize(JsonParser jp, DeserializationContext ctxt)
