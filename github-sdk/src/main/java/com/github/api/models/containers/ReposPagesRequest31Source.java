 ...
 */
@JsonDeserialize(using = ReposPagesRequest31Source.ReposPagesRequest31SourceDeserializer.class)
public abstract class ReposPagesRequest31Source {
     ...
     */
    public static ReposPagesRequest31Source fromSource2(Source2Enum source2) {
     ...
     */
    public static ReposPagesRequest31Source fromSource21(Source21 source21) {
    ...
    @TypeCombinatorCase
    private static class Source2Case extends ReposPagesRequest31Source {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Source21Case extends ReposPagesRequest31Source {
    ...
    /**
     * This is a custom deserializer class for ReposPagesRequest31Source.
     */
    protected static class ReposPagesRequest31SourceDeserializer
            extends JsonDeserializer<ReposPagesRequest31Source> {

        @Override
        public ReposPagesRequest31Source deserialize(JsonParser jp, DeserializationContext ctxt)
