...
/**
 * This is a model class for InstallationnewPermissionsAcceptedevent type.
 */
public class InstallationnewPermissionsAcceptedevent {
     ...
     * Default constructor.
     */
    public InstallationnewPermissionsAcceptedevent() {
     ...
     */
    protected InstallationnewPermissionsAcceptedevent(String action, Installation48 installation,
            Sender sender, Enterprise1 enterprise, Organization2 organization,
            List<Repository5> repositories, Repository3 repository,
            OptionalNullable<Object> requester) {
        this.action = action;
        this.enterprise = enterprise;
        this.installation = installation;
        this.organization = organization;
    ...
    /**
     * Converts this InstallationnewPermissionsAcceptedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "InstallationnewPermissionsAcceptedevent [" + "action=" + action + ", installation="
                + installation + ", sender=" + sender + ", enterprise=" + enterprise
                + ", organization=" + organization + ", repositories=" + repositories
                + ", repository=" + repository + ", requester=" + requester + "]";
    }

    /**
     * Builds a new {@link InstallationnewPermissionsAcceptedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link InstallationnewPermissionsAcceptedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link InstallationnewPermissionsAcceptedevent}.
     */
    public static class Builder {
        private String action = "new_permissions_accepted";
        private Installation48 installation;
        private Sender sender;
        private Enterprise1 enterprise;
        private Organization2 organization;
        ...
        /**
         * Builds a new {@link InstallationnewPermissionsAcceptedevent} object using the set fields.
         * @return {@link InstallationnewPermissionsAcceptedevent}
         */
        public InstallationnewPermissionsAcceptedevent build() {
            return new InstallationnewPermissionsAcceptedevent(action, installation, sender,
                    enterprise, organization, repositories, repository, requester);
        }
    }
}
