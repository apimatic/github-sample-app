 ...
 */
@JsonDeserialize(using = PullRequest40Assignees.PullRequest40AssigneesDeserializer.class)
public abstract class PullRequest40Assignees {
     ...
     */
    public static PullRequest40Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest40Assignees fromUser3(User3 user3) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest40Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User3Case extends PullRequest40Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest40Assignees.
     */
    protected static class PullRequest40AssigneesDeserializer
            extends JsonDeserializer<PullRequest40Assignees> {

        @Override
        public PullRequest40Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
