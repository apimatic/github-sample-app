...
import com.github.api.models.ReposIssuesIssueNumberLabelsRequest3;
 ...
 */
@JsonDeserialize(using = IssuesSetLabelsBody.IssuesSetLabelsBodyDeserializer.class)
public abstract class IssuesSetLabelsBody {
    
    /**
     * One-of type initialization method.
     * @param reposIssuesIssueNumberLabelsRequest3 ReposIssuesIssueNumberLabelsRequest3 value for reposIssuesIssueNumberLabelsRequest3.
     * @return The ReposIssuesIssueNumberLabelsRequest3Case object.
     */
    public static IssuesSetLabelsBody fromReposIssuesIssueNumberLabelsRequest3(
            ReposIssuesIssueNumberLabelsRequest3 reposIssuesIssueNumberLabelsRequest3) {
        return reposIssuesIssueNumberLabelsRequest3 == null ? null : new ReposIssuesIssueNumberLabelsRequest3Case(reposIssuesIssueNumberLabelsRequest3);
    }
     ...
     */
    public static IssuesSetLabelsBody fromMString(List<String> mString) {
     ...
     */
    public static IssuesSetLabelsBody fromReposIssuesIssueNumberLabelsRequest1(
     ...
     */
    public static IssuesSetLabelsBody fromReposIssuesIssueNumberLabelsRequest2(
     ...
     */
    public static IssuesSetLabelsBody fromString2(String string2) {
    ...
    public interface Cases<R> {
        R reposIssuesIssueNumberLabelsRequest3(ReposIssuesIssueNumberLabelsRequest3 reposIssuesIssueNumberLabelsRequest3);
    ...
    /**
     * This is a implementation class for ReposIssuesIssueNumberLabelsRequest3Case.
     */
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ReposIssuesIssueNumberLabelsRequest3Case extends IssuesSetLabelsBody {

        @JsonValue
        private ReposIssuesIssueNumberLabelsRequest3 reposIssuesIssueNumberLabelsRequest3;

        ReposIssuesIssueNumberLabelsRequest3Case(ReposIssuesIssueNumberLabelsRequest3 reposIssuesIssueNumberLabelsRequest3) {
            this.reposIssuesIssueNumberLabelsRequest3 = reposIssuesIssueNumberLabelsRequest3;
        }

        @Override
        public <R> R match(Cases<R> cases) {
            return cases.reposIssuesIssueNumberLabelsRequest3(this.reposIssuesIssueNumberLabelsRequest3);
        }
        ...
        @JsonCreator
        private ReposIssuesIssueNumberLabelsRequest3Case(JsonNode jsonNode) throws IOException {
            this.reposIssuesIssueNumberLabelsRequest3 = ApiHelper.deserialize(jsonNode,
                ReposIssuesIssueNumberLabelsRequest3.class);
        }

        @Override
        public String toString() {
            return reposIssuesIssueNumberLabelsRequest3.toString();
        }
    }
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class MStringCase extends IssuesSetLabelsBody {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ReposIssuesIssueNumberLabelsRequest1Case extends IssuesSetLabelsBody {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ReposIssuesIssueNumberLabelsRequest2Case extends IssuesSetLabelsBody {
    ...
    @TypeCombinatorCase
    private static class String2Case extends IssuesSetLabelsBody {
    ...
    /**
     * This is a custom deserializer class for IssuesSetLabelsBody.
     */
    protected static class IssuesSetLabelsBodyDeserializer
            extends JsonDeserializer<IssuesSetLabelsBody> {

        @Override
        public IssuesSetLabelsBody deserialize(JsonParser jp, DeserializationContext ctxt)
                throws IOException, JsonProcessingException {
            ObjectCodec oc = jp.getCodec();
            JsonNode node = oc.readTree(jp);
            return ApiHelper.deserialize(node, Arrays.asList(
                    ReposIssuesIssueNumberLabelsRequest3Case.class, MStringCase.class,
