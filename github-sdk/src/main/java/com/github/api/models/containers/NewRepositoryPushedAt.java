 ...
 */
@JsonDeserialize(using = NewRepositoryPushedAt.NewRepositoryPushedAtDeserializer.class)
public abstract class NewRepositoryPushedAt {
     ...
     */
    public static NewRepositoryPushedAt fromNumber(int number) {
     ...
     */
    public static NewRepositoryPushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static NewRepositoryPushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends NewRepositoryPushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends NewRepositoryPushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends NewRepositoryPushedAt {
    ...
    /**
     * This is a custom deserializer class for NewRepositoryPushedAt.
     */
    protected static class NewRepositoryPushedAtDeserializer
            extends JsonDeserializer<NewRepositoryPushedAt> {

        @Override
        public NewRepositoryPushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
