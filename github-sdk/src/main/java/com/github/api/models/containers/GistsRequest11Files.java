 ...
 */
@JsonDeserialize(using = GistsRequest11Files.GistsRequest11FilesDeserializer.class)
public abstract class GistsRequest11Files {
     ...
     */
    public static GistsRequest11Files fromFiles5(Files5 files5) {
     ...
     */
    public static GistsRequest11Files fromFiles51(Files51 files51) {
     ...
     */
    public static GistsRequest11Files fromFiles53(Files53 files53) {
    ...
    @TypeCombinatorCase
    private static class Files5Case extends GistsRequest11Files {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Files51Case extends GistsRequest11Files {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Files53Case extends GistsRequest11Files {
    ...
    /**
     * This is a custom deserializer class for GistsRequest11Files.
     */
    protected static class GistsRequest11FilesDeserializer
            extends JsonDeserializer<GistsRequest11Files> {

        @Override
        public GistsRequest11Files deserialize(JsonParser jp, DeserializationContext ctxt)
