...
/**
 * This is a model class for UserPackagesResponse type.
 */
public class UserPackagesResponse {
    ...
    /**
     * Converts this UserPackagesResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "UserPackagesResponse [" + "id=" + id + ", name=" + name + ", packageType="
                + packageType + ", url=" + url + ", htmlUrl=" + htmlUrl + ", versionCount="
                + versionCount + ", visibility=" + visibility + ", createdAt=" + createdAt
                + ", updatedAt=" + updatedAt + ", owner=" + owner + ", repository=" + repository
                + "]";
    }

    /**
     * Builds a new {@link UserPackagesResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UserPackagesResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UserPackagesResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UserPackagesResponse} object using the set fields.
         * @return {@link UserPackagesResponse}
         */
        public UserPackagesResponse build() {
            return new UserPackagesResponse(id, name, packageType, url, htmlUrl, versionCount,
                    visibility, createdAt, updatedAt, owner, repository);
        }
    }
}
