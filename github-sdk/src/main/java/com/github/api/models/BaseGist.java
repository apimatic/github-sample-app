...
/**
 * This is a model class for BaseGist type.
 */
public class BaseGist {
    ...
    /**
     * Converts this BaseGist into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BaseGist [" + "url=" + url + ", forksUrl=" + forksUrl + ", commitsUrl=" + commitsUrl
    ...
    /**
     * Builds a new {@link BaseGist.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BaseGist.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BaseGist}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BaseGist} object using the set fields.
         * @return {@link BaseGist}
         */
        public BaseGist build() {
            return new BaseGist(url, forksUrl, commitsUrl, id, nodeId, gitPullUrl, gitPushUrl,
                    htmlUrl, files, mPublic, createdAt, updatedAt, description, comments, user,
                    commentsUrl, owner, truncated, forks, history);
        }
    }
}
