...
/**
 * This is a model class for Starcreatedevent type.
 */
public class Starcreatedevent {
    ...
    /**
     * Converts this Starcreatedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Starcreatedevent [" + "action=" + action + ", repository=" + repository
                + ", sender=" + sender + ", starredAt=" + starredAt + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Starcreatedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Starcreatedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Starcreatedevent}.
     */
    public static class Builder {
         ...
         * @param  starredAt  String value for starredAt.
         */
        public Builder(String action, Repository3 repository, Sender sender, String starredAt) {
            this.action = action;
            this.repository = repository;
            this.sender = sender;
            this.starredAt = starredAt;
        ...
        /**
         * Builds a new {@link Starcreatedevent} object using the set fields.
         * @return {@link Starcreatedevent}
         */
        public Starcreatedevent build() {
            return new Starcreatedevent(action, repository, sender, starredAt, enterprise,
