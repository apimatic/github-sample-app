 ...
 */
@JsonDeserialize(using = Repo20PushedAt.Repo20PushedAtDeserializer.class)
public abstract class Repo20PushedAt {
     ...
     */
    public static Repo20PushedAt fromNumber(int number) {
     ...
     */
    public static Repo20PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repo20PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo20PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo20PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repo20PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repo20PushedAt.
     */
    protected static class Repo20PushedAtDeserializer
            extends JsonDeserializer<Repo20PushedAt> {

        @Override
        public Repo20PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
