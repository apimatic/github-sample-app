...
public class Status {
    ...
    public String toString() {
        return "Status [" + "url=" + url + ", avatarUrl=" + avatarUrl + ", id=" + id + ", nodeId="
                + nodeId + ", state=" + state + ", description=" + description + ", targetUrl="
                + targetUrl + ", context=" + context + ", createdAt=" + createdAt + ", updatedAt="
                + updatedAt + ", creator=" + creator + "]";
    }
    ...
    public static class Builder {
         ...
         */
        public Status build() {
            return new Status(url, avatarUrl, id, nodeId, state, description, targetUrl, context,
