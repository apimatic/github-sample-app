...
/**
 * This is a model class for UserMigrationsResponse type.
 */
public class UserMigrationsResponse {
    private int id;
    ...
    /**
     * Converts this UserMigrationsResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "UserMigrationsResponse [" + "id=" + id + ", owner=" + owner + ", guid=" + guid
    ...
    /**
     * Builds a new {@link UserMigrationsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UserMigrationsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UserMigrationsResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UserMigrationsResponse} object using the set fields.
         * @return {@link UserMigrationsResponse}
         */
        public UserMigrationsResponse build() {
            return new UserMigrationsResponse(id, owner, guid, state, lockRepositories,
