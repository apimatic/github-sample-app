...
import com.github.api.models.containers.ReposIssuesIssueNumberAssigneesResponseLabels;
...
/**
 * This is a model class for ReposIssuesIssueNumberAssigneesResponse type.
 */
public class ReposIssuesIssueNumberAssigneesResponse {
    private int id;
    ...
    private Object user;
    private List<ReposIssuesIssueNumberAssigneesResponseLabels> labels;
     ...
     * Default constructor.
     */
    public ReposIssuesIssueNumberAssigneesResponse() {
    }
     ...
     * @param  labels  List of ReposIssuesIssueNumberAssigneesResponseLabels value for labels.
    ...
    public ReposIssuesIssueNumberAssigneesResponse(
            ...
            String title,
            Object user,
            List<ReposIssuesIssueNumberAssigneesResponseLabels> labels,
            Object assignee,
            Object milestone,
            boolean locked,
            int comments,
     ...
     */
    protected ReposIssuesIssueNumberAssigneesResponse(int id, String nodeId, String url,
            String repositoryUrl, String labelsUrl, String commentsUrl, String eventsUrl,
            String htmlUrl, int number, String state, String title, Object user,
            List<ReposIssuesIssueNumberAssigneesResponseLabels> labels, Object assignee,
            Object milestone, boolean locked, int comments, LocalDateTime closedAt,
            LocalDateTime createdAt, LocalDateTime updatedAt,
            AuthorAssociationEnum authorAssociation, Object stateReason,
     ...
     * @return Returns the List of ReposIssuesIssueNumberAssigneesResponseLabels
     */
    @JsonGetter("labels")
    public List<ReposIssuesIssueNumberAssigneesResponseLabels> getLabels() {
        return labels;
    }
     ...
     * labels on this issue; send an empty array to clear all labels from the issue; note that the
     * labels are silently dropped for users without push access to the repository
     * @param labels Value for List of ReposIssuesIssueNumberAssigneesResponseLabels
     */
    @JsonSetter("labels")
    public void setLabels(List<ReposIssuesIssueNumberAssigneesResponseLabels> labels) {
        this.labels = labels;
    }
    ...
    /**
     * Converts this ReposIssuesIssueNumberAssigneesResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReposIssuesIssueNumberAssigneesResponse [" + "id=" + id + ", nodeId=" + nodeId
                + ", url=" + url + ", repositoryUrl=" + repositoryUrl + ", labelsUrl=" + labelsUrl
                + ", commentsUrl=" + commentsUrl + ", eventsUrl=" + eventsUrl + ", htmlUrl="
                + htmlUrl + ", number=" + number + ", state=" + state + ", title=" + title
                + ", user=" + user + ", labels=" + labels + ", assignee=" + assignee
                + ", milestone=" + milestone + ", locked=" + locked + ", comments=" + comments
                + ", closedAt=" + closedAt + ", createdAt=" + createdAt + ", updatedAt=" + updatedAt
                + ", authorAssociation=" + authorAssociation + ", stateReason=" + stateReason
                + ", body=" + body + ", assignees=" + assignees + ", activeLockReason="
                + activeLockReason + ", pullRequest=" + pullRequest + ", draft=" + draft
                + ", closedBy=" + closedBy + ", bodyHtml=" + bodyHtml + ", bodyText=" + bodyText
                + ", timelineUrl=" + timelineUrl + ", repository=" + repository
                + ", performedViaGithubApp=" + performedViaGithubApp + ", reactions=" + reactions
                + "]";
    }

    /**
     * Builds a new {@link ReposIssuesIssueNumberAssigneesResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReposIssuesIssueNumberAssigneesResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReposIssuesIssueNumberAssigneesResponse}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder labels(List<ReposIssuesIssueNumberAssigneesResponseLabels> labels) {
            this.labels = labels;
            return this;
        }
        ...
        /**
         * Builds a new {@link ReposIssuesIssueNumberAssigneesResponse} object using the set fields.
         * @return {@link ReposIssuesIssueNumberAssigneesResponse}
         */
        public ReposIssuesIssueNumberAssigneesResponse build() {
            return new ReposIssuesIssueNumberAssigneesResponse(id, nodeId, url, repositoryUrl,
                    labelsUrl, commentsUrl, eventsUrl, htmlUrl, number, state, title, user, labels,
                    assignee, milestone, locked, comments, closedAt, createdAt, updatedAt,
                    authorAssociation, stateReason, body, assignees, activeLockReason, pullRequest,
                    draft, closedBy, bodyHtml, bodyText, timelineUrl, repository,
