...
/**
 * This is a model class for RequestedTeam7 type.
 */
public class RequestedTeam7 {
    private int id;
    ...
    /**
     * Converts this RequestedTeam7 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RequestedTeam7 [" + "id=" + id + ", nodeId=" + nodeId + ", name=" + name + ", slug="
                + slug + ", description=" + description + ", permission=" + permission + ", url="
                + url + ", htmlUrl=" + htmlUrl + ", membersUrl=" + membersUrl + ", repositoriesUrl="
                + repositoriesUrl + ", parent=" + parent + ", privacy=" + privacy + ", permissions="
                + permissions + "]";
    }

    /**
     * Builds a new {@link RequestedTeam7.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RequestedTeam7.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RequestedTeam7}.
     */
    public static class Builder {
        ...
        public Builder(int id, String nodeId, String name, String slug, String description,
                ...
                String repositoriesUrl, Parent3 parent) {
            this.id = id;
            this.nodeId = nodeId;
            this.name = name;
            this.slug = slug;
        ...
        /**
         * Builds a new {@link RequestedTeam7} object using the set fields.
         * @return {@link RequestedTeam7}
         */
        public RequestedTeam7 build() {
            return new RequestedTeam7(id, nodeId, name, slug, description, permission, url, htmlUrl,
