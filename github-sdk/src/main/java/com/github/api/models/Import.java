...
/**
 * This is a model class for Import type.
 */
public class Import {
    private String vcs;
     ...
     */
    protected Import(String vcs, String vcsUrl, Status10Enum status, String url, String htmlUrl,
            String authorsUrl, String repositoryUrl, Boolean useLfs, String svcRoot,
    ...
    /**
     * Converts this Import into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Import [" + "vcs=" + vcs + ", vcsUrl=" + vcsUrl + ", status=" + status + ", url="
                + url + ", htmlUrl=" + htmlUrl + ", authorsUrl=" + authorsUrl + ", repositoryUrl="
                + repositoryUrl + ", useLfs=" + useLfs + ", svcRoot=" + svcRoot + ", tfvcProject="
                + tfvcProject + ", statusText=" + statusText + ", failedStep=" + failedStep
                + ", errorMessage=" + errorMessage + ", importPercent=" + importPercent
    ...
    /**
     * Builds a new {@link Import.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Import.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Import}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Import} object using the set fields.
         * @return {@link Import}
         */
        public Import build() {
            return new Import(vcs, vcsUrl, status, url, htmlUrl, authorsUrl, repositoryUrl, useLfs,
                    svcRoot, tfvcProject, statusText, failedStep, errorMessage, importPercent,
                    commitCount, pushPercent, hasLargeFiles, largeFilesSize, largeFilesCount,
                    projectChoices, message, authorsCount, svnRoot);
        }
    }
}
