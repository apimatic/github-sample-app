 ...
 */
@JsonDeserialize(using = Repo11CreatedAt.Repo11CreatedAtDeserializer.class)
public abstract class Repo11CreatedAt {
     ...
     */
    public static Repo11CreatedAt fromNumber(int number) {
     ...
     */
    public static Repo11CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo11CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo11CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repo11CreatedAt.
     */
    protected static class Repo11CreatedAtDeserializer
            extends JsonDeserializer<Repo11CreatedAt> {

        @Override
        public Repo11CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
