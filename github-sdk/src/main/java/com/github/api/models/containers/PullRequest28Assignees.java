 ...
 */
@JsonDeserialize(using = PullRequest28Assignees.PullRequest28AssigneesDeserializer.class)
public abstract class PullRequest28Assignees {
     ...
     */
    public static PullRequest28Assignees fromObject(Map<String, Object> object) {
     ...
     */
    public static PullRequest28Assignees fromUser65(User65 user65) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends PullRequest28Assignees {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class User65Case extends PullRequest28Assignees {
    ...
    /**
     * This is a custom deserializer class for PullRequest28Assignees.
     */
    protected static class PullRequest28AssigneesDeserializer
            extends JsonDeserializer<PullRequest28Assignees> {

        @Override
        public PullRequest28Assignees deserialize(JsonParser jp, DeserializationContext ctxt)
