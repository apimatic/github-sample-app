...
/**
 * SecurityProduct1Enum to be used.
 */
public enum SecurityProduct1Enum {
    DEPENDENCY_GRAPH,
    ...
    private static TreeMap<String, SecurityProduct1Enum> valueMap = new TreeMap<>();
    ...
    public static SecurityProduct1Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of SecurityProduct1Enum values to list of string values.
     * @param toConvert The list of SecurityProduct1Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SecurityProduct1Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SecurityProduct1Enum enumValue : toConvert) {
