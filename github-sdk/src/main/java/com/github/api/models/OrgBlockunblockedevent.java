...
/**
 * This is a model class for OrgBlockunblockedevent type.
 */
public class OrgBlockunblockedevent {
    private String action;
    private Object blockedUser;
     ...
     * @param  blockedUser  Object value for blockedUser.
    ...
    /**
     * Getter for BlockedUser.
     * @return Returns the Object
     */
    @JsonGetter("blocked_user")
    public Object getBlockedUser() {
        return blockedUser;
    }

    /**
     * Setter for BlockedUser.
     * @param blockedUser Value for Object
     */
    @JsonSetter("blocked_user")
    public void setBlockedUser(Object blockedUser) {
        this.blockedUser = blockedUser;
    }
    ...
    /**
     * Converts this OrgBlockunblockedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OrgBlockunblockedevent [" + "action=" + action + ", blockedUser=" + blockedUser
    ...
    /**
     * Builds a new {@link OrgBlockunblockedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link OrgBlockunblockedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, blockedUser, organization, sender)
    ...
    /**
     * Class to build instances of {@link OrgBlockunblockedevent}.
     */
    public static class Builder {
        private String action = "unblocked";
        private Object blockedUser;
        private Organization2 organization;
        private Sender sender;
        private Enterprise1 enterprise;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Object blockedUser, Organization2 organization,
                Sender sender) {
            this.action = action;
            this.blockedUser = blockedUser;
            this.organization = organization;
         ...
         * @return Builder
         */
        public Builder blockedUser(Object blockedUser) {
            this.blockedUser = blockedUser;
            return this;
        }
        ...
        /**
         * Builds a new {@link OrgBlockunblockedevent} object using the set fields.
         * @return {@link OrgBlockunblockedevent}
         */
        public OrgBlockunblockedevent build() {
            return new OrgBlockunblockedevent(action, blockedUser, organization, sender, enterprise,
