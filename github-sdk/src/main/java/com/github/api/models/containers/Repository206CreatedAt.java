 ...
 */
@JsonDeserialize(using = Repository206CreatedAt.Repository206CreatedAtDeserializer.class)
public abstract class Repository206CreatedAt {
     ...
     */
    public static Repository206CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository206CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository206CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository206CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository206CreatedAt.
     */
    protected static class Repository206CreatedAtDeserializer
            extends JsonDeserializer<Repository206CreatedAt> {

        @Override
        public Repository206CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
