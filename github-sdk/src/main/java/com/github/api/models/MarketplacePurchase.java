...
/**
 * This is a model class for MarketplacePurchase type.
 */
public class MarketplacePurchase {
     ...
     */
    protected MarketplacePurchase(String url, String type, int id, String login,
    ...
    /**
     * Converts this MarketplacePurchase into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MarketplacePurchase [" + "url=" + url + ", type=" + type + ", id=" + id + ", login="
                + login + ", marketplacePurchase=" + marketplacePurchase
                + ", organizationBillingEmail=" + organizationBillingEmail + ", email=" + email
                + ", marketplacePendingChange=" + marketplacePendingChange + "]";
    }

    /**
     * Builds a new {@link MarketplacePurchase.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MarketplacePurchase.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MarketplacePurchase}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link MarketplacePurchase} object using the set fields.
         * @return {@link MarketplacePurchase}
         */
        public MarketplacePurchase build() {
            return new MarketplacePurchase(url, type, id, login, marketplacePurchase,
