...
/**
 * This is a model class for RepositoryInvitation type.
 */
public class RepositoryInvitation {
    ...
    /**
     * Converts this RepositoryInvitation into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "RepositoryInvitation [" + "id=" + id + ", repository=" + repository + ", invitee="
                + invitee + ", inviter=" + inviter + ", permissions=" + permissions + ", createdAt="
                + createdAt + ", url=" + url + ", htmlUrl=" + htmlUrl + ", nodeId=" + nodeId
                + ", expired=" + expired + "]";
    }

    /**
     * Builds a new {@link RepositoryInvitation.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link RepositoryInvitation.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link RepositoryInvitation}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link RepositoryInvitation} object using the set fields.
         * @return {@link RepositoryInvitation}
         */
        public RepositoryInvitation build() {
            return new RepositoryInvitation(id, repository, invitee, inviter, permissions,
                    createdAt, url, htmlUrl, nodeId, expired);
        }
    }
}
