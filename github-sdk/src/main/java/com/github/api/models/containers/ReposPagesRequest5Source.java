 ...
 */
@JsonDeserialize(using = ReposPagesRequest5Source.ReposPagesRequest5SourceDeserializer.class)
public abstract class ReposPagesRequest5Source {
     ...
     */
    public static ReposPagesRequest5Source fromSource2(Source2Enum source2) {
     ...
     */
    public static ReposPagesRequest5Source fromSource21(Source21 source21) {
    ...
    @TypeCombinatorCase
    private static class Source2Case extends ReposPagesRequest5Source {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Source21Case extends ReposPagesRequest5Source {
    ...
    /**
     * This is a custom deserializer class for ReposPagesRequest5Source.
     */
    protected static class ReposPagesRequest5SourceDeserializer
            extends JsonDeserializer<ReposPagesRequest5Source> {

        @Override
        public ReposPagesRequest5Source deserialize(JsonParser jp, DeserializationContext ctxt)
