...
/**
 * This is a model class for Milestone type.
 */
public class Milestone {
    ...
    /**
     * Converts this Milestone into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Milestone [" + "url=" + url + ", htmlUrl=" + htmlUrl + ", labelsUrl=" + labelsUrl
                + ", id=" + id + ", nodeId=" + nodeId + ", number=" + number + ", state=" + state
                + ", title=" + title + ", description=" + description + ", creator=" + creator
                + ", openIssues=" + openIssues + ", closedIssues=" + closedIssues + ", createdAt="
                + createdAt + ", updatedAt=" + updatedAt + ", closedAt=" + closedAt + ", dueOn="
                + dueOn + "]";
    }

    /**
     * Builds a new {@link Milestone.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Milestone.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Milestone}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Milestone} object using the set fields.
         * @return {@link Milestone}
         */
        public Milestone build() {
            return new Milestone(url, htmlUrl, labelsUrl, id, nodeId, number, state, title,
                    description, creator, openIssues, closedIssues, createdAt, updatedAt, closedAt,
                    dueOn);
        }
    }
