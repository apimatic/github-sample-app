 ...
 */
@JsonDeserialize(using = Repo13CreatedAt.Repo13CreatedAtDeserializer.class)
public abstract class Repo13CreatedAt {
     ...
     */
    public static Repo13CreatedAt fromNumber(int number) {
     ...
     */
    public static Repo13CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo13CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo13CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repo13CreatedAt.
     */
    protected static class Repo13CreatedAtDeserializer
            extends JsonDeserializer<Repo13CreatedAt> {

        @Override
        public Repo13CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
