...
/**
 * This is a model class for Repositoryeditedevent type.
 */
public class Repositoryeditedevent {
    private String action;
    private Changes29 changes;
     ...
     * @param  changes  Changes29 value for changes.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes29
     */
    @JsonGetter("changes")
    public Changes29 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes29
     */
    @JsonSetter("changes")
    public void setChanges(Changes29 changes) {
        this.changes = changes;
    }
    ...
    /**
     * Converts this Repositoryeditedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repositoryeditedevent [" + "action=" + action + ", changes=" + changes
                + ", repository=" + repository + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Repositoryeditedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repositoryeditedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Repositoryeditedevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes29 changes, Repository3 repository, Sender sender) {
            this.action = action;
            this.changes = changes;
            this.repository = repository;
            this.sender = sender;
         ...
         * @return Builder
         */
        public Builder changes(Changes29 changes) {
            this.changes = changes;
            return this;
        }
        ...
        /**
         * Builds a new {@link Repositoryeditedevent} object using the set fields.
         * @return {@link Repositoryeditedevent}
         */
        public Repositoryeditedevent build() {
            return new Repositoryeditedevent(action, changes, repository, sender, enterprise,
