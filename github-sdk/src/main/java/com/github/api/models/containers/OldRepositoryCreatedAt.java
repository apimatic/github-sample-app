 ...
 */
@JsonDeserialize(using = OldRepositoryCreatedAt.OldRepositoryCreatedAtDeserializer.class)
public abstract class OldRepositoryCreatedAt {
     ...
     */
    public static OldRepositoryCreatedAt fromNumber(int number) {
     ...
     */
    public static OldRepositoryCreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends OldRepositoryCreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends OldRepositoryCreatedAt {
    ...
    /**
     * This is a custom deserializer class for OldRepositoryCreatedAt.
     */
    protected static class OldRepositoryCreatedAtDeserializer
            extends JsonDeserializer<OldRepositoryCreatedAt> {

        @Override
        public OldRepositoryCreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
