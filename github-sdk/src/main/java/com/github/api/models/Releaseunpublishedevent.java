...
/**
 * This is a model class for Releaseunpublishedevent type.
 */
public class Releaseunpublishedevent {
     ...
     * Default constructor.
     */
    public Releaseunpublishedevent() {
        action = "unpublished";
    }
    ...
    /**
     * Converts this Releaseunpublishedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Releaseunpublishedevent [" + "action=" + action + ", release=" + release
                + ", repository=" + repository + ", enterprise=" + enterprise + ", installation="
                + installation + ", organization=" + organization + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link Releaseunpublishedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Releaseunpublishedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, release, repository)
    ...
    /**
     * Class to build instances of {@link Releaseunpublishedevent}.
     */
    public static class Builder {
        private String action = "unpublished";
        private Release9 release;
        private Repository3 repository;
        private Enterprise1 enterprise;
        private Installation1 installation;
         ...
         * @param  repository  Repository3 value for repository.
         */
        public Builder(String action, Release9 release, Repository3 repository) {
            this.action = action;
            this.release = release;
            this.repository = repository;
        }
        ...
        /**
         * Builds a new {@link Releaseunpublishedevent} object using the set fields.
         * @return {@link Releaseunpublishedevent}
         */
        public Releaseunpublishedevent build() {
            return new Releaseunpublishedevent(action, release, repository, enterprise,
