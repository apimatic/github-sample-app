...
/**
 * This is a model class for SecretScanningAlertreopenedevent type.
 */
public class SecretScanningAlertreopenedevent {
     ...
     * Default constructor.
     */
    public SecretScanningAlertreopenedevent() {
        action = "reopened";
    }
    ...
    /**
     * Converts this SecretScanningAlertreopenedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SecretScanningAlertreopenedevent [" + "action=" + action + ", alert=" + alert
                + ", repository=" + repository + ", enterprise=" + enterprise + ", installation="
                + installation + ", organization=" + organization + ", sender=" + sender + "]";
    }

    /**
     * Builds a new {@link SecretScanningAlertreopenedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SecretScanningAlertreopenedevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SecretScanningAlertreopenedevent}.
     */
    public static class Builder {
        private String action = "reopened";
        private SecretScanningAlert alert;
        private Repository3 repository;
        private Enterprise1 enterprise;
        private Installation1 installation;
         ...
         * @param  repository  Repository3 value for repository.
         */
        public Builder(String action, SecretScanningAlert alert, Repository3 repository) {
            this.action = action;
            this.alert = alert;
            this.repository = repository;
        }
        ...
        /**
         * Builds a new {@link SecretScanningAlertreopenedevent} object using the set fields.
         * @return {@link SecretScanningAlertreopenedevent}
         */
        public SecretScanningAlertreopenedevent build() {
            return new SecretScanningAlertreopenedevent(action, alert, repository, enterprise,
