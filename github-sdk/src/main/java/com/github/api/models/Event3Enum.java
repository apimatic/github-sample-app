...
public enum Event3Enum {
    ...
    private static TreeMap<String, Event3Enum> valueMap = new TreeMap<>();
    ...
    public static Event3Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Event3Enum values to list of string values.
     * @param toConvert The list of Event3Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Event3Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Event3Enum enumValue : toConvert) {
