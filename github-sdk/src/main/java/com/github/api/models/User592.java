...
/**
 * This is a model class for User592 type.
 */
public class User592 {
     ...
     */
    protected User592(String avatarUrl, Boolean deleted, OptionalNullable<String> email,
            String eventsUrl, String followersUrl, String followingUrl, String gistsUrl,
            String gravatarId, String htmlUrl, Integer id, String login, String name, String nodeId,
            String organizationsUrl, String receivedEventsUrl, String reposUrl, Boolean siteAdmin,
            String starredUrl, String subscriptionsUrl, Type4Enum type, String url) {
        this.avatarUrl = avatarUrl;
        this.deleted = deleted;
        this.email = email;
        this.eventsUrl = eventsUrl;
    ...
    /**
     * Converts this User592 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "User592 [" + "avatarUrl=" + avatarUrl + ", deleted=" + deleted + ", email=" + email
                + ", eventsUrl=" + eventsUrl + ", followersUrl=" + followersUrl + ", followingUrl="
                + followingUrl + ", gistsUrl=" + gistsUrl + ", gravatarId=" + gravatarId
                + ", htmlUrl=" + htmlUrl + ", id=" + id + ", login=" + login + ", name=" + name
                + ", nodeId=" + nodeId + ", organizationsUrl=" + organizationsUrl
    ...
    /**
     * Builds a new {@link User592.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link User592.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link User592}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link User592} object using the set fields.
         * @return {@link User592}
         */
        public User592 build() {
            return new User592(avatarUrl, deleted, email, eventsUrl, followersUrl, followingUrl,
                    gistsUrl, gravatarId, htmlUrl, id, login, name, nodeId, organizationsUrl,
