...
/**
 * This is a model class for Config9 type.
 */
public class Config9 {
    ...
    /**
     * Converts this Config9 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Config9 [" + "url=" + url + ", contentType=" + contentType + ", secret=" + secret
                + ", insecureSsl=" + insecureSsl + "]";
    }

    /**
     * Builds a new {@link Config9.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Config9.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Config9}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Config9} object using the set fields.
         * @return {@link Config9}
         */
        public Config9 build() {
            return new Config9(url, contentType, secret, insecureSsl);
        }
    }
}
