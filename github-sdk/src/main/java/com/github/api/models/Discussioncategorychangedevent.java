...
/**
 * This is a model class for Discussioncategorychangedevent type.
 */
public class Discussioncategorychangedevent {
    private String action;
    private Changes1 changes;
     ...
     * Default constructor.
     */
    public Discussioncategorychangedevent() {
     ...
     * @param  changes  Changes1 value for changes.
     * @param  discussion  Discussion1 value for discussion.
    ...
    /**
     * Getter for Changes.
     * @return Returns the Changes1
     */
    @JsonGetter("changes")
    public Changes1 getChanges() {
        return changes;
    }

    /**
     * Setter for Changes.
     * @param changes Value for Changes1
     */
    @JsonSetter("changes")
    public void setChanges(Changes1 changes) {
        this.changes = changes;
    }
    ...
    public Discussion1 getDiscussion() {
        return discussion;
    }

    /**
     * Setter for Discussion.
     * @param discussion Value for Discussion1
     */
    @JsonSetter("discussion")
    public void setDiscussion(Discussion1 discussion) {
        this.discussion = discussion;
    }
    ...
    /**
     * Converts this Discussioncategorychangedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Discussioncategorychangedevent [" + "action=" + action + ", changes=" + changes
                + ", discussion=" + discussion + ", repository=" + repository + ", sender=" + sender
                + ", enterprise=" + enterprise + ", installation=" + installation
                + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Discussioncategorychangedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Discussioncategorychangedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, changes, discussion, repository, sender)
    ...
    /**
     * Class to build instances of {@link Discussioncategorychangedevent}.
     */
    public static class Builder {
        private String action = "category_changed";
        private Changes1 changes;
        private Discussion1 discussion;
        private Repository3 repository;
        private Sender sender;
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, Changes1 changes, Discussion1 discussion,
         ...
         * @return Builder
         */
        public Builder changes(Changes1 changes) {
            this.changes = changes;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder discussion(Discussion1 discussion) {
            this.discussion = discussion;
            return this;
        }
        ...
        /**
         * Builds a new {@link Discussioncategorychangedevent} object using the set fields.
         * @return {@link Discussioncategorychangedevent}
         */
        public Discussioncategorychangedevent build() {
            return new Discussioncategorychangedevent(action, changes, discussion, repository,
