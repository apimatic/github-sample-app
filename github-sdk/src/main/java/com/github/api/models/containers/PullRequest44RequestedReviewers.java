 ...
 */
@JsonDeserialize(using = PullRequest44RequestedReviewers.PullRequest44RequestedReviewersDeserializer.class)
public abstract class PullRequest44RequestedReviewers {
     ...
     */
    public static PullRequest44RequestedReviewers fromDynamic(DynamicResponse dynamic) {
     ...
     */
    public static PullRequest44RequestedReviewers fromTeam4(Team4 team4) {
    ...
    @TypeCombinatorCase
    private static class DynamicCase extends PullRequest44RequestedReviewers {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class Team4Case extends PullRequest44RequestedReviewers {
    ...
    /**
     * This is a custom deserializer class for PullRequest44RequestedReviewers.
     */
    protected static class PullRequest44RequestedReviewersDeserializer
            extends JsonDeserializer<PullRequest44RequestedReviewers> {

        @Override
        public PullRequest44RequestedReviewers deserialize(JsonParser jp, DeserializationContext ctxt)
