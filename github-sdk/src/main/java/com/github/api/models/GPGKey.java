...
/**
 * This is a model class for GPGKey type.
 */
public class GPGKey {
    private int id;
     ...
     */
    protected GPGKey(int id, Integer primaryKeyId, String keyId, String publicKey,
    ...
    /**
     * Converts this GPGKey into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GPGKey [" + "id=" + id + ", primaryKeyId=" + primaryKeyId + ", keyId=" + keyId
    ...
    /**
     * Builds a new {@link GPGKey.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GPGKey.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GPGKey}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GPGKey} object using the set fields.
         * @return {@link GPGKey}
         */
        public GPGKey build() {
            return new GPGKey(id, primaryKeyId, keyId, publicKey, emails, subkeys, canSign,
                    canEncryptComms, canEncryptStorage, canCertify, createdAt, expiresAt, revoked,
                    rawKey, name);
        }
    }
