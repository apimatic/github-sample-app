 ...
 */
@JsonDeserialize(using = Repository52PushedAt.Repository52PushedAtDeserializer.class)
public abstract class Repository52PushedAt {
     ...
     */
    public static Repository52PushedAt fromNumber(int number) {
     ...
     */
    public static Repository52PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repository52PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository52PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository52PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repository52PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository52PushedAt.
     */
    protected static class Repository52PushedAtDeserializer
            extends JsonDeserializer<Repository52PushedAt> {

        @Override
        public Repository52PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
