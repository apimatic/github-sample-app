...
/**
 * This is a model class for Repository1 type.
 */
public class Repository1 {
    ...
    /**
     * Converts this Repository1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repository1 [" + "id=" + id + ", nodeId=" + nodeId + ", name=" + name
    ...
    /**
     * Builds a new {@link Repository1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repository1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Repository1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Repository1} object using the set fields.
         * @return {@link Repository1}
         */
        public Repository1 build() {
            return new Repository1(id, nodeId, name, fullName, owner, mPrivate, htmlUrl,
                    description, fork, url, archiveUrl, assigneesUrl, blobsUrl, branchesUrl,
