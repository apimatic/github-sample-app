...
/**
 * This is a model class for EnterprisesActionsRunnerGroupsRequest type.
 */
public class EnterprisesActionsRunnerGroupsRequest {
    private String name;
    private Visibility78Enum visibility;
    private List<Integer> selectedOrganizationIds;
     ...
     * Default constructor.
     */
    public EnterprisesActionsRunnerGroupsRequest() {
     ...
     * @param  visibility  Visibility78Enum value for visibility.
     * @param  selectedOrganizationIds  List of Integer value for selectedOrganizationIds.
     ...
     * @return Returns the Visibility78Enum
     */
    @JsonGetter("visibility")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Visibility78Enum getVisibility() {
        return visibility;
    }

    /**
     * Setter for Visibility.
     * @param visibility Value for Visibility78Enum
     */
    @JsonSetter("visibility")
    public void setVisibility(Visibility78Enum visibility) {
        this.visibility = visibility;
    }

    /**
     * Getter for SelectedOrganizationIds.
     * List of organization IDs that can access the runner group.
     * @return Returns the List of Integer
     */
    @JsonGetter("selected_organization_ids")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    /**
     * Setter for SelectedOrganizationIds.
     * List of organization IDs that can access the runner group.
     * @param selectedOrganizationIds Value for List of Integer
     */
    @JsonSetter("selected_organization_ids")
    ...
    /**
     * Converts this EnterprisesActionsRunnerGroupsRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "EnterprisesActionsRunnerGroupsRequest [" + "name=" + name + ", visibility="
                + visibility + ", selectedOrganizationIds=" + selectedOrganizationIds + ", runners="
    ...
    /**
     * Builds a new {@link EnterprisesActionsRunnerGroupsRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link EnterprisesActionsRunnerGroupsRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(name)
                .visibility(getVisibility())
                .selectedOrganizationIds(getSelectedOrganizationIds())
                .runners(getRunners())
    ...
    /**
     * Class to build instances of {@link EnterprisesActionsRunnerGroupsRequest}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder visibility(Visibility78Enum visibility) {
            this.visibility = visibility;
            return this;
        }
        ...
        /**
         * Builds a new {@link EnterprisesActionsRunnerGroupsRequest} object using the set fields.
         * @return {@link EnterprisesActionsRunnerGroupsRequest}
         */
        public EnterprisesActionsRunnerGroupsRequest build() {
            return new EnterprisesActionsRunnerGroupsRequest(name, visibility,
                    selectedOrganizationIds, runners, allowsPublicRepositories,
