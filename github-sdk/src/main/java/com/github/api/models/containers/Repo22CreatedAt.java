 ...
 */
@JsonDeserialize(using = Repo22CreatedAt.Repo22CreatedAtDeserializer.class)
public abstract class Repo22CreatedAt {
     ...
     */
    public static Repo22CreatedAt fromNumber(int number) {
     ...
     */
    public static Repo22CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repo22CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repo22CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repo22CreatedAt.
     */
    protected static class Repo22CreatedAtDeserializer
            extends JsonDeserializer<Repo22CreatedAt> {

        @Override
        public Repo22CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
