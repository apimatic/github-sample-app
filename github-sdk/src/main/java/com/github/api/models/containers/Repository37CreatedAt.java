 ...
 */
@JsonDeserialize(using = Repository37CreatedAt.Repository37CreatedAtDeserializer.class)
public abstract class Repository37CreatedAt {
     ...
     */
    public static Repository37CreatedAt fromNumber(int number) {
     ...
     */
    public static Repository37CreatedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository37CreatedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository37CreatedAt {
    ...
    /**
     * This is a custom deserializer class for Repository37CreatedAt.
     */
    protected static class Repository37CreatedAtDeserializer
            extends JsonDeserializer<Repository37CreatedAt> {

        @Override
        public Repository37CreatedAt deserialize(JsonParser jp, DeserializationContext ctxt)
