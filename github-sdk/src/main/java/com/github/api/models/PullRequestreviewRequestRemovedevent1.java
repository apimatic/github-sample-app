...
/**
 * This is a model class for PullRequestreviewRequestRemovedevent1 type.
 */
public class PullRequestreviewRequestRemovedevent1 {
    private String action;
    private Enterprise1 enterprise;
    private Installation1 installation;
    private int number;
    private Organization2 organization;
    private PullRequest47 pullRequest;
    private Repository3 repository;
    private RequestedTeam5 requestedTeam;
    private Sender sender;

    /**
     * Default constructor.
     */
    public PullRequestreviewRequestRemovedevent1() {
     ...
     * @param  pullRequest  PullRequest47 value for pullRequest.
     * @param  repository  Repository3 value for repository.
     * @param  requestedTeam  RequestedTeam5 value for requestedTeam.
    ...
    public PullRequestreviewRequestRemovedevent1(
            String action,
            int number,
            PullRequest47 pullRequest,
            Repository3 repository,
            RequestedTeam5 requestedTeam,
            Sender sender,
     ...
     * @return Returns the PullRequest47
     */
    @JsonGetter("pull_request")
    public PullRequest47 getPullRequest() {
        return pullRequest;
    }

    /**
     * Setter for PullRequest.
     * @param pullRequest Value for PullRequest47
     */
    @JsonSetter("pull_request")
    public void setPullRequest(PullRequest47 pullRequest) {
        this.pullRequest = pullRequest;
    }
     ...
     * @return Returns the RequestedTeam5
     */
    @JsonGetter("requested_team")
    public RequestedTeam5 getRequestedTeam() {
        return requestedTeam;
    }

    /**
     * Setter for RequestedTeam.
     * @param requestedTeam Value for RequestedTeam5
     */
    @JsonSetter("requested_team")
    public void setRequestedTeam(RequestedTeam5 requestedTeam) {
        this.requestedTeam = requestedTeam;
    }
    ...
    /**
     * Converts this PullRequestreviewRequestRemovedevent1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestreviewRequestRemovedevent1 [" + "action=" + action + ", number=" + number
                + ", pullRequest=" + pullRequest + ", repository=" + repository + ", requestedTeam="
                + requestedTeam + ", sender=" + sender + ", enterprise=" + enterprise
                + ", installation=" + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link PullRequestreviewRequestRemovedevent1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestreviewRequestRemovedevent1.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, number, pullRequest, repository, requestedTeam,
                sender)
    ...
    /**
     * Class to build instances of {@link PullRequestreviewRequestRemovedevent1}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest47 pullRequest, Repository3 repository,
                RequestedTeam5 requestedTeam, Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
            this.repository = repository;
         ...
         * @return Builder
         */
        public Builder pullRequest(PullRequest47 pullRequest) {
            this.pullRequest = pullRequest;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder requestedTeam(RequestedTeam5 requestedTeam) {
            this.requestedTeam = requestedTeam;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequestreviewRequestRemovedevent1} object using the set fields.
         * @return {@link PullRequestreviewRequestRemovedevent1}
         */
        public PullRequestreviewRequestRemovedevent1 build() {
            return new PullRequestreviewRequestRemovedevent1(action, number, pullRequest,
                    repository, requestedTeam, sender, enterprise, installation, organization);
        }
    }
}
