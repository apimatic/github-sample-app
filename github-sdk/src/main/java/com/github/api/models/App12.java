...
/**
 * This is a model class for App12 type.
 */
public class App12 {
    private LocalDateTime createdAt;
    private String description;
    private List<Event11Enum> events;
     ...
     * @param  events  List of Event11Enum value for events.
     ...
     * @return Returns the List of Event11Enum
     */
    @JsonGetter("events")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<Event11Enum> getEvents() {
        return events;
    }
     ...
     * Setter for Events.
     * The list of events for the GitHub app
     * @param events Value for List of Event11Enum
     */
    @JsonSetter("events")
    public void setEvents(List<Event11Enum> events) {
        this.events = events;
    }
    ...
    /**
     * Converts this App12 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "App12 [" + "createdAt=" + createdAt + ", description=" + description
    ...
    /**
     * Builds a new {@link App12.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link App12.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link App12}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder events(List<Event11Enum> events) {
            this.events = events;
            return this;
        }
        ...
        /**
         * Builds a new {@link App12} object using the set fields.
         * @return {@link App12}
         */
        public App12 build() {
            return new App12(createdAt, description, externalUrl, htmlUrl, id, name, nodeId, owner,
