...
/**
 * This is a model class for Repositorypublicizedevent type.
 */
public class Repositorypublicizedevent {
     ...
     * Default constructor.
     */
    public Repositorypublicizedevent() {
        action = "publicized";
    }
    ...
    /**
     * Converts this Repositorypublicizedevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Repositorypublicizedevent [" + "action=" + action + ", repository=" + repository
                + ", sender=" + sender + ", enterprise=" + enterprise + ", installation="
                + installation + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link Repositorypublicizedevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Repositorypublicizedevent.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(action, repository, sender)
    ...
    /**
     * Class to build instances of {@link Repositorypublicizedevent}.
     */
    public static class Builder {
        private String action = "publicized";
        private Repository3 repository;
        private Sender sender;
        private Enterprise1 enterprise;
        private Installation1 installation;
        ...
        /**
         * Builds a new {@link Repositorypublicizedevent} object using the set fields.
         * @return {@link Repositorypublicizedevent}
         */
        public Repositorypublicizedevent build() {
            return new Repositorypublicizedevent(action, repository, sender, enterprise,
