 ...
 */
@JsonDeserialize(using = Repository20PushedAt.Repository20PushedAtDeserializer.class)
public abstract class Repository20PushedAt {
     ...
     */
    public static Repository20PushedAt fromNumber(int number) {
     ...
     */
    public static Repository20PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository20PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository20PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository20PushedAt.
     */
    protected static class Repository20PushedAtDeserializer
            extends JsonDeserializer<Repository20PushedAt> {

        @Override
        public Repository20PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
