...
import com.github.api.models.containers.PullRequest33Assignees;
import com.github.api.models.containers.PullRequest33RequestedReviewers;
...
/**
 * This is a model class for PullRequest33 type.
 */
public class PullRequest33 {
    private Links2 links;
    private Object activeLockReason;
    private Integer additions;
    private Object assignee;
    private List<PullRequest33Assignees> assignees;
    ...
    private List<PullRequest33RequestedReviewers> requestedReviewers;
     ...
     * @param  head  Head13 value for head.
     ...
     * @param  requestedReviewers  List of PullRequest33RequestedReviewers value for
     *         requestedReviewers.
    ...
    public PullRequest33(
            ...
            Object assignee,
            List<PullRequest33Assignees> assignees,
            ...
            int number,
            String patchUrl,
            List<PullRequest33RequestedReviewers> requestedReviewers,
     ...
     */
    protected PullRequest33(Links2 links, Object activeLockReason, Object assignee,
            List<PullRequest33Assignees> assignees, AuthorAssociationEnum authorAssociation,
            Object autoMerge, Base13 base, String body, LocalDateTime closedAt, String commentsUrl,
            String commitsUrl, LocalDateTime createdAt, String diffUrl, boolean draft, Head13 head,
            ...
            int number, String patchUrl, List<PullRequest33RequestedReviewers> requestedReviewers,
     ...
     * @return Returns the List of PullRequest33Assignees
     */
    @JsonGetter("assignees")
    public List<PullRequest33Assignees> getAssignees() {
        return assignees;
    }

    /**
     * Setter for Assignees.
     * @param assignees Value for List of PullRequest33Assignees
     */
    @JsonSetter("assignees")
    public void setAssignees(List<PullRequest33Assignees> assignees) {
        this.assignees = assignees;
    }
    ...
    /**
     * Getter for Base.
     * @return Returns the Base13
     */
    @JsonGetter("base")
    public Base13 getBase() {
        return base;
    }

    /**
     * Setter for Base.
     * @param base Value for Base13
     */
    @JsonSetter("base")
    public void setBase(Base13 base) {
        this.base = base;
    }
    ...
    /**
     * Getter for Head.
     * @return Returns the Head13
     */
    @JsonGetter("head")
    public Head13 getHead() {
        return head;
    }

    /**
     * Setter for Head.
     * @param head Value for Head13
     */
    @JsonSetter("head")
    public void setHead(Head13 head) {
        this.head = head;
    }
     ...
     * @return Returns the List of PullRequest33RequestedReviewers
     */
    @JsonGetter("requested_reviewers")
    public List<PullRequest33RequestedReviewers> getRequestedReviewers() {
        return requestedReviewers;
    }

    /**
     * Setter for RequestedReviewers.
     * @param requestedReviewers Value for List of PullRequest33RequestedReviewers
     */
    @JsonSetter("requested_reviewers")
    public void setRequestedReviewers(List<PullRequest33RequestedReviewers> requestedReviewers) {
        this.requestedReviewers = requestedReviewers;
    }
    ...
    /**
     * Converts this PullRequest33 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequest33 [" + "links=" + links + ", activeLockReason=" + activeLockReason
    ...
    /**
     * Builds a new {@link PullRequest33.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequest33.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequest33}.
     */
    public static class Builder {
        ...
        public Builder(Links2 links, Object activeLockReason, Object assignee,
                List<PullRequest33Assignees> assignees, AuthorAssociationEnum authorAssociation,
                Object autoMerge, Base13 base, String body, LocalDateTime closedAt,
                String commentsUrl, String commitsUrl, LocalDateTime createdAt, String diffUrl,
                boolean draft, Head13 head, String htmlUrl, int id, String issueUrl,
         ...
         * @return Builder
         */
        public Builder assignees(List<PullRequest33Assignees> assignees) {
            this.assignees = assignees;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder base(Base13 base) {
            this.base = base;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder head(Head13 head) {
            this.head = head;
            return this;
        }
        ...
        /**
         * Builds a new {@link PullRequest33} object using the set fields.
         * @return {@link PullRequest33}
         */
        public PullRequest33 build() {
            return new PullRequest33(links, activeLockReason, assignee, assignees,
                    authorAssociation, autoMerge, base, body, closedAt, commentsUrl, commitsUrl,
                    createdAt, diffUrl, draft, head, htmlUrl, id, issueUrl, labels, locked,
