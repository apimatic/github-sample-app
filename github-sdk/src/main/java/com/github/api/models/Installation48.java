...
import com.github.api.models.containers.Installation48Account;
...
/**
 * This is a model class for Installation48 type.
 */
public class Installation48 {
    private int id;
     ...
     */
    protected Installation48(int id, Account account, RepositorySelectionEnum repositorySelection,
            String accessTokensUrl, String repositoriesUrl, String htmlUrl, int appId, int targetId,
            String targetType, Permissions3 permissions, List<String> events,
            LocalDateTime createdAt, LocalDateTime updatedAt, String singleFileName, String appSlug,
            Object suspendedBy, LocalDateTime suspendedAt, Boolean hasMultipleSingleFiles,
            List<String> singleFilePaths, OptionalNullable<String> contactEmail) {
        this.id = id;
        this.account = account;
        this.repositorySelection = repositorySelection;
        this.accessTokensUrl = accessTokensUrl;
    ...
    /**
     * Converts this Installation48 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Installation48 [" + "id=" + id + ", account=" + account + ", repositorySelection="
                + repositorySelection + ", accessTokensUrl=" + accessTokensUrl
                + ", repositoriesUrl=" + repositoriesUrl + ", htmlUrl=" + htmlUrl + ", appId="
                + appId + ", targetId=" + targetId + ", targetType=" + targetType + ", permissions="
                + permissions + ", events=" + events + ", createdAt=" + createdAt + ", updatedAt="
                + updatedAt + ", singleFileName=" + singleFileName + ", appSlug=" + appSlug
                + ", suspendedBy=" + suspendedBy + ", suspendedAt=" + suspendedAt
                + ", hasMultipleSingleFiles=" + hasMultipleSingleFiles + ", singleFilePaths="
                + singleFilePaths + ", contactEmail=" + contactEmail + "]";
    }

    /**
     * Builds a new {@link Installation48.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Installation48.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Installation48}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Installation48} object using the set fields.
         * @return {@link Installation48}
         */
        public Installation48 build() {
            return new Installation48(id, account, repositorySelection, accessTokensUrl,
                    repositoriesUrl, htmlUrl, appId, targetId, targetType, permissions, events,
                    createdAt, updatedAt, singleFileName, appSlug, suspendedBy, suspendedAt,
