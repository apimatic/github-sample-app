...
/**
 * This is a model class for Comment8 type.
 */
public class Comment8 {
    ...
    /**
     * Converts this Comment8 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Comment8 [" + "links=" + links + ", authorAssociation=" + authorAssociation
                + ", body=" + body + ", commitId=" + commitId + ", createdAt=" + createdAt
                + ", diffHunk=" + diffHunk + ", htmlUrl=" + htmlUrl + ", id=" + id + ", line="
                + line + ", nodeId=" + nodeId + ", originalCommitId=" + originalCommitId
    ...
    /**
     * Builds a new {@link Comment8.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Comment8.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Comment8}.
     */
    public static class Builder {
        ...
        public Builder(Links11 links, AuthorAssociationEnum authorAssociation, String body,
                ...
                Integer line, String nodeId, String originalCommitId, Integer originalLine,
        ...
        /**
         * Builds a new {@link Comment8} object using the set fields.
         * @return {@link Comment8}
         */
        public Comment8 build() {
            return new Comment8(links, authorAssociation, body, commitId, createdAt, diffHunk,
                    htmlUrl, id, line, nodeId, originalCommitId, originalLine, originalPosition,
                    originalStartLine, path, position, pullRequestReviewId, pullRequestUrl,
                    reactions, side, startLine, startSide, updatedAt, url, user, inReplyToId);
        }
    }
}
