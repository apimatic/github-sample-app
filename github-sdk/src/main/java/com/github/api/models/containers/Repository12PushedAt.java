 ...
 */
@JsonDeserialize(using = Repository12PushedAt.Repository12PushedAtDeserializer.class)
public abstract class Repository12PushedAt {
     ...
     */
    public static Repository12PushedAt fromNumber(int number) {
     ...
     */
    public static Repository12PushedAt fromDateTime(LocalDateTime dateTime) {
     ...
     */
    public static Repository12PushedAt fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository12PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository12PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends Repository12PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository12PushedAt.
     */
    protected static class Repository12PushedAtDeserializer
            extends JsonDeserializer<Repository12PushedAt> {

        @Override
        public Repository12PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
