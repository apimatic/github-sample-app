...
/**
 * Event7Enum to be used.
 */
public enum Event7Enum {
    ...
    private static TreeMap<String, Event7Enum> valueMap = new TreeMap<>();
    ...
    public static Event7Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of Event7Enum values to list of string values.
     * @param toConvert The list of Event7Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<Event7Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (Event7Enum enumValue : toConvert) {
