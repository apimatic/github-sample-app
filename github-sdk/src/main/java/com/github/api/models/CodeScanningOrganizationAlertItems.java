...
/**
 * This is a model class for CodeScanningOrganizationAlertItems type.
 */
public class CodeScanningOrganizationAlertItems {
     ...
     * @param  rule  CodeScanningAlertRule value for rule.
     ...
     * @param  repository  Repository1 value for repository.
     ...
     */
    protected CodeScanningOrganizationAlertItems(int number, LocalDateTime createdAt, String url,
            ...
            CodeScanningAlertRule rule, CodeScanningAnalysisTool tool,
            CodeScanningAlertInstance mostRecentInstance, Repository1 repository,
            LocalDateTime updatedAt, OptionalNullable<LocalDateTime> fixedAt,
            OptionalNullable<String> dismissedComment) {
        this.number = number;
        this.createdAt = createdAt;
        this.updatedAt = updatedAt;
        this.url = url;
    ...
    /**
     * Getter for Rule.
     * @return Returns the CodeScanningAlertRule
     */
    @JsonGetter("rule")
    ...
    /**
     * Setter for Rule.
     * @param rule Value for CodeScanningAlertRule
     */
    @JsonSetter("rule")
     ...
     * @return Returns the Repository1
     */
     ...
     * @param repository Value for Repository1
     */
    ...
    /**
     * Converts this CodeScanningOrganizationAlertItems into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CodeScanningOrganizationAlertItems [" + "number=" + number + ", createdAt="
                + createdAt + ", url=" + url + ", htmlUrl=" + htmlUrl + ", instancesUrl="
                + instancesUrl + ", state=" + state + ", dismissedBy=" + dismissedBy
                + ", dismissedAt=" + dismissedAt + ", dismissedReason=" + dismissedReason
                + ", rule=" + rule + ", tool=" + tool + ", mostRecentInstance=" + mostRecentInstance
                + ", repository=" + repository + ", updatedAt=" + updatedAt + ", fixedAt=" + fixedAt
                + ", dismissedComment=" + dismissedComment + "]";
    }

    /**
     * Builds a new {@link CodeScanningOrganizationAlertItems.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CodeScanningOrganizationAlertItems.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CodeScanningOrganizationAlertItems}.
     */
    public static class Builder {
        ...
        public Builder(int number, LocalDateTime createdAt, String url, String htmlUrl,
                ...
                LocalDateTime dismissedAt, Object dismissedReason, CodeScanningAlertRule rule,
                CodeScanningAnalysisTool tool, CodeScanningAlertInstance mostRecentInstance,
                Repository1 repository) {
            this.number = number;
            this.createdAt = createdAt;
            this.url = url;
         ...
         * @return Builder
         */
        public Builder rule(CodeScanningAlertRule rule) {
            this.rule = rule;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder repository(Repository1 repository) {
            this.repository = repository;
            return this;
        }
        ...
        /**
         * Builds a new {@link CodeScanningOrganizationAlertItems} object using the set fields.
         * @return {@link CodeScanningOrganizationAlertItems}
         */
        public CodeScanningOrganizationAlertItems build() {
            return new CodeScanningOrganizationAlertItems(number, createdAt, url, htmlUrl,
                    instancesUrl, state, dismissedBy, dismissedAt, dismissedReason, rule, tool,
                    mostRecentInstance, repository, updatedAt, fixedAt, dismissedComment);
        }
    }
}
