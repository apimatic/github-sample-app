 ...
 */
@JsonDeserialize(using = PackageVersion3Body.PackageVersion3BodyDeserializer.class)
public abstract class PackageVersion3Body {
     ...
     */
    public static PackageVersion3Body fromMString(String mString) {
     ...
     */
    public static PackageVersion3Body fromObject(Map<String, Object> object) {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends PackageVersion3Body {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class ObjectCase extends PackageVersion3Body {
    ...
    /**
     * This is a custom deserializer class for PackageVersion3Body.
     */
    protected static class PackageVersion3BodyDeserializer
            extends JsonDeserializer<PackageVersion3Body> {

        @Override
        public PackageVersion3Body deserialize(JsonParser jp, DeserializationContext ctxt)
