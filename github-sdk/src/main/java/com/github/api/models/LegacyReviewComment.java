...
/**
 * This is a model class for LegacyReviewComment type.
 */
public class LegacyReviewComment {
     ...
     */
    protected LegacyReviewComment(String url, Integer pullRequestReviewId, int id, String nodeId,
            String diffHunk, String path, Integer position, int originalPosition, String commitId,
            String originalCommitId, Object user, String body, LocalDateTime createdAt,
            ...
            String bodyText, String bodyHtml, ReactionRollup reactions, Side1Enum side,
            Object startSide, Integer line, Integer originalLine,
    ...
    /**
     * Converts this LegacyReviewComment into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "LegacyReviewComment [" + "url=" + url + ", pullRequestReviewId="
                ...
                + ", links=" + links + ", inReplyToId=" + inReplyToId + ", bodyText=" + bodyText
                + ", bodyHtml=" + bodyHtml + ", reactions=" + reactions + ", side=" + side
                + ", startSide=" + startSide + ", line=" + line + ", originalLine=" + originalLine
                + ", startLine=" + startLine + ", originalStartLine=" + originalStartLine + "]";
    }

    /**
     * Builds a new {@link LegacyReviewComment.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link LegacyReviewComment.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link LegacyReviewComment}.
     */
    public static class Builder {
        ...
        public Builder(String url, Integer pullRequestReviewId, int id, String nodeId,
                String diffHunk, String path, Integer position, int originalPosition,
                String commitId, String originalCommitId, Object user, String body,
                LocalDateTime createdAt, LocalDateTime updatedAt, String htmlUrl,
                String pullRequestUrl, AuthorAssociationEnum authorAssociation, Links11 links) {
            this.url = url;
            this.pullRequestReviewId = pullRequestReviewId;
            this.id = id;
            this.nodeId = nodeId;
        ...
        /**
         * Builds a new {@link LegacyReviewComment} object using the set fields.
         * @return {@link LegacyReviewComment}
         */
        public LegacyReviewComment build() {
            return new LegacyReviewComment(url, pullRequestReviewId, id, nodeId, diffHunk, path,
                    position, originalPosition, commitId, originalCommitId, user, body, createdAt,
                    updatedAt, htmlUrl, pullRequestUrl, authorAssociation, links, inReplyToId,
                    bodyText, bodyHtml, reactions, side, startSide, line, originalLine, startLine,
                    originalStartLine);
        }
    }
}
