 ...
 */
@JsonDeserialize(using = Repository18PushedAt.Repository18PushedAtDeserializer.class)
public abstract class Repository18PushedAt {
     ...
     */
    public static Repository18PushedAt fromNumber(int number) {
     ...
     */
    public static Repository18PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository18PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository18PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository18PushedAt.
     */
    protected static class Repository18PushedAtDeserializer
            extends JsonDeserializer<Repository18PushedAt> {

        @Override
        public Repository18PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
