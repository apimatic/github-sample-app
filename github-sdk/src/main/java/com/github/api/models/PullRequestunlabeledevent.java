...
/**
 * This is a model class for PullRequestunlabeledevent type.
 */
public class PullRequestunlabeledevent {
     ...
     * Default constructor.
     */
    public PullRequestunlabeledevent() {
        action = "unlabeled";
    }
    ...
    /**
     * Converts this PullRequestunlabeledevent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PullRequestunlabeledevent [" + "action=" + action + ", number=" + number
                + ", pullRequest=" + pullRequest + ", repository=" + repository + ", sender="
                + sender + ", enterprise=" + enterprise + ", installation=" + installation
                + ", label=" + label + ", organization=" + organization + "]";
    }

    /**
     * Builds a new {@link PullRequestunlabeledevent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PullRequestunlabeledevent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PullRequestunlabeledevent}.
     */
    public static class Builder {
         ...
         * @param  sender  Sender value for sender.
         */
        public Builder(String action, int number, PullRequest28 pullRequest, Repository3 repository,
                Sender sender) {
            this.action = action;
            this.number = number;
            this.pullRequest = pullRequest;
        ...
        /**
         * Builds a new {@link PullRequestunlabeledevent} object using the set fields.
         * @return {@link PullRequestunlabeledevent}
         */
        public PullRequestunlabeledevent build() {
            return new PullRequestunlabeledevent(action, number, pullRequest, repository, sender,
                    enterprise, installation, label, organization);
        }
    }
}
