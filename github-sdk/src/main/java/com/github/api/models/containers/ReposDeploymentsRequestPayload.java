 ...
 */
@JsonDeserialize(using = ReposDeploymentsRequestPayload.ReposDeploymentsRequestPayloadDeserializer.class)
public abstract class ReposDeploymentsRequestPayload {
     ...
     */
    public static ReposDeploymentsRequestPayload fromObject(Map<String, Object> object) {
     ...
     */
    public static ReposDeploymentsRequestPayload fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class ObjectCase extends ReposDeploymentsRequestPayload {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends ReposDeploymentsRequestPayload {
    ...
    /**
     * This is a custom deserializer class for ReposDeploymentsRequestPayload.
     */
    protected static class ReposDeploymentsRequestPayloadDeserializer
            extends JsonDeserializer<ReposDeploymentsRequestPayload> {

        @Override
        public ReposDeploymentsRequestPayload deserialize(JsonParser jp, DeserializationContext ctxt)
