 ...
 */
@JsonDeserialize(using = Repository37PushedAt.Repository37PushedAtDeserializer.class)
public abstract class Repository37PushedAt {
     ...
     */
    public static Repository37PushedAt fromNumber(int number) {
     ...
     */
    public static Repository37PushedAt fromDateTime(LocalDateTime dateTime) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Repository37PushedAt {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorCase
    private static class DateTimeCase extends Repository37PushedAt {
    ...
    /**
     * This is a custom deserializer class for Repository37PushedAt.
     */
    protected static class Repository37PushedAtDeserializer
            extends JsonDeserializer<Repository37PushedAt> {

        @Override
        public Repository37PushedAt deserialize(JsonParser jp, DeserializationContext ctxt)
