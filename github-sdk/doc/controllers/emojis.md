...
```java
EmojisController emojisController = client.getEmojisController();
```
...
API method documentation: [https://docs.github.com/rest/reference/emojis#get-emojis](https://docs.github.com/rest/reference/emojis#get-emojis)

```java
CompletableFuture<Map<String, String>> emojisGetAsync()
```
...
```java
emojisController.emojisGetAsync().thenAccept(result -> {
...
```
{
  "plus1": "https://github.githubassets.com/images/icons/emoji/unicode/1f44d.png?v8",
  "minus1": "https://github.githubassets.com/images/icons/emoji/unicode/1f44e.png?v8",
