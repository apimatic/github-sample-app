...
API method documentation: [https://docs.github.com/rest/reference/search#search-code](https://docs.github.com/rest/reference/search#search-code)

```java
CompletableFuture<SearchCodeResponse> searchCodeAsync(
    final String q,
...
| `sort` | [`Sort151Enum`](../../doc/models/sort-151-enum.md) | Query, Optional | Sorts the results of your query. Can only be `indexed`, which indicates how recently a file has been indexed by the GitHub search infrastructure. Default: [best match](https://docs.github.com/rest/reference/search#ranking-search-results) |
...
[`SearchCodeResponse`](../../doc/models/search-code-response.md)
...
searchController.searchCodeAsync(q, null, null, perPage, page).thenAccept(result -> {
