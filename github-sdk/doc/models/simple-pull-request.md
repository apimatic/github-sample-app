...
| `Assignees` | [`List<SimplePullRequestAssignees>`]($m/SimplePullRequestAssignees) | Required | - | List<SimplePullRequestAssignees> getAssignees() | setAssignees(List<SimplePullRequestAssignees> assignees) |
...
| `RequestedReviewers` | [`List<SimplePullRequestRequestedReviewers>`]($m/SimplePullRequestRequestedReviewers) | Required | - | List<SimplePullRequestRequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<SimplePullRequestRequestedReviewers> requestedReviewers) |
