...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"unlocked"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest53`](../../doc/models/pull-request-53.md) | Required | - | PullRequest53 getPullRequest() | setPullRequest(PullRequest53 pullRequest) |
