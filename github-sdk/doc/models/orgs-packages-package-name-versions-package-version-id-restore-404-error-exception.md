...
# Orgs Packages Package Name Versions Package Version Id Restore 404 Error Exception

## Structure

`OrgsPackagesPackageNameVersionsPackageVersionIdRestore404ErrorException`
