...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"unblocked"` | String getAction() | setAction(String action) |
| `BlockedUser` | `Object` | Required | - | Object getBlockedUser() | setBlockedUser(Object blockedUser) |
