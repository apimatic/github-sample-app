...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"prereleased"` | String getAction() | setAction(String action) |
...
| `Release` | [`Release8`](../../doc/models/release-8.md) | Required | - | Release8 getRelease() | setRelease(Release8 release) |
