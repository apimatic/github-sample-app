...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"enqueued"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest34`](../../doc/models/pull-request-34.md) | Required | - | PullRequest34 getPullRequest() | setPullRequest(PullRequest34 pullRequest) |
