...
| `Assignees` | [`List<PullRequest41Assignees>`]($m/PullRequest41Assignees) | Required | - | List<PullRequest41Assignees> getAssignees() | setAssignees(List<PullRequest41Assignees> assignees) |
...
| `Head` | [`Head21`](../../doc/models/head-21.md) | Required | - | Head21 getHead() | setHead(Head21 head) |
...
| `RequestedReviewers` | [`List<PullRequest41RequestedReviewers>`]($m/PullRequest41RequestedReviewers) | Required | - | List<PullRequest41RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest41RequestedReviewers> requestedReviewers) |
