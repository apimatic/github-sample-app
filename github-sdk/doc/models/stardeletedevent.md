...
| `StarredAt` | `Object` | Required | The time the star was created. This is a timestamp in ISO 8601 format: `YYYY-MM-DDTHH:MM:SSZ`. Will be `null` for the `deleted` action. | Object getStarredAt() | setStarredAt(Object starredAt) |
