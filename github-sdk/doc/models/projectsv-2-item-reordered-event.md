...
# Projectsv 2 Item Reordered Event
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"reordered"` | String getAction() | setAction(String action) |
| `Changes` | [`Changes23`](../../doc/models/changes-23.md) | Required | - | Changes23 getChanges() | setChanges(Changes23 changes) |
