...
# Pull Request Review Threadunresolvedevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"unresolved"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`SimplePullRequest4`](../../doc/models/simple-pull-request-4.md) | Required | - | SimplePullRequest4 getPullRequest() | setPullRequest(SimplePullRequest4 pullRequest) |
...
| `Thread` | [`Thread2`](../../doc/models/thread-2.md) | Required | - | Thread2 getThread() | setThread(Thread2 thread) |
