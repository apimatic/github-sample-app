...
# Pull Requestreview Requestedevent 1

## Structure

`PullRequestreviewRequestedevent1`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"review_requested"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest49`](../../doc/models/pull-request-49.md) | Required | - | PullRequest49 getPullRequest() | setPullRequest(PullRequest49 pullRequest) |
...
| `RequestedTeam` | [`RequestedTeam6`](../../doc/models/requested-team-6.md) | Required | - | RequestedTeam6 getRequestedTeam() | setRequestedTeam(RequestedTeam6 requestedTeam) |
