...
| `Assignees` | [`List<PullRequest33Assignees>`]($m/PullRequest33Assignees) | Required | - | List<PullRequest33Assignees> getAssignees() | setAssignees(List<PullRequest33Assignees> assignees) |
| `AuthorAssociation` | [`AuthorAssociationEnum`](../../doc/models/author-association-enum.md) | Required | - | AuthorAssociationEnum getAuthorAssociation() | setAuthorAssociation(AuthorAssociationEnum authorAssociation) |
| `AutoMerge` | `Object` | Required | - | Object getAutoMerge() | setAutoMerge(Object autoMerge) |
| `Base` | [`Base13`](../../doc/models/base-13.md) | Required | - | Base13 getBase() | setBase(Base13 base) |
...
| `Head` | [`Head13`](../../doc/models/head-13.md) | Required | - | Head13 getHead() | setHead(Head13 head) |
...
| `RequestedReviewers` | [`List<PullRequest33RequestedReviewers>`]($m/PullRequest33RequestedReviewers) | Required | - | List<PullRequest33RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest33RequestedReviewers> requestedReviewers) |
