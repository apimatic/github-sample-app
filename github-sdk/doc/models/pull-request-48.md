...
| `Assignees` | [`List<PullRequest48Assignees>`]($m/PullRequest48Assignees) | Required | - | List<PullRequest48Assignees> getAssignees() | setAssignees(List<PullRequest48Assignees> assignees) |
...
| `RequestedReviewers` | [`List<PullRequest48RequestedReviewers>`]($m/PullRequest48RequestedReviewers) | Required | - | List<PullRequest48RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest48RequestedReviewers> requestedReviewers) |
