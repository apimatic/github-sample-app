...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"demilestoned"` | String getAction() | setAction(String action) |
...
| `Milestone` | [`Milestone7`](../../doc/models/milestone-7.md) | Optional | - | Milestone7 getMilestone() | setMilestone(Milestone7 milestone) |
...
| `PullRequest` | [`PullRequest33`](../../doc/models/pull-request-33.md) | Required | - | PullRequest33 getPullRequest() | setPullRequest(PullRequest33 pullRequest) |
