...
| `CreatedAt` | [`Repository12CreatedAt`]($m/Repository12CreatedAt) | Required | - | Repository12CreatedAt getCreatedAt() | setCreatedAt(Repository12CreatedAt createdAt) |
...
| `PushedAt` | [`Repository12PushedAt`]($m/Repository12PushedAt) | Required | - | Repository12PushedAt getPushedAt() | setPushedAt(Repository12PushedAt pushedAt) |
