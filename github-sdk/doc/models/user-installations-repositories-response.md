...
# User Installations Repositories Response

## Structure

`UserInstallationsRepositoriesResponse`
...
| `RepositorySelection` | `String` | Optional | - | String getRepositorySelection() | setRepositorySelection(String repositorySelection) |
