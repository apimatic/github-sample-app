...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"category_changed"` | String getAction() | setAction(String action) |
| `Changes` | [`Changes1`](../../doc/models/changes-1.md) | Required | - | Changes1 getChanges() | setChanges(Changes1 changes) |
| `Discussion` | [`Discussion1`](../../doc/models/discussion-1.md) | Required | - | Discussion1 getDiscussion() | setDiscussion(Discussion1 discussion) |
