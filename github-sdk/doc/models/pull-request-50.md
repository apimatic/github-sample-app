...
| `Assignees` | [`List<PullRequest50Assignees>`]($m/PullRequest50Assignees) | Required | - | List<PullRequest50Assignees> getAssignees() | setAssignees(List<PullRequest50Assignees> assignees) |
...
| `Head` | [`Head35`](../../doc/models/head-35.md) | Required | - | Head35 getHead() | setHead(Head35 head) |
...
| `RequestedReviewers` | [`List<PullRequest50RequestedReviewers>`]($m/PullRequest50RequestedReviewers) | Required | - | List<PullRequest50RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest50RequestedReviewers> requestedReviewers) |
