...
| `Assignees` | [`List<PullRequest34Assignees>`]($m/PullRequest34Assignees) | Required | - | List<PullRequest34Assignees> getAssignees() | setAssignees(List<PullRequest34Assignees> assignees) |
...
| `RequestedReviewers` | [`List<PullRequest34RequestedReviewers>`]($m/PullRequest34RequestedReviewers) | Required | - | List<PullRequest34RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest34RequestedReviewers> requestedReviewers) |
