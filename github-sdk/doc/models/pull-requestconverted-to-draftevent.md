...
# Pull Requestconverted to Draftevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"converted_to_draft"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest32`](../../doc/models/pull-request-32.md) | Required | - | PullRequest32 getPullRequest() | setPullRequest(PullRequest32 pullRequest) |
