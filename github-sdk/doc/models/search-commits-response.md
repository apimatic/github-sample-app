...
| `Items` | [`List<CommitSearchResultItem>`](../../doc/models/commit-search-result-item.md) | Required | - | List<CommitSearchResultItem> getItems() | setItems(List<CommitSearchResultItem> items) |
