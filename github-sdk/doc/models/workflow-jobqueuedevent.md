...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"queued"` | String getAction() | setAction(String action) |
...
| `WorkflowJob` | [`WorkflowJob2`](../../doc/models/workflow-job-2.md) | Required | - | WorkflowJob2 getWorkflowJob() | setWorkflowJob(WorkflowJob2 workflowJob) |
