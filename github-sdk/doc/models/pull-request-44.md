...
| `Assignees` | [`List<PullRequest44Assignees>`]($m/PullRequest44Assignees) | Required | - | List<PullRequest44Assignees> getAssignees() | setAssignees(List<PullRequest44Assignees> assignees) |
...
| `RequestedReviewers` | [`List<PullRequest44RequestedReviewers>`]($m/PullRequest44RequestedReviewers) | Required | - | List<PullRequest44RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest44RequestedReviewers> requestedReviewers) |
