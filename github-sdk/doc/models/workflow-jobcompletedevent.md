...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"completed"` | String getAction() | setAction(String action) |
...
| `WorkflowJob` | [`WorkflowJob`](../../doc/models/workflow-job.md) | Required | - | WorkflowJob getWorkflowJob() | setWorkflowJob(WorkflowJob workflowJob) |
