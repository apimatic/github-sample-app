...
| `CheckRun` | `Object` | Optional | - | Object getCheckRun() | setCheckRun(Object checkRun) |
| `Deployment` | [`Deployment5`](../../doc/models/deployment-5.md) | Required | - | Deployment5 getDeployment() | setDeployment(Deployment5 deployment) |
| `DeploymentStatus` | [`DeploymentStatus12`](../../doc/models/deployment-status-12.md) | Required | - | DeploymentStatus12 getDeploymentStatus() | setDeploymentStatus(DeploymentStatus12 deploymentStatus) |
...
| `Workflow` | `Object` | Optional | - | Object getWorkflow() | setWorkflow(Object workflow) |
