...
# Repos Commits Ref Status Response

## Structure

`ReposCommitsRefStatusResponse`
...
| `Statuses` | [`List<SimpleCommitStatus>`](../../doc/models/simple-commit-status.md) | Required | - | List<SimpleCommitStatus> getStatuses() | setStatuses(List<SimpleCommitStatus> statuses) |
