...
| `CreatedAt` | [`Repository67CreatedAt`]($m/Repository67CreatedAt) | Required | - | Repository67CreatedAt getCreatedAt() | setCreatedAt(Repository67CreatedAt createdAt) |
...
| `PushedAt` | [`Repository67PushedAt`]($m/Repository67PushedAt) | Required | - | Repository67PushedAt getPushedAt() | setPushedAt(Repository67PushedAt pushedAt) |
