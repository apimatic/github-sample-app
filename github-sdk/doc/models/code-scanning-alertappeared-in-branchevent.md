...
# Code Scanning Alertappeared in Branchevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"appeared_in_branch"` | String getAction() | setAction(String action) |
| `Alert` | [`Alert20`](../../doc/models/alert-20.md) | Required | - | Alert20 getAlert() | setAlert(Alert20 alert) |
| `CommitOid` | `String` | Required | The commit SHA of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, the event was triggered by the `sender` and this value will be empty. | String getCommitOid() | setCommitOid(String commitOid) |
...
| `Ref` | `String` | Required | The Git reference of the code scanning alert. When the action is `reopened_by_user` or `closed_by_user`, the event was triggered by the `sender` and this value will be empty. | String getRef() | setRef(String ref) |
