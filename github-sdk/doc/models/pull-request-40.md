...
| `Assignees` | [`List<PullRequest40Assignees>`]($m/PullRequest40Assignees) | Required | - | List<PullRequest40Assignees> getAssignees() | setAssignees(List<PullRequest40Assignees> assignees) |
