...
| `CreatedAt` | [`Repository19CreatedAt`]($m/Repository19CreatedAt) | Required | - | Repository19CreatedAt getCreatedAt() | setCreatedAt(Repository19CreatedAt createdAt) |
...
| `PushedAt` | [`Repository19PushedAt`]($m/Repository19PushedAt) | Required | - | Repository19PushedAt getPushedAt() | setPushedAt(Repository19PushedAt pushedAt) |
