...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"transferred"` | String getAction() | setAction(String action) |
| `Changes` | [`Changes4`](../../doc/models/changes-4.md) | Required | - | Changes4 getChanges() | setChanges(Changes4 changes) |
