...
# Notifications Threads Response

## Structure

`NotificationsThreadsResponse`
...
| `Unread` | `boolean` | Required | - | boolean getUnread() | setUnread(boolean unread) |
| `UpdatedAt` | `String` | Required | - | String getUpdatedAt() | setUpdatedAt(String updatedAt) |
| `LastReadAt` | `String` | Required | - | String getLastReadAt() | setLastReadAt(String lastReadAt) |
