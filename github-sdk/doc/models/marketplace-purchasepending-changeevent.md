...
# Marketplace Purchasepending Changeevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"pending_change"` | String getAction() | setAction(String action) |
...
| `PreviousMarketplacePurchase` | [`MarketplacePurchase7`](../../doc/models/marketplace-purchase-7.md) | Optional | - | MarketplacePurchase7 getPreviousMarketplacePurchase() | setPreviousMarketplacePurchase(MarketplacePurchase7 previousMarketplacePurchase) |
