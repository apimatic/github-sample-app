...
| `Deployment` | [`Deployment4`](../../doc/models/deployment-4.md) | Required | - | Deployment4 getDeployment() | setDeployment(Deployment4 deployment) |
...
| `WorkflowRun` | `Object` | Required | - | Object getWorkflowRun() | setWorkflowRun(Object workflowRun) |
