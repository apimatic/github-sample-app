...
# Projectsv 2 Item Restored Event
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"restored"` | String getAction() | setAction(String action) |
| `Changes` | [`Changes20`](../../doc/models/changes-20.md) | Required | - | Changes20 getChanges() | setChanges(Changes20 changes) |
