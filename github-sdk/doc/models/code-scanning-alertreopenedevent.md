...
# Code Scanning Alertreopenedevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"reopened"` | String getAction() | setAction(String action) |
| `Alert` | `Object` | Required | - | Object getAlert() | setAlert(Object alert) |
