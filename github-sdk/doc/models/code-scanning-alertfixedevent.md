...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"fixed"` | String getAction() | setAction(String action) |
| `Alert` | [`Alert32`](../../doc/models/alert-32.md) | Required | - | Alert32 getAlert() | setAlert(Alert32 alert) |
