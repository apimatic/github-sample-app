...
| `Commit` | [`Commit6`](../../doc/models/commit-6.md) | Required | - | Commit6 getCommit() | setCommit(Commit6 commit) |
...
| `Parents` | [`List<Parent1>`](../../doc/models/parent-1.md) | Required | - | List<Parent1> getParents() | setParents(List<Parent1> parents) |
