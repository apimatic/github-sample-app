...
| `Workflow` | `Object` | Required | - | Object getWorkflow() | setWorkflow(Object workflow) |
| `WorkflowRun` | [`WorkflowRun3`](../../doc/models/workflow-run-3.md) | Required | - | WorkflowRun3 getWorkflowRun() | setWorkflowRun(WorkflowRun3 workflowRun) |
