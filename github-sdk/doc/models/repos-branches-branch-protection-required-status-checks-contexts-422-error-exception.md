...
# Repos Branches Branch Protection Required Status Checks Contexts 422 Error Exception

## Structure

`ReposBranchesBranchProtectionRequiredStatusChecksContexts422ErrorException`
