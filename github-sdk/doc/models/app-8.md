...
| `Events` | [`List<Event7Enum>`](../../doc/models/event-7-enum.md) | Optional | The list of events for the GitHub app | List<Event7Enum> getEvents() | setEvents(List<Event7Enum> events) |
