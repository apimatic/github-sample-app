...
| `Assignees` | [`List<PullRequest49Assignees>`]($m/PullRequest49Assignees) | Required | - | List<PullRequest49Assignees> getAssignees() | setAssignees(List<PullRequest49Assignees> assignees) |
