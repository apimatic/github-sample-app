...
# Pull Request Review Threadresolvedevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"resolved"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`SimplePullRequest3`](../../doc/models/simple-pull-request-3.md) | Required | - | SimplePullRequest3 getPullRequest() | setPullRequest(SimplePullRequest3 pullRequest) |
...
| `Thread` | [`Thread1`](../../doc/models/thread-1.md) | Required | - | Thread1 getThread() | setThread(Thread1 thread) |
