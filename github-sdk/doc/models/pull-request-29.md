...
| `Assignees` | [`List<PullRequest29Assignees>`]($m/PullRequest29Assignees) | Required | - | List<PullRequest29Assignees> getAssignees() | setAssignees(List<PullRequest29Assignees> assignees) |
...
| `RequestedReviewers` | [`List<PullRequest29RequestedReviewers>`]($m/PullRequest29RequestedReviewers) | Required | - | List<PullRequest29RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest29RequestedReviewers> requestedReviewers) |
