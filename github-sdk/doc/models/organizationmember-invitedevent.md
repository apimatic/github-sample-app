...
# Organizationmember Invitedevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"member_invited"` | String getAction() | setAction(String action) |
...
| `Invitation` | [`Invitation2`](../../doc/models/invitation-2.md) | Required | - | Invitation2 getInvitation() | setInvitation(Invitation2 invitation) |
