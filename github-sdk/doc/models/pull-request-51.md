...
| `Assignees` | [`List<PullRequest51Assignees>`]($m/PullRequest51Assignees) | Required | - | List<PullRequest51Assignees> getAssignees() | setAssignees(List<PullRequest51Assignees> assignees) |
| `AuthorAssociation` | [`AuthorAssociationEnum`](../../doc/models/author-association-enum.md) | Required | - | AuthorAssociationEnum getAuthorAssociation() | setAuthorAssociation(AuthorAssociationEnum authorAssociation) |
| `AutoMerge` | `Object` | Required | - | Object getAutoMerge() | setAutoMerge(Object autoMerge) |
| `Base` | [`Base37`](../../doc/models/base-37.md) | Required | - | Base37 getBase() | setBase(Base37 base) |
...
| `RequestedReviewers` | [`List<PullRequest51RequestedReviewers>`]($m/PullRequest51RequestedReviewers) | Required | - | List<PullRequest51RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest51RequestedReviewers> requestedReviewers) |
