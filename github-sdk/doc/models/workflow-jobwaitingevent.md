...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"waiting"` | String getAction() | setAction(String action) |
...
| `WorkflowJob` | [`WorkflowJob3`](../../doc/models/workflow-job-3.md) | Required | - | WorkflowJob3 getWorkflowJob() | setWorkflowJob(WorkflowJob3 workflowJob) |
