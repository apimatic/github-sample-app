...
| `Assignees` | [`List<SimplePullRequest4Assignees>`]($m/SimplePullRequest4Assignees) | Required | - | List<SimplePullRequest4Assignees> getAssignees() | setAssignees(List<SimplePullRequest4Assignees> assignees) |
| `AuthorAssociation` | [`AuthorAssociationEnum`](../../doc/models/author-association-enum.md) | Required | - | AuthorAssociationEnum getAuthorAssociation() | setAuthorAssociation(AuthorAssociationEnum authorAssociation) |
| `AutoMerge` | `Object` | Required | - | Object getAutoMerge() | setAutoMerge(Object autoMerge) |
| `Base` | [`Base34`](../../doc/models/base-34.md) | Required | - | Base34 getBase() | setBase(Base34 base) |
...
| `Head` | [`Head34`](../../doc/models/head-34.md) | Required | - | Head34 getHead() | setHead(Head34 head) |
...
| `RequestedReviewers` | [`List<SimplePullRequest4RequestedReviewers>`]($m/SimplePullRequest4RequestedReviewers) | Required | - | List<SimplePullRequest4RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<SimplePullRequest4RequestedReviewers> requestedReviewers) |
