...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"rerequested"` | String getAction() | setAction(String action) |
| `ActionsMeta` | `Object` | Optional | - | Object getActionsMeta() | setActionsMeta(Object actionsMeta) |
| `CheckSuite` | [`CheckSuite42`](../../doc/models/check-suite-42.md) | Required | - | CheckSuite42 getCheckSuite() | setCheckSuite(CheckSuite42 checkSuite) |
