...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"updated"` | String getAction() | setAction(String action) |
...
| `Package` | [`Package4`](../../doc/models/package-4.md) | Required | - | Package4 getPackage() | setPackage(Package4 mPackage) |
