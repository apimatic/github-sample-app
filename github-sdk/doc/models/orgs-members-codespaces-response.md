...
# Orgs Members Codespaces Response

## Structure

`OrgsMembersCodespacesResponse`
...
| `Codespaces` | [`List<Codespace>`](../../doc/models/codespace.md) | Required | - | List<Codespace> getCodespaces() | setCodespaces(List<Codespace> codespaces) |
