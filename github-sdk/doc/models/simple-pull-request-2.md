...
| `Assignees` | [`List<SimplePullRequest2Assignees>`]($m/SimplePullRequest2Assignees) | Required | - | List<SimplePullRequest2Assignees> getAssignees() | setAssignees(List<SimplePullRequest2Assignees> assignees) |
...
| `RequestedReviewers` | [`List<SimplePullRequest2RequestedReviewers>`]($m/SimplePullRequest2RequestedReviewers) | Required | - | List<SimplePullRequest2RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<SimplePullRequest2RequestedReviewers> requestedReviewers) |
