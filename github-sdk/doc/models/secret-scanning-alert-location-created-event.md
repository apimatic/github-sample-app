...
|  --- | --- | --- | --- | --- | --- |
| `Action` | [`Action1Enum`](../../doc/models/action-1-enum.md) | Optional | - | Action1Enum getAction() | setAction(Action1Enum action) |
| `Alert` | [`SecretScanningAlert`](../../doc/models/secret-scanning-alert.md) | Required | - | SecretScanningAlert getAlert() | setAlert(SecretScanningAlert alert) |
...
| `Location` | [`SecretScanningLocation`](../../doc/models/secret-scanning-location.md) | Required | - | SecretScanningLocation getLocation() | setLocation(SecretScanningLocation location) |
