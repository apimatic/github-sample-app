...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"closed"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest31`](../../doc/models/pull-request-31.md) | Required | - | PullRequest31 getPullRequest() | setPullRequest(PullRequest31 pullRequest) |
