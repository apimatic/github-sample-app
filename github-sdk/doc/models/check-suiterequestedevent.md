...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"requested"` | String getAction() | setAction(String action) |
| `ActionsMeta` | `Object` | Optional | - | Object getActionsMeta() | setActionsMeta(Object actionsMeta) |
| `CheckSuite` | [`CheckSuite32`](../../doc/models/check-suite-32.md) | Required | - | CheckSuite32 getCheckSuite() | setCheckSuite(CheckSuite32 checkSuite) |
