...
# Code Scanning Alertclosed by Userevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"closed_by_user"` | String getAction() | setAction(String action) |
| `Alert` | [`Alert19`](../../doc/models/alert-19.md) | Required | - | Alert19 getAlert() | setAlert(Alert19 alert) |
