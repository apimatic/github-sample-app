...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"in_progress"` | String getAction() | setAction(String action) |
...
| `WorkflowJob` | [`WorkflowJob1`](../../doc/models/workflow-job-1.md) | Required | - | WorkflowJob1 getWorkflowJob() | setWorkflowJob(WorkflowJob1 workflowJob) |
| `Deployment` | [`Deployment6`](../../doc/models/deployment-6.md) | Optional | - | Deployment6 getDeployment() | setDeployment(Deployment6 deployment) |
