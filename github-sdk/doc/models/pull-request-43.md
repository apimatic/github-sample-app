...
| `Assignees` | [`List<PullRequest43Assignees>`]($m/PullRequest43Assignees) | Required | - | List<PullRequest43Assignees> getAssignees() | setAssignees(List<PullRequest43Assignees> assignees) |
| `AuthorAssociation` | [`AuthorAssociationEnum`](../../doc/models/author-association-enum.md) | Required | - | AuthorAssociationEnum getAuthorAssociation() | setAuthorAssociation(AuthorAssociationEnum authorAssociation) |
| `AutoMerge` | `Object` | Optional | - | Object getAutoMerge() | setAutoMerge(Object autoMerge) |
...
| `RequestedReviewers` | [`List<PullRequest43RequestedReviewers>`]($m/PullRequest43RequestedReviewers) | Required | - | List<PullRequest43RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest43RequestedReviewers> requestedReviewers) |
