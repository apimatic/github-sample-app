...
# Users Installation Response

## Structure

`UsersInstallationResponse`
...
| `Account` | [`Account`]($m/UsersInstallationResponseAccount) | Required | - | Account getAccount() | setAccount(Account account) |
