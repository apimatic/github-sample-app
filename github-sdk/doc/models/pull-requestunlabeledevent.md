...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"unlabeled"` | String getAction() | setAction(String action) |
...
| `Label` | [`Label10`](../../doc/models/label-10.md) | Optional | - | Label10 getLabel() | setLabel(Label10 label) |
...
| `PullRequest` | [`PullRequest28`](../../doc/models/pull-request-28.md) | Required | - | PullRequest28 getPullRequest() | setPullRequest(PullRequest28 pullRequest) |
