...
# Organizationmember Removedevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"member_removed"` | String getAction() | setAction(String action) |
...
| `Membership` | [`Membership1`](../../doc/models/membership-1.md) | Required | - | Membership1 getMembership() | setMembership(Membership1 membership) |
