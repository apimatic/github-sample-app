...
| `Events` | [`List<Event12Enum>`](../../doc/models/event-12-enum.md) | Optional | The list of events for the GitHub app | List<Event12Enum> getEvents() | setEvents(List<Event12Enum> events) |
