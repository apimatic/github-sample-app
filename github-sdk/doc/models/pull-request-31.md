...
| `Assignees` | [`List<PullRequest31Assignees>`]($m/PullRequest31Assignees) | Required | - | List<PullRequest31Assignees> getAssignees() | setAssignees(List<PullRequest31Assignees> assignees) |
