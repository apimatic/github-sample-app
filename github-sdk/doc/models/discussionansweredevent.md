...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"answered"` | String getAction() | setAction(String action) |
| `Answer` | [`Answer`](../../doc/models/answer.md) | Required | - | Answer getAnswer() | setAnswer(Answer answer) |
| `Discussion` | [`Discussion`](../../doc/models/discussion.md) | Required | - | Discussion getDiscussion() | setDiscussion(Discussion discussion) |
