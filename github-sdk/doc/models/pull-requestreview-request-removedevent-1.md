...
# Pull Requestreview Request Removedevent 1

## Structure

`PullRequestreviewRequestRemovedevent1`

## Fields

| Name | Type | Tags | Description | Getter | Setter |
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"review_request_removed"` | String getAction() | setAction(String action) |
...
| `Number` | `int` | Required | The pull request number. | int getNumber() | setNumber(int number) |
...
| `PullRequest` | [`PullRequest47`](../../doc/models/pull-request-47.md) | Required | - | PullRequest47 getPullRequest() | setPullRequest(PullRequest47 pullRequest) |
...
| `RequestedTeam` | [`RequestedTeam5`](../../doc/models/requested-team-5.md) | Required | - | RequestedTeam5 getRequestedTeam() | setRequestedTeam(RequestedTeam5 requestedTeam) |
