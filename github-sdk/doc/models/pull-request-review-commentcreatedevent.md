...
# Pull Request Review Commentcreatedevent
...
| `Comment` | [`Comment8`](../../doc/models/comment-8.md) | Required | - | Comment8 getComment() | setComment(Comment8 comment) |
...
| `PullRequest` | [`PullRequest43`](../../doc/models/pull-request-43.md) | Required | - | PullRequest43 getPullRequest() | setPullRequest(PullRequest43 pullRequest) |
