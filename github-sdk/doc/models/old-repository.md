...
| `CreatedAt` | [`OldRepositoryCreatedAt`]($m/OldRepositoryCreatedAt) | Required | - | OldRepositoryCreatedAt getCreatedAt() | setCreatedAt(OldRepositoryCreatedAt createdAt) |
...
| `PushedAt` | [`OldRepositoryPushedAt`]($m/OldRepositoryPushedAt) | Required | - | OldRepositoryPushedAt getPushedAt() | setPushedAt(OldRepositoryPushedAt pushedAt) |
