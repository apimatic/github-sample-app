...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"requested_action"` | String getAction() | setAction(String action) |
| `CheckRun` | [`CheckRun3`](../../doc/models/check-run-3.md) | Required | - | CheckRun3 getCheckRun() | setCheckRun(CheckRun3 checkRun) |
...
| `RequestedAction` | [`RequestedAction2`](../../doc/models/requested-action-2.md) | Optional | - | RequestedAction2 getRequestedAction() | setRequestedAction(RequestedAction2 requestedAction) |
