...
| `CreatedAt` | [`Repository4CreatedAt`]($m/Repository4CreatedAt) | Required | - | Repository4CreatedAt getCreatedAt() | setCreatedAt(Repository4CreatedAt createdAt) |
...
| `PushedAt` | [`Repository4PushedAt`]($m/Repository4PushedAt) | Required | - | Repository4PushedAt getPushedAt() | setPushedAt(Repository4PushedAt pushedAt) |
