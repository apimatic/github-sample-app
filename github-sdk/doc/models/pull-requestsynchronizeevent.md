...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"synchronize"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest50`](../../doc/models/pull-request-50.md) | Required | - | PullRequest50 getPullRequest() | setPullRequest(PullRequest50 pullRequest) |
