...
# Pull Request Reviewsubmittedevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"submitted"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`SimplePullRequest2`](../../doc/models/simple-pull-request-2.md) | Required | - | SimplePullRequest2 getPullRequest() | setPullRequest(SimplePullRequest2 pullRequest) |
