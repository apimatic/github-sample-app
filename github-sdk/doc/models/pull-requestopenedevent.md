...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"opened"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest40`](../../doc/models/pull-request-40.md) | Required | - | PullRequest40 getPullRequest() | setPullRequest(PullRequest40 pullRequest) |
