...
| `Assignees` | [`List<PullRequest53Assignees>`]($m/PullRequest53Assignees) | Required | - | List<PullRequest53Assignees> getAssignees() | setAssignees(List<PullRequest53Assignees> assignees) |
...
| `RequestedReviewers` | [`List<PullRequest53RequestedReviewers>`]($m/PullRequest53RequestedReviewers) | Required | - | List<PullRequest53RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest53RequestedReviewers> requestedReviewers) |
