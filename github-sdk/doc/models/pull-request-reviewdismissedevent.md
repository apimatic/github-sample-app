...
# Pull Request Reviewdismissedevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"dismissed"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`SimplePullRequest`](../../doc/models/simple-pull-request.md) | Required | - | SimplePullRequest getPullRequest() | setPullRequest(SimplePullRequest pullRequest) |
...
| `Review` | [`Review4`](../../doc/models/review-4.md) | Required | - | Review4 getReview() | setReview(Review4 review) |
