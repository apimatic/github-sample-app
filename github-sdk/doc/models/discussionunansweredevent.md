...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"unanswered"` | String getAction() | setAction(String action) |
| `Discussion` | [`Discussion13`](../../doc/models/discussion-13.md) | Required | - | Discussion13 getDiscussion() | setDiscussion(Discussion13 discussion) |
...
| `OldAnswer` | [`Answer`](../../doc/models/answer.md) | Required | - | Answer getOldAnswer() | setOldAnswer(Answer oldAnswer) |
