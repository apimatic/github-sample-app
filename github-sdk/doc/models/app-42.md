...
| `Events` | [`List<Event2Enum>`](../../doc/models/event-2-enum.md) | Optional | The list of events for the GitHub app | List<Event2Enum> getEvents() | setEvents(List<Event2Enum> events) |
