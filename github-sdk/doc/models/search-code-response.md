...
| `Items` | [`List<CodeSearchResultItem>`](../../doc/models/code-search-result-item.md) | Required | - | List<CodeSearchResultItem> getItems() | setItems(List<CodeSearchResultItem> items) |
