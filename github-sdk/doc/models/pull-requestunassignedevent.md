...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"unassigned"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest51`](../../doc/models/pull-request-51.md) | Required | - | PullRequest51 getPullRequest() | setPullRequest(PullRequest51 pullRequest) |
