...
| `CreatedAt` | [`Repository43CreatedAt`]($m/Repository43CreatedAt) | Required | - | Repository43CreatedAt getCreatedAt() | setCreatedAt(Repository43CreatedAt createdAt) |
...
| `PushedAt` | [`Repository43PushedAt`]($m/Repository43PushedAt) | Required | - | Repository43PushedAt getPushedAt() | setPushedAt(Repository43PushedAt pushedAt) |
