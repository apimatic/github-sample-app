...
# Sponsorshippending Tier Changeevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"pending_tier_change"` | String getAction() | setAction(String action) |
| `Changes` | [`Changes34`](../../doc/models/changes-34.md) | Required | - | Changes34 getChanges() | setChanges(Changes34 changes) |
| `EffectiveDate` | `String` | Optional | The `pending_cancellation` and `pending_tier_change` event types will include the date the cancellation or tier change will take effect. | String getEffectiveDate() | setEffectiveDate(String effectiveDate) |
...
| `Sponsorship` | [`Sponsorship`](../../doc/models/sponsorship.md) | Required | - | Sponsorship getSponsorship() | setSponsorship(Sponsorship sponsorship) |
