...
# Pull Requestready for Reviewevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"ready_for_review"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest41`](../../doc/models/pull-request-41.md) | Required | - | PullRequest41 getPullRequest() | setPullRequest(PullRequest41 pullRequest) |
