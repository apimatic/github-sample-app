...
# Repos Branches Branch Protection Required Status Checks Contexts 404 Error Exception

## Structure

`ReposBranchesBranchProtectionRequiredStatusChecksContexts404ErrorException`
