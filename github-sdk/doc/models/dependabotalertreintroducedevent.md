...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"reintroduced"` | String getAction() | setAction(String action) |
| `Alert` | [`Alert8`](../../doc/models/alert-8.md) | Required | - | Alert8 getAlert() | setAlert(Alert8 alert) |
