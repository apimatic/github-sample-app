...
| `CreatedAt` | [`Repository37CreatedAt`]($m/Repository37CreatedAt) | Required | - | Repository37CreatedAt getCreatedAt() | setCreatedAt(Repository37CreatedAt createdAt) |
...
| `MergeCommitMessage` | [`MergeCommitMessage12Enum`](../../doc/models/merge-commit-message-12-enum.md) | Optional | - | MergeCommitMessage12Enum getMergeCommitMessage() | setMergeCommitMessage(MergeCommitMessage12Enum mergeCommitMessage) |
| `MergeCommitTitle` | [`MergeCommitTitle12Enum`](../../doc/models/merge-commit-title-12-enum.md) | Optional | - | MergeCommitTitle12Enum getMergeCommitTitle() | setMergeCommitTitle(MergeCommitTitle12Enum mergeCommitTitle) |
...
| `PushedAt` | [`Repository37PushedAt`]($m/Repository37PushedAt) | Required | - | Repository37PushedAt getPushedAt() | setPushedAt(Repository37PushedAt pushedAt) |
