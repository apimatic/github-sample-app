...
| `Assignees` | [`List<PullRequest28Assignees>`]($m/PullRequest28Assignees) | Required | - | List<PullRequest28Assignees> getAssignees() | setAssignees(List<PullRequest28Assignees> assignees) |
...
| `RequestedReviewers` | [`List<PullRequest28RequestedReviewers>`]($m/PullRequest28RequestedReviewers) | Required | - | List<PullRequest28RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<PullRequest28RequestedReviewers> requestedReviewers) |
