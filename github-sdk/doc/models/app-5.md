...
| `Events` | [`List<Event4Enum>`](../../doc/models/event-4-enum.md) | Optional | The list of events for the GitHub app | List<Event4Enum> getEvents() | setEvents(List<Event4Enum> events) |
