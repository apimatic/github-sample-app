...
| `CreatedAt` | [`Repository20CreatedAt`]($m/Repository20CreatedAt) | Required | - | Repository20CreatedAt getCreatedAt() | setCreatedAt(Repository20CreatedAt createdAt) |
...
| `PushedAt` | [`Repository20PushedAt`]($m/Repository20PushedAt) | Required | - | Repository20PushedAt getPushedAt() | setPushedAt(Repository20PushedAt pushedAt) |
...
| `SquashMergeCommitMessage` | [`SquashMergeCommitMessage13Enum`](../../doc/models/squash-merge-commit-message-13-enum.md) | Optional | - | SquashMergeCommitMessage13Enum getSquashMergeCommitMessage() | setSquashMergeCommitMessage(SquashMergeCommitMessage13Enum squashMergeCommitMessage) |
