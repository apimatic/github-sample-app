...
| `LastModifiedAt` | `LocalDateTime` | Optional | - | LocalDateTime getLastModifiedAt() | setLastModifiedAt(LocalDateTime lastModifiedAt) |
| `LineNumbers` | `List<String>` | Optional | - | List<String> getLineNumbers() | setLineNumbers(List<String> lineNumbers) |
