...
# Repos Branches Branch Protection Required Pull Request Reviews 422 Error Exception

## Structure

`ReposBranchesBranchProtectionRequiredPullRequestReviews422ErrorException`
