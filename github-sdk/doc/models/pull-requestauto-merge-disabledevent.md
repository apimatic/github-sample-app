...
# Pull Requestauto Merge Disabledevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"auto_merge_disabled"` | String getAction() | setAction(String action) |
...
| `PullRequest` | [`PullRequest29`](../../doc/models/pull-request-29.md) | Required | - | PullRequest29 getPullRequest() | setPullRequest(PullRequest29 pullRequest) |
