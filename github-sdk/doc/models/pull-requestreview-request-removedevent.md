...
# Pull Requestreview Request Removedevent
...
| `PullRequest` | [`PullRequest46`](../../doc/models/pull-request-46.md) | Required | - | PullRequest46 getPullRequest() | setPullRequest(PullRequest46 pullRequest) |
...
| `RequestedReviewer` | `Object` | Required | - | Object getRequestedReviewer() | setRequestedReviewer(Object requestedReviewer) |
