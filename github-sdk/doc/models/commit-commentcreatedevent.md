...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | The action performed. Can be `created`.<br>**Default**: `"created"` | String getAction() | setAction(String action) |
| `Comment` | [`Comment11`](../../doc/models/comment-11.md) | Required | - | Comment11 getComment() | setComment(Comment11 comment) |
