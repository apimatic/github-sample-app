...
| `CreatedAt` | [`Repository161CreatedAt`]($m/Repository161CreatedAt) | Required | - | Repository161CreatedAt getCreatedAt() | setCreatedAt(Repository161CreatedAt createdAt) |
...
| `PushedAt` | [`Repository161PushedAt`]($m/Repository161PushedAt) | Required | - | Repository161PushedAt getPushedAt() | setPushedAt(Repository161PushedAt pushedAt) |
