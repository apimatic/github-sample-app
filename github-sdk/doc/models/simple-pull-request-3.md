...
| `Assignees` | [`List<SimplePullRequest3Assignees>`]($m/SimplePullRequest3Assignees) | Required | - | List<SimplePullRequest3Assignees> getAssignees() | setAssignees(List<SimplePullRequest3Assignees> assignees) |
...
| `Head` | [`Head8`](../../doc/models/head-8.md) | Required | - | Head8 getHead() | setHead(Head8 head) |
...
| `RequestedReviewers` | [`List<SimplePullRequest3RequestedReviewers>`]($m/SimplePullRequest3RequestedReviewers) | Required | - | List<SimplePullRequest3RequestedReviewers> getRequestedReviewers() | setRequestedReviewers(List<SimplePullRequest3RequestedReviewers> requestedReviewers) |
