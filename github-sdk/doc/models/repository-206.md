...
| `CreatedAt` | [`Repository206CreatedAt`]($m/Repository206CreatedAt) | Required | - | Repository206CreatedAt getCreatedAt() | setCreatedAt(Repository206CreatedAt createdAt) |
...
| `PushedAt` | [`Repository206PushedAt`]($m/Repository206PushedAt) | Required | - | Repository206PushedAt getPushedAt() | setPushedAt(Repository206PushedAt pushedAt) |
