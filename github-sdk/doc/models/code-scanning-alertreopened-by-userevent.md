...
# Code Scanning Alertreopened by Userevent
...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | **Default**: `"reopened_by_user"` | String getAction() | setAction(String action) |
| `Alert` | [`Alert42`](../../doc/models/alert-42.md) | Required | - | Alert42 getAlert() | setAlert(Alert42 alert) |
