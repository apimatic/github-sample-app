...
|  --- | --- | --- | --- | --- | --- |
| `Action` | `String` | Required, Constant | The action that was performed.<br>**Default**: `"closed"` | String getAction() | setAction(String action) |
...
| `Issue` | [`Issue16`](../../doc/models/issue-16.md) | Required | - | Issue16 getIssue() | setIssue(Issue16 issue) |
