...
| `Events` | [`List<Event16Enum>`](../../doc/models/event-16-enum.md) | Optional | The list of events for the GitHub app | List<Event16Enum> getEvents() | setEvents(List<Event16Enum> events) |
